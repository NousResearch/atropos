...
def vr_optimization_function(features):
    ...
    # Feature weights
    weights = [-1.7520140247728957, 1.16865982623378, -0.22217354108158904, -1.3510415026080107, 1.0467079942883317, -1.802607352540241]
    x = np.dot(features, weights[:len(features)])
    
    # Polynomial function
    result = (-0.9717716282884401 * x**3 + 0.173355474869477 * x**2 + 
              0.6194853611721087 * x + 0.6066102847243802)
