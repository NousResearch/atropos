...
class TestScalingLogic(unittest.TestCase):
    ...
    def test_scale_up_with_pending(self):
        ...
        target = self.controller.calculate_desired(metrics, current_actors=1, pending_actors=3)
    ...
    def test_drain_aware_scale_down(self):
        ...
        target = self.controller.calculate_desired(metrics, current_actors=5, draining_actors=4)
