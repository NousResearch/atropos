...
Your JSON action:"""
    ...
    async def collect_trajectories(
        ...
        print(
            "DEBUG SPATIAL_ENV: llm_completion_raw received from get_anthropic_completion: "{llm_completion_raw}'"
        )
        ...
        if (
            ...
            print(
                "DEBUG SPATIAL_ENV: llm_completion_raw is invalid ("{llm_completion_raw}'). Using internal mock action."
            )
