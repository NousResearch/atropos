...
def collect_wikipedia_articles(num_articles=50, min_size=2000, days_ago=90, save_path="wikipedia_articles.json"):
    """
    ...
    HEADERS = {
        'User-Agent': 'WikipediaArticleCollector/0.1 (your-email@example.com)'
    }
    ...
    filtered_articles = [article for article in all_articles if article.get('newlen', 0) >= min_size]
