...
This script demonstrates how to run the WikipediaArticleCreatorEnv using OpenAI models.
It processes a single topic and saves the resulting article to a markdown file.
...
from environments.hack0.wikipedia.wikipedia_article_creator import (
...
def parse_args():
    parser = argparse.ArgumentParser(description="Run Wikipedia Article Creator with OpenAI")
    parser.add_argument(
        "--topic", 
        type=str, 
