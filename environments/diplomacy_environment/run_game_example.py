...
from ai_diplomacy.lm_game import DiplomacyGame, run_llm_game
...
async def create_game_with_atropos_agents(
    game_id: str = "atropos-test-game", models: Optional[Dict[str, str]] = None
) -> Dict:
    """
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Run Diplomacy games with Atropos integration"
    )
    ...
    parser.add_argument(
        "--max-turns", type=int, default=10, help="Maximum turns to play"
    )
    parser.add_argument(
        "--atropos-server",
        type=str,
