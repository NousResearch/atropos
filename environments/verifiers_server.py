...
# Optional dependency: verifiers environments come from PrimeIntellect hub.
try:
...
class VerifiersEnv(BaseEnv):
    def __init__(
        ...
        if vf is None:
            raise ImportError(
                "Missing optional dependency 'verifiers'. Install it to use VerifiersEnv "
                "(e.g. `pip install verifiers`)."
