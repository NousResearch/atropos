...
class HangmanOnlineEnv(BaseEnv):
    ...
    async def get_next_item(self, i: int = None) -> Tuple[int, None]:
        ...
        Returns:
            A tuple containing the seed and None (for future curriculum use)
        """
        seed = i if i is not None else random.randint(0, 1000000)
        return (seed, None)
