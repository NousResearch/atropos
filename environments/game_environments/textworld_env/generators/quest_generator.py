...
class QuestGenerator:
    ...
    def generate(
        ...
        try:
            ...
            if game_file:
                ...
                logger.info(
                    f"Generated quest game: {quest_type} ({difficulty}) - {game_file}"
                )
    ...
    def generate_with_custom_quest(
        self,
        commands: List[str],
        difficulty: str = "medium",
        output_folder: str = DEFAULT_OUTPUT_FOLDER,
...
if __name__ == "__main__":
    ...
    for quest_type in ["fetch", "delivery", "exploration"]:
        for difficulty in ["easy", "medium", "hard"]:
            ...
            game_file, config = generator.generate(
                difficulty=difficulty, quest_type=quest_type
            )
    ...
    game_file, config = generator.generate_with_custom_quest(
        commands=commands, difficulty="medium"
    )
