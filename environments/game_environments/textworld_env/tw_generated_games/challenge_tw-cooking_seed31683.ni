...
The kitchen part 2 is some text that varies. The kitchen part 2 is " You make out an oven.[if oven_0 is open and there is something in the oven_0] The oven contains [a list of things in the oven_0]. You look at the price tag that the oven's owner still hasn't taken off. Sixty bucks?! Where'd they buy this oven, some kind of expensive store?[end if]".
...
The f_4 and the f_6 and the f_1 and the f_2 and the f_3 and the f_5 and the f_0 and the f_7 are foods.
The f_4 and the f_6 and the f_1 and the f_2 and the f_3 and the f_5 and the f_0 and the f_7 are privately-named.
