...
The recreation zone part 0 is some text that varies. The recreation zone part 0 is "You find yourself in a recreation zone. A standard kind of place. Okay, just remember what you're here to do, and everything will go great.
...
The steam room part 0 is some text that varies. The steam room part 0 is "You have entered the most normal of all possible steam rooms.
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an life changing round of TextWorld? You do! Here is your task for today. First stop, head south. With that done, pick up the broom from the fl".
The objective part 1 is some text that varies. The objective part 1 is "oor of the washroom. And if you do that, you're the winner!".
