...
The kitchen part 6 is some text that varies. The kitchen part 6 is " Oh, great. Here's a table. [if there is something on the s_0]On the table you make out [a list of things on the s_0].[end if]".
...
The kitchen part 8 is some text that varies. The kitchen part 8 is " You can make out a counter. [if there is something on the s_1]On the counter you can make out [a list of things on the s_1].[end if]".
The kitchen part 9 is some text that varies. The kitchen part 9 is "[if there is nothing on the s_1]Looks like someone's already been here and taken everything off it, though. This always happens, here in TextWorld![end if]".
...
The f_0 and the f_5 and the f_6 and the f_1 and the f_2 and the f_3 and the f_7 and the f_8 and the f_4 are foods.
The f_0 and the f_5 and the f_6 and the f_1 and the f_2 and the f_3 and the f_7 and the f_8 and the f_4 are privately-named.
...
The printed name of f_6 is "cilantro".
Understand "cilantro" as f_6.
