...
The r_0 and the r_1 and the r_10 and the r_9 and the r_6 and the r_4 and the r_7 and the r_2 and the r_3 and the r_5 and the r_8 and the r_11 are rooms.
...
The kitchen part 5 is some text that varies. The kitchen part 5 is " You smell a pungent smell, and follow it to a table. [if there is something on the s_0]You see [a list of things on the s_0] on the table. You can't wait to tell the folks at home about this![end if]".
...
The kitchen part 7 is some text that varies. The kitchen part 7 is " Oh, great. Here's a counter. [if there is something on the s_1]On the counter you can see [a list of things on the s_1]. It doesn't get more TextWorld than this![end if]".
...
The driveway part 0 is some text that varies. The driveway part 0 is "Here we are in the driveway. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The backyard part 0 is some text that varies. The backyard part 0 is "You've just sauntered into a backyard. The room is well lit.
 ...
 You can see a patio chair. The patio chair is stylish.[if there is something on the s_5] On the patio chair you can see [a list of things on the s_5]. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[end if]".
...
The backyard part 9 is some text that varies. The backyard part 9 is " patio door leading west. There is an exit to the south. Don't worry, there is no door.".
...
The bedroom part 1 is some text that varies. The bedroom part 1 is "[if there is nothing on the s_4] But there isn't a thing on it. You think about smashing the bed to bits, throwing the bits into the garbage, etc, until you get bored and decide to move on.[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "I am sorry to announce that you are now in the bathroom. Let's see what's in here.
...
The f_4 and the f_3 and the f_1 and the f_5 and the f_0 and the f_2 are foods.
The f_4 and the f_3 and the f_1 and the f_5 and the f_0 and the f_2 are privately-named.
...
The r_0 and the r_1 and the r_10 and the r_9 and the r_6 and the r_4 and the r_7 and the r_2 and the r_3 and the r_5 and the r_8 and the r_11 are rooms.
The r_0 and the r_1 and the r_10 and the r_9 and the r_6 and the r_4 and the r_7 and the r_2 and the r_3 and the r_5 and the r_8 and the r_11 are privately-named.
