...
The kitchen part 2 is some text that varies. The kitchen part 2 is " You scan the room for a counter, and you find a counter. The counter is normal.[if there is something on the s_1] On the counter you make out [a list of things on the s_1].[end if]".
...
The kitchen part 4 is some text that varies. The kitchen part 4 is " You hear a noise behind you and spin around, but you can't see anything other than a stove. The stove is standard.[if there is something on the s_2] On the stove you make out [a list of things on the s_2].[end if]".
...
The kitchen part 6 is some text that varies. The kitchen part 6 is " Look out! It's a- oh, never mind, it's just a kitchen island. Why don't you take a picture of it, it'll last longer! [if there is something on the s_3]You see [a list of things on the s_3] on the kitchen island.[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "Well I'll be, you are in a place we're calling a bedroom. I guess you better just go and list everything you see here.
...
The bedroom part 5 is some text that varies. The bedroom part 5 is " You rest your hand against a wall, but you miss the wall and fall onto a king-size bed. The king-size bed is standard.[if there is something on the s_0] On the king-size bed you make out [a list of things on the s_0].[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " You can see a bbq. The bbq is usual.[if there is something on the s_8] On the bbq you see [a list of things on the s_8].[end if]".
The backyard part 3 is some text that varies. The backyard part 3 is "[if there is nothing on the s_8] However, the bbq, like an empty bbq, has nothing on it. You make a mental note to not get your hopes up the next time you see a bbq in a room.[end if]".
The backyard part 4 is some text that varies. The backyard part 4 is " You see a patio table. The patio table is normal.[if there is something on the s_9] On the patio table you can make out [a list of things on the s_9]. There's something strange about this being here, but you can't put your finger on it.[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You're now in the living room.
 ...
 You see a couch. You shudder, but continue examining the couch. [if there is something on the s_5]On the couch you see [a list of things on the s_5].[end if]".
...
The living room part 2 is some text that varies. The living room part 2 is " You can make out a low table. [if there is something on the s_6]On the low table you make out [a list of things on the s_6]. There's something strange about this thing being here, but you don't have time to worry about that now.[end if]".
...
The bathroom part 1 is some text that varies. The bathroom part 1 is " toilet.[if c_3 is open and there is something in the c_3] The toilet contains [a list of things in the c_3]. Make a note of this, you might have to put stuff on or in it later on.[end if]".
...
The bathroom part 4 is some text that varies. The bathroom part 4 is " bath is nearby.[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4].[end if]".
...
The bathroom part 6 is some text that varies. The bathroom part 6 is " You can make out a sink. The sink is usual.[if there is something on the s_4] On the sink you make out [a list of things on the s_4]. You shudder, but continue examining the room.[end if]".
The bathroom part 7 is some text that varies. The bathroom part 7 is "[if there is nothing on the s_4] But the thing is empty, unfortunately. It would have been so cool if there was stuff on the sink.[end if]".
...
The garden part 0 is some text that varies. The garden part 0 is "You have entered the most standard of all possible gardens. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The f_4 is in r_5.
The f_4 is edible.
The description of f_5 is "The tomato plant looks inviting.".
...
The s_9 is in r_4.
The description of f_0 is "The lettuce looks delectable.".
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an profound round of TextWorld? You do! Here is how to play! First thing I need you to do is to ensure that the chest drawer is open. And then,".
The objective part 1 is some text that varies. The objective part 1 is " pick up the old key from the chest drawer. Then, assure that the wooden door inside the bedroom is unlocked. And then, open the wooden door. After that, venture east. After that, ensure that the refr".
The objective part 2 is some text that varies. The objective part 2 is "igerator is open. Then, pick up the apple from the refrigerator. If you can get your hands on the apple, rest the apple on the stove within the kitchen. And once you've done that, you win!".
