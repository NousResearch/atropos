...
The bar part 0 is some text that varies. The bar part 0 is "You find yourself in a bar. An usual one. I guess you better just go and list everything you see here.
...
Test quest0_0 with "go west / go south / take insect"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First off, go to the west. Then, make an attempt to take a trip south. Then, recover the insect from the".
The objective part 1 is some text that varies. The objective part 1 is " floor of the chamber. Got that? Good!".
