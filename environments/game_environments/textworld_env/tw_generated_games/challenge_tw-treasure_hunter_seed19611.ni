...
The workshop part 0 is some text that varies. The workshop part 0 is "Well, here we are in a workshop. You start to take note of what's in the room.
...
The vault part 0 is some text that varies. The vault part 0 is "I am pleased to announce that you are now in the vault. You begin looking for stuff.
...
The kitchenette part 0 is some text that varies. The kitchenette part 0 is "This might come as a shock to you, but you've just entered a kitchenette. Let's see what's in here.
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! First thing I need you to do is to move west. Okay, and then, retrieve the latchkey from the floor of the study. Alright, thanks!".
