...
The vault part 0 is some text that varies. The vault part 0 is "Ah, the vault. This is some kind of vault, really great standard vibes in this place, a wonderful standard atmosphere. Let's see what's in here.
...
The closet part 0 is some text that varies. The closet part 0 is "Fancy seeing you here. Here, by the way, being the closet. You can barely contain your excitement.
...
The description of f_0 is "that's a standard pizza!".
The printed name of f_0 is "pizza".
Understand "pizza" as f_0.
The f_0 is in r_1.
The description of o_0 is "The glove is dirty.".
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another fast paced round of TextWorld! Your task for today is to pick-up the glove from the floor of the vault.".
