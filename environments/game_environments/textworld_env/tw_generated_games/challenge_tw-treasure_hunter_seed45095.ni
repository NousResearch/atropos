...
The r_2 and the r_3 and the r_4 and the r_0 and the r_1 are rooms.
...
The studio part 0 is some text that varies. The studio part 0 is "This might come as a shock to you, but you've just come into a studio. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The r_2 and the r_3 and the r_4 and the r_0 and the r_1 are rooms.
The r_2 and the r_3 and the r_4 and the r_0 and the r_1 are privately-named.
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is your task for today. First thing I need you to do is to try to take a trip east. With that accomplished, venture east. Following that, recover the key from the floor of t".
The objective part 1 is some text that varies. The objective part 1 is "he studio. Once that's all handled, you can stop!".
