...
The o_0 is in r_1.
The description of o_1 is "The mat looks well matched to everything else here".
...
Test quest0_0 with "go east / take soap dispenser"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is how to play! Your first objective is to try to go east. That done, recover the soap dispenser from the floor of the laundromat. And once you've done that, you win!".
