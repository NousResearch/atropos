...
The restroom part 0 is some text that varies. The restroom part 0 is "This restroom you have just entered is definitely normal.
...
The cubicle part 0 is some text that varies. The cubicle part 0 is "You are in a cubicle. An ordinary kind of place. You can barely contain your excitement.
...
The office part 0 is some text that varies. The office part 0 is "You're now in an office. You can barely contain your excitement.
...
The f_0 is in r_3.
The description of o_0 is "The shirt would seem to be to fit in here".
...
Test quest0_0 with "go west / take burger"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First off, make an attempt to head west. And then, recover the burger from the floor of the steam room. ".
