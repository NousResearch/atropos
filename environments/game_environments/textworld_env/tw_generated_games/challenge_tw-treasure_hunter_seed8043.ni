...
The salon part 0 is some text that varies. The salon part 0 is "You arrive in a salon. An usual one. Let's see what's in here.
...
The canteen part 0 is some text that varies. The canteen part 0 is "You find yourself in a canteen. A normal kind of place. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The lounge part 0 is some text that varies. The lounge part 0 is "Fancy seeing you here. Here, by the way, being the lounge.
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is your task for today. First thing I need you to do is to try to go to the south. After that, pick-up the passkey from the floor of the garage. And once you've done that, y".
The objective part 1 is some text that varies. The objective part 1 is "ou win!".
