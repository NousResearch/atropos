...
The parlor part 0 is some text that varies. The parlor part 0 is "You make a grand eccentric entrance into a parlor. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
Test quest0_0 with "go west / go north / take cookie"
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Here is your task for today. First step, go west. Then, try to go to the north. Okay, and then, retrieve the coo".
The objective part 1 is some text that varies. The objective part 1 is "kie from the floor of the vault. Got that? Good!".
