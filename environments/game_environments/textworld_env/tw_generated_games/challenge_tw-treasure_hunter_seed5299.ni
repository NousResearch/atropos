...
The cookery part 0 is some text that varies. The cookery part 0 is "Well, here we are in a cookery. The room is well lit.
...
The steam room part 0 is some text that varies. The steam room part 0 is "If you're wondering why everything seems so normal all of a sudden, it's because you've just walked into the steam room.
...
The restroom part 0 is some text that varies. The restroom part 0 is "You've moved into a standard room. Your mind races to think of what kind of room would be standard. And then it hits you. Of course. You're in the restroom. You begin looking for stuff.
...
The k_0 is in r_3.
The description of o_0 is "The teacup looks out of place here".
...
Test quest0_0 with "go west / take teacup"
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! First step, move west. And then, lift the teacup from the floor of the cookery. Got that? Good!".
