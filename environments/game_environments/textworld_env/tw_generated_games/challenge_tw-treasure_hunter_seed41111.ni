...
The chamber part 0 is some text that varies. The chamber part 0 is "Of every chamber you could have sauntered into, you had to show up in an usual one.
...
The bar part 0 is some text that varies. The bar part 0 is "You arrive in a bar. A typical one. You try to gain information on your surroundings by using a technique you call 'looking.'
...
Test quest0_0 with "take synthesizer"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Your task for today is to lift the synthesizer from the floor of the bar.".
