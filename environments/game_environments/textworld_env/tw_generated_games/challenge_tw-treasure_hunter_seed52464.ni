...
The closet part 0 is some text that varies. The closet part 0 is "I am stoked to announce that you are now in the closet.
...
The cellar part 0 is some text that varies. The cellar part 0 is "You have moved into the most standard of all possible cellars.
...
The workshop part 0 is some text that varies. The workshop part 0 is "You find yourself in a standard kind of place. That is to say, you're in a workshop.
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a exciting session of TextWorld! Here is your task for today. First stop, go west. If you can finish that, pick up the fondue from the floor of the cellar. Got that? Good!".
