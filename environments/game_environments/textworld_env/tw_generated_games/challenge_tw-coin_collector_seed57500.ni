...
The basement part 0 is some text that varies. The basement part 0 is "You have fallen into the most usual of all possible basements.
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First stop, move east. Then, retrieve the coin from the floor of the basement. Got that? Good!".
