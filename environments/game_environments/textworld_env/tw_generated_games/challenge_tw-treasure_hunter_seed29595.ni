...
The cookhouse part 0 is some text that varies. The cookhouse part 0 is "You find yourself in a cookhouse. A normal one. You can barely contain your excitement.
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a profound round of TextWorld! Here is how to play! Your first objective is to make an effort to go to the north. And then, venture east. After that, retrieve the latchkey from the".
The objective part 1 is some text that varies. The objective part 1 is " floor of the cookhouse. Got that? Good!".
