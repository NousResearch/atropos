...
The r_0 and the r_2 and the r_10 and the r_11 and the r_5 and the r_3 and the r_4 and the r_6 and the r_7 and the r_9 and the r_1 and the r_8 are rooms.
...
The kitchen part 0 is some text that varies. The kitchen part 0 is "You arrive in a kitchen. An ordinary kind of place.
 ...
 You smell an awful smell, and follow it to a fridge.[if c_0 is open and there is something in the c_0] The fridge contains [a list of things in the c_0]. Classic TextWorld.[end if]".
...
The kitchen part 5 is some text that varies. The kitchen part 5 is "[if there is nothing on the s_0]But the thing hasn't got anything on it. You make a mental note to not get your hopes up the next time you see a table in a room.[end if]".
The kitchen part 6 is some text that varies. The kitchen part 6 is " You can see a counter. The counter is vast.[if there is something on the s_1] On the counter you see [a list of things on the s_1], so there's that.[end if]".
The kitchen part 7 is some text that varies. The kitchen part 7 is "[if there is nothing on the s_1] But the thing hasn't got anything on it. Aw, and here you were, all excited for there to be things on it![end if]".
...
The livingroom part 0 is some text that varies. The livingroom part 0 is "You are in a livingroom. A normal one. You try to gain information on your surroundings by using a technique you call 'looking.'

 You bend down to tie your shoe. When you stand up, you notice a sofa. The sofa is comfy.[if there is something on the s_6] On the sofa you see [a list of things on the s_6].[end if]".
...
The street part 0 is some text that varies. The street part 0 is "A crooked placard tells you that you are now in the street.
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You find yourself in a bedroom. A typical kind of place.
 ...
 You lean against the wall, inadvertently pressing a secret button. The wall opens up to reveal a bed. You shudder, but continue examining the bed. [if there is something on the s_9]You see [a list of things on the s_9] on the bed.[end if]".
The bedroom part 1 is some text that varies. The bedroom part 1 is "[if there is nothing on the s_9]But oh no! there's nothing on this piece of trash. Aw, and here you were, all excited for there to be things on it![end if]".
...
The corridor part 1 is some text that varies. The corridor part 1 is " fiberglass door leading south. You don't like doors? Why not try going north, that entranceway is not blocked by one. There is an exit to the west.".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You have come into a bathroom. Not the bathroom you'd expect. No, this is a bathroom. Okay, just remember what you're here to do, and everything will go great.

 You scan the room for a toilet, and you find a toilet. [if there is something on the s_5]You see [a list of things on the s_5] on the toilet.[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You are in a backyard. A normal kind of place. You decide to just list off a complete list of everything you see in the room, because hey, why not?

 You see a patio table. The patio table is stylish.[if there is something on the s_7] On the patio table you can see [a list of things on the s_7].[end if]".
...
The driveway part 0 is some text that varies. The driveway part 0 is "Guess what, you are in the place we're calling the driveway.
...
The shed part 2 is some text that varies. The shed part 2 is " You see a workbench. You wonder idly who left that here. The workbench is wooden.[if there is something on the s_4] On the workbench you see [a list of things on the s_4].[end if]".
...
The f_9 and the f_0 and the f_1 and the f_10 and the f_2 and the f_3 and the f_4 and the f_6 and the f_7 and the f_5 and the f_8 are foods.
The f_9 and the f_0 and the f_1 and the f_10 and the f_2 and the f_3 and the f_4 and the f_6 and the f_7 and the f_5 and the f_8 are privately-named.
...
The r_0 and the r_2 and the r_10 and the r_11 and the r_5 and the r_3 and the r_4 and the r_6 and the r_7 and the r_9 and the r_1 and the r_8 are rooms.
The r_0 and the r_2 and the r_10 and the r_11 and the r_5 and the r_3 and the r_4 and the r_6 and the r_7 and the r_9 and the r_1 and the r_8 are privately-named.
...
The printed name of f_9 is "salt".
Understand "salt" as f_9.
The base of ingredient_0 is f_9.
The f_9 is cooked.
The f_9 is edible.
The f_9 is on the s_2.
...
The printed name of f_5 is "parsley".
Understand "parsley" as f_5.
The f_5 is cuttable.
The f_5 is edible.
The f_5 is in the c_0.
The f_5 is uncut.
The description of f_8 is "You couldn't pay me to eat that [noun].".
The printed name of f_8 is "black pepper".
Understand "black pepper" as f_8.
Understand "black" as f_8.
