...
The launderette part 0 is some text that varies. The launderette part 0 is "I am sorry to announce that you are now in the launderette.
...
The steam room part 0 is some text that varies. The steam room part 0 is "You've seen better steam rooms, but at least this one seems pretty usual. The room is well lit.
...
The office part 0 is some text that varies. The office part 0 is "Well, here we are in an office. Let's see what's in here.
...
The o_0 is in r_0.
The description of o_1 is "The mouse is expensive looking.".
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a exciting episode of TextWorld! Pick-up the vacuum from the floor of the launderette.".
