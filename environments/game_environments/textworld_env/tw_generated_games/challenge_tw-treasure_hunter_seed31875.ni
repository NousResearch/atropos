...
The chamber part 0 is some text that varies. The chamber part 0 is "Okay, so you're in a chamber, cool, but is it typical? You better believe it is.
...
The spare room part 0 is some text that varies. The spare room part 0 is "You arrive in a spare room. The room is well lit.
...
The k_0 is in r_2.
The description of o_0 is "The plant is dirty.".
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a exciting session of TextWorld! Here is your task for today. First off, if it's not too much trouble, I need you to make an attempt to venture north. Then, pick-up the latchkey fr".
The objective part 1 is some text that varies. The objective part 1 is "om the floor of the spare room. And if you do that, you're the winner!".
