...
The office part 0 is some text that varies. The office part 0 is "You're now in the office. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The studio part 0 is some text that varies. The studio part 0 is "You make a grand eccentric entrance into a studio. The room is well lit.
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "I never took you for the sort of person who would show up in a bathroom, but I guess I was wrong. Okay, just remember what you're here to do, and everything will go great.
...
Test quest0_0 with "go east / go south / take stick of butter"
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! First, it would be great if you could venture east. Then, head south. If you can accomplish that,".
The objective part 1 is some text that varies. The objective part 1 is " lift the stick of butter from the floor of the steam room. Alright, thanks!".
