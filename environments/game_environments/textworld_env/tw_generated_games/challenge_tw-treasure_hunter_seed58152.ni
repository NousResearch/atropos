...
The cellar part 0 is some text that varies. The cellar part 0 is "You find yourself in a cellar. A typical kind of place. You begin to take stock of what's in the room.
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! Here is how to play! First off, attempt to take a trip west. With that done, pick-up the gummy be".
The objective part 1 is some text that varies. The objective part 1 is "ar from the floor of the garage. And once you've done that, you win!".
