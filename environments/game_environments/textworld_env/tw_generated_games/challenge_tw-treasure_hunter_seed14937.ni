...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Here is your task for today. Your first objective is to go north. Then, retrieve the Cat Calendar from the floor of the office. Once that's all han".
The objective part 1 is some text that varies. The objective part 1 is "dled, you can stop!".
