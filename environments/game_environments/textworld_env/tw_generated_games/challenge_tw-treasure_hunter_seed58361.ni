...
The shower part 0 is some text that varies. The shower part 0 is "You are in a normal kind of place. That is to say, you're in a shower.
...
The salon part 0 is some text that varies. The salon part 0 is "You find yourself in a salon. Okay, just remember what you're here to do, and everything will go great.
...
The description of f_0 is "The gooseberry looks tantalizing.".
...
Test quest0_0 with "take gooseberry"
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a life changing session of TextWorld! Lift the gooseberry from the floor of the steam room.".
