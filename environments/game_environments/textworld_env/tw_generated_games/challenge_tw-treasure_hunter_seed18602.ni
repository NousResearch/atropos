...
The studio part 0 is some text that varies. The studio part 0 is "You find yourself in a studio. A standard one. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The chamber part 0 is some text that varies. The chamber part 0 is "You're now in a chamber. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
Test quest0_0 with "go south / take loaf of bread"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is your task for today. Your first objective is to make an attempt to travel south. And then, retrieve the loaf of bread from the floor of the laundry place. And once you've".
