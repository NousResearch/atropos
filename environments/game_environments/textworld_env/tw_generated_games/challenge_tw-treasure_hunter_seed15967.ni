...
There is an exit to the east. Don't worry, it is unguarded. You don't like doors? Why not try going south, that entranceway is unblocked. You need an unguarded exit? You should try going west.".
...
The closet part 0 is some text that varies. The closet part 0 is "You find yourself in a closet. Let's see what's in here.
...
Test quest0_0 with "go east / take whisk"
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Here is how to play! First off, if it's not too much trouble, I need you to make an effort to take a trip east. ".
The objective part 1 is some text that varies. The objective part 1 is "And then, recover the whisk from the floor of the canteen. Alright, thanks!".
