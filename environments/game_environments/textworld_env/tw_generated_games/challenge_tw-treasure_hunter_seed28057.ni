...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You are in a bedroom. An ordinary one. The room is well lit.
...
The chamber part 0 is some text that varies. The chamber part 0 is "Well, here we are in the chamber. You can barely contain your excitement.
...
The cookery part 0 is some text that varies. The cookery part 0 is "You arrive in a cookery. You begin to take stock of what's in the room.
...
The description of f_0 is "that's a typical cauliflower!".
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! Your task for today is to pick up the cauliflower from the floor of the vault.".
