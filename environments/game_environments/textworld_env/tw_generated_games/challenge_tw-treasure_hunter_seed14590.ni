...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another exciting episode of TextWorld! Here is how to play! First stop, attempt to take a trip north. Then, pick-up the latchkey from the floor of the basement. And if you do that, you're t".
