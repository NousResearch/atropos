...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another exciting game of TextWorld! First, it would be a great idea if you could go to the south. And then, take a trip west. With that over with, pick-up the keycard from the floor of the ".
The objective part 1 is some text that varies. The objective part 1 is "canteen. Got that? Good!".
