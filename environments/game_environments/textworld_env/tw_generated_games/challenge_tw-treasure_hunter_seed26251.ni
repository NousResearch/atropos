...
The cookery part 0 is some text that varies. The cookery part 0 is "This might come as a shock to you, but you've just entered a cookery.
...
The canteen part 0 is some text that varies. The canteen part 0 is "You arrive in a typical kind of place. That is to say, you're in a canteen.
...
The recreation zone part 0 is some text that varies. The recreation zone part 0 is "Of every recreation zone you could have sauntered into, you had to walk into a standard one.
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another life changing game of TextWorld! Retrieve the key from the floor of the canteen.".
