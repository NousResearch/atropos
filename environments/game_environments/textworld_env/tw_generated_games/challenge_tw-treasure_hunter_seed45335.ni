...
The r_1 and the r_4 and the r_3 and the r_0 and the r_2 are rooms.

Understand "steam room" as r_1.
The internal name of r_1 is "steam room".
The printed name of r_1 is "-= Steam Room =-".
The steam room part 0 is some text that varies. The steam room part 0 is "You find yourself in a steam room. A standard one. I guess you better just go and list everything you see here.
...
The launderette part 0 is some text that varies. The launderette part 0 is "Of every launderette you could have walked into, you had to walk into an usual one. You start to take note of what's in the room.
...
The r_1 and the r_4 and the r_3 and the r_0 and the r_2 are rooms.
The r_1 and the r_4 and the r_3 and the r_0 and the r_2 are privately-named.
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an fast paced round of TextWorld? You do! Here is how to play! First thing I need you to do is to take a trip west. And then, retrieve the stic".
The objective part 1 is some text that varies. The objective part 1 is "k of butter from the floor of the scullery. And once you've done that, you win!".
