...
The laundromat part 0 is some text that varies. The laundromat part 0 is "You are in a laundromat. A normal one.
...
The kitchenette part 0 is some text that varies. The kitchenette part 0 is "A well framed sign tells you that you are now in the kitchenette. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The vault part 0 is some text that varies. The vault part 0 is "Okay, so you're in a vault, cool, but is it standard? You better believe it is.
...
The objective part 0 is some text that varies. The objective part 0 is "Your objective is to pick up the chocolate bar from the floor of the vault.".
