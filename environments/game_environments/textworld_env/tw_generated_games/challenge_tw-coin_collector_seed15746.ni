...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First off, if it's not too much trouble, I need you to make an effort to go to the north. Okay, and then".
The objective part 1 is some text that varies. The objective part 1 is ", retrieve the coin from the floor of the scullery. Once that's all handled, you can stop!".
