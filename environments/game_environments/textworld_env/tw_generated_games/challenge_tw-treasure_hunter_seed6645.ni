...
You don't like doors? Why not try going east, that entranceway is unguarded. You need an unguarded exit? You should try going south. You don't like doors? Why not try going west, that entranceway is unblocked.".
...
The dish-pit part 0 is some text that varies. The dish-pit part 0 is "Look around you. Take it all in. It's not every day someone gets to be in a dish-pit. You can barely contain your excitement.
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Here is your task for today. First off, venture north. Then, recover the paper towel from the floor of the steam".
The objective part 1 is some text that varies. The objective part 1 is " room. Once that's all handled, you can stop!".
