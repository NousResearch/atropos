...
Test quest0_0 with "go east / go north / take passkey"
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Here is your task for today. First of all, go east. With that over with, try to head north. And then, pick up th".
The objective part 1 is some text that varies. The objective part 1 is "e passkey from the floor of the studio. Once that's all handled, you can stop!".
