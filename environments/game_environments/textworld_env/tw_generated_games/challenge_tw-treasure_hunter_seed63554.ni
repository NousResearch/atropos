...
The cookery part 0 is some text that varies. The cookery part 0 is "You make another one of your grand eccentric entrances into a cookery. You start to take note of what's in the room.
...
The o_0 is in r_3.
The description of o_1 is "The spoon is expensive looking.".
...
Test quest0_0 with "go north / take textbook"
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an life changing round of TextWorld? You do! Here is how to play! First thing I need you to do is to make an attempt to move north. And then, r".
The objective part 1 is some text that varies. The objective part 1 is "etrieve the textbook from the floor of the parlor. Got that? Good!".
