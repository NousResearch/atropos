...
The spare room part 0 is some text that varies. The spare room part 0 is "Of every spare room you could have sauntered into, you had to come round an usual one.
...
The f_0 is in r_0.
The description of o_0 is "The monitor is well-used.".
...
Test quest0_0 with "go north / take monitor"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is your task for today. First stop, attempt to take a trip north. After that, pick up the monitor from the floor of the bedchamber. And if you do that, you're the winner!".
