...
The bedroom part 0 is some text that varies. The bedroom part 0 is "This bedroom you have just entered is definitely standard.
...
The f_0 is in r_2.
The description of o_0 is "The fork is antiquated.".
...
Test quest0_0 with "go east / take fork"
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a life changing game of TextWorld! First off, go east. And then, lift the fork from the floor of the kitchen. And once you've done that, you win!".
