...
The office part 0 is some text that varies. The office part 0 is "Of every office you could have shown up in, you had to saunter into an ordinary one.
...
The closet part 0 is some text that varies. The closet part 0 is "You find yourself in a closet. A normal one. You can barely contain your excitement.
...
The f_0 is in r_0.
The description of f_1 is "The garlic clove looks appealing.".
...
The objective part 0 is some text that varies. The objective part 0 is "Your objective is to retrieve the fondue from the floor of the canteen.".
