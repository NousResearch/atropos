...
The laundromat part 0 is some text that varies. The laundromat part 0 is "This is going to sound unbelievable, but you've just entered a laundromat.
...
The closet part 0 is some text that varies. The closet part 0 is "Ah, the closet. This is some kind of closet, really great standard vibes in this place, a wonderful standard atmosphere.
...
The spare room part 0 is some text that varies. The spare room part 0 is "You are in a spare room. An ordinary one. The room is well lit.
...
The studio part 0 is some text that varies. The studio part 0 is "You are in a studio. A typical kind of place. The room is well lit.
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another fast paced game of TextWorld! Here is your task for today. First stop, go south. Okay, and then, try to travel west. And then, pick-up the latchkey from the floor of the kitchen. An".
The objective part 1 is some text that varies. The objective part 1 is "d once you've done that, you win!".
