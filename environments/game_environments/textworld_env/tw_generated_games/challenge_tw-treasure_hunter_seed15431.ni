...
The attic part 0 is some text that varies. The attic part 0 is "Of every attic you could have shown up in, you had to show up in an usual one.
...
The parlor part 0 is some text that varies. The parlor part 0 is "You are in a parlor. A typical one. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The spare room part 0 is some text that varies. The spare room part 0 is "You arrive in a spare room. A normal kind of place. You can barely contain your excitement.
...
The f_0 is in r_3.
The description of o_0 is "The scarf is modern.".
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! Lift the broccoli from the floor of the attic.".
