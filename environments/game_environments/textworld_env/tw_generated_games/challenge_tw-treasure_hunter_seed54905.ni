...
The garage part 0 is some text that varies. The garage part 0 is "Ah, the garage. This is some kind of garage, really great usual vibes in this place, a wonderful usual atmosphere. The room is well lit.
...
The f_0 is in r_4.
The description of o_0 is "The poem would seem to be out of place here".
...
Test quest0_0 with "go east / take poem"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is how to play! First step, move east. And then, recover the poem from the floor of the bedchamber. And if you do that, you're the winner!".
