...
You don't like doors? Why not try going east, that entranceway is unblocked. You don't like doors? Why not try going north, that entranceway is unguarded. You don't like doors? Why not try going west, that entranceway is unguarded.".
...
The scullery part 0 is some text that varies. The scullery part 0 is "You arrive in a scullery. A normal one. Let's see what's in here.
...
The f_0 is in r_1.
The description of o_0 is "The iron is modern.".
...
Test quest0_0 with "go east / take cashew"
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a fast paced round of TextWorld! Here is how to play! First thing I need you to do is to go east. Next, lift the cashew from the floor of the cookhouse. And if you do that, you're ".
