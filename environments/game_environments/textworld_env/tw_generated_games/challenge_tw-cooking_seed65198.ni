...
The r_0 and the r_4 and the r_1 and the r_2 and the r_3 and the r_5 and the r_6 and the r_7 and the r_9 and the r_10 and the r_11 and the r_8 are rooms.
...
The kitchen part 6 is some text that varies. The kitchen part 6 is " You see a counter. The counter is vast.[if there is something on the s_1] On the counter you see [a list of things on the s_1], so there's that.[end if]".
...
The kitchen part 8 is some text that varies. The kitchen part 8 is " Look over there! a stove. What a coincidence, weren't you just thinking about a stove? The stove is conventional.[if there is something on the stove_0] On the stove you make out [a list of things on the stove_0].[end if]".
...
The kitchen part 11 is some text that varies. The kitchen part 11 is " frosted-glass door leading west. You need an exit without a door? You should try going east. You don't like doors? Why not try going south, that entranceway is not blocked by one.".
...
The pantry part 0 is some text that varies. The pantry part 0 is "You've come into an ordinary room. Your mind races to think of what kind of room would be ordinary. And then it hits you. Of course. You're in the pantry. You decide to just list off a complete list of everything you see in the room, because hey, why not?

 As if things weren't amazing enough already, you can even see a shelf. [if there is something on the s_2]On the shelf you make out [a list of things on the s_2].[end if]".
...
The corridor part 2 is some text that varies. The corridor part 2 is " front door leading south. You don't like doors? Why not try going north, that entranceway is not blocked by one. You don't like doors? Why not try going west, that entranceway is not blocked by one.".
...
The livingroom part 0 is some text that varies. The livingroom part 0 is "You make another one of your grand eccentric entrances into a livingroom.
 ...
 What's that over there? It looks like it's a sofa. [if there is something on the s_9]On the sofa you can see [a list of things on the s_9].[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You arrive in a bedroom. An usual kind of place.
 ...
 You see a gleam over in a corner, where you can see a bed. The bed is large.[if there is something on the s_7] On the bed you can make out [a list of things on the s_7]. I mean, just wow! Isn't TextWorld just the best?[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You've come into a normal room. Your mind races to think of what kind of room would be normal. And then it hits you. Of course. You're in the backyard.

 You make out a patio chair. [if there is something on the s_4]You see [a list of things on the s_4] on the patio chair. I mean, just wow! Isn't TextWorld just the best?[end if]".
The backyard part 1 is some text that varies. The backyard part 1 is "[if there is nothing on the s_4]But there isn't a thing on it. What's the point of an empty patio chair?[end if]".
The backyard part 2 is some text that varies. The backyard part 2 is " Look out! It's a- oh, never mind, it's just a patio table. The patio table is stylish.[if there is something on the s_6] On the patio table you see [a list of things on the s_6]. Now that's what I call TextWorld![end if]".
...
The street part 0 is some text that varies. The street part 0 is "You are in a street. An usual kind of place. Let's see what's in here.
...
The supermarket part 0 is some text that varies. The supermarket part 0 is "You have stumbled into the most typical of all possible supermarkets. Okay, just remember what you're here to do, and everything will go great.
...
The shed part 0 is some text that varies. The shed part 0 is "You are in a shed. An usual one. The room is well lit.
 ...
 Oh, great. Here's a toolbox. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[if c_1 is open and there is something in the c_1] The toolbox contains [a list of things in the c_1].[end if]".
...
The r_0 and the r_4 and the r_1 and the r_2 and the r_3 and the r_5 and the r_6 and the r_7 and the r_9 and the r_10 and the r_11 and the r_8 are rooms.
The r_0 and the r_4 and the r_1 and the r_2 and the r_3 and the r_5 and the r_6 and the r_7 and the r_9 and the r_10 and the r_11 and the r_8 are privately-named.
