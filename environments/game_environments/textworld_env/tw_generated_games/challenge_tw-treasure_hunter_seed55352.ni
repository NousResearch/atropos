...
The vault part 0 is some text that varies. The vault part 0 is "Fancy seeing you here. Here, by the way, being the vault. You can barely contain your excitement.
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First, it would be a great idea if you could make an attempt to go to the west. And then, retrieve the s".
The objective part 1 is some text that varies. The objective part 1 is "hadfly from the floor of the sauna. Once that's all handled, you can stop!".
