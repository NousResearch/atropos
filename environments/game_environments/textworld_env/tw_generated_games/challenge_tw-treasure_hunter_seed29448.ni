...
The studio part 0 is some text that varies. The studio part 0 is "This might come as a shock to you, but you've just come into a studio.
...
The closet part 0 is some text that varies. The closet part 0 is "You're now in the closet. Okay, just remember what you're here to do, and everything will go great.
...
The salon part 0 is some text that varies. The salon part 0 is "Okay, so you're in a salon, cool, but is it standard? You better believe it is. You can barely contain your excitement.
...
The k_0 is in r_0.
The description of o_0 is "The novel would seem to be well matched to everything else here".
...
Test quest0_0 with "go east / go east / take novel"
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a exciting game of TextWorld! Here is your task for today. Your first objective is to make an effort to travel east. Okay, and then, head east. And then, lift the novel from the fl".
The objective part 1 is some text that varies. The objective part 1 is "oor of the chamber. Once that's all handled, you can stop!".
