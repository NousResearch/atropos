...
The kitchen part 0 is some text that varies. The kitchen part 0 is "You are in a kitchen. An ordinary one. You start to take note of what's in the room.
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You've entered a bathroom.
 ...
 You can see a toilet. [if there is something on the s_4]On the toilet you can make out [a list of things on the s_4], so there's that.[end if]".
The bathroom part 1 is some text that varies. The bathroom part 1 is "[if there is nothing on the s_4]But the thing hasn't got anything on it. You move on, clearly depressed by your TextWorld experience.[end if]".
...
The corridor part 0 is some text that varies. The corridor part 0 is "You've stumbled into an usual room. Your mind races to think of what kind of room would be usual. And then it hits you. Of course. You're in the corridor.
...
The pantry part 0 is some text that varies. The pantry part 0 is "You arrive in a pantry. An ordinary kind of place.
 ...
 Were you looking for a shelf? Because look over there, it's a shelf. What a coincidence, weren't you just thinking about a shelf? [if there is something on the s_2]On the shelf you make out [a list of things on the s_2], so there's that.[end if]".
...
The livingroom part 0 is some text that varies. The livingroom part 0 is "A rusty board tells you that you are now in the livingroom. You begin to take stock of what's here.
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "Well, here we are in the bedroom. You begin to take stock of what's in the room.
 ...
 You can see a bed. The bed is large.[if there is something on the s_3] On the bed you see [a list of things on the s_3]. Huh, weird.[end if]".
