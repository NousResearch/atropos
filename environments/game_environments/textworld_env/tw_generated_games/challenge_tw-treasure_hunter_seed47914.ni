...
The laundromat part 0 is some text that varies. The laundromat part 0 is "You find yourself in a laundromat. A standard one. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! First stop, travel west. And then, retrieve the keycard from the floor of the cookery. And once y".
The objective part 1 is some text that varies. The objective part 1 is "ou've done that, you win!".
