...
The canteen part 0 is some text that varies. The canteen part 0 is "Well, here we are in a canteen. Okay, just remember what you're here to do, and everything will go great.
...
The office part 0 is some text that varies. The office part 0 is "You find yourself in an office. A typical kind of place. You begin to take stock of what's here.
...
The dish-pit part 0 is some text that varies. The dish-pit part 0 is "You have walked into the most normal of all possible dish-pits. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an profound round of TextWorld? You do! Here is how to play! First of all, travel north. With that accomplished, pick-up the passkey from the f".
The objective part 1 is some text that varies. The objective part 1 is "loor of the dish-pit. Got that? Good!".
