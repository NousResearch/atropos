...
The basement part 0 is some text that varies. The basement part 0 is "Look at you, bigshot, walking into a basement like it isn't some huge deal. I guess you better just go and list everything you see here.
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is your task for today. First step, make an attempt to move west. And then, recover the keycard from the floor of the chamber. And if you do that, you're the winner!".
