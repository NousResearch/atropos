...
The bathroom part 0 is some text that varies. The bathroom part 0 is "Look at that board! What does it say? It says Welcome to the bathroom? Well that's cool.
...
The office part 0 is some text that varies. The office part 0 is "You're now in an office. You begin to take stock of what's here.
...
The f_0 is in r_2.
The description of o_0 is "The fly larva seems well matched to everything else here".
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! First off, attempt to go to the south. Then, pick-up the cookie from the floor of the laundry place. That's it!".
