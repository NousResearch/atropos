...
The bedroom part 0 is some text that varies. The bedroom part 0 is "This just in- You, in the bedroom. You begin to take stock of what's here.
...
The objective part 0 is some text that varies. The objective part 0 is "Your objective is to retrieve the key from the floor of the pantry.".
