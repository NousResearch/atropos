...
The studio part 0 is some text that varies. The studio part 0 is "You make a grand eccentric entrance into a studio. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The spare room part 0 is some text that varies. The spare room part 0 is "You arrive in a spare room. A typical one.
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Here is how to play! Your first objective is to make an attempt to take a trip south. Once you manage that, lift".
The objective part 1 is some text that varies. The objective part 1 is " the keycard from the floor of the spare room. And once you've done that, you win!".
