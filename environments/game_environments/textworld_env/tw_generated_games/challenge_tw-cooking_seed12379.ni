...
The kitchen part 4 is some text that varies. The kitchen part 4 is " You can see a table. [if there is something on the s_0]You see [a list of things on the s_0] on the table. Hmmm... what else, what else?[end if]".
...
The corridor part 0 is some text that varies. The corridor part 0 is "You arrive in a corridor. A typical kind of place. The room is well lit.
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You are in a bathroom. A standard kind of place. You decide to start listing off everything you see in the room, as if you were in a text adventure.
 ...
 Hey, want to see a toilet? Look over there, a toilet. [if there is something on the s_3]On the toilet you can make out [a list of things on the s_3].[end if]".
...
The f_1 and the f_10 and the f_11 and the f_0 and the f_2 and the f_3 and the f_4 and the f_6 and the f_7 and the f_8 and the f_9 and the f_13 and the f_12 and the f_5 are foods.
The f_1 and the f_10 and the f_11 and the f_0 and the f_2 and the f_3 and the f_4 and the f_6 and the f_7 and the f_8 and the f_9 and the f_13 and the f_12 and the f_5 are privately-named.
...
The printed name of f_11 is "cilantro".
Understand "cilantro" as f_11.
...
The printed name of f_13 is "parsley".
Understand "parsley" as f_13.
...
The printed name of f_12 is "flour".
Understand "flour" as f_12.
The f_12 is edible.
The f_12 is on the s_2.
