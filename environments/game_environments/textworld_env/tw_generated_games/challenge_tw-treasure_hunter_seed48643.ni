...
The spare room part 0 is some text that varies. The spare room part 0 is "Of every spare room you could have shown up in, you had to come round an ordinary one. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The study part 0 is some text that varies. The study part 0 is "You're not going to believe this, but you've just entered a study. Let's see what's in here.
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a exciting game of TextWorld! Here is how to play! First step, make an effort to travel north. After that, lift the passkey from the floor of the workshop. And if you do that, you'".
