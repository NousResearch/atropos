...
The studio part 0 is some text that varies. The studio part 0 is "Here we are in the studio. You start to take note of what's in the room.
...
Test quest0_0 with "go east / go north / take broom"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another exciting episode of TextWorld! Your first objective is to make an effort to venture east. Then, head north. After that, pick-up the broom from the floor of the spare room. Alright, ".
