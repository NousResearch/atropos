...
The canteen part 0 is some text that varies. The canteen part 0 is "You are in a canteen. An usual one. Let's see what's in here.
...
The f_0 is in r_1.
The description of o_0 is "The fork appears to be to fit in here".
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! Your task for today is to pick-up the sandwich from the floor of the study.".
