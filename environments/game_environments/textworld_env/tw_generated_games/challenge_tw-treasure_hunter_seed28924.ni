...
The dish-pit part 0 is some text that varies. The dish-pit part 0 is "You are in a dish-pit. An ordinary kind of place. You begin to take stock of what's in the room.
...
The canteen part 0 is some text that varies. The canteen part 0 is "Okay, so you're in a canteen, cool, but is it ordinary? You better believe it is.
...
Test quest0_0 with "go west / go south / take berry"
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Here is your task for today. First step, move west. And then, make an effort to go to the south. And then, recover the berry from the floor of the ".
The objective part 1 is some text that varies. The objective part 1 is "canteen. That's it!".
