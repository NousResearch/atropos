...
The sauna part 0 is some text that varies. The sauna part 0 is "Well, here we are in a sauna. You begin to take stock of what's here.
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to TextWorld! Please retrieve the keycard from the floor of the workshop.".
