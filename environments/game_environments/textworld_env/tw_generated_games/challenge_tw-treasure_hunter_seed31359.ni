...
The studio part 0 is some text that varies. The studio part 0 is "You've entered a studio. You begin to take stock of what's here.
...
Test quest0_0 with "go south / take chocolate bar"
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a fast paced game of TextWorld! Here is how to play! First step, make an attempt to take a trip south. And then, pick up the chocolate bar from the floor of the parlor. And once yo".
