...
The study part 0 is some text that varies. The study part 0 is "You have fallen into the most ordinary of all possible studys.
...
The studio part 0 is some text that varies. The studio part 0 is "Of every studio you could have sauntered into, you had to come round an usual one.
...
The k_0 is in r_1.
The description of o_0 is "The desktop computer looks out of place here".
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another exciting game of TextWorld! Your task for today is to pick-up the key from the floor of the study.".
