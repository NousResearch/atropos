...
You need an unblocked exit? You should try going east. There is an exit to the north. Don't worry, it is unblocked. There is an exit to the west. Don't worry, it is unguarded.".
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an exciting round of TextWorld? You do! First of all, you could, like, make an effort to go to the east. With that accomplished, pick-up the fo".
The objective part 1 is some text that varies. The objective part 1 is "ndue from the floor of the restroom. And once you've done that, you win!".
