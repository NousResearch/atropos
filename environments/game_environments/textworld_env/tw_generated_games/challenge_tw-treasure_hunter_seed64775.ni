...
The f_0 is in r_3.
The description of o_0 is "The teapot appears to be to fit in here".
...
Test quest0_0 with "take teapot"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to TextWorld! Please retrieve the teapot from the floor of the cookhouse.".
