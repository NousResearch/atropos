...
The r_0 and the r_6 and the r_1 and the r_10 and the r_9 and the r_11 and the r_2 and the r_4 and the r_3 and the r_8 and the r_5 and the r_7 are rooms.
...
The kitchen part 7 is some text that varies. The kitchen part 7 is " You see a counter. Now why would someone leave that there? The counter is vast.[if there is something on the s_1] On the counter you can make out [a list of things on the s_1].[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "I never took you for the sort of person who would show up in a backyard, but I guess I was wrong.
 ...
 You can make out a patio chair. [if there is something on the s_7]You see [a list of things on the s_7] on the patio chair. Hmmm... what else, what else?[end if]".
The backyard part 1 is some text that varies. The backyard part 1 is "[if there is nothing on the s_7]But the thing is empty, unfortunately. It would have been so cool if there was stuff on the patio chair.[end if]".
The backyard part 2 is some text that varies. The backyard part 2 is " You can make out a patio table. You wonder idly who left that here. The patio table is stylish.[if there is something on the s_8] On the patio table you can make out [a list of things on the s_8].[end if]".
...
The corridor part 1 is some text that varies. The corridor part 1 is " fiberglass door leading north. You don't like doors? Why not try going east, that entranceway is not blocked by one. You don't like doors? Why not try going south, that entranceway is not blocked by one. There is an exit to the west.".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You find yourself in a bathroom. A typical one.
 ...
 You can see a toilet. [if there is something on the s_9]On the toilet you see [a list of things on the s_9].[end if]".
...
The shed part 0 is some text that varies. The shed part 0 is "You arrive in a shed. An ordinary kind of place. You start to take note of what's in the room.
...
The shed part 3 is some text that varies. The shed part 3 is " You can see a workbench. Now why would someone leave that there? [if there is something on the s_4]You see [a list of things on the s_4] on the workbench, so there's that.[end if]".
...
The f_0 and the f_1 and the f_3 and the f_2 and the f_5 and the f_4 are foods.
The f_0 and the f_1 and the f_3 and the f_2 and the f_5 and the f_4 are privately-named.
...
The r_0 and the r_6 and the r_1 and the r_10 and the r_9 and the r_11 and the r_2 and the r_4 and the r_3 and the r_8 and the r_5 and the r_7 are rooms.
The r_0 and the r_6 and the r_1 and the r_10 and the r_9 and the r_11 and the r_2 and the r_4 and the r_3 and the r_8 and the r_5 and the r_7 are privately-named.
...
The printed name of f_3 is "water".
The indefinite article of f_3 is "some".
Understand "water" as f_3.
The base of ingredient_0 is f_3.
The f_3 is cooked.
The f_3 is drinkable.
The f_3 is edible.
