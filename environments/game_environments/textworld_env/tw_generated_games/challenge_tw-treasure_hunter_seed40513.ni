...
The bedroom part 0 is some text that varies. The bedroom part 0 is "If you're wondering why everything seems so standard all of a sudden, it's because you've just walked into the bedroom.
...
The sauna part 0 is some text that varies. The sauna part 0 is "You've entered a sauna. I guess you better just go and list everything you see here.
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "Look at you, bigshot, walking into a bathroom like it isn't some huge deal. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The o_0 is in r_1.
The description of o_1 is "The sponge is cheap looking.".
...
Test quest0_0 with "go west / go west / take butterfly"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is your task for today. First off, try to take a trip west. After that, venture west. And then, lift the butterfly from the floor of the shower. Alright, thanks!".
