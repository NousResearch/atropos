...
The r_0 and the r_5 and the r_1 and the r_4 and the r_6 and the r_8 and the r_2 and the r_3 and the r_7 are rooms.
...
The kitchen part 3 is some text that varies. The kitchen part 3 is " Oh, great. Here's an oven. I mean, just wow! Isn't TextWorld just the best?[if oven_0 is open and there is something in the oven_0] The oven contains [a list of things in the oven_0].[end if]".
...
The pantry part 0 is some text that varies. The pantry part 0 is "You are in a standard kind of place. That is to say, you're in a pantry.
...
The backyard part 0 is some text that varies. The backyard part 0 is "You find yourself in a backyard. A typical one. You can barely contain your excitement.
 ...
 Oh wow! Is that what I think it is? It is! It's a patio table. The patio table is stylish.[if there is something on the s_5] On the patio table you make out [a list of things on the s_5].[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " Look out! It's a- oh, never mind, it's just a patio chair. The patio chair is stylish.[if there is something on the s_7] On the patio chair you can make out [a list of things on the s_7].[end if]".
The backyard part 3 is some text that varies. The backyard part 3 is "[if there is nothing on the s_7] But there isn't a thing on it. This always happens![end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You are in a bathroom. A typical one. You try to gain information on your surroundings by using a technique you call 'looking.'
 ...
 You smell a wretched smell, and follow it to a toilet. You wonder idly who left that here. [if there is something on the s_3]You see [a list of things on the s_3] on the toilet.[end if]".
...
The garden part 0 is some text that varies. The garden part 0 is "Okay, so you're in a garden, cool, but is it usual? You better believe it is. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The r_0 and the r_5 and the r_1 and the r_4 and the r_6 and the r_8 and the r_2 and the r_3 and the r_7 are rooms.
The r_0 and the r_5 and the r_1 and the r_4 and the r_6 and the r_8 and the r_2 and the r_3 and the r_7 are privately-named.
