...
The closet part 0 is some text that varies. The closet part 0 is "Of every closet you could have walked into, you had to come round an ordinary one.
...
The cellar part 0 is some text that varies. The cellar part 0 is "You find yourself in a cellar. A typical one. You begin to take stock of what's here.
...
The laundromat part 0 is some text that varies. The laundromat part 0 is "You have walked into a laundromat. Not the laundromat you'd expect. No, this is a laundromat.
...
The k_0 is in r_1.
The description of o_0 is "The cloak seems well matched to everything else here".
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. Your first objective is to take a trip north. With that accomplished, make an attempt to move west. Then".
The objective part 1 is some text that varies. The objective part 1 is ", pick up the passkey from the floor of the steam room. And once you've done that, you win!".
