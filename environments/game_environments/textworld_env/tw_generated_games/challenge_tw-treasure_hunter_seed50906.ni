...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You arrive in a bedroom. An usual one. Okay, just remember what you're here to do, and everything will go great.
...
The f_0 is in r_4.
The description of o_0 is "The nest of insects is unremarkable.".
...
Test quest0_0 with "go north / take nest of insects"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First off, if it's not too much trouble, I need you to make an effort to take a trip north. After that, ".
The objective part 1 is some text that varies. The objective part 1 is "lift the nest of insects from the floor of the studio. Got that? Good!".
