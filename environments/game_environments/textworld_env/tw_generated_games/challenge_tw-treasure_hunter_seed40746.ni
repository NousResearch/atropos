...
The restroom part 0 is some text that varies. The restroom part 0 is "You are in a restroom. A typical one. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The attic part 0 is some text that varies. The attic part 0 is "I am pleased to announce that you are now in the attic.
...
The k_0 is in r_0.
The description of o_0 is "The mat is well-used.".
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to TextWorld! Please recover the key from the floor of the cookhouse.".
