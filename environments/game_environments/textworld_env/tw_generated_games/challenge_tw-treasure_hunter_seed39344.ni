...
The basement part 0 is some text that varies. The basement part 0 is "You make a grand eccentric entrance into a basement.
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a life changing round of TextWorld! First off, if it's not too much trouble, I need you to attempt to venture south. Okay, and then, retrieve the loaf of bread from the floor of th".
The objective part 1 is some text that varies. The objective part 1 is "e cellar. Alright, thanks!".
