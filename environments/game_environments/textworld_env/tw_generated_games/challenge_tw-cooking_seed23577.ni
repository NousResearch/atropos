...
The r_0 and the r_6 and the r_1 and the r_2 and the r_8 and the r_3 and the r_5 and the r_4 and the r_7 are rooms.
...
The kitchen part 6 is some text that varies. The kitchen part 6 is "[if there is nothing on the s_0]Unfortunately, there isn't a thing on it. What's the point of an empty table?[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You arrive in a backyard. A normal one. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The backyard part 2 is some text that varies. The backyard part 2 is " Were you looking for a patio table? Because look over there, it's a patio table. [if there is something on the s_5]On the patio table you can make out [a list of things on the s_5].[end if]".
The backyard part 3 is some text that varies. The backyard part 3 is "[if there is nothing on the s_5]But oh no! there's nothing on this piece of junk.[end if]".
...
The livingroom part 0 is some text that varies. The livingroom part 0 is "You're now in a livingroom. Let's see what's in here.
 ...
 Were you looking for a sofa? Because look over there, it's a sofa. [if there is something on the s_7]You see [a list of things on the s_7] on the sofa.[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You find yourself in a bathroom. A normal kind of place.
 ...
 You make out a toilet. You wonder idly who left that here. [if there is something on the s_4]On the toilet you make out [a list of things on the s_4].[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You find yourself in a bedroom. An usual kind of place. You begin to take stock of what's in the room.
 ...
 You see a bed. [if there is something on the s_6]On the bed you can see [a list of things on the s_6], so there's that.[end if]".
...
The shed part 0 is some text that varies. The shed part 0 is "You're now in a shed.
 ...
 You see a toolbox. You wonder idly who left that here.[if c_1 is open and there is something in the c_1] The toolbox contains [a list of things in the c_1]. Suddenly, you bump your head on the ceiling, but it's not such a bad bump that it's going to prevent you from looking at objects and even things.[end if]".
...
The shed part 2 is some text that varies. The shed part 2 is " Look over there! a workbench. The workbench is wooden.[if there is something on the s_8] On the workbench you make out [a list of things on the s_8]. Wow! Just like in the movies![end if]".
The shed part 3 is some text that varies. The shed part 3 is "[if there is nothing on the s_8] But the thing is empty, unfortunately. You think about smashing the workbench to bits, throwing the bits in the dump, etc, until you get bored and decide to move on.[end if]".
...
The f_5 and the f_7 and the f_1 and the f_6 and the f_0 and the f_2 and the f_3 and the f_4 are foods.
The f_5 and the f_7 and the f_1 and the f_6 and the f_0 and the f_2 and the f_3 and the f_4 are privately-named.
...
The r_0 and the r_6 and the r_1 and the r_2 and the r_8 and the r_3 and the r_5 and the r_4 and the r_7 are rooms.
The r_0 and the r_6 and the r_1 and the r_2 and the r_8 and the r_3 and the r_5 and the r_4 and the r_7 are privately-named.
