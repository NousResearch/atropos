...
The r_0 and the r_1 and the r_2 and the r_5 and the r_3 and the r_6 and the r_8 and the r_4 and the r_7 are rooms.
...
The kitchen part 5 is some text that varies. The kitchen part 5 is " If you haven't noticed it already, there seems to be something there by the wall, it's a table. [if there is something on the s_0]You see [a list of things on the s_0] on the table. There's something strange about this thing being here, but you don't have time to worry about that now.[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "Guess what, you are in the place we're calling the bedroom.
 ...
 Look out! It's a- oh, never mind, it's just a bed. [if there is something on the s_4]You see [a list of things on the s_4] on the bed. You can't wait to tell the folks at home about this![end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You are in a backyard. An usual kind of place. I guess you better just go and list everything you see here.
 ...
 As if things weren't amazing enough already, you can even see a patio table. The patio table is stylish.[if there is something on the s_3] On the patio table you can make out [a list of things on the s_3].[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " You scan the room, seeing a BBQ. Something scurries by right in the corner of your eye. Probably nothing.[if toaster_0 is open and there is something in the toaster_0] The BBQ contains [a list of things in the toaster_0].[end if]".
...
The shed part 3 is some text that varies. The shed part 3 is " You make out a workbench. The workbench is wooden.[if there is something on the s_8] On the workbench you can make out [a list of things on the s_8]. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[end if]".
The shed part 4 is some text that varies. The shed part 4 is "[if there is nothing on the s_8] The workbench appears to be empty. What, you think everything in TextWorld should have stuff on it?[end if]".
...
The r_0 and the r_1 and the r_2 and the r_5 and the r_3 and the r_6 and the r_8 and the r_4 and the r_7 are rooms.
The r_0 and the r_1 and the r_2 and the r_5 and the r_3 and the r_6 and the r_8 and the r_4 and the r_7 are privately-named.
...
Test quest2_0 with "inventory / go east / examine cookbook / open fridge / take pork chop from fridge / cook pork chop with stove"
...
Test quest4_0 with "inventory / go east / examine cookbook / open fridge / take pork chop from fridge / cook pork chop with stove / prepare meal"
...
Test quest5_0 with "inventory / go east / examine cookbook / open fridge / take pork chop from fridge / cook pork chop with stove / prepare meal / eat meal"
