...
The office part 0 is some text that varies. The office part 0 is "Okay, so you're in an office, cool, but is it ordinary? You better believe it is. I guess you better just go and list everything you see here.
...
The description of o_0 is "The worm looks out of place here".
The printed name of o_0 is "worm".
Understand "worm" as o_0.
The o_0 is in r_2.
The description of o_1 is "The frisbee is cheap looking.".
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a exciting session of TextWorld! Your task for today is to retrieve the worm from the floor of the spare room.".
