...
The attic part 0 is some text that varies. The attic part 0 is "Okay, so you're in an attic, cool, but is it typical? You better believe it is. The room is well lit.
...
The recreation zone part 0 is some text that varies. The recreation zone part 0 is "Well, here we are in the recreation zone. Okay, just remember what you're here to do, and everything will go great.



You need an unblocked exit? You should try going east. You need an unguarded exit? You should try going north. There is an exit to the south. Don't worry, it is unguarded.".
...
The pantry part 0 is some text that varies. The pantry part 0 is "Okay, so you're in a pantry, cool, but is it ordinary? You better believe it is. You begin to take stock of what's here.
...
Test quest0_0 with "go east / take candy bar"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another exciting round of TextWorld! First, it would be great if you could try to venture east. Then, retrieve the candy bar from the floor of the garage. And once you've done that, you win".
The objective part 1 is some text that varies. The objective part 1 is "!".
