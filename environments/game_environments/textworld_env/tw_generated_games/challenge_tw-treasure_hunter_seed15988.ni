...
The vault part 0 is some text that varies. The vault part 0 is "Wow! You're in a vault.
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an profound round of TextWorld? You do! Here is how to play! First stop, make an attempt to go to the north. With that accomplished, try to tra".
The objective part 1 is some text that varies. The objective part 1 is "vel east. Then, pick up the sponge from the floor of the laundromat. And if you do that, you're the winner!".
