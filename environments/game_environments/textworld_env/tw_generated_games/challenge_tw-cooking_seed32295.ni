...
The kitchen part 5 is some text that varies. The kitchen part 5 is " You can make out a table. What a great pairing of adjectives and nouns! The table is massive.[if there is something on the s_0] On the table you make out [a list of things on the s_0]. Wow! Just like in the movies![end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You've entered a bedroom.
 ...
 You see a bed. The bed is large.[if there is something on the s_4] On the bed you make out [a list of things on the s_4]. Something scurries by right in the corner of your eye. Probably nothing.[end if]".
...
The corridor part 0 is some text that varies. The corridor part 0 is "You are in a corridor. It seems to be pretty normal here.
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You arrive in a bathroom. A standard one.
 ...
 You can make out a toilet. [if there is something on the s_5]You see [a list of things on the s_5] on the toilet. Something scurries by right in the corner of your eye. Probably nothing.[end if]".
...
The f_2 and the f_4 and the f_6 and the f_0 and the f_1 and the f_3 and the f_5 are foods.
The f_2 and the f_4 and the f_6 and the f_0 and the f_1 and the f_3 and the f_5 are privately-named.
