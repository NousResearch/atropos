...
The kitchen part 5 is some text that varies. The kitchen part 5 is " You see a gleam over in a corner, where you can see a table. [if there is something on the s_0]On the table you see [a list of things on the s_0].[end if]".
...
The kitchen part 9 is some text that varies. The kitchen part 9 is " You rest your hand against a wall, but you miss the wall and fall onto a stove. What a coincidence, weren't you just thinking about a stove? The stove is conventional.[if there is something on the stove_0] On the stove you see [a list of things on the stove_0].[end if]".
The kitchen part 10 is some text that varies. The kitchen part 10 is "[if there is nothing on the stove_0] But there isn't a thing on it. You swear loudly.[end if]".
...
The f_10 and the f_5 and the f_7 and the f_0 and the f_1 and the f_11 and the f_2 and the f_3 and the f_4 and the f_6 and the f_8 and the f_9 are foods.
The f_10 and the f_5 and the f_7 and the f_0 and the f_1 and the f_11 and the f_2 and the f_3 and the f_4 and the f_6 and the f_8 and the f_9 are privately-named.
...
The printed name of f_10 is "cilantro".
Understand "cilantro" as f_10.
...
Test quest1_0 with "inventory / examine cookbook / drop carrot / drop purple potato / drop red potato / take red hot pepper from counter"
...
Test quest5_0 with "inventory / examine cookbook / drop carrot / drop purple potato / drop red potato / take red hot pepper from counter / open fridge / take cilantro from fridge"
...
Test quest9_0 with "inventory / examine cookbook / drop carrot / drop purple potato / drop red potato / take red hot pepper from counter / open fridge / take cilantro from fridge / take cilantro from fridge / take water from fridge"
...
Test quest12_0 with "inventory / examine cookbook / drop carrot / drop purple potato / drop red potato / take red hot pepper from counter / open fridge / take cilantro from fridge / take cilantro from fridge / take water from fridge / prepare meal"
...
Test quest13_0 with "inventory / examine cookbook / drop carrot / drop purple potato / drop red potato / take red hot pepper from counter / open fridge / take cilantro from fridge / take cilantro from fridge / take water from fridge / prepare meal / eat meal"
