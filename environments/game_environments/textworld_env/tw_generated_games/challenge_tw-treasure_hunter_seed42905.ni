...
The closet part 0 is some text that varies. The closet part 0 is "I am sorry to announce that you are now in the closet. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The laundry place part 0 is some text that varies. The laundry place part 0 is "A rusty board tells you that you are now in the laundry place.
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to TextWorld! Please recover the key from the floor of the sauna.".
