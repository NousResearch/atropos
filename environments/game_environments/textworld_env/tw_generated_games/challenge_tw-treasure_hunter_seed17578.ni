...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Here is how to play! First off, if it's not too much trouble, I need you to travel north. With that done, lift the latchkey from the floor of the c".
The objective part 1 is some text that varies. The objective part 1 is "ookhouse. And if you do that, you're the winner!".
