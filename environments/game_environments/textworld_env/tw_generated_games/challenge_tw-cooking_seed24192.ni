...
The kitchen part 0 is some text that varies. The kitchen part 0 is "You are in a kitchen. A typical one. You begin looking for stuff.
...
The kitchen part 3 is some text that varies. The kitchen part 3 is " You see an oven. Hmmm... what else, what else?[if oven_0 is open and there is something in the oven_0] The oven contains [a list of things in the oven_0]. You wonder idly who left that here.[end if]".
...
The kitchen part 5 is some text that varies. The kitchen part 5 is " If you haven't noticed it already, there seems to be something there by the wall, it's a table. [if there is something on the s_0]On the table you can see [a list of things on the s_0].[end if]".
...
The f_1 and the f_4 and the f_2 and the f_3 and the f_5 and the f_6 and the f_7 and the f_0 are foods.
The f_1 and the f_4 and the f_2 and the f_3 and the f_5 and the f_6 and the f_7 and the f_0 are privately-named.
