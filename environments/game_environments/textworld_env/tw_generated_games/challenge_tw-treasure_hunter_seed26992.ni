...
The chamber part 0 is some text that varies. The chamber part 0 is "Fancy seeing you here. Here, by the way, being the chamber. You begin to take stock of what's in the room.
...
The dish-pit part 0 is some text that varies. The dish-pit part 0 is "You find yourself in a dish-pit. A normal one. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The f_0 is in r_4.
The description of o_0 is "The napkin is clean.".
...
Test quest0_0 with "go west / go west / take berry"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another fast paced episode of TextWorld! Here is your task for today. First off, if it's not too much trouble, I need you to move west. And then, travel west. Then, retrieve the berry from ".
The objective part 1 is some text that varies. The objective part 1 is "the floor of the dish-pit. That's it!".
