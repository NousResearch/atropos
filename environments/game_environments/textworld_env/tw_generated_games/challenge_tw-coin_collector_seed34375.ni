...
The cellar part 0 is some text that varies. The cellar part 0 is "You're now in a cellar. You begin looking for stuff.
...
The kitchen part 0 is some text that varies. The kitchen part 0 is "Okay, so you're in a kitchen, cool, but is it typical? You better believe it is. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The description of o_0 is "The coin would seem to be to fit in here".
...
Test quest0_0 with "go west / go south / go south / go east / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Here is how to play! First step, move west. Then, venture south. And then, take a trip south. Once you get throu".
The objective part 1 is some text that varies. The objective part 1 is "gh with that, attempt to take a trip east. With that done, pick-up the coin from the floor of the cellar. Got that? Good!".
