...
The r_0 and the r_6 and the r_1 and the r_11 and the r_10 and the r_3 and the r_2 and the r_9 and the r_4 and the r_5 and the r_7 and the r_8 are rooms.
...
The kitchen part 4 is some text that varies. The kitchen part 4 is " You see a gleam over in a corner, where you can see a table. The table is massive.[if there is something on the s_0] On the table you can make out [a list of things on the s_0].[end if]".
...
The kitchen part 7 is some text that varies. The kitchen part 7 is "[if there is nothing on the s_1]But there isn't a thing on it. This always happens, here in TextWorld![end if]".
...
The kitchen part 12 is some text that varies. The kitchen part 12 is " sliding patio door leading west. There is an exit to the south.".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You're now in the backyard. You begin to take stock of what's here.
 ...
 You can see a patio table. The patio table is stylish.[if there is something on the s_4] On the patio table you see [a list of things on the s_4], so there's that.[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " You can make out a patio chair. The patio chair is stylish.[if there is something on the s_6] On the patio chair you see [a list of things on the s_6]. Now that's what I call TextWorld![end if]".
...
The backyard part 5 is some text that varies. The backyard part 5 is " BBQ close by.[if toaster_0 is open and there is something in the toaster_0] The BBQ contains [a list of things in the toaster_0]. There's something strange about this thing being here, but you don't have time to worry about that now.[end if]".
...
The supermarket part 0 is some text that varies. The supermarket part 0 is "You are in a supermarket. A typical one. You begin to take stock of what's in the room.
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You find yourself in a bedroom. A standard one.
 ...
 You rest your hand against a wall, but you miss the wall and fall onto a bed. The bed is large.[if there is something on the s_8] On the bed you make out [a list of things on the s_8].[end if]".
...
The livingroom part 0 is some text that varies. The livingroom part 0 is "You are in a livingroom. An ordinary one.
 ...
 You lean against the wall, inadvertently pressing a secret button. The wall opens up to reveal a sofa. Now why would someone leave that there? The sofa is comfy.[if there is something on the s_7] On the sofa you can see [a list of things on the s_7].[end if]".
...
The shed part 0 is some text that varies. The shed part 0 is "You're now in the shed.
 ...
 You rest your hand against a wall, but you miss the wall and fall onto a toolbox.[if c_1 is open and there is something in the c_1] The toolbox contains [a list of things in the c_1]. You can't wait to tell the folks at home about this![end if]".
...
The shed part 2 is some text that varies. The shed part 2 is " You rest your hand against a wall, but you miss the wall and fall onto a workbench. The workbench is wooden.[if there is something on the s_5] On the workbench you can see [a list of things on the s_5].[end if]".
...
The r_0 and the r_6 and the r_1 and the r_11 and the r_10 and the r_3 and the r_2 and the r_9 and the r_4 and the r_5 and the r_7 and the r_8 are rooms.
The r_0 and the r_6 and the r_1 and the r_11 and the r_10 and the r_3 and the r_2 and the r_9 and the r_4 and the r_5 and the r_7 and the r_8 are privately-named.
...
Test quest1_0 with "inventory / open wooden door / go south / open sliding patio door / go east / examine cookbook / examine cookbook / go west / go south / take carrot"
...
Test quest4_0 with "inventory / open wooden door / go south / open sliding patio door / go east / examine cookbook / examine cookbook / go west / go south / take carrot / go north / go north / go east / prepare meal"
...
Test quest5_0 with "inventory / open wooden door / go south / open sliding patio door / go east / examine cookbook / examine cookbook / go west / go south / take carrot / go north / go north / go east / prepare meal / eat meal"
