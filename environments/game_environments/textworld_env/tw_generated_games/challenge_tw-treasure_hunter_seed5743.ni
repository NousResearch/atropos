...
The description of o_0 is "The paper towel is cheap looking.".
The printed name of o_0 is "paper towel".
Understand "paper towel" as o_0.
Understand "paper" as o_0.
Understand "towel" as o_0.
The o_0 is in r_0.
The description of o_1 is "The tv would seem to be out of place here".
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another exciting session of TextWorld! Your task for today is to retrieve the paper towel from the floor of the launderette.".
