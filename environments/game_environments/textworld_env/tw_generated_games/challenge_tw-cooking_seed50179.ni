...
The kitchen part 8 is some text that varies. The kitchen part 8 is "[if there is nothing on the s_1] But the thing is empty. This always happens, here in TextWorld![end if]".
...
The f_1 and the f_6 and the f_8 and the f_0 and the f_2 and the f_3 and the f_4 and the f_5 and the f_7 are foods.
The f_1 and the f_6 and the f_8 and the f_0 and the f_2 and the f_3 and the f_4 and the f_5 and the f_7 are privately-named.
