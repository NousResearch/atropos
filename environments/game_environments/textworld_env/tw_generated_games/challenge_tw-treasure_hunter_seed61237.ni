...
The salon part 0 is some text that varies. The salon part 0 is "You are in a normal kind of place. That is to say, you're in a salon.



You don't like doors? Why not try going east, that entranceway is unguarded. There is an unguarded exit to the south. You don't like doors? Why not try going west, that entranceway is unblocked.".
...
The objective part 0 is some text that varies. The objective part 0 is "Your objective is to retrieve the latchkey from the floor of the bar.".
