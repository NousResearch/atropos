...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Here is how to play! First off, if it's not too much trouble, I need you to make an effort to move north. After ".
The objective part 1 is some text that varies. The objective part 1 is "that, attempt to travel west. And then, pick up the passkey from the floor of the cookery. Alright, thanks!".
