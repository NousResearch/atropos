...
The kitchen part 4 is some text that varies. The kitchen part 4 is " You can make out a table. Wow, isn't TextWorld just the best? The table is massive.[if there is something on the s_0] On the table you can see [a list of things on the s_0]. Wow! Just like in the movies![end if]".
...
The kitchen part 6 is some text that varies. The kitchen part 6 is " You smell an intriguing smell, and follow it to a counter. The counter is vast.[if there is something on the s_1] On the counter you see [a list of things on the s_1].[end if]".
The kitchen part 7 is some text that varies. The kitchen part 7 is "[if there is nothing on the s_1] Unfortunately, there isn't a thing on it. What's the point of an empty counter?[end if]".
...
The f_2 and the f_1 and the f_4 and the f_0 and the f_3 are foods.
The f_2 and the f_1 and the f_4 and the f_0 and the f_3 are privately-named.
