...
The lounge part 0 is some text that varies. The lounge part 0 is "You are in a lounge. It seems to be pretty typical here. The room is well lit.
...
The workshop part 0 is some text that varies. The workshop part 0 is "You're now in a workshop. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The cellar part 0 is some text that varies. The cellar part 0 is "You are in a cellar. I guess you better just go and list everything you see here.
...
The description of o_0 is "The pen appears to be to fit in here".
The printed name of o_0 is "pen".
Understand "pen" as o_0.
The o_0 is in r_4.
The description of o_1 is "The broom would seem to be out of place here".
...
Test quest0_0 with "go north / go east / take pen"
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Here is how to play! First step, go north. Then, travel east. And then, lift the pen from the floor of the workshop. And once you've done that, you".
The objective part 1 is some text that varies. The objective part 1 is " win!".
