...
There is an exit to the north. Don't worry, it is unblocked. There is an unblocked exit to the south. There is an unguarded exit to the west.".
...
Test quest0_0 with "go south / take cane"
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! First off, head south. If you can finish that, pick up the cane from the floor of the spare room. And once you've done that, you win!".
