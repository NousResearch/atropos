...
The vault part 0 is some text that varies. The vault part 0 is "You have stumbled into the most standard of all possible vaults.
...
The bar part 0 is some text that varies. The bar part 0 is "You arrive in a bar. An ordinary one. You begin looking for stuff.
...
The description of o_0 is "The nest of bats appears to fit in here".
The printed name of o_0 is "nest of bats".
Understand "nest of bats" as o_0.
Understand "nest" as o_0.
Understand "bats" as o_0.
The o_0 is in r_2.
The description of o_1 is "The sock looks out of place here".
...
Test quest0_0 with "go east / take nest of bats"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First off, if it's not too much trouble, I need you to make an attempt to take a trip east. After that, ".
The objective part 1 is some text that varies. The objective part 1 is "recover the nest of bats from the floor of the steam room. Got that? Good!".
