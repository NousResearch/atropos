...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Your first objective is to head west. Following that, recover the latchkey from the floor of the kitchenette. Once that's all handled, you can stop".
