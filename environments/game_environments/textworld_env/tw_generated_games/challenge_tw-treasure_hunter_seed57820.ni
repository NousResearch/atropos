...
The garage part 0 is some text that varies. The garage part 0 is "A rusty signboard tells you that you are now in the garage.
...
The k_0 is in r_1.
The description of o_0 is "The pair of headphones appears to be well matched to everything else here".
...
Test quest0_0 with "go north / take pair of headphones"
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an life changing round of TextWorld? You do! Here is your task for today. First thing I need you to do is to take a trip north. With that accom".
The objective part 1 is some text that varies. The objective part 1 is "plished, retrieve the pair of headphones from the floor of the garage. And if you do that, you're the winner!".
