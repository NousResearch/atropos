...
The workshop part 0 is some text that varies. The workshop part 0 is "You are in a workshop. A typical kind of place. The room is well lit.
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! First, it would be great if you could move south. Following that, make an attempt to head east. Then, retrieve the keycard from the floor of the st".
The objective part 1 is some text that varies. The objective part 1 is "eam room. And if you do that, you're the winner!".
