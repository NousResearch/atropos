...
The steam room part 0 is some text that varies. The steam room part 0 is "You have moved into the most usual of all possible steam rooms. You begin to take stock of what's in the room.
...
You don't like doors? Why not try going north, that entranceway is unguarded. There is an unguarded exit to the south. You don't like doors? Why not try going west, that entranceway is unguarded.".
...
The bedchamber part 0 is some text that varies. The bedchamber part 0 is "You've entered a bedchamber. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The f_0 is in r_3.
The description of o_0 is "The top hat is cheap looking.".
...
Test quest0_0 with "take top hat"
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Your task for today is to pick up the top hat from the floor of the vault.".
