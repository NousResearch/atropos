...
The r_0 and the r_6 and the r_2 and the r_5 and the r_4 and the r_7 and the r_1 and the r_10 and the r_11 and the r_3 and the r_8 and the r_9 are rooms.
...
The kitchen part 1 is some text that varies. The kitchen part 1 is " conventional looking fridge in the corner.[if c_0 is open and there is something in the c_0] The fridge contains [a list of things in the c_0]. Make a note of this, you might have to put stuff on or in it later on.[end if]".
...
The kitchen part 6 is some text that varies. The kitchen part 6 is " You see a gleam over in a corner, where you can see a table. [if there is something on the s_0]On the table you see [a list of things on the s_0].[end if]".
...
The kitchen part 8 is some text that varies. The kitchen part 8 is " You can see a counter. The counter is vast.[if there is something on the s_1] On the counter you can see [a list of things on the s_1]. Now that's what I call TextWorld![end if]".
...
The kitchen part 11 is some text that varies. The kitchen part 11 is "[if there is nothing on the stove_0] But there isn't a thing on it. This always happens![end if]".
...
The kitchen part 14 is some text that varies. The kitchen part 14 is " screen door leading west. You need an exit without a door? You should try going north.".
...
The backyard part 0 is some text that varies. The backyard part 0 is "Well, here we are in a backyard.
 ...
 You see a patio table. [if there is something on the s_8]You see [a list of things on the s_8] on the patio table.[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " You bend down to tie your shoe. When you stand up, you notice a patio chair. [if there is something on the s_9]You see [a list of things on the s_9] on the patio chair. There's something strange about this being here, but you can't put your finger on it.[end if]".
The backyard part 3 is some text that varies. The backyard part 3 is "[if there is nothing on the s_9]However, the patio chair, like an empty patio chair, has nothing on it. It would have been so cool if there was stuff on the patio chair.[end if]".
...
You don't like doors? Why not try going east, that entranceway is not blocked by one. You don't like doors? Why not try going north, that entranceway is not blocked by one. You need an exit without a door? You should try going south. There is an exit to the west. Don't worry, there is no door.".
...
The livingroom part 3 is some text that varies. The livingroom part 3 is " front door leading south. There is an exit to the west.".
...
The shed part 0 is some text that varies. The shed part 0 is "You are in a shed. You begin to take stock of what's in the room.
...
The shed part 2 is some text that varies. The shed part 2 is " You bend down to tie your shoe. When you stand up, you notice a workbench. You wonder idly who left that here. [if there is something on the s_4]You see [a list of things on the s_4] on the workbench.[end if]".
...
The supermarket part 0 is some text that varies. The supermarket part 0 is "Well how about that, you are in a place we're calling a supermarket. You begin looking for stuff.
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "I am so happy to announce that you are now in the bathroom. I guess you better just go and list everything you see here.
...
The driveway part 0 is some text that varies. The driveway part 0 is "You are in a driveway. A typical kind of place. You can barely contain your excitement.
...
The f_4 and the f_0 and the f_1 and the f_5 and the f_2 and the f_3 are foods.
The f_4 and the f_0 and the f_1 and the f_5 and the f_2 and the f_3 are privately-named.
...
The r_0 and the r_6 and the r_2 and the r_5 and the r_4 and the r_7 and the r_1 and the r_10 and the r_11 and the r_3 and the r_8 and the r_9 are rooms.
The r_0 and the r_6 and the r_2 and the r_5 and the r_4 and the r_7 and the r_1 and the r_10 and the r_11 and the r_3 and the r_8 and the r_9 are privately-named.
