...
The cubicle part 0 is some text that varies. The cubicle part 0 is "You find yourself in a cubicle. A normal kind of place. The room is well lit.
...
The office part 0 is some text that varies. The office part 0 is "I am so happy to announce that you are now in the office.
...
The laundry place part 0 is some text that varies. The laundry place part 0 is "Here we are in the laundry place.
...
The cookery part 0 is some text that varies. The cookery part 0 is "You've seen better cookerys, but at least this one seems pretty standard. Let's see what's in here.
...
The f_0 is in r_2.
The description of o_0 is "The staple appears out of place here".
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to TextWorld! Please retrieve the staple from the floor of the office.".
