...
There is an unblocked exit to the north. You need an unguarded exit? You should try going south. There is an unguarded exit to the west.".
...
Test quest0_0 with "go north / take coconut"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First of all, make an attempt to venture north. Then, retrieve the coconut from the floor of the sculler".
The objective part 1 is some text that varies. The objective part 1 is "y. Got that? Good!".
