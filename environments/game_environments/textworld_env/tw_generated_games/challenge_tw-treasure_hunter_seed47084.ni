...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You've just sauntered into a bathroom. You try to gain information on your surroundings by using a technique you call 'looking.'
...
Test quest0_0 with "go west / go south / take broccoli"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. Your first objective is to make an effort to move west. Then, try to take a trip south. And then, pick-u".
The objective part 1 is some text that varies. The objective part 1 is "p the broccoli from the floor of the kitchenette. Got that? Good!".
