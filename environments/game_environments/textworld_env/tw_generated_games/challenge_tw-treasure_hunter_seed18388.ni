...
The kitchen part 0 is some text that varies. The kitchen part 0 is "You have come into the most normal of all possible kitchens. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is how to play! First off, make an effort to take a trip north. Once you do that, recover the key from the floor of the studio. And if you do that, you're the winner!".
