...
The r_0 and the r_1 and the r_2 and the r_4 and the r_3 and the r_5 and the r_6 and the r_8 and the r_10 and the r_7 and the r_9 and the r_11 are rooms.
...
The kitchen part 0 is some text that varies. The kitchen part 0 is "You find yourself in a kitchen. An usual kind of place.
 ...
 You scan the room for a fridge, and you find a fridge. You wonder idly who left that here.[if c_0 is open and there is something in the c_0] The fridge contains [a list of things in the c_0], so there's that.[end if]".
...
The kitchen part 8 is some text that varies. The kitchen part 8 is " You can see a stove. The stove is conventional.[if there is something on the stove_0] On the stove you see [a list of things on the stove_0]. Hmmm... what else, what else?[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "Well how about that, you are in the place we're calling the bathroom. You begin looking for stuff.
...
The livingroom part 0 is some text that varies. The livingroom part 0 is "You've just sauntered into a livingroom.
 ...
 You can see a sofa. The sofa is comfy.[if there is something on the s_7] On the sofa you make out [a list of things on the s_7], so there's that.[end if]".
...
north of r_5 and south of r_9 is a door called d_3.
...
The backyard part 0 is some text that varies. The backyard part 0 is "You've just shown up in a backyard. You decide to start listing off everything you see in the room, as if you were in a text adventure.
 ...
 You make out a patio chair. The patio chair is stylish.[if there is something on the s_6] On the patio chair you can make out [a list of things on the s_6].[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " You can see a BBQ. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[if toaster_0 is open and there is something in the toaster_0] The BBQ contains [a list of things in the toaster_0]. You check the price tag on the BBQ. A hundred big ones?! That's ridiculous! Did you ever meet my pal, they work for a company? I'm sure my friend could get you one of those for 35 bucks![end if]".
...
The shed part 2 is some text that varies. The shed part 2 is " You smell an awful smell, and follow it to a workbench. [if there is something on the s_5]On the workbench you see [a list of things on the s_5].[end if]".
...
The street part 0 is some text that varies. The street part 0 is "You've entered a street. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The driveway part 0 is some text that varies. The driveway part 0 is "This might come as a shock to you, but you've just come into a driveway.
...
south of r_9 and north of r_5 is a door called d_3.
...
The supermarket part 0 is some text that varies. The supermarket part 0 is "If you're wondering why everything seems so standard all of a sudden, it's because you've just shown up in the supermarket.
...
The r_0 and the r_1 and the r_2 and the r_4 and the r_3 and the r_5 and the r_6 and the r_8 and the r_10 and the r_7 and the r_9 and the r_11 are rooms.
The r_0 and the r_1 and the r_2 and the r_4 and the r_3 and the r_5 and the r_6 and the r_8 and the r_10 and the r_7 and the r_9 and the r_11 are privately-named.
