...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Here is your task for today. First of all, go to the west. That done, try to move west. And then, pick up the passkey from the floor of the bedcham".
The objective part 1 is some text that varies. The objective part 1 is "ber. And if you do that, you're the winner!".
