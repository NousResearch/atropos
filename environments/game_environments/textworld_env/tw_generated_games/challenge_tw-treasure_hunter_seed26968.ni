...
Test quest0_0 with "go west / take candy bar"
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an exciting round of TextWorld? You do! Here is how to play! First stop, try to venture west. If you can get around to doing that, lift the can".
The objective part 1 is some text that varies. The objective part 1 is "dy bar from the floor of the salon. And if you do that, you're the winner!".
