...
The kitchen part 3 is some text that varies. The kitchen part 3 is " You see a counter. The counter is ordinary.[if there is something on the s_1] On the counter you make out [a list of things on the s_1]. Now that's what I call TextWorld![end if]".
The kitchen part 4 is some text that varies. The kitchen part 4 is "[if there is nothing on the s_1] However, the counter, like an empty counter, has nothing on it. Hm. Oh well[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You find yourself in a bedroom. An usual one.
 ...
 What's that over there? It looks like it's a chest drawer. The light flickers for a second, but nothing else happens.[if c_0 is open and there is something in the c_0] The chest drawer contains [a list of things in the c_0]. The light flickers for a second, but nothing else happens.[end if]".
...
The bedroom part 3 is some text that varies. The bedroom part 3 is " antique trunk, which looks usual, in the room.[if c_1 is open and there is something in the c_1] The antique trunk contains [a list of things in the c_1].[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " What's that over there? It looks like it's a bbq. The bbq is ordinary.[if there is something on the s_8] On the bbq you can see [a list of things on the s_8].[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " You can make out a patio table. The patio table is usual.[if there is something on the s_9] On the patio table you can see [a list of things on the s_9], so there's that.[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You're now in a living room.
 ...
 You see a couch. The couch is standard.[if there is something on the s_5] On the couch you see [a list of things on the s_5].[end if]".
...
The living room part 2 is some text that varies. The living room part 2 is " Were you looking for a low table? Because look over there, it's a low table. The low table is usual.[if there is something on the s_6] On the low table you make out [a list of things on the s_6]. You shudder, but continue examining the room.[end if]".
...
The living room part 4 is some text that varies. The living room part 4 is " As if things weren't amazing enough already, you can even see a tv. [if there is something on the s_7]You see [a list of things on the s_7] on the tv.[end if]".
...
The bathroom part 3 is some text that varies. The bathroom part 3 is " bath, which looks ordinary, in the corner.[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4].[end if]".
...
The bathroom part 5 is some text that varies. The bathroom part 5 is " You make out a sink. The sink is normal.[if there is something on the s_4] On the sink you see [a list of things on the s_4]. There's something strange about this thing being here, but you don't have time to worry about that now.[end if]".
...
The f_4 is in r_5.
The f_4 is edible.
The description of f_5 is "The apple looks tempting.".
...
The description of f_2 is "The tomato plant looks inviting.".
