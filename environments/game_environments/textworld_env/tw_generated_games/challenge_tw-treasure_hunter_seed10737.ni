...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Here is your task for today. First stop, go to the south. And then, attempt to travel west. With that done, pick".
The objective part 1 is some text that varies. The objective part 1 is "-up the key from the floor of the basement. And if you do that, you're the winner!".
