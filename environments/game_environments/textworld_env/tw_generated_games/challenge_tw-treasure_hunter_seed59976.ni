...
The workshop part 0 is some text that varies. The workshop part 0 is "You are in a workshop. An usual kind of place. You begin to take stock of what's in the room.
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. Your first objective is to attempt to go north. With that done, lift the passkey from the floor of the s".
The objective part 1 is some text that varies. The objective part 1 is "tudy. Alright, thanks!".
