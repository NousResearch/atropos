...
The r_0 and the r_4 and the r_1 and the r_2 and the r_5 and the r_7 and the r_6 and the r_9 and the r_10 and the r_11 and the r_3 and the r_8 are rooms.
...
The kitchen part 7 is some text that varies. The kitchen part 7 is " You smell a wretched smell, and follow it to a counter. [if there is something on the s_1]You see [a list of things on the s_1] on the counter.[end if]".
...
The kitchen part 9 is some text that varies. The kitchen part 9 is " Oh, great. Here's a stove. [if there is something on the stove_0]On the stove you can see [a list of things on the stove_0].[end if]".
...
The livingroom part 0 is some text that varies. The livingroom part 0 is "You've entered a livingroom. Okay, just remember what you're here to do, and everything will go great.
 ...
 You can see a sofa. The sofa is comfy.[if there is something on the s_5] On the sofa you see [a list of things on the s_5]. I mean, just wow! Isn't TextWorld just the best?[end if]".
...
The corridor part 1 is some text that varies. The corridor part 1 is " sliding patio door leading south. There is an exit to the east. There is an exit to the west. Don't worry, there is no door.".
...
The bathroom part 1 is some text that varies. The bathroom part 1 is "[if there is nothing on the s_9]But the thing hasn't got anything on it. You move on, clearly upset with your TextWorld experience.[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " What's that over there? It looks like it's a patio table. [if there is something on the s_8]You see [a list of things on the s_8] on the patio table. Wow! Just like in the movies![end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " Oh, great. Here's a BBQ. You can't wait to tell the folks at home about this![if toaster_0 is open and there is something in the toaster_0] The BBQ contains [a list of things in the toaster_0].[end if]".
...
The driveway part 0 is some text that varies. The driveway part 0 is "You're now in the driveway. I guess you better just go and list everything you see here.
...
The street part 0 is some text that varies. The street part 0 is "Wow! You're in a street.
...
The supermarket part 0 is some text that varies. The supermarket part 0 is "Guess what, you are in the place we're calling the supermarket.

 Oh, great. Here's a showcase. Wow, isn't TextWorld just the best? The showcase is metallic.[if there is something on the s_3] On the showcase you can see [a list of things on the s_3].[end if]".
...
The pantry part 0 is some text that varies. The pantry part 0 is "Well I'll be, you are in a place we're calling a pantry. You begin to take stock of what's here.

 You lean against the wall, inadvertently pressing a secret button. The wall opens up to reveal a shelf. What a coincidence, weren't you just thinking about a shelf? The shelf is wooden.[if there is something on the s_2] On the shelf you can make out [a list of things on the s_2]. It doesn't get more TextWorld than this![end if]".
...
The shed part 0 is some text that varies. The shed part 0 is "This might come as a shock to you, but you've just walked into a shed.
...
The r_0 and the r_4 and the r_1 and the r_2 and the r_5 and the r_7 and the r_6 and the r_9 and the r_10 and the r_11 and the r_3 and the r_8 are rooms.
The r_0 and the r_4 and the r_1 and the r_2 and the r_5 and the r_7 and the r_6 and the r_9 and the r_10 and the r_11 and the r_3 and the r_8 are privately-named.
