...
The pantry part 0 is some text that varies. The pantry part 0 is "You are in a pantry. A typical kind of place. You begin looking for stuff.
...
Test quest0_0 with "go east / go east / take whisk"
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an life changing round of TextWorld? You do! Here is your task for today. First off, head east. With that accomplished, make an effort to go ea".
The objective part 1 is some text that varies. The objective part 1 is "st. Next, lift the whisk from the floor of the canteen. Once that's all handled, you can stop!".
