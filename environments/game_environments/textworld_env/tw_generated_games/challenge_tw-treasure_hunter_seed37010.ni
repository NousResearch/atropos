...
The basement part 0 is some text that varies. The basement part 0 is "You've just walked into a basement. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The chamber part 0 is some text that varies. The chamber part 0 is "You've moved into a normal room. Your mind races to think of what kind of room would be normal. And then it hits you. Of course. You're in the chamber.
...
Test quest0_0 with "go south / go south / take burger"
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a profound session of TextWorld! First, it would be good if you could venture south. After that, take a trip south. If you can manage that, pick up the burger from the floor of the".
The objective part 1 is some text that varies. The objective part 1 is " chamber. That's it!".
