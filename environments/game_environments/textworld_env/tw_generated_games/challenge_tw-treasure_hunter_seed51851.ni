...
The attic part 0 is some text that varies. The attic part 0 is "You have stumbled into the most standard of all possible attics.
...
Test quest0_0 with "go east / take cabbage"
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! Here is how to play! First of all, you could, like, head east. And then, recover the cabbage from".
The objective part 1 is some text that varies. The objective part 1 is " the floor of the laundromat. And once you've done that, you win!".
