...
The description of f_0 is "The coconut looks inviting.".
...
Test quest0_0 with "go west / take mop"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First step, move west. And then, retrieve the mop from the floor of the washroom. That's it!".
