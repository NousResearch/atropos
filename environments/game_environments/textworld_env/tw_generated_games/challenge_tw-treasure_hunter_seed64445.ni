...
There is an unblocked exit to the east. You need an unblocked exit? You should try going south. There is an unguarded exit to the west.".
...
The bedchamber part 0 is some text that varies. The bedchamber part 0 is "You arrive in a bedchamber. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The f_0 is in r_4.
The description of o_0 is "The lamp seems out of place here".
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an exciting round of TextWorld? You do! First off, travel north. Okay, and then, go east. Next, retrieve the stick of butter from the floor of ".
The objective part 1 is some text that varies. The objective part 1 is "the pantry. And once you've done that, you win!".
