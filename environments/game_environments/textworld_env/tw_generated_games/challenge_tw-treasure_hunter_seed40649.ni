...
The spare room part 0 is some text that varies. The spare room part 0 is "I never took you for the sort of person who would show up in a spare room, but I guess I was wrong. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The cellar part 0 is some text that varies. The cellar part 0 is "I never took you for the sort of person who would show up in a cellar, but I guess I was wrong. I guess you better just go and list everything you see here.
...
Test quest0_0 with "go east / take berry"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First, it would be a great idea if you could venture east. And then, lift the berry from the floor of th".
The objective part 1 is some text that varies. The objective part 1 is "e recreation zone. And if you do that, you're the winner!".
