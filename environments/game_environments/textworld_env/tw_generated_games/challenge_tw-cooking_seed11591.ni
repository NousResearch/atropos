...
The backyard part 0 is some text that varies. The backyard part 0 is "You're now in the backyard. You begin to take stock of what's in the room.
 ...
 You make out a patio table. [if there is something on the s_6]On the patio table you make out [a list of things on the s_6].[end if]".
...
The livingroom part 0 is some text that varies. The livingroom part 0 is "You've entered a livingroom.
 ...
 If you haven't noticed it already, there seems to be something there by the wall, it's a sofa! [if there is something on the s_4]You see [a list of things on the s_4] on the sofa. You can't wait to tell the folks at home about this![end if]".
...
The shed part 0 is some text that varies. The shed part 0 is "You find yourself in a shed. A typical kind of place.
 ...
 Were you looking for a toolbox? Because look over there, it's a toolbox. I mean, just wow! Isn't TextWorld just the best?[if c_1 is open and there is something in the c_1] The toolbox contains [a list of things in the c_1]. Hmmm... what else, what else?[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "I never took you for the sort of person who would show up in a bedroom, but I guess I was wrong.
 ...
 You scan the room, seeing a bed. The bed is large.[if there is something on the s_7] On the bed you make out [a list of things on the s_7]. Wow! Just like in the movies![end if]".
