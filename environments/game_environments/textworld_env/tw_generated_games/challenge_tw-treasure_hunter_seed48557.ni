...
The steam room part 0 is some text that varies. The steam room part 0 is "Well, here we are in a steam room. Let's see what's in here.
...
The laundry place part 0 is some text that varies. The laundry place part 0 is "You arrive in a laundry place. A standard one. You begin to take stock of what's in the room.
...
The cellar part 0 is some text that varies. The cellar part 0 is "Well, here we are in a cellar. You can barely contain your excitement.
...
The attic part 0 is some text that varies. The attic part 0 is "This might come as a shock to you, but you've just walked into an attic.
...
Test quest0_0 with "go east / take butterfly"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another profound session of TextWorld! Here is your task for today. First of all, attempt to go east. Then, pick-up the butterfly from the floor of the cellar. And if you do that, you're th".
The objective part 1 is some text that varies. The objective part 1 is "e winner!".
