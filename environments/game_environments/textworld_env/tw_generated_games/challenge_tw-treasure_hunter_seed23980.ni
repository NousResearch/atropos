...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Here is how to play! First step, attempt to venture west. After that, retrieve the sandwich from the floor of th".
The objective part 1 is some text that varies. The objective part 1 is "e kitchenette. And once you've done that, you win!".
