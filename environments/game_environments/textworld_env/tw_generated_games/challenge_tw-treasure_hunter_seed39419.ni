...
The studio part 0 is some text that varies. The studio part 0 is "You've just sauntered into a studio. The room is well lit.
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! Here is your task for today. First of all, make an attempt to go north. Okay, and then, pick-up t".
The objective part 1 is some text that varies. The objective part 1 is "he latchkey from the floor of the study. Once that's all handled, you can stop!".
