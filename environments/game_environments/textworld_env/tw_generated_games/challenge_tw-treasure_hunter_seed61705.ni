...
The bedchamber part 0 is some text that varies. The bedchamber part 0 is "Guess what, you are in a place we're calling a bedchamber. You begin looking for stuff.
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Pick up the keycard from the floor of the laundromat.".
