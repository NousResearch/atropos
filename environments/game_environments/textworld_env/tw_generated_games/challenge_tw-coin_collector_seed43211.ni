...
The attic part 0 is some text that varies. The attic part 0 is "Well, here we are in the attic. Let's see what's in here.
...
The recreation zone part 0 is some text that varies. The recreation zone part 0 is "Okay, so you're in a recreation zone, cool, but is it standard? You better believe it is. You begin to take stock of what's here.
...
The garage part 0 is some text that varies. The garage part 0 is "You are in a garage. It seems to be pretty usual here. You begin looking for stuff.
...
Test quest0_0 with "go west / go south / go east / go east / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! First of all, move west. With that over with, make an effort to venture south. Then, try to head east. After that, attempt to move east. After that, pick up the coin from the flo".
The objective part 1 is some text that varies. The objective part 1 is "or of the garage. Alright, thanks!".
