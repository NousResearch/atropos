...
The attic part 0 is some text that varies. The attic part 0 is "I am excited to announce that you are now in the attic.
...
The laundromat part 0 is some text that varies. The laundromat part 0 is "Well, here we are in the laundromat. You begin looking for stuff.
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an exciting round of TextWorld? You do! Here is your task for today. First thing I need you to do is to make an effort to go to the north. Afte".
The objective part 1 is some text that varies. The objective part 1 is "r that, retrieve the keycard from the floor of the salon. And once you've done that, you win!".
