...
The study part 0 is some text that varies. The study part 0 is "You arrive in a study. A normal kind of place. You start to take note of what's in the room.
...
The basement part 0 is some text that varies. The basement part 0 is "You've walked into an usual room. Your mind races to think of what kind of room would be usual. And then it hits you. Of course. You're in the basement.
...
The k_0 is in r_0.
The description of o_0 is "The pencil is expensive looking.".
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a exciting session of TextWorld! Retrieve the key from the floor of the basement.".
