...
The cubicle part 0 is some text that varies. The cubicle part 0 is "You have come into the most typical of all possible cubicles. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Your task for today is to pick-up the passkey from the floor of the steam room.".
