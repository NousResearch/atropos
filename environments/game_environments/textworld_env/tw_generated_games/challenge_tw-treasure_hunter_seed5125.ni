...
The cookery part 0 is some text that varies. The cookery part 0 is "You've just walked into a cookery. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The attic part 0 is some text that varies. The attic part 0 is "A crooked sign tells you that you are now in the attic.
...
Test quest0_0 with "go south / take sandwich"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First off, if it's not too much trouble, I need you to try to take a trip south. With that done, pick-up".
The objective part 1 is some text that varies. The objective part 1 is " the sandwich from the floor of the office. Once that's all handled, you can stop!".
