...
The chamber part 0 is some text that varies. The chamber part 0 is "You arrive in a chamber. An ordinary kind of place. Let's see what's in here.
...
Test quest0_0 with "go east / go north / go west / go south / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! Your first objective is to travel east. After that, go north. After that, move west. If you can f".
The objective part 1 is some text that varies. The objective part 1 is "inish that, venture south. Following that, pick-up the coin from the floor of the studio. Got that? Good!".
