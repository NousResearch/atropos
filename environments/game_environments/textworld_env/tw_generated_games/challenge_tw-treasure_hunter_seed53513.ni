...
The description of o_0 is "The coffee cup looks well matched to everything else here".
...
Test quest0_0 with "go east / go east / take coffee cup"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another profound episode of TextWorld! First thing I need you to do is to attempt to venture east. And then, go east. And then, recover the coffee cup from the floor of the cookery. Alright".
