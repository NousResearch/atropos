...
The kitchen part 1 is some text that varies. The kitchen part 1 is " ordinary looking refrigerator in the corner.[if c_2 is open and there is something in the c_2] The refrigerator contains [a list of things in the c_2].[end if]".
...
The kitchen part 3 is some text that varies. The kitchen part 3 is " What's that over there? It looks like it's a counter. [if there is something on the s_1]You see [a list of things on the s_1] on the counter.[end if]".
...
The kitchen part 5 is some text that varies. The kitchen part 5 is " You can see a stove. [if there is something on the s_2]You see [a list of things on the s_2] on the stove.[end if]".
...
The kitchen part 7 is some text that varies. The kitchen part 7 is " You see a kitchen island. The kitchen island is normal.[if there is something on the s_3] On the kitchen island you see [a list of things on the s_3]. Suddenly, you bump your head on the ceiling, but it's not such a bad bump that it's going to prevent you from looking at objects and even things.[end if]".
...
The bedroom part 3 is some text that varies. The bedroom part 3 is " You scan the room, seeing an antique trunk.[if c_1 is open and there is something in the c_1] The antique trunk contains [a list of things in the c_1]. You can't wait to tell the folks at home about this![end if]".
...
The bedroom part 5 is some text that varies. The bedroom part 5 is " You see a king-size bed. The king-size bed is normal.[if there is something on the s_0] On the king-size bed you can make out [a list of things on the s_0].[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "Well, here we are in a backyard. You can barely contain your excitement.
 ...
 You can see a set of chairs. The set of chairs is ordinary.[if there is something on the s_10] On the set of chairs you can make out [a list of things on the s_10].[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " You bend down to tie your shoe. When you stand up, you notice a bbq. The bbq is standard.[if there is something on the s_8] On the bbq you can see [a list of things on the s_8]. Now that's what I call TextWorld![end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " You see a gleam over in a corner, where you can see a patio table. [if there is something on the s_9]You see [a list of things on the s_9] on the patio table.[end if]".
The backyard part 5 is some text that varies. The backyard part 5 is "[if there is nothing on the s_9]The patio table appears to be empty. You move on, clearly upset by your TextWorld experience.[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "If you're wondering why everything seems so normal all of a sudden, it's because you've just walked into the living room. You decide to just list off a complete list of everything you see in the room, because hey, why not?

 You see a couch. The couch is typical.[if there is something on the s_5] On the couch you see [a list of things on the s_5]. Hmmm... what else, what else?[end if]".
...
The living room part 2 is some text that varies. The living room part 2 is " You see a low table. [if there is something on the s_6]On the low table you see [a list of things on the s_6]. Wow! Just like in the movies![end if]".
...
The living room part 4 is some text that varies. The living room part 4 is " You see a tv. [if there is something on the s_7]On the tv you can see [a list of things on the s_7], so there's that.[end if]".
The living room part 5 is some text that varies. The living room part 5 is "[if there is nothing on the s_7]Unfortunately, there isn't a thing on it. You move on, clearly infuriated by TextWorld.[end if]".
...
The bathroom part 3 is some text that varies. The bathroom part 3 is " bath.[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4]. You wonder idly who left that here.[end if]".
...
The bathroom part 5 is some text that varies. The bathroom part 5 is " You see a sink. [if there is something on the s_4]You see [a list of things on the s_4] on the sink. There's something strange about this being here, but you can't put your finger on it.[end if]".
...
The description of d_0 is "it's a commanding wooden door [if open]It is open.[else if closed]It is closed.[otherwise]It is locked.[end if]".
...
The c_4 is in r_3.
The c_4 is closed.
The description of f_3 is "The half of a bag of chips looks savory.".
...
The f_4 is in r_5.
The f_4 is edible.
The description of f_5 is "The milk looks tempting.".
...
The description of f_2 is "The lettuce looks appetizing.".
