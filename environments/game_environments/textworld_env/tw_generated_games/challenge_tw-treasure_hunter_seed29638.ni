...
The spare room part 0 is some text that varies. The spare room part 0 is "You are in a spare room. A standard kind of place. You start to take note of what's in the room.



You need an unblocked exit? You should try going north. You need an unguarded exit? You should try going south. There is an exit to the west. Don't worry, it is unblocked.".
...
The kitchenette part 0 is some text that varies. The kitchenette part 0 is "You have come into a kitchenette. Not the kitchenette you'd expect. No, this is a kitchenette.
...
Test quest0_0 with "go north / take butterfly"
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! Here is your task for today. Your first objective is to make an attempt to move north. Following ".
The objective part 1 is some text that varies. The objective part 1 is "that, recover the butterfly from the floor of the spare room. Got that? Good!".
