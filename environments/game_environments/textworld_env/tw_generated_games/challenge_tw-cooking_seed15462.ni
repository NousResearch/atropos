...
The kitchen part 2 is some text that varies. The kitchen part 2 is " You make out an oven. What a great pairing of adjectives and nouns![if oven_0 is open and there is something in the oven_0] The oven contains [a list of things in the oven_0].[end if]".
...
The f_2 and the f_0 and the f_1 and the f_3 and the f_4 and the f_6 and the f_5 are foods.
The f_2 and the f_0 and the f_1 and the f_3 and the f_4 and the f_6 and the f_5 are privately-named.
