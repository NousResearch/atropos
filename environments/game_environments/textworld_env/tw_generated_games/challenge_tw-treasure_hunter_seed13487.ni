...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a exciting episode of TextWorld! First of all, you could, like, make an effort to venture west. Then, try to take a trip west. Then, retrieve the passkey from the floor of the cubi".
The objective part 1 is some text that varies. The objective part 1 is "cle. Once that's all handled, you can stop!".
