...
The washroom part 0 is some text that varies. The washroom part 0 is "You arrive in a washroom. An ordinary kind of place. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The chamber part 0 is some text that varies. The chamber part 0 is "Well, here we are in the chamber. You begin looking for stuff.
...
The f_0 is in r_0.
The description of o_0 is "The pair of pants is expensive looking.".
...
Test quest0_0 with "go west / take cauliflower"
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! First of all, you could, like, make an effort to go west. Then, lift the cauliflower from the flo".
The objective part 1 is some text that varies. The objective part 1 is "or of the shower. And once you've done that, you win!".
