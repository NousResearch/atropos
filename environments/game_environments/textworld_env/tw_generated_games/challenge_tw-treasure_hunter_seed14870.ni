...
The scullery part 0 is some text that varies. The scullery part 0 is "I never took you for the sort of person who would show up in a scullery, but I guess I was wrong.
...
The playroom part 0 is some text that varies. The playroom part 0 is "Look at that board! What does it say? It says Welcome to the playroom? Well that's cool. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The f_0 is in r_1.
The description of o_0 is "The cushion is brand new.".
...
Test quest0_0 with "go south / go west / take cushion"
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! First thing I need you to do is to take a trip south. If you can finish that, head west. And then, lift the cush".
The objective part 1 is some text that varies. The objective part 1 is "ion from the floor of the salon. Got that? Good!".
