...
The bar part 0 is some text that varies. The bar part 0 is "You arrive in a bar. A standard kind of place. You start to take note of what's in the room.
...
The cubicle part 0 is some text that varies. The cubicle part 0 is "You're now in a cubicle. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Here is how to play! First stop, go to the west. After that, recover the keycard from the floor of the bar. Once".
The objective part 1 is some text that varies. The objective part 1 is " that's all handled, you can stop!".
