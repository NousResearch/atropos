...
The kitchen part 1 is some text that varies. The kitchen part 1 is " refrigerator, which looks usual, close by.[if c_2 is open and there is something in the c_2] The refrigerator contains [a list of things in the c_2].[end if]".
...
The kitchen part 3 is some text that varies. The kitchen part 3 is " You see a counter! The counter is typical.[if there is something on the s_1] On the counter you see [a list of things on the s_1].[end if]".
...
The kitchen part 5 is some text that varies. The kitchen part 5 is " You make out a stove. [if there is something on the s_2]On the stove you see [a list of things on the s_2]. Hmmm... what else, what else?[end if]".
...
The kitchen part 7 is some text that varies. The kitchen part 7 is " You see a kitchen island. [if there is something on the s_3]You see [a list of things on the s_3] on the kitchen island. Now that's what I call TextWorld![end if]".
The kitchen part 8 is some text that varies. The kitchen part 8 is "[if there is nothing on the s_3]But there isn't a thing on it. Hm. Oh well[end if]".
...
The kitchen part 11 is some text that varies. The kitchen part 11 is " wooden door leading west. You need an unguarded exit? You should try going north. You don't like doors? Why not try going south, that entranceway is unblocked.".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You are in a bedroom. An ordinary kind of place.
 ...
 You can see a chest drawer.[if c_0 is open and there is something in the c_0] The chest drawer contains [a list of things in the c_0]. You look at the price tag on the chest drawer. A hundred dollars?! Where'd they buy this chest drawer, some kind of expensive place?[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You find yourself in a backyard. An usual kind of place. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The backyard part 3 is some text that varies. The backyard part 3 is "[if there is nothing on the s_8] Unfortunately, there isn't a thing on it. It would have been so cool if there was stuff on the bbq! oh well.[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You're now in a living room. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.

 You see a couch. [if there is something on the s_5]You see [a list of things on the s_5] on the couch. Huh, weird.[end if]".
...
The bathroom part 4 is some text that varies. The bathroom part 4 is " You smell a pungent smell, and follow it to a sink. The sink is standard.[if there is something on the s_4] On the sink you can see [a list of things on the s_4], so there's that.[end if]".
...
Test quest0_0 with "open chest drawer / take old key from chest drawer / unlock wooden door with old key / open wooden door / go east / go south / take tomato plant from couch / go north / put tomato plant on stove"
