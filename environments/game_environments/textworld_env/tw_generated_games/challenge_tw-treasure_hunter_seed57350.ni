...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! Here is your task for today. First of all, make an effort to head south. If you can get around to".
The objective part 1 is some text that varies. The objective part 1 is " doing that, pick-up the keycard from the floor of the office. And once you've done that, you win!".
