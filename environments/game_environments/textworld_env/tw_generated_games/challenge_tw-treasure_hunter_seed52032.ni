...
There is an exit to the east. Don't worry, it is unguarded. There is an unguarded exit to the north. You need an unguarded exit? You should try going south.".
...
The f_0 is in r_4.
The description of f_1 is "that's a normal fondue!".
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! First of all, go south. Next, retrieve the cashew from the floor of the vault. Once that's all handled, you can stop!".
