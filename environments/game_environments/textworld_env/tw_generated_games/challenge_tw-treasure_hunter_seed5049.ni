...
The shower part 0 is some text that varies. The shower part 0 is "You arrive in a shower. A standard one. You can barely contain your excitement.
...
The chamber part 0 is some text that varies. The chamber part 0 is "Well how about that, you are in the place we're calling the chamber. I guess you better just go and list everything you see here.
...
The f_0 is in r_0.
The description of f_1 is "that's an usual cauliflower!".
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. Your first objective is to take a trip west. After that, recover the coconut from the floor of the works".
The objective part 1 is some text that varies. The objective part 1 is "hop. That's it!".
