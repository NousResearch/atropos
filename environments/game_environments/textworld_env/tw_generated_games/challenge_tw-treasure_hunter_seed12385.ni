...
The recreation zone part 0 is some text that varies. The recreation zone part 0 is "You arrive in a recreation zone. An ordinary one. You start to take note of what's in the room.
...
The cookhouse part 0 is some text that varies. The cookhouse part 0 is "You've stumbled into an ordinary room. Your mind races to think of what kind of room would be ordinary. And then it hits you. Of course. You're in the cookhouse. You begin to take stock of what's here.
...
The steam room part 0 is some text that varies. The steam room part 0 is "You find yourself in a steam room. A normal kind of place. Let's see what's in here.
...
Test quest0_0 with "go east / go south / take cashew"
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a life changing game of TextWorld! Here is your task for today. First of all, you could, like, make an attempt to move east. Then, make an attempt to go south. After that, lift the".
The objective part 1 is some text that varies. The objective part 1 is " cashew from the floor of the vault. And once you've done that, you win!".
