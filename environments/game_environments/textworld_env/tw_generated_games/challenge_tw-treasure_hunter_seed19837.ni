...
The canteen part 0 is some text that varies. The canteen part 0 is "Guess what, you are in a place we're calling a canteen. You begin looking for stuff.
...
The description of o_0 is "The insect is unremarkable.".
The printed name of o_0 is "insect".
Understand "insect" as o_0.
The o_0 is in r_1.
The description of o_1 is "The keyboard appears well matched to everything else here".
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is your task for today. First of all, you could, like, make an attempt to take a trip west. Then, pick up the insect from the floor of the canteen. And if you do that, you'r".
