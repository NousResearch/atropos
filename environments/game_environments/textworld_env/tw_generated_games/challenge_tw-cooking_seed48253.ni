...
The kitchen part 4 is some text that varies. The kitchen part 4 is " You can see a table. [if there is something on the s_0]You see [a list of things on the s_0] on the table. Now that's what I call TextWorld![end if]".
...
The kitchen part 8 is some text that varies. The kitchen part 8 is " You scan the room for a stove, and you find a stove. The stove is conventional.[if there is something on the stove_0] On the stove you make out [a list of things on the stove_0], so there's that.[end if]".
The kitchen part 9 is some text that varies. The kitchen part 9 is "[if there is nothing on the stove_0] The stove appears to be empty. You swear loudly.[end if]".
...
The f_1 and the f_6 and the f_7 and the f_0 and the f_2 and the f_3 and the f_4 and the f_5 and the f_8 are foods.
The f_1 and the f_6 and the f_7 and the f_0 and the f_2 and the f_3 and the f_4 and the f_5 and the f_8 are privately-named.
