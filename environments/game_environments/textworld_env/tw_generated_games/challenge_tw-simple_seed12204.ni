...
The kitchen part 0 is some text that varies. The kitchen part 0 is "Welcome to the kitchen. You begin to take stock of what's in the room.
...
The kitchen part 3 is some text that varies. The kitchen part 3 is " You can make out a counter. The counter is ordinary.[if there is something on the s_1] On the counter you can make out [a list of things on the s_1]. There's something strange about this being here, but you can't put your finger on it.[end if]".
...
The kitchen part 5 is some text that varies. The kitchen part 5 is " You see a stove. Make a note of this, you might have to put stuff on or in it later on. [if there is something on the s_2]On the stove you can see [a list of things on the s_2].[end if]".
The kitchen part 6 is some text that varies. The kitchen part 6 is "[if there is nothing on the s_2]But there isn't a thing on it. What's the point of an empty stove?[end if]".
The kitchen part 7 is some text that varies. The kitchen part 7 is " You see a kitchen island. Now why would someone leave that there? The kitchen island is usual.[if there is something on the s_3] On the kitchen island you can see [a list of things on the s_3].[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You arrive in a bedroom. A typical kind of place.
 ...
 You can see a chest drawer. The light flickers for a second, but nothing else happens.[if c_0 is open and there is something in the c_0] The chest drawer contains [a list of things in the c_0].[end if]".
...
The bedroom part 5 is some text that varies. The bedroom part 5 is " You can see a king-size bed. The king-size bed is standard.[if there is something on the s_0] On the king-size bed you can make out [a list of things on the s_0].[end if]".
The bedroom part 6 is some text that varies. The bedroom part 6 is "[if there is nothing on the s_0] The king-size bed appears to be empty. What, you think everything in TextWorld should have stuff on it?[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "I am excited to announce that you are now in the backyard. The room is well lit.

 You smell an intriguing smell, and follow it to a set of chairs. The set of chairs is ordinary.[if there is something on the s_10] On the set of chairs you can make out [a list of things on the s_10]. There's something strange about this thing being here, but you don't have time to worry about that now.[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " Oh, great. Here's a patio table. [if there is something on the s_9]On the patio table you make out [a list of things on the s_9].[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You are in a living room. An usual one.
...
The living room part 2 is some text that varies. The living room part 2 is " If you haven't noticed it already, there seems to be something there by the wall, it's a low table. [if there is something on the s_6]You see [a list of things on the s_6] on the low table.[end if]".
...
The living room part 5 is some text that varies. The living room part 5 is "[if there is nothing on the s_7]But the thing hasn't got anything on it. Oh! Why couldn't there just be stuff on it?[end if]".
...
The bathroom part 5 is some text that varies. The bathroom part 5 is " You can make out a sink. [if there is something on the s_4]On the sink you can make out [a list of things on the s_4]. Suddenly, you bump your head on the ceiling, but it's not such a bad bump that it's going to prevent you from looking at objects and even things.[end if]".
...
The description of d_0 is "it's a commanding wooden door [if open]You can see inside it.[else if closed]You can't see inside it because the lid's in your way.[otherwise]There is a lock on it.[end if]".
...
The f_4 is in r_5.
The f_4 is edible.
The description of f_5 is "that's an usual milk!".
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another profound round of TextWorld! Here is how to play! First of all, open the chest drawer. And then, take the old key from the chest drawer in the bedroom. And then, check that the wood".
The objective part 1 is some text that varies. The objective part 1 is "en door in the bedroom is unlocked with the old key. And then, ensure that the wooden door in the bedroom is open. Then, try to head east. Next, ensure that the screen door inside the kitchen is open.".
The objective part 2 is some text that varies. The objective part 2 is " And then, make an effort to move east. Then, make an effort to move south. With that done, recover the apple from the floor of the garden. And then, go to the north. Following that, make an effort to".
The objective part 3 is some text that varies. The objective part 3 is " travel west. That done, put the apple on the stove. Alright, thanks!".
