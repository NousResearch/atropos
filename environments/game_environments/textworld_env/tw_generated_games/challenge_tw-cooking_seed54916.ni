...
The kitchen part 0 is some text that varies. The kitchen part 0 is "I am excited to announce that you are now in the kitchen. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The kitchen part 7 is some text that varies. The kitchen part 7 is " You can make out a counter. Make a note of this, you might have to put stuff on or in it later on. The counter is vast.[if there is something on the s_1] On the counter you make out [a list of things on the s_1].[end if]".
...
The kitchen part 9 is some text that varies. The kitchen part 9 is " You hear a noise behind you and spin around, but you can't see anything other than a stove. [if there is something on the stove_0]On the stove you make out [a list of things on the stove_0].[end if]".
...
The f_1 and the f_11 and the f_7 and the f_0 and the f_10 and the f_2 and the f_3 and the f_4 and the f_5 and the f_6 and the f_8 and the f_9 are foods.
The f_1 and the f_11 and the f_7 and the f_0 and the f_10 and the f_2 and the f_3 and the f_4 and the f_5 and the f_6 and the f_8 and the f_9 are privately-named.
