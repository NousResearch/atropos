...
The garage part 0 is some text that varies. The garage part 0 is "This is going to sound unbelievable, but you've just entered a garage.
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! First thing I need you to do is to attempt to go to the south. And then, try to travel east. Okay".
The objective part 1 is some text that varies. The objective part 1 is ", and then, retrieve the fondue from the floor of the workshop. Alright, thanks!".
