...
There is an unblocked exit to the north. You need an unblocked exit? You should try going south. You don't like doors? Why not try going west, that entranceway is unblocked.".
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a exciting episode of TextWorld! First off, if it's not too much trouble, I need you to attempt to take a trip west. And then, retrieve the key from the floor of the kitchenette. A".
