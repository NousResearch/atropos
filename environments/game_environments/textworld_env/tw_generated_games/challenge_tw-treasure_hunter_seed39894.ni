...
The study part 0 is some text that varies. The study part 0 is "You arrive in a normal kind of place. That is to say, you're in a study. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The f_0 is in r_2.
The description of o_0 is "The spoon is brand new.".
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a fast paced episode of TextWorld! Retrieve the licorice strip from the floor of the attic.".
