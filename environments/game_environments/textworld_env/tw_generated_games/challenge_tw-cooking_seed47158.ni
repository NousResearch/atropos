...
The kitchen part 8 is some text that varies. The kitchen part 8 is " You scan the room for a stove, and you find a stove. The stove is conventional.[if there is something on the stove_0] On the stove you make out [a list of things on the stove_0]. Classic TextWorld.[end if]".
...
The f_2 and the f_4 and the f_0 and the f_1 and the f_3 and the f_5 and the f_6 are foods.
The f_2 and the f_4 and the f_0 and the f_1 and the f_3 and the f_5 and the f_6 are privately-named.
