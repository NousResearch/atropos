...
The pantry part 0 is some text that varies. The pantry part 0 is "You are in a pantry. An ordinary one. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First off, if it's not too much trouble, I need you to make an attempt to take a trip south. Once you ma".
The objective part 1 is some text that varies. The objective part 1 is "nage that, go west. If you can finish that, retrieve the key from the floor of the office. Once that's all handled, you can stop!".
