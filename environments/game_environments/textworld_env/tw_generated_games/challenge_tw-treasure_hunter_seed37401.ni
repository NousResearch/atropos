...
The spare room part 0 is some text that varies. The spare room part 0 is "You are in a spare room. An usual kind of place. You start to take note of what's in the room.
...
The cubicle part 0 is some text that varies. The cubicle part 0 is "You find yourself in a cubicle. An usual kind of place. I guess you better just go and list everything you see here.
...
The o_0 is in r_0.
The description of o_1 is "The mug is cheap looking.".
...
Test quest0_0 with "go west / take coffee cup"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another life changing game of TextWorld! First stop, venture west. If you can succeed at that, pick-up the coffee cup from the floor of the kitchenette. Once that's all handled, you can sto".
The objective part 1 is some text that varies. The objective part 1 is "p!".
