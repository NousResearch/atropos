...
The studio part 0 is some text that varies. The studio part 0 is "You find yourself in a studio. An ordinary kind of place. Okay, just remember what you're here to do, and everything will go great.
...
The cubicle part 0 is some text that varies. The cubicle part 0 is "Well how about that, you are in a place we're calling a cubicle. The room is well lit.
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is how to play! First step, take a trip north. Then, go east. Following that, recover the key from the floor of the cubicle. Once that's all handled, you can stop!".
