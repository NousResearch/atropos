...
The office part 0 is some text that varies. The office part 0 is "If you're wondering why everything seems so ordinary all of a sudden, it's because you've just sauntered into the office. The room is well lit.
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a fast paced game of TextWorld! First stop, move west. And then, pick-up the sponge from the floor of the sauna. That's it!".
