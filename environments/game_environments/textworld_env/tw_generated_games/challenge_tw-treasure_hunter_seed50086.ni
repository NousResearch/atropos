...
The lounge part 0 is some text that varies. The lounge part 0 is "You have fallen into the most normal of all possible lounges.
...
The dish-pit part 0 is some text that varies. The dish-pit part 0 is "I am sorry to announce that you are now in the dish-pit. I guess you better just go and list everything you see here.
...
The o_0 is in r_3.
The description of o_1 is "The dvd looks to fit in here".
...
Test quest0_0 with "go north / go north / take laptop"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is your task for today. First step, try to travel north. If you can accomplish that, travel north. Next, pick-up the laptop from the floor of the bedroom. That's it!".
