...
The closet part 0 is some text that varies. The closet part 0 is "Well, here we are in a closet. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another life changing session of TextWorld! Here is your task for today. First of all, head south. And then, retrieve the fondue from the floor of the bedchamber. That's it!".
