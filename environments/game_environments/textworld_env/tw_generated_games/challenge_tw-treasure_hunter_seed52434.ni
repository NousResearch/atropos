...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! First thing I need you to do is to take a trip east. Then, pick-up the stick of butter from the floor of the off".
The objective part 1 is some text that varies. The objective part 1 is "ice. And if you do that, you're the winner!".
