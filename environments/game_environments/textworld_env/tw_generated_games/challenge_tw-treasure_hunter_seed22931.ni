...
The chamber part 0 is some text that varies. The chamber part 0 is "This just in- You, in the chamber. I guess you better just go and list everything you see here.
...
The description of o_0 is "The novel is well-used.".
The printed name of o_0 is "novel".
Understand "novel" as o_0.
The o_0 is in r_2.
The description of o_1 is "The hat looks out of place here".
...
Test quest0_0 with "go north / go north / take novel"
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an fast paced round of TextWorld? You do! Here is your task for today. First of all, you could, like, go to the north. And then, go north. Once".
The objective part 1 is some text that varies. The objective part 1 is " you do that, pick-up the novel from the floor of the chamber. And if you do that, you're the winner!".
