...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Here is your task for today. First thing I need you to do is to try to go north. Following that, lift the passke".
The objective part 1 is some text that varies. The objective part 1 is "y from the floor of the playroom. Once that's all handled, you can stop!".
