...
The washroom part 0 is some text that varies. The washroom part 0 is "You are in a washroom. It seems to be pretty standard here.
...
The spare room part 0 is some text that varies. The spare room part 0 is "You arrive in a spare room. A typical kind of place. Let's see what's in here.
...
Test quest0_0 with "go east / go east / take loaf of bread"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another life changing game of TextWorld! Your first objective is to make an attempt to go east. And then, take a trip east. Then, retrieve the loaf of bread from the floor of the washroom. ".
