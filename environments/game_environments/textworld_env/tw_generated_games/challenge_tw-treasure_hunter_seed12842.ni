...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First, it would be fantastic if you could make an attempt to go west. With that done, pick up the latchk".
The objective part 1 is some text that varies. The objective part 1 is "ey from the floor of the scullery. Got that? Good!".
