...
The cookhouse part 0 is some text that varies. The cookhouse part 0 is "Look at you, bigshot, walking into a cookhouse like it isn't some huge deal. The room is well lit.
...
The study part 0 is some text that varies. The study part 0 is "You are in a study. A normal one. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The f_0 is in r_3.
The description of f_1 is "The durian looks delectable.".
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another life changing episode of TextWorld! Your task for today is to lift the loaf of bread from the floor of the laundry place.".
