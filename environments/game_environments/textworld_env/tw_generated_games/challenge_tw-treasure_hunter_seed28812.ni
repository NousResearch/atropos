...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a fast paced session of TextWorld! Here is your task for today. First off, try to venture west. That done, make an effort to go to the north. And then, recover the keycard from the".
The objective part 1 is some text that varies. The objective part 1 is " floor of the laundry place. And if you do that, you're the winner!".
