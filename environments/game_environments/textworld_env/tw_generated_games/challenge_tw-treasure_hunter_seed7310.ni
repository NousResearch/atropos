...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You arrive in a bedroom. A normal kind of place. You begin to take stock of what's here.
...
The f_0 is in r_1.
The description of f_1 is "The peanut looks appealing.".
...
Test quest0_0 with "go west / take garlic clove"
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! Here is how to play! First of all, attempt to go west. Then, pick up the garlic clove from the fl".
The objective part 1 is some text that varies. The objective part 1 is "oor of the cellar. Alright, thanks!".
