...
The restroom part 0 is some text that varies. The restroom part 0 is "Okay, so you're in a restroom, cool, but is it standard? You better believe it is.
...
The f_0 is in r_0.
The description of f_1 is "The cashew looks tantalizing.".
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Your task for today is to lift the garlic clove from the floor of the restroom.".
