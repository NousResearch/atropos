...
The shower part 0 is some text that varies. The shower part 0 is "You are in an ordinary kind of place. That is to say, you're in a shower.
...
The kitchen part 0 is some text that varies. The kitchen part 0 is "You are in a kitchen. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The cookery part 0 is some text that varies. The cookery part 0 is "You find yourself in a cookery. An usual one. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The f_0 is in r_1.
The description of f_1 is "The gummy bear looks tantalizing.".
...
The objective part 0 is some text that varies. The objective part 0 is "Your objective is to pick up the burger from the floor of the cubicle.".
