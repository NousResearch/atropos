...
The r_0 and the r_2 and the r_1 and the r_11 and the r_10 and the r_5 and the r_3 and the r_4 and the r_8 and the r_6 and the r_7 and the r_9 are rooms.
...
The kitchen part 5 is some text that varies. The kitchen part 5 is " You can see a table. [if there is something on the s_0]You see [a list of things on the s_0] on the table. You shudder, but continue examining the room.[end if]".
...
The kitchen part 9 is some text that varies. The kitchen part 9 is " As if things weren't amazing enough already, you can even see a stove. [if there is something on the stove_0]On the stove you make out [a list of things on the stove_0].[end if]".
...
The kitchen part 13 is some text that varies. The kitchen part 13 is " patio door leading north. You don't like doors? Why not try going west, that entranceway is not blocked by one.".
...
The pantry part 0 is some text that varies. The pantry part 0 is "You've just walked into a pantry. You decide to start listing off everything you see in the room, as if you were in a text adventure.
 ...
 Oh wow! Is that what I think it is? It is! It's a shelf. [if there is something on the s_2]You see [a list of things on the s_2] on the shelf. There's something strange about this being here, but you can't put your finger on it.[end if]".
...
The supermarket part 0 is some text that varies. The supermarket part 0 is "You are in a supermarket. An ordinary kind of place. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.

 You can see a showcase. The showcase is metallic.[if there is something on the s_3] On the showcase you can see [a list of things on the s_3]. Now that's what I call TextWorld![end if]".
...
The livingroom part 0 is some text that varies. The livingroom part 0 is "You find yourself in a livingroom. An usual kind of place. You can barely contain your excitement.

 Were you looking for a sofa? Because look over there, it's a sofa. [if there is something on the s_9]You see [a list of things on the s_9] on the sofa.[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You are in a bedroom. A typical one. You begin to take stock of what's here.

 You make out a bed. [if there is something on the s_7]On the bed you can see [a list of things on the s_7].[end if]".
...
The shed part 2 is some text that varies. The shed part 2 is " Look over there! a workbench. [if there is something on the s_8]You see [a list of things on the s_8] on the workbench.[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You're now in the backyard.
 ...
 You see a gleam over in a corner, where you can see a patio chair. Wow, isn't TextWorld just the best? [if there is something on the s_4]On the patio chair you can see [a list of things on the s_4].[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " As if things weren't amazing enough already, you can even see a patio table. [if there is something on the s_6]On the patio table you see [a list of things on the s_6].[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " You can see a BBQ. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[if toaster_0 is open and there is something in the toaster_0] The BBQ contains [a list of things in the toaster_0].[end if]".
...
The driveway part 0 is some text that varies. The driveway part 0 is "Fancy seeing you here. Here, by the way, being the driveway. Okay, just remember what you're here to do, and everything will go great.
...
The f_4 and the f_6 and the f_1 and the f_5 and the f_2 and the f_3 and the f_0 are foods.
The f_4 and the f_6 and the f_1 and the f_5 and the f_2 and the f_3 and the f_0 are privately-named.
...
The r_0 and the r_2 and the r_1 and the r_11 and the r_10 and the r_5 and the r_3 and the r_4 and the r_8 and the r_6 and the r_7 and the r_9 are rooms.
The r_0 and the r_2 and the r_1 and the r_11 and the r_10 and the r_5 and the r_3 and the r_4 and the r_8 and the r_6 and the r_7 and the r_9 are privately-named.
...
The d_1 is closed.
The description of d_4 is "It's a grand [noun] [if open]You can see inside it.[else if locked]There is a lock on it and seems impossible to force open.[otherwise]You can't see inside it because the lid's in your way.[end if]".
...
The printed name of f_1 is "cilantro".
Understand "cilantro" as f_1.
