...
The workshop part 0 is some text that varies. The workshop part 0 is "Of every workshop you could have shown up in, you had to show up in a normal one. Let's see what's in here.
...
Test quest0_0 with "go north / go east / take legume"
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an exciting round of TextWorld? You do! Here is how to play! First off, if it's not too much trouble, I need you to make an attempt to travel n".
The objective part 1 is some text that varies. The objective part 1 is "orth. And then, make an effort to head east. Then, pick up the legume from the floor of the workshop. Once that's all handled, you can stop!".
