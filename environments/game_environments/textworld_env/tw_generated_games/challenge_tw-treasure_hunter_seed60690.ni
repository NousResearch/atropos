...
The bar part 0 is some text that varies. The bar part 0 is "This might come as a shock to you, but you've just walked into a bar.
...
The f_0 is in r_0.
The description of f_1 is "that's a typical banana!".
...
The objective part 0 is some text that varies. The objective part 0 is "Your objective is to lift the stick of butter from the floor of the closet.".
