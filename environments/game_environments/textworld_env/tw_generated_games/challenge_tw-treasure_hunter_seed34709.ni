...
The kitchenette part 0 is some text that varies. The kitchenette part 0 is "This might come as a shock to you, but you've just fallen into a kitchenette. You begin to take stock of what's in the room.
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to TextWorld! Please pick-up the coffee cup from the floor of the scullery.".
