...
The kitchen part 6 is some text that varies. The kitchen part 6 is " You can make out a table. You shudder, but continue examining the table. [if there is something on the s_0]On the table you can make out [a list of things on the s_0].[end if]".
...
The corridor part 0 is some text that varies. The corridor part 0 is "You find yourself in a corridor. A standard one. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You arrive in a bedroom. An ordinary one. Okay, just remember what you're here to do, and everything will go great.
 ...
 You rest your hand against a wall, but you miss the wall and fall onto a bed. Why don't you take a picture of it, it'll last longer! The bed is large.[if there is something on the s_3] On the bed you see [a list of things on the s_3].[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You arrive in a bathroom. A normal kind of place.
 ...
 You make out a toilet. The toilet is white.[if there is something on the s_4] On the toilet you can make out [a list of things on the s_4]. Classic TextWorld.[end if]".
