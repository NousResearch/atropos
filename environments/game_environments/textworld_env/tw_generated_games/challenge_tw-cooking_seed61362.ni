...
The r_0 and the r_2 and the r_1 and the r_4 and the r_6 and the r_7 and the r_9 and the r_10 and the r_3 and the r_8 and the r_11 and the r_5 are rooms.
...
The kitchen part 8 is some text that varies. The kitchen part 8 is "[if there is nothing on the s_1] But there isn't a thing on it. This always happens![end if]".
The kitchen part 9 is some text that varies. The kitchen part 9 is " You smell an interesting smell, and follow it to a stove. The stove is conventional.[if there is something on the stove_0] On the stove you can see [a list of things on the stove_0].[end if]".
...
The corridor part 1 is some text that varies. The corridor part 1 is " patio door leading south. There is an exit to the east. Don't worry, there is no door. There is an exit to the north. Don't worry, there is no door. You don't like doors? Why not try going west, that entranceway is not blocked by one.".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "Okay, so you're in a bedroom, cool, but is it normal? You better believe it is. You begin to take stock of what's here.

 You see a gleam over in a corner, where you can see a bed. The bed is large.[if there is something on the s_6] On the bed you make out [a list of things on the s_6].[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You find yourself in a backyard. You start to take note of what's in the room.
 ...
 Look out! It's a- oh, never mind, it's just a patio chair. The patio chair is stylish.[if there is something on the s_5] On the patio chair you can see [a list of things on the s_5].[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " You scan the room, seeing a patio table. The patio table is stylish.[if there is something on the s_9] On the patio table you make out [a list of things on the s_9].[end if]".
The backyard part 3 is some text that varies. The backyard part 3 is "[if there is nothing on the s_9] But oh no! there's nothing on this piece of garbage. Oh! Why couldn't there just be stuff on it?[end if]".
...
The backyard part 10 is some text that varies. The backyard part 10 is " sliding patio door leading west. There is an exit to the south. Don't worry, there is no door.".
...
The street part 0 is some text that varies. The street part 0 is "You are in a street. A standard kind of place. You begin to take stock of what's here.
...
The pantry part 0 is some text that varies. The pantry part 0 is "You find yourself in a pantry.
 ...
 You scan the room, seeing a shelf. Wow, isn't TextWorld just the best? [if there is something on the s_2]On the shelf you make out [a list of things on the s_2].[end if]".
...
The r_0 and the r_2 and the r_1 and the r_4 and the r_6 and the r_7 and the r_9 and the r_10 and the r_3 and the r_8 and the r_11 and the r_5 are rooms.
The r_0 and the r_2 and the r_1 and the r_4 and the r_6 and the r_7 and the r_9 and the r_10 and the r_3 and the r_8 and the r_11 and the r_5 are privately-named.
