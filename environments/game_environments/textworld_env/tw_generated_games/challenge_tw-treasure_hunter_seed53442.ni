...
The cubicle part 0 is some text that varies. The cubicle part 0 is "You arrive in a cubicle. A typical one. You begin looking for stuff.



There is an unblocked exit to the east. There is an unblocked exit to the north. You need an unguarded exit? You should try going west.".
...
The canteen part 0 is some text that varies. The canteen part 0 is "You arrive in a canteen. A standard kind of place. Okay, just remember what you're here to do, and everything will go great.
...
The chamber part 0 is some text that varies. The chamber part 0 is "You've just sauntered into a chamber. The room is well lit.
...
The k_0 is in r_1.
The description of o_0 is "The nest of puppies seems well matched to everything else here".
...
Test quest0_0 with "go west / take nest of puppies"
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a fast paced game of TextWorld! Here is how to play! First off, if it's not too much trouble, I need you to head west. And then, pick up the nest of puppies from the floor of the a".
