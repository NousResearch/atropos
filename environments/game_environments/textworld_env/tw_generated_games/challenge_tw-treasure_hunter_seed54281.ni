...
The canteen part 0 is some text that varies. The canteen part 0 is "You find yourself in a canteen. A standard one. You can barely contain your excitement.
...
The kitchen part 0 is some text that varies. The kitchen part 0 is "You have entered the most usual of all possible kitchens.
...
The recreation zone part 0 is some text that varies. The recreation zone part 0 is "You are in a recreation zone. Let's see what's in here.
...
The f_0 is in r_1.
The description of o_0 is "The glass appears well matched to everything else here".
...
Test quest0_0 with "go south / take glass"
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a life changing game of TextWorld! Your first objective is to try to head south. That done, pick up the glass from the floor of the canteen. Once that's all handled, you can stop!".
