...
The attic part 0 is some text that varies. The attic part 0 is "Guess what, you are in the place we're calling the attic. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The kitchen part 0 is some text that varies. The kitchen part 0 is "Of every kitchen you could have shown up in, you had to walk into a typical one. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
Test quest0_0 with "take cookie"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Your task for today is to pick up the cookie from the floor of the kitchen.".
