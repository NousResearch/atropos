...
The shower part 0 is some text that varies. The shower part 0 is "You are in a shower. A typical one. You begin looking for stuff.
...
The bar part 0 is some text that varies. The bar part 0 is "You are in a bar. A standard one. You can barely contain your excitement.
...
The restroom part 0 is some text that varies. The restroom part 0 is "Ah, the restroom. This is some kind of restroom, really great ordinary vibes in this place, a wonderful ordinary atmosphere. And now, well, you're in it. I guess you better just go and list everything you see here.
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Your first objective is to attempt to travel north. And then, pick up the latchkey from the floor of the bedroom. Once that's all handled, you can ".
The objective part 1 is some text that varies. The objective part 1 is "stop!".
