...
The f_0 is in r_1.
The description of f_1 is "that's an ordinary grape!".
...
Test quest0_0 with "go south / go east / take legume"
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an profound round of TextWorld? You do! Here is how to play! First stop, attempt to move south. And then, go east. If you can get around to doi".
The objective part 1 is some text that varies. The objective part 1 is "ng that, retrieve the legume from the floor of the cellar. Got that? Good!".
