...
The r_0 and the r_1 and the r_3 and the r_2 and the r_9 and the r_5 and the r_8 and the r_6 and the r_10 and the r_4 and the r_7 and the r_11 are rooms.
...
The kitchen part 6 is some text that varies. The kitchen part 6 is " Oh, great. Here's a table. The table is massive.[if there is something on the s_0] On the table you can see [a list of things on the s_0].[end if]".
...
The kitchen part 8 is some text that varies. The kitchen part 8 is " Hey, want to see a counter? Look over there, a counter. [if there is something on the s_1]On the counter you make out [a list of things on the s_1]. Huh, weird.[end if]".
...
The kitchen part 10 is some text that varies. The kitchen part 10 is " You make out a stove. The stove is conventional.[if there is something on the stove_0] On the stove you can see [a list of things on the stove_0].[end if]".
...
The livingroom part 0 is some text that varies. The livingroom part 0 is "You arrive in a livingroom. A normal kind of place. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You're now in the bathroom. Okay, just remember what you're here to do, and everything will go great.
 ...
 Oh, great. Here's a toilet. I guess it's true what they say, if you're looking for a toilet, go to TextWorld. [if there is something on the s_8]You see [a list of things on the s_8] on the toilet.[end if]".
...
The shed part 2 is some text that varies. The shed part 2 is " You can see a workbench. [if there is something on the s_6]On the workbench you make out [a list of things on the s_6].[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " What's that over there? It looks like it's a BBQ. I mean, just wow! Isn't TextWorld just the best?[if toaster_0 is open and there is something in the toaster_0] The BBQ contains [a list of things in the toaster_0]. Does this look like anything mentioned in the instructions?[end if]".
...
The street part 0 is some text that varies. The street part 0 is "You've just sauntered into a street. You can barely contain your excitement.
...
The bedroom part 1 is some text that varies. The bedroom part 1 is "[if there is nothing on the s_5]However, the bed, like an empty bed, has nothing on it. Aw, and here you were, all excited for there to be things on it![end if]".
...
The supermarket part 0 is some text that varies. The supermarket part 0 is "You are in a supermarket. A standard one. Okay, just remember what you're here to do, and everything will go great.
...
The f_4 and the f_3 and the f_0 and the f_1 and the f_2 are foods.
The f_4 and the f_3 and the f_0 and the f_1 and the f_2 are privately-named.
...
The r_0 and the r_1 and the r_3 and the r_2 and the r_9 and the r_5 and the r_8 and the r_6 and the r_10 and the r_4 and the r_7 and the r_11 are rooms.
The r_0 and the r_1 and the r_3 and the r_2 and the r_9 and the r_5 and the r_8 and the r_6 and the r_10 and the r_4 and the r_7 and the r_11 are privately-named.
