...
The garage part 0 is some text that varies. The garage part 0 is "Guess what, you are in the place we're calling the garage. You begin looking for stuff.
...
The kitchenette part 0 is some text that varies. The kitchenette part 0 is "This kitchenette you have just entered is definitely standard.
...
Test quest0_0 with "go south / go west / take broom"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First off, if it's not too much trouble, I need you to make an effort to head south. And then, move west".
The objective part 1 is some text that varies. The objective part 1 is ". After that, pick-up the broom from the floor of the restroom. That's it!".
