...
The bedchamber part 0 is some text that varies. The bedchamber part 0 is "You find yourself in a bedchamber. A typical kind of place. You start to take note of what's in the room.
...
The f_0 is in r_2.
The description of o_0 is "The hat would seem to be to fit in here".
...
Test quest0_0 with "go north / take hat"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First stop, travel north. Then, retrieve the hat from the floor of the attic. Once that's all handled, y".
