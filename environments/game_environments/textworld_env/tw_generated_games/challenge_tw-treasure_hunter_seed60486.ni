...
The garage part 0 is some text that varies. The garage part 0 is "You have walked into a garage. Not the garage you'd expect. No, this is a garage.
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Here is your task for today. First, it would be great if you could make an effort to travel north. With that ove".
The objective part 1 is some text that varies. The objective part 1 is "r with, retrieve the latchkey from the floor of the canteen. And if you do that, you're the winner!".
