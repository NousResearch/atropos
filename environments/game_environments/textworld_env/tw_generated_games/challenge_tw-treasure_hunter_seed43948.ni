...
The cellar part 0 is some text that varies. The cellar part 0 is "You are in a cellar. A normal one. Let's see what's in here.
...
The scullery part 0 is some text that varies. The scullery part 0 is "You arrive in a typical kind of place. That is to say, you're in a scullery.
...
The k_0 is in r_0.
The description of o_0 is "The nest of shrimp would seem to be to fit in here".
...
The objective part 0 is some text that varies. The objective part 0 is "Your objective is to lift the keycard from the floor of the cellar.".
