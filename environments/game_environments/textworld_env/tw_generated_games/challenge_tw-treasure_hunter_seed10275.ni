...
Test quest0_0 with "go north / take controller"
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an profound round of TextWorld? You do! First thing I need you to do is to go north. With that over with, retrieve the controller from the floo".
The objective part 1 is some text that varies. The objective part 1 is "r of the parlor. And if you do that, you're the winner!".
