...
The spare room part 0 is some text that varies. The spare room part 0 is "Okay, so you're in a spare room, cool, but is it usual? You better believe it is.



You don't like doors? Why not try going east, that entranceway is unblocked. You need an unguarded exit? You should try going north. You don't like doors? Why not try going west, that entranceway is unblocked.".
...
The description of o_0 is "The novel is antiquated.".
The printed name of o_0 is "novel".
Understand "novel" as o_0.
The o_0 is in r_1.
The description of o_1 is "The pair of headphones is cheap looking.".
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a fast paced episode of TextWorld! Your task for today is to lift the novel from the floor of the salon.".
