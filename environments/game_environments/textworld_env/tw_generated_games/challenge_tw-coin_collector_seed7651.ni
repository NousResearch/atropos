...
The bathroom part 0 is some text that varies. The bathroom part 0 is "I am excited to announce that you are now in the bathroom. The room is well lit.
...
The office part 0 is some text that varies. The office part 0 is "You find yourself in an office. An ordinary one. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The attic part 0 is some text that varies. The attic part 0 is "Okay, so you're in an attic, cool, but is it standard? You better believe it is.
...
Test quest0_0 with "go west / go north / go north / go north / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First stop, make an effort to take a trip west. Once you succeed at that, try to head north. Then, attem".
The objective part 1 is some text that varies. The objective part 1 is "pt to take a trip north. With that accomplished, go north. Then, pick-up the coin from the floor of the attic. That's it!".
