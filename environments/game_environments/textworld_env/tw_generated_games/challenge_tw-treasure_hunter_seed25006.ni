...
The basement part 0 is some text that varies. The basement part 0 is "Look at you, bigshot, walking into a basement like it isn't some huge deal. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The studio part 0 is some text that varies. The studio part 0 is "You find yourself in an ordinary kind of place. That is to say, you're in a studio. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The attic part 0 is some text that varies. The attic part 0 is "You've entered an attic. I guess you better just go and list everything you see here.
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! First of all, you could, like, take a trip south. Then, recover the shadfly from the floor of the basement. And if you do that, you're the winner!".
