...
The cubicle part 0 is some text that varies. The cubicle part 0 is "You are in a cubicle. It seems to be pretty typical here. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another fast paced episode of TextWorld! Here is how to play! First of all, you could, like, try to take a trip south. With that done, head west. Okay, and then, pick up the latchkey from t".
The objective part 1 is some text that varies. The objective part 1 is "he floor of the cubicle. And once you've done that, you win!".
