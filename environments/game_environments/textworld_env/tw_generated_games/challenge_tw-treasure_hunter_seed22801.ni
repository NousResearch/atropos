...
Test quest0_0 with "go north / go east / take shirt"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. Your first objective is to make an effort to go to the north. Okay, and then, move east. Then, recover t".
The objective part 1 is some text that varies. The objective part 1 is "he shirt from the floor of the shower. Got that? Good!".
