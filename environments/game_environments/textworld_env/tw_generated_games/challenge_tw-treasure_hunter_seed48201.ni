...
The kitchenette part 0 is some text that varies. The kitchenette part 0 is "Look at you, bigshot, walking into a kitchenette like it isn't some huge deal. Okay, just remember what you're here to do, and everything will go great.
...
The lounge part 0 is some text that varies. The lounge part 0 is "You find yourself in a lounge. An ordinary kind of place. I guess you better just go and list everything you see here.
...
The f_0 is in r_0.
The description of o_0 is "The dvd seems well matched to everything else here".
...
The objective part 0 is some text that varies. The objective part 0 is "Your objective is to lift the dvd from the floor of the lounge.".
