...
The salon part 0 is some text that varies. The salon part 0 is "You're now in a salon. You begin to take stock of what's in the room.
...
The office part 0 is some text that varies. The office part 0 is "You have stumbled into an office. Not the office you'd expect. No, this is an office. You can barely contain your excitement.
...
The closet part 0 is some text that varies. The closet part 0 is "You've moved into an ordinary room. Your mind races to think of what kind of room would be ordinary. And then it hits you. Of course. You're in the closet. You begin looking for stuff.
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "Ah, the bedroom. This is some kind of bedroom, really great typical vibes in this place, a wonderful typical atmosphere. And now, well, you're in it. Let's see what's in here.
...
The playroom part 0 is some text that varies. The playroom part 0 is "You've just shown up in a playroom. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Here is your task for today. First off, make an attempt to venture west. If you can finish that, try to take a t".
The objective part 1 is some text that varies. The objective part 1 is "rip south. And then, pick up the keycard from the floor of the salon. Alright, thanks!".
