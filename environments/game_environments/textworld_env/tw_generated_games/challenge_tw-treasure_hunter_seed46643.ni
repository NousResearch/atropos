...
The parlor part 0 is some text that varies. The parlor part 0 is "You've just shown up in a parlor. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The attic part 0 is some text that varies. The attic part 0 is "You're now in an attic. Let's see what's in here.
...
The f_0 is in r_0.
The description of o_0 is "The sock is dirty.".
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to TextWorld! Please retrieve the sock from the floor of the closet.".
