...
The kitchen part 0 is some text that varies. The kitchen part 0 is "You arrive in a kitchen. You decide to start listing off everything you see in the room, as if you were in a text adventure.
 ...
 You see a fridge. Something scurries by right in the corner of your eye. Probably nothing.[if c_0 is open and there is something in the c_0] The fridge contains [a list of things in the c_0]. I mean, just wow! Isn't TextWorld just the best?[end if]".
...
The kitchen part 7 is some text that varies. The kitchen part 7 is " Were you looking for a counter? Because look over there, it's a counter. What a great pairing of adjectives and nouns! [if there is something on the s_1]You see [a list of things on the s_1] on the counter.[end if]".
...
The pantry part 0 is some text that varies. The pantry part 0 is "You are in a pantry. A normal kind of place. Let's see what's in here.
 ...
 You see a shelf. The shelf is wooden.[if there is something on the s_2] On the shelf you can make out [a list of things on the s_2]. Wow! Just like in the movies![end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You arrive in a bedroom. A normal kind of place. You begin to take stock of what's in the room.
 ...
 You can make out a bed. Why don't you take a picture of it, it'll last longer! The bed is large.[if there is something on the s_4] On the bed you can see [a list of things on the s_4], so there's that.[end if]".
...
The livingroom part 1 is some text that varies. The livingroom part 1 is "[if there is nothing on the s_3] But there isn't a thing on it. This always happens![end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You arrive in a bathroom. A typical kind of place. You decide to just list off a complete list of everything you see in the room, because hey, why not?
 ...
 You see a toilet. [if there is something on the s_5]You see [a list of things on the s_5] on the toilet. It doesn't get more TextWorld than this![end if]".
