...
The vault part 0 is some text that varies. The vault part 0 is "You have come into a vault. Not the vault you'd expect. No, this is a vault.
...
The workshop part 0 is some text that varies. The workshop part 0 is "Look around you. Take it all in. It's not every day someone gets to be in a workshop. You can barely contain your excitement.
...
Test quest0_0 with "go west / take lampshade"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First off, if it's not too much trouble, I need you to attempt to venture west. Once you finish that, re".
The objective part 1 is some text that varies. The objective part 1 is "cover the lampshade from the floor of the vault. And if you do that, you're the winner!".
