...
The chamber part 0 is some text that varies. The chamber part 0 is "A decrepit notice tells you that you are now in the chamber.
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Here is your task for today. First stop, venture north. With that accomplished, recover the worm from the floor of the restroom. Got that? Good!".
