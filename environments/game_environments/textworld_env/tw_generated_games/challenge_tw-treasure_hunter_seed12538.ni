...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another profound game of TextWorld! Here is how to play! First step, make an attempt to head south. That done, recover the worm from the floor of the workshop. Alright, thanks!".
