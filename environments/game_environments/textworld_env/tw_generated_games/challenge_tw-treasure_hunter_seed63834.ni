...
The cubicle part 0 is some text that varies. The cubicle part 0 is "You find yourself in a cubicle. A standard kind of place. I guess you better just go and list everything you see here.
...
The shower part 0 is some text that varies. The shower part 0 is "Here we are in the shower.
...
The bedchamber part 0 is some text that varies. The bedchamber part 0 is "You've just sauntered into a bedchamber. You try to gain information on your surroundings by using a technique you call 'looking.'
...
Test quest0_0 with "go east / go north / take cookie"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another profound session of TextWorld! Here is how to play! First off, if it's not too much trouble, I need you to make an effort to move east. Then, travel north. Okay, and then, lift the ".
The objective part 1 is some text that varies. The objective part 1 is "cookie from the floor of the bedchamber. Once that's all handled, you can stop!".
