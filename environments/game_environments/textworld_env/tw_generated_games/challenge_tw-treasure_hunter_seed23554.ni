...
The study part 0 is some text that varies. The study part 0 is "I am sorry to announce that you are now in the study. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
Test quest0_0 with "go north / go north / take fondue"
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Here is how to play! First off, if it's not too much trouble, I need you to try to go north. Then, head north. And then, lift the fondue from the f".
The objective part 1 is some text that varies. The objective part 1 is "loor of the dish-pit. Once that's all handled, you can stop!".
