...
The study part 0 is some text that varies. The study part 0 is "You find yourself in a study. A typical kind of place. You start to take note of what's in the room.
...
The description of f_0 is "that's a standard garlic clove!".
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another life changing episode of TextWorld! Here is how to play! First off, if it's not too much trouble, I need you to make an effort to head north. With that accomplished, lift the passke".
The objective part 1 is some text that varies. The objective part 1 is "y from the floor of the cellar. Got that? Good!".
