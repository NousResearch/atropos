...
The kitchen part 3 is some text that varies. The kitchen part 3 is " You make out a counter. The counter is ordinary.[if there is something on the s_1] On the counter you make out [a list of things on the s_1].[end if]".
...
The kitchen part 5 is some text that varies. The kitchen part 5 is " Oh wow! Is that what I think it is? It is! It's a stove. The stove is typical.[if there is something on the s_2] On the stove you see [a list of things on the s_2].[end if]".
...
The kitchen part 7 is some text that varies. The kitchen part 7 is " You see a kitchen island. [if there is something on the s_3]You see [a list of things on the s_3] on the kitchen island.[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You've just walked into a bedroom. You begin looking for stuff.

 You can see [if c_0 is locked]a locked[else if c_0 is open]an opened[otherwise]a closed[end if]".
The bedroom part 1 is some text that varies. The bedroom part 1 is " chest drawer here.[if c_0 is open and there is something in the c_0] The chest drawer contains [a list of things in the c_0].[end if]".
...
The bedroom part 6 is some text that varies. The bedroom part 6 is " What's that over there? It looks like it's a king-size bed. The king-size bed is normal.[if there is something on the s_0] On the king-size bed you make out [a list of things on the s_0].[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You're now in the backyard.
 ...
 You can make out a set of chairs. [if there is something on the s_10]On the set of chairs you can make out [a list of things on the s_10]. It doesn't get more TextWorld than this![end if]".
The backyard part 1 is some text that varies. The backyard part 1 is "[if there is nothing on the s_10]Unfortunately, there isn't a thing on it. You move on, clearly done caring about your TextWorld experience.[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " You see a gleam over in a corner, where you can see a patio table. The patio table is typical.[if there is something on the s_9] On the patio table you can make out [a list of things on the s_9].[end if]".
The backyard part 5 is some text that varies. The backyard part 5 is "[if there is nothing on the s_9] The patio table appears to be empty. Oh! Why couldn't there just be stuff on it?[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You've entered a living room.
 ...
 You scan the room for a couch, and you find a couch. The couch is normal.[if there is something on the s_5] On the couch you see [a list of things on the s_5].[end if]".
...
The living room part 2 is some text that varies. The living room part 2 is " You see a low table. The low table is typical.[if there is something on the s_6] On the low table you can see [a list of things on the s_6].[end if]".
The living room part 3 is some text that varies. The living room part 3 is "[if there is nothing on the s_6] But there isn't a thing on it. Hopefully, this discovery doesn't ruin your TextWorld experience![end if]".
The living room part 4 is some text that varies. The living room part 4 is " You can see a tv. The tv is ordinary.[if there is something on the s_7] On the tv you make out [a list of things on the s_7].[end if]".
The living room part 5 is some text that varies. The living room part 5 is "[if there is nothing on the s_7] Looks like someone's already been here and taken everything off it, though. It would have been so cool if there was stuff on the tv.[end if]".
...
The bathroom part 1 is some text that varies. The bathroom part 1 is " toilet, which looks typical, close by.[if c_3 is open and there is something in the c_3] The toilet contains [a list of things in the c_3].[end if]".
...
The bathroom part 3 is some text that varies. The bathroom part 3 is " You scan the room for a bath, and you find a bath.[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4].[end if]".
...
The bathroom part 5 is some text that varies. The bathroom part 5 is " Oh, great. Here's a sink. [if there is something on the s_4]On the sink you can see [a list of things on the s_4]. Suddenly, you bump your head on the ceiling, but it's not such a bad bump that it's going to prevent you from looking at objects and even things.[end if]".
The bathroom part 6 is some text that varies. The bathroom part 6 is "[if there is nothing on the s_4]But the thing is empty.[end if]".
...
The c_4 is in r_3.
The c_4 is closed.
The description of f_3 is "The milk looks delectable.".
...
The s_9 is in r_4.
The description of f_0 is "The tomato plant looks savory.".
...
Test quest0_0 with "open chest drawer / take old key from chest drawer / unlock wooden door with old key / open wooden door / go east / open refrigerator / take half of a bag of chips from refrigerator / put half of a bag of chips on stove"
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Here is your task for today. First of all, assure that the chest drawer is opened. Then, pick up the old key fro".
The objective part 1 is some text that varies. The objective part 1 is "m the chest drawer in the bedroom. With the old key, insert the old key into the wooden door within the bedroom's lock to unlock it. And then, open the wooden door within the bedroom. And then, make a".
The objective part 2 is some text that varies. The objective part 2 is "n attempt to venture east. With that done, open the refrigerator. And then, take the half of a bag of chips from the refrigerator. After that, place the half of a bag of chips on the stove. Once that'".
