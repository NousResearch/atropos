...
The garage part 0 is some text that varies. The garage part 0 is "Well, here we are in the garage. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The sauna part 0 is some text that varies. The sauna part 0 is "You are in a sauna. It seems to be pretty normal here.
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Here is how to play! First of all, you could, like, attempt to go west. If you can succeed at that, retrieve the".
The objective part 1 is some text that varies. The objective part 1 is " stick of butter from the floor of the garage. Got that? Good!".
