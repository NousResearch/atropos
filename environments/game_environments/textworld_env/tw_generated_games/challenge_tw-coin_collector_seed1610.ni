...
The shower part 0 is some text that varies. The shower part 0 is "You're now in the shower. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The chamber part 0 is some text that varies. The chamber part 0 is "If you're wondering why everything seems so typical all of a sudden, it's because you've just walked into the chamber. You begin to take stock of what's in the room.
...
The description of o_0 is "The coin is modern.".
...
Test quest0_0 with "go south / go south / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Here is your task for today. First of all, you could, like, go to the south. Then, take a trip south. And then, recover the coin from the floor of ".
The objective part 1 is some text that varies. The objective part 1 is "the garage. And once you've done that, you win!".
