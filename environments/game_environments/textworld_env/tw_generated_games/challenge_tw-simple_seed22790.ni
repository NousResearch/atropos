...
The kitchen part 1 is some text that varies. The kitchen part 1 is " refrigerator, which looks normal, right there by you.[if c_2 is open and there is something in the c_2] The refrigerator contains [a list of things in the c_2]. Suddenly, you bump your head on the ceiling, but it's not such a bad bump that it's going to prevent you from looking at objects and even things.[end if]".
...
The kitchen part 3 is some text that varies. The kitchen part 3 is " You can see a counter. Make a note of this, you might have to put stuff on or in it later on. The counter is standard.[if there is something on the s_1] On the counter you see [a list of things on the s_1]. You can't wait to tell the folks at home about this![end if]".
The kitchen part 4 is some text that varies. The kitchen part 4 is "[if there is nothing on the s_1] Unfortunately, there isn't a thing on it. What, you think everything in TextWorld should have stuff on it?[end if]".
...
The bedroom part 3 is some text that varies. The bedroom part 3 is " You see an antique trunk.[if c_1 is open and there is something in the c_1] The antique trunk contains [a list of things in the c_1]. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[end if]".
...
The bedroom part 5 is some text that varies. The bedroom part 5 is " You can make out a king-size bed. Wow, isn't TextWorld just the best? [if there is something on the s_0]On the king-size bed you can make out [a list of things on the s_0].[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " You make out a bbq. The bbq is ordinary.[if there is something on the s_8] On the bbq you make out [a list of things on the s_8]. Hmmm... what else, what else?[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " What's that over there? It looks like it's a patio table. [if there is something on the s_9]On the patio table you can see [a list of things on the s_9].[end if]".
...
The living room part 2 is some text that varies. The living room part 2 is " Oh wow! Is that what I think it is? It is! It's a low table. [if there is something on the s_6]You see [a list of things on the s_6] on the low table.[end if]".
...
The living room part 4 is some text that varies. The living room part 4 is " Oh, great. Here's a tv. [if there is something on the s_7]On the tv you make out [a list of things on the s_7].[end if]".
...
The bathroom part 4 is some text that varies. The bathroom part 4 is " You scan the room, seeing a sink. You shudder, but continue examining the sink. [if there is something on the s_4]You see [a list of things on the s_4] on the sink.[end if]".
The bathroom part 5 is some text that varies. The bathroom part 5 is "[if there is nothing on the s_4]However, the sink, like an empty sink, has nothing on it. It would have been so cool if there was stuff on the sink.[end if]".
...
The f_4 is in r_5.
The f_4 is edible.
The description of f_5 is "The half of a bag of chips looks heavenly.".
...
The description of f_1 is "The bell pepper looks delectable.".
