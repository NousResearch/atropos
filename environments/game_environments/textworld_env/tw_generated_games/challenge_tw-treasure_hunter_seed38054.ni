...
The shower part 0 is some text that varies. The shower part 0 is "A crooked sign tells you that you are now in the shower. I guess you better just go and list everything you see here.
...
The parlor part 0 is some text that varies. The parlor part 0 is "You find yourself in a parlor. An usual one. I guess you better just go and list everything you see here.
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You arrive in a bathroom. An usual one. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The k_0 is in r_2.
The description of o_0 is "The pillow appears to be to fit in here".
...
Test quest0_0 with "go west / go west / take pillow"
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a profound round of TextWorld! Here is your task for today. First thing I need you to do is to go to the west. And then, make an effort to go to the west. With that over with, retr".
The objective part 1 is some text that varies. The objective part 1 is "ieve the pillow from the floor of the chamber. Alright, thanks!".
