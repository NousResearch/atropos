...
The laundry place part 0 is some text that varies. The laundry place part 0 is "Well, here we are in the laundry place. I guess you better just go and list everything you see here.
...
The bar part 0 is some text that varies. The bar part 0 is "You are in a bar. It seems to be pretty usual here.
...
The kitchenette part 0 is some text that varies. The kitchenette part 0 is "You have walked into the most normal of all possible kitchenettes.
...
The f_0 is in r_3.
The description of f_1 is "that's a typical licorice strip!".
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Here is how to play! First of all, you could, like, travel north. With that accomplished, recover the burger fro".
The objective part 1 is some text that varies. The objective part 1 is "m the floor of the laundry place. And if you do that, you're the winner!".
