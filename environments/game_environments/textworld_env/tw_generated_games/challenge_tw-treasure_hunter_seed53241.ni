...
The office part 0 is some text that varies. The office part 0 is "You find yourself in an office. A typical one. I guess you better just go and list everything you see here.
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Here is how to play! First, it would be great if you could make an attempt to travel west. Then, recover the soap dispenser from the floor of the s".
The objective part 1 is some text that varies. The objective part 1 is "auna. Got that? Good!".
