...
The office part 0 is some text that varies. The office part 0 is "Ah, the office. This is some kind of office, really great ordinary vibes in this place, a wonderful ordinary atmosphere. And now, well, you're in it. You begin to take stock of what's here.
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! First of all, you could, like, go to the south. That done, make an effort to venture east. Okay, ".
The objective part 1 is some text that varies. The objective part 1 is "and then, lift the passkey from the floor of the study. Alright, thanks!".
