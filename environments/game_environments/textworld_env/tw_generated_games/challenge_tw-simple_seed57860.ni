...
The kitchen part 1 is some text that varies. The kitchen part 1 is " refrigerator, which looks standard, here.[if c_2 is open and there is something in the c_2] The refrigerator contains [a list of things in the c_2]. The light flickers for a second, but nothing else happens.[end if]".
...
The kitchen part 6 is some text that varies. The kitchen part 6 is "[if there is nothing on the s_2]But oh no! there's nothing on this piece of garbage. Hm. Oh well[end if]".
The kitchen part 7 is some text that varies. The kitchen part 7 is " You can make out a kitchen island. The kitchen island is ordinary.[if there is something on the s_3] On the kitchen island you make out [a list of things on the s_3]. Hmmm... what else, what else?[end if]".
...
The kitchen part 11 is some text that varies. The kitchen part 11 is " wooden door leading west. There is an unguarded exit to the north. There is an unguarded exit to the south.".
...
The bedroom part 5 is some text that varies. The bedroom part 5 is " As if things weren't amazing enough already, you can even see a king-size bed. What a great pairing of adjectives and nouns! [if there is something on the s_0]On the king-size bed you make out [a list of things on the s_0]. You shudder, but continue examining the room.[end if]".
The bedroom part 6 is some text that varies. The bedroom part 6 is "[if there is nothing on the s_0]But there isn't a thing on it. Aw, and here you were, all excited for there to be things on it![end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You've stumbled into an usual room. Your mind races to think of what kind of room would be usual. And then it hits you. Of course. You're in the living room.
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You are in a bathroom. It seems to be pretty usual here.
...
The bathroom part 5 is some text that varies. The bathroom part 5 is " You see a sink. The sink is ordinary.[if there is something on the s_4] On the sink you can see [a list of things on the s_4]. There's something strange about this being here, but you can't put your finger on it.[end if]".
...
The f_4 is in r_5.
The f_4 is edible.
The description of f_5 is "The milk looks appetizing.".
