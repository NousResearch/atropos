...
The r_0 and the r_3 and the r_4 and the r_2 and the r_5 and the r_1 are rooms.
...
The kitchen part 12 is some text that varies. The kitchen part 12 is " frosted-glass door leading south. There is an exit to the north. There is an exit to the west. Don't worry, there is no door.".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You've entered a bathroom.
 ...
 You can make out a toilet. Make a note of this, you might have to put stuff on or in it later on. The toilet is white.[if there is something on the s_3] On the toilet you make out [a list of things on the s_3].[end if]".
...
The pantry part 0 is some text that varies. The pantry part 0 is "You have stumbled into a pantry. Not the pantry you'd expect. No, this is a pantry.
 ...
 You scan the room, seeing a shelf. The shelf is wooden.[if there is something on the s_2] On the shelf you make out [a list of things on the s_2]. Hmmm... what else, what else?[end if]".
...
The r_0 and the r_3 and the r_4 and the r_2 and the r_5 and the r_1 are rooms.
The r_0 and the r_3 and the r_4 and the r_2 and the r_5 and the r_1 are privately-named.
...
The printed name of f_8 is "salt".
Understand "salt" as f_8.
