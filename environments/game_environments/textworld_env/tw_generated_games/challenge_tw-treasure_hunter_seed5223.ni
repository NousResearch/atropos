...
The dish-pit part 0 is some text that varies. The dish-pit part 0 is "You find yourself in a dish-pit. A typical kind of place. You begin to take stock of what's in the room.
...
The salon part 0 is some text that varies. The salon part 0 is "If you're wondering why everything seems so usual all of a sudden, it's because you've just sauntered into the salon.
...
The cellar part 0 is some text that varies. The cellar part 0 is "You find yourself in a cellar. A standard kind of place. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
Test quest0_0 with "go west / take keycard"
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! First of all, head west. And then, pick-up the keycard from the floor of the kitchen. Once that's all handled, y".
The objective part 1 is some text that varies. The objective part 1 is "ou can stop!".
