...
The bar part 0 is some text that varies. The bar part 0 is "Look at you, bigshot, walking into a bar like it isn't some huge deal. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a fast paced game of TextWorld! Here is your task for today. First thing I need you to do is to make an attempt to move east. Then, pick up the keycard from the floor of the study.".
