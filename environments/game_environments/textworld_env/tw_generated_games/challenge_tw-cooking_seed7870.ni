...
The r_0 and the r_5 and the r_3 and the r_2 and the r_4 and the r_6 and the r_7 and the r_1 and the r_8 are rooms.
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "Of every bedroom you could have sauntered into, you had to come round an usual one. Okay, just remember what you're here to do, and everything will go great.

 You can see a bed. [if there is something on the s_3]You see [a list of things on the s_3] on the bed. Something scurries by right in the corner of your eye. Probably nothing.[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You arrive in a bathroom. An usual one. You can barely contain your excitement.

 You can see a toilet. [if there is something on the s_7]You see [a list of things on the s_7] on the toilet.[end if]".
The bathroom part 1 is some text that varies. The bathroom part 1 is "[if there is nothing on the s_7]But there isn't a thing on it. Hm. Oh well[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " You smell an awful smell, and follow it to a patio table. The patio table is stylish.[if there is something on the s_8] On the patio table you see [a list of things on the s_8].[end if]".
...
The shed part 1 is some text that varies. The shed part 1 is " toolbox, which looks metallic, here.[if c_1 is open and there is something in the c_1] The toolbox contains [a list of things in the c_1].[end if]".
...
The livingroom part 0 is some text that varies. The livingroom part 0 is "You are in a livingroom. An ordinary kind of place.
 ...
 You can make out a sofa. [if there is something on the s_6]On the sofa you can see [a list of things on the s_6]. Something scurries by right in the corner of your eye. Probably nothing.[end if]".
...
The garden part 0 is some text that varies. The garden part 0 is "A decrepit sign tells you that you are now in the garden.
...
The f_1 and the f_3 and the f_5 and the f_0 and the f_2 and the f_4 and the f_6 and the f_7 are foods.
The f_1 and the f_3 and the f_5 and the f_0 and the f_2 and the f_4 and the f_6 and the f_7 are privately-named.
...
The r_0 and the r_5 and the r_3 and the r_2 and the r_4 and the r_6 and the r_7 and the r_1 and the r_8 are rooms.
The r_0 and the r_5 and the r_3 and the r_2 and the r_4 and the r_6 and the r_7 and the r_1 and the r_8 are privately-named.
