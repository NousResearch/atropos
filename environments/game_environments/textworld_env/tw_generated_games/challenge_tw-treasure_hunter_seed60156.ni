...
The washroom part 0 is some text that varies. The washroom part 0 is "You are in a washroom. A typical kind of place. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The bar part 0 is some text that varies. The bar part 0 is "You make a grand eccentric entrance into a bar. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The f_0 is in r_1.
The description of o_0 is "The paper towel appears to fit in here".
...
Test quest0_0 with "go east / go east / take paper towel"
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an life changing round of TextWorld? You do! First thing I need you to do is to try to go east. With that done, try to go east. After that, rec".
The objective part 1 is some text that varies. The objective part 1 is "over the paper towel from the floor of the sauna. And if you do that, you're the winner!".
