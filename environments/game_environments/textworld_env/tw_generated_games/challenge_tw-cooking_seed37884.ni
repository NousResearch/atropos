...
The kitchen part 3 is some text that varies. The kitchen part 3 is " oven close by.[if oven_0 is open and there is something in the oven_0] The oven contains [a list of things in the oven_0]. Make a note of this, you might have to put stuff on or in it later on.[end if]".
...
The corridor part 0 is some text that varies. The corridor part 0 is "You have walked into the most usual of all possible corridors. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The pantry part 0 is some text that varies. The pantry part 0 is "You've just walked into a pantry. Okay, just remember what you're here to do, and everything will go great.
 ...
 You see a shelf. Wow, isn't TextWorld just the best? [if there is something on the s_2]On the shelf you see [a list of things on the s_2].[end if]".
...
The f_5 and the f_7 and the f_9 and the f_0 and the f_1 and the f_3 and the f_4 and the f_6 and the f_8 and the f_2 are foods.
The f_5 and the f_7 and the f_9 and the f_0 and the f_1 and the f_3 and the f_4 and the f_6 and the f_8 and the f_2 are privately-named.
...
The printed name of f_7 is "flour".
Understand "flour" as f_7.
