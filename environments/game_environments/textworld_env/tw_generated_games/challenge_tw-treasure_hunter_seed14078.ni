...
The k_0 is in r_4.
The description of o_0 is "The iron appears out of place here".
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Here is how to play! Your first objective is to move north. Then, make an attempt to go west. If you can succeed at that, retrieve the passkey from".
The objective part 1 is some text that varies. The objective part 1 is " the floor of the kitchenette. And once you've done that, you win!".
