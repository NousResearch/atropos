...
The chamber part 0 is some text that varies. The chamber part 0 is "This might come as a shock to you, but you've just entered a chamber.
...
The laundromat part 0 is some text that varies. The laundromat part 0 is "You arrive in an ordinary kind of place. That is to say, you're in a laundromat. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The f_0 is in r_0.
The description of o_0 is "The plant is well-used.".
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. Your first objective is to head north. Once you get around to doing that, lift the plant from the floor ".
The objective part 1 is some text that varies. The objective part 1 is "of the bedchamber. And if you do that, you're the winner!".
