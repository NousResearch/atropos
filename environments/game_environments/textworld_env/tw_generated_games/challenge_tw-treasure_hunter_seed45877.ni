...
The cookhouse part 0 is some text that varies. The cookhouse part 0 is "Okay, so you're in a cookhouse, cool, but is it typical? You better believe it is.
...
The lounge part 0 is some text that varies. The lounge part 0 is "You find yourself in a lounge. An usual one. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The spare room part 0 is some text that varies. The spare room part 0 is "You have come into the most ordinary of all possible spare rooms.
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Here is how to play! First of all, you could, like, take a trip west. Next, recover the passkey from the floor o".
The objective part 1 is some text that varies. The objective part 1 is "f the cookhouse. Got that? Good!".
