...
The bedchamber part 0 is some text that varies. The bedchamber part 0 is "You find yourself in a bedchamber. A normal kind of place. You begin to take stock of what's here.
...
The salon part 0 is some text that varies. The salon part 0 is "You find yourself in a salon. A typical one. You begin looking for stuff.
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Your task for today is to retrieve the keycard from the floor of the chamber.".
