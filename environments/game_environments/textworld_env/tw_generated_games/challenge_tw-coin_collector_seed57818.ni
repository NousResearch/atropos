...
The canteen part 0 is some text that varies. The canteen part 0 is "You arrive in a canteen. A typical kind of place. I guess you better just go and list everything you see here.
...
The launderette part 0 is some text that varies. The launderette part 0 is "You have moved into a launderette. Not the launderette you'd expect. No, this is a launderette.
...
The description of o_0 is "The coin looks well matched to everything else here".
...
Test quest0_0 with "go south / go east / go north / go east / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! First off, make an effort to travel south. Once you accomplish that, take a trip east. And then, make an attempt".
The objective part 1 is some text that varies. The objective part 1 is " to go north. With that done, attempt to go east. Then, pick-up the coin from the floor of the canteen. And once you've done that, you win!".
