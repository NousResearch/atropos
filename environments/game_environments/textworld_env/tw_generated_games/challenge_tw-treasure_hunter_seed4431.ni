...
The sauna part 0 is some text that varies. The sauna part 0 is "You arrive in an ordinary kind of place. That is to say, you're in a sauna. You can barely contain your excitement.
...
The bar part 0 is some text that varies. The bar part 0 is "Well, here we are in a bar. You begin to take stock of what's here.
...
The chamber part 0 is some text that varies. The chamber part 0 is "You find yourself in a chamber. An ordinary one. Let's see what's in here.
...
The f_0 is in r_1.
The description of o_0 is "The sponge seems to fit in here".
...
Test quest0_0 with "go east / go north / take sponge"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First thing I need you to do is to go east. After that, take a trip north. Okay, and then, retrieve the ".
The objective part 1 is some text that varies. The objective part 1 is "sponge from the floor of the sauna. Once that's all handled, you can stop!".
