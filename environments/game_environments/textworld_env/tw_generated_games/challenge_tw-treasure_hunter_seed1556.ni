...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Here is your task for today. First, it would be fantastic if you could attempt to travel west. Following that, recover the passkey from the floor o".
The objective part 1 is some text that varies. The objective part 1 is "f the study. Once that's all handled, you can stop!".
