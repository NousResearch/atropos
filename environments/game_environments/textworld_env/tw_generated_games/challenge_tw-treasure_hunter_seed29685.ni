...
The studio part 0 is some text that varies. The studio part 0 is "You find yourself in a studio. A standard one. You can barely contain your excitement.
...
The cubicle part 0 is some text that varies. The cubicle part 0 is "You are in a cubicle. A standard one. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The f_0 is in r_0.
The description of o_0 is "The Cat Calendar is dirty.".
...
Test quest0_0 with "go north / take Cat Calendar"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First off, if it's not too much trouble, I need you to make an attempt to travel north. Following that, ".
The objective part 1 is some text that varies. The objective part 1 is "lift the Cat Calendar from the floor of the cubicle. Once that's all handled, you can stop!".
