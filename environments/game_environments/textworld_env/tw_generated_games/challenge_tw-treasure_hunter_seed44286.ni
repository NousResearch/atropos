...
The office part 0 is some text that varies. The office part 0 is "You find yourself in an office. A normal kind of place. You begin to take stock of what's in the room.
...
The vault part 0 is some text that varies. The vault part 0 is "You are in a vault. It seems to be pretty standard here. I guess you better just go and list everything you see here.
...
Test quest0_0 with "go west / go south / take shadfly"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another profound game of TextWorld! Here is how to play! First step, try to go west. With that accomplished, move south. And then, pick up the shadfly from the floor of the bedroom. Got tha".
