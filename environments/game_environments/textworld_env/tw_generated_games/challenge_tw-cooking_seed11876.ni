...
The kitchen part 6 is some text that varies. The kitchen part 6 is " You can see a table. Wow, isn't TextWorld just the best? The table is massive.[if there is something on the s_0] On the table you make out [a list of things on the s_0]. There's something strange about this being here, but you can't put your finger on it.[end if]".
...
The kitchen part 11 is some text that varies. The kitchen part 11 is "[if there is nothing on the stove_0] But the thing is empty. Aw, here you were, all excited for there to be things on it![end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You find yourself in a backyard. An usual kind of place.
 ...
 You can make out a patio chair. [if there is something on the s_6]You see [a list of things on the s_6] on the patio chair.[end if]".
...
The shed part 0 is some text that varies. The shed part 0 is "Well how about that, you are in the place we're calling the shed. The room is well lit.

 What's that over there? It looks like it's a toolbox. Hmmm... what else, what else?[if c_1 is open and there is something in the c_1] The toolbox contains [a list of things in the c_1]. Wow, isn't TextWorld just the best?[end if]".
...
The shed part 3 is some text that varies. The shed part 3 is "[if there is nothing on the s_8]But there isn't a thing on it. It would have been so cool if there was stuff on the workbench.[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You find yourself in a bathroom. A standard kind of place.
 ...
 You can see a toilet. [if there is something on the s_3]On the toilet you make out [a list of things on the s_3]. Wow! Just like in the movies![end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "Well, here we are in the bedroom. Let's see what's in here.
 ...
 You can make out a bed. Why don't you take a picture of it, it'll last longer! [if there is something on the s_4]On the bed you make out [a list of things on the s_4].[end if]".
...
Test quest5_0 with "inventory / examine cookbook / take red apple from counter / take pork chop from fridge"
...
Test quest8_0 with "inventory / examine cookbook / take red apple from counter / take pork chop from fridge / prepare meal"
...
Test quest9_0 with "inventory / examine cookbook / take red apple from counter / take pork chop from fridge / prepare meal / eat meal"
