...
The bar part 0 is some text that varies. The bar part 0 is "Guess what, you are in a place we're calling a bar. The room is well lit.
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an profound round of TextWorld? You do! Here is how to play! First thing I need you to do is to attempt to take a trip west. And then, pick up ".
The objective part 1 is some text that varies. The objective part 1 is "the passkey from the floor of the cookery. Alright, thanks!".
