...
The kitchen part 0 is some text that varies. The kitchen part 0 is "If you're wondering why everything seems so typical all of a sudden, it's because you've just shown up in the kitchen.
...
The kitchen part 3 is some text that varies. The kitchen part 3 is " You can make out a counter. [if there is something on the s_1]On the counter you can see [a list of things on the s_1].[end if]".
...
The kitchen part 5 is some text that varies. The kitchen part 5 is " Were you looking for a stove? Because look over there, it's a stove. [if there is something on the s_2]On the stove you see [a list of things on the s_2].[end if]".
...
The kitchen part 7 is some text that varies. The kitchen part 7 is " If you haven't noticed it already, there seems to be something there by the wall, it's a kitchen island. [if there is something on the s_3]On the kitchen island you can make out [a list of things on the s_3]. There's something strange about this thing being here, but you don't have time to worry about that now.[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You are in a bedroom. A typical one. You start to take note of what's in the room.
 ...
 You can make out a chest drawer. You shudder, but continue examining the room.[if c_0 is open and there is something in the c_0] The chest drawer contains [a list of things in the c_0]. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[end if]".
...
The bedroom part 5 is some text that varies. The bedroom part 5 is " You make out a king-size bed. [if there is something on the s_0]You see [a list of things on the s_0] on the king-size bed.[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " You see a bbq. What a coincidence, weren't you just thinking about a bbq? [if there is something on the s_8]On the bbq you see [a list of things on the s_8].[end if]".
...
The bathroom part 6 is some text that varies. The bathroom part 6 is " You can make out a sink. The sink is usual.[if there is something on the s_4] On the sink you can see [a list of things on the s_4]. It doesn't get more TextWorld than this![end if]".
...
The f_3 is in r_5.
The f_3 is edible.
The description of f_4 is "The apple looks delectable.".
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Here is how to play! First, it would be great if you could doublecheck that the chest drawer is opened. And then, take the old key from the chest d".
The objective part 1 is some text that varies. The objective part 1 is "rawer. And then, unlock the wooden door with the old key. Then, ensure that the wooden door inside the bedroom is open. Then, make an effort to move east. Then, open the refrigerator in the kitchen. A".
The objective part 2 is some text that varies. The objective part 2 is "fter that, recover the tomato plant from the refrigerator. And then, put the tomato plant on the stove inside the kitchen. That's it!".
