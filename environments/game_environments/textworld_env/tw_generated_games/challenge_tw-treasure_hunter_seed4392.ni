...
The steam room part 0 is some text that varies. The steam room part 0 is "You are in a steam room. A typical kind of place. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The studio part 0 is some text that varies. The studio part 0 is "You have come into a studio. Not the studio you'd expect. No, this is a studio.
...
Test quest0_0 with "go south / take soap dispenser"
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a profound round of TextWorld! Here is how to play! First of all, you could, like, attempt to go south. That done, recover the soap dispenser from the floor of the steam room. And ".
