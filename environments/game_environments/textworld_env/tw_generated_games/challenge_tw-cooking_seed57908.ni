...
The r_0 and the r_6 and the r_2 and the r_3 and the r_4 and the r_1 and the r_5 and the r_7 and the r_8 are rooms.
...
The kitchen part 8 is some text that varies. The kitchen part 8 is " You can see a stove. What a coincidence, weren't you just thinking about a stove? [if there is something on the stove_0]You see [a list of things on the stove_0] on the stove.[end if]".
...
The kitchen part 12 is some text that varies. The kitchen part 12 is " screen door leading west. You need an exit without a door? You should try going south.".
...
The backyard part 3 is some text that varies. The backyard part 3 is "[if there is nothing on the s_7]Looks like someone's already been here and taken everything off it, though. Sometimes, just sometimes, TextWorld can just be the worst.[end if]".
...
The backyard part 9 is some text that varies. The backyard part 9 is " wooden door leading south. You don't like doors? Why not try going north, that entranceway is not blocked by one.".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "Well, here we are in the bathroom. You can barely contain your excitement.
...
The livingroom part 0 is some text that varies. The livingroom part 0 is "You find yourself in a livingroom. A typical kind of place.
 ...
 You can see a sofa. Wow, isn't TextWorld just the best? The sofa is comfy.[if there is something on the s_3] On the sofa you can see [a list of things on the s_3]. Hmmm... what else, what else?[end if]".
...
The shed part 3 is some text that varies. The shed part 3 is "[if there is nothing on the s_6]But oh no! there's nothing on this piece of garbage. Hm. Oh well[end if]".
...
The garden part 0 is some text that varies. The garden part 0 is "You're now in a garden. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The r_0 and the r_6 and the r_2 and the r_3 and the r_4 and the r_1 and the r_5 and the r_7 and the r_8 are rooms.
The r_0 and the r_6 and the r_2 and the r_3 and the r_4 and the r_1 and the r_5 and the r_7 and the r_8 are privately-named.
