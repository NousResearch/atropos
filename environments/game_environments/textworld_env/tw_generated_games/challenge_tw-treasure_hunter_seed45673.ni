...
The sauna part 0 is some text that varies. The sauna part 0 is "You're now in the sauna. You begin to take stock of what's here.
...
The shower part 0 is some text that varies. The shower part 0 is "Ah, the shower. This is some kind of shower, really great typical vibes in this place, a wonderful typical atmosphere. And now, well, you're in it.
...
The playroom part 0 is some text that varies. The playroom part 0 is "You're now in a playroom. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a profound game of TextWorld! Here is your task for today. First of all, you could, like, attempt to travel west. And then, pick-up the keycard from the floor of the shower. Got th".
