...
The description of o_0 is "The glove would seem to be well matched to everything else here".
The printed name of o_0 is "glove".
Understand "glove" as o_0.
The o_0 is in r_4.
The description of o_1 is "The nest of bugs appears to fit in here".
...
Test quest0_0 with "go east / take glove"
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a life changing round of TextWorld! Here is your task for today. First off, make an effort to move east. With that over with, lift the glove from the floor of the vault. Once that'".
The objective part 1 is some text that varies. The objective part 1 is "s all handled, you can stop!".
