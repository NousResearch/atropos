...
The parlor part 0 is some text that varies. The parlor part 0 is "You find yourself in an usual kind of place. That is to say, you're in a parlor.
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! Here is how to play! First off, try to venture north. Once you manage that, try to go to the west".
The objective part 1 is some text that varies. The objective part 1 is ". Then, retrieve the passkey from the floor of the bar. And once you've done that, you win!".
