...
The r_0 and the r_6 and the r_11 and the r_10 and the r_4 and the r_3 and the r_5 and the r_7 and the r_9 and the r_1 and the r_2 and the r_8 are rooms.
...
The kitchen part 4 is some text that varies. The kitchen part 4 is " You see a table. [if there is something on the s_0]On the table you can make out [a list of things on the s_0]. I mean, just wow! Isn't TextWorld just the best?[end if]".
The kitchen part 5 is some text that varies. The kitchen part 5 is "[if there is nothing on the s_0]But there isn't a thing on it. It would have been so cool if there was stuff on the table! oh well.[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You've come into a typical room. Your mind races to think of what kind of room would be typical. And then it hits you. Of course. You're in the backyard. You start to take note of what's in the room.

 What's that over there? It looks like it's a patio chair. The patio chair is stylish.[if there is something on the s_5] On the patio chair you can make out [a list of things on the s_5]. Now that's what I call TextWorld![end if]".
...
The street part 0 is some text that varies. The street part 0 is "You have stumbled into the most typical of all possible streets.
...
The pantry part 0 is some text that varies. The pantry part 0 is "Of every pantry you could have walked into, you had to saunter into an usual one.
...
The pantry part 1 is some text that varies. The pantry part 1 is "[if there is nothing on the s_2] Looks like someone's already been here and taken everything off it, though. You move on, clearly depressed by TextWorld.[end if]".
...
The livingroom part 0 is some text that varies. The livingroom part 0 is "You find yourself in a livingroom. An usual kind of place.
 ...
 You bend down to tie your shoe. When you stand up, you notice a sofa. [if there is something on the s_4]On the sofa you see [a list of things on the s_4].[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "This is going to sound unbelievable, but you've just entered a bedroom.
 ...
 You see a bed. The bed is large.[if there is something on the s_9] On the bed you see [a list of things on the s_9].[end if]".
...
The shed part 3 is some text that varies. The shed part 3 is " You can make out a workbench. I guess it's true what they say, if you're looking for a workbench, go to TextWorld. The workbench is wooden.[if there is something on the s_6] On the workbench you can see [a list of things on the s_6].[end if]".
The shed part 4 is some text that varies. The shed part 4 is "[if there is nothing on the s_6] But the thing is empty. Oh! Why couldn't there just be stuff on it?[end if]".
...
The r_0 and the r_6 and the r_11 and the r_10 and the r_4 and the r_3 and the r_5 and the r_7 and the r_9 and the r_1 and the r_2 and the r_8 are rooms.
The r_0 and the r_6 and the r_11 and the r_10 and the r_4 and the r_3 and the r_5 and the r_7 and the r_9 and the r_1 and the r_2 and the r_8 are privately-named.
...
This is the simpler notify score changes rule:
	...
	if quest1 completed is true and quest4 completed is true and quest7 completed is true and quest8 completed is true and quest10 completed is true and quest11 completed is true:
