...
The cellar part 0 is some text that varies. The cellar part 0 is "You arrive in a cellar. An usual one. You begin looking for stuff.
...
Test quest0_0 with "go east / go south / take shadfly"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First off, if it's not too much trouble, I need you to go east. With that accomplished, go to the south.".
The objective part 1 is some text that varies. The objective part 1 is " Following that, retrieve the shadfly from the floor of the canteen. And if you do that, you're the winner!".
