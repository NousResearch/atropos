...
The cookery part 0 is some text that varies. The cookery part 0 is "You find yourself in a cookery. A standard kind of place. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another life changing game of TextWorld! Here is your task for today. First step, make an effort to go east. And then, recover the fondue from the floor of the cellar. Once that's all handl".
The objective part 1 is some text that varies. The objective part 1 is "ed, you can stop!".
