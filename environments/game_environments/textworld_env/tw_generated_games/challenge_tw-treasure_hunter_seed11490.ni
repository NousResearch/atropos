...
Test quest0_0 with "go south / go south / take licorice strip"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another profound game of TextWorld! Your first objective is to venture south. And then, move south. Next, lift the licorice strip from the floor of the bar. And once you've done that, you w".
