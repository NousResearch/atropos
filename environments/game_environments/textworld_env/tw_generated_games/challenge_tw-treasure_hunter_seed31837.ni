...
The steam room part 0 is some text that varies. The steam room part 0 is "You find yourself in a steam room. A standard kind of place. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The cookery part 0 is some text that varies. The cookery part 0 is "You've entered a cookery. You begin looking for stuff.
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! Here is how to play! First of all, you could, like, attempt to head north. Once you get around to".
The objective part 1 is some text that varies. The objective part 1 is " doing that, pick up the Cat Calendar from the floor of the study. And if you do that, you're the winner!".
