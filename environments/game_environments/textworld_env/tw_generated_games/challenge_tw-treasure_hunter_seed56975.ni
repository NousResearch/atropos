...
The cubicle part 0 is some text that varies. The cubicle part 0 is "You arrive in a cubicle. I guess you better just go and list everything you see here.
...
The k_0 is in r_2.
The description of o_0 is "The Advent Calendar is antiquated.".
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Here is your task for today. First thing I need you to do is to go north. Then, head east. Following that, lift the latchkey from the floor of the ".
The objective part 1 is some text that varies. The objective part 1 is "study. Once that's all handled, you can stop!".
