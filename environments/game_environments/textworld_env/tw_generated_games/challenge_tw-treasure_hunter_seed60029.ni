...
The washroom part 0 is some text that varies. The washroom part 0 is "You arrive in a washroom. A typical kind of place. You can barely contain your excitement.
...
The cookhouse part 0 is some text that varies. The cookhouse part 0 is "If you're wondering why everything seems so usual all of a sudden, it's because you've just walked into the cookhouse. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The playroom part 0 is some text that varies. The playroom part 0 is "Well, here we are in the playroom. The room is well lit.
...
The f_0 is in r_2.
The description of o_0 is "The glove is clean.".
...
Test quest0_0 with "go north / go west / take durian"
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a exciting game of TextWorld! Here is how to play! First stop, take a trip north. Okay, and then, go west. Next, retrieve the durian from the floor of the washroom. That's it!".
