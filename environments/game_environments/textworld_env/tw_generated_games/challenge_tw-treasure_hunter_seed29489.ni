...
Test quest0_0 with "go east / take gummy bear"
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a life changing episode of TextWorld! Here is how to play! First stop, take a trip east. Following that, recover the gummy bear from the floor of the playroom. And if you do that, ".
