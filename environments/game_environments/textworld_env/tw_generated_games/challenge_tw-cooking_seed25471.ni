...
The r_0 and the r_5 and the r_1 and the r_6 and the r_8 and the r_9 and the r_10 and the r_2 and the r_3 and the r_4 and the r_7 and the r_11 are rooms.
...
The kitchen part 10 is some text that varies. The kitchen part 10 is " You hear a noise behind you and spin around, but you can't see anything other than a stove. You wonder idly who left that here. [if there is something on the stove_0]On the stove you can see [a list of things on the stove_0].[end if]".
The kitchen part 11 is some text that varies. The kitchen part 11 is "[if there is nothing on the stove_0]However, the stove, like an empty stove, has nothing on it. You think about smashing the stove to bits, throwing the bits in a fire, etc, until you get bored and decide to move on.[end if]".
...
The pantry part 0 is some text that varies. The pantry part 0 is "You arrive in a pantry. A standard kind of place.
 ...
 You scan the room, seeing a shelf. [if there is something on the s_2]On the shelf you see [a list of things on the s_2].[end if]".
...
The livingroom part 0 is some text that varies. The livingroom part 0 is "Of every livingroom you could have shown up in, you had to come round an ordinary one.
 ...
 You make out a sofa. [if there is something on the s_6]You see [a list of things on the s_6] on the sofa. You shudder, but continue examining the room.[end if]".
...
The livingroom part 3 is some text that varies. The livingroom part 3 is " fiberglass door leading east. There is an exit to the south. Don't worry, there is no door. There is an exit to the west.".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You've just sauntered into a backyard. You decide to just list off a complete list of everything you see in the room, because hey, why not?

 You make out a patio table. [if there is something on the s_7]You see [a list of things on the s_7] on the patio table, so there's that.[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " Oh, great. Here's a patio chair. [if there is something on the s_8]On the patio chair you can see [a list of things on the s_8].[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " Look over there! a BBQ. You check the price tag that the BBQ's owner still hasn't taken off. 50 bucks? What a deal! You'll have to ask where they got this![if toaster_0 is open and there is something in the toaster_0] The BBQ contains [a list of things in the toaster_0]. Suddenly, you bump your head on the ceiling, but it's not such a bad bump that it's going to prevent you from looking at objects and even things.[end if]".
...
The shed part 2 is some text that varies. The shed part 2 is " You can see a workbench. [if there is something on the s_4]You see [a list of things on the s_4] on the workbench. There's something strange about this being here, but you can't put your finger on it.[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "Ah, the bedroom. This is some kind of bedroom, really great usual vibes in this place, a wonderful usual atmosphere. And now, well, you're in it. You begin looking for stuff.

 Hey, want to see a bed? Look over there, a bed. [if there is something on the s_5]On the bed you see [a list of things on the s_5]. Wow! Just like in the movies![end if]".
The bedroom part 1 is some text that varies. The bedroom part 1 is "[if there is nothing on the s_5]But oh no! there's nothing on this piece of junk. What's the point of an empty bed?[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "Well, here we are in a bathroom.
 ...
 You lean against the wall, inadvertently pressing a secret button. The wall opens up to reveal a toilet. [if there is something on the s_9]On the toilet you can see [a list of things on the s_9].[end if]".
The bathroom part 1 is some text that varies. The bathroom part 1 is "[if there is nothing on the s_9]But oh no! there's nothing on this piece of trash. Hopefully this doesn't make you too upset.[end if]".
...
The f_0 and the f_1 and the f_4 and the f_3 and the f_2 are foods.
The f_0 and the f_1 and the f_4 and the f_3 and the f_2 are privately-named.
...
The r_0 and the r_5 and the r_1 and the r_6 and the r_8 and the r_9 and the r_10 and the r_2 and the r_3 and the r_4 and the r_7 and the r_11 are rooms.
The r_0 and the r_5 and the r_1 and the r_6 and the r_8 and the r_9 and the r_10 and the r_2 and the r_3 and the r_4 and the r_7 and the r_11 are privately-named.
...
The printed name of f_2 is "salt".
Understand "salt" as f_2.
The f_2 is edible.
