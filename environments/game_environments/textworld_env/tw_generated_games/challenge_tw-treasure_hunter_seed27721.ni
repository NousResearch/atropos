...
The studio part 0 is some text that varies. The studio part 0 is "You find yourself in a studio. A standard one. The room is well lit.
...
Test quest0_0 with "go west / go west / take keycard"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First thing I need you to do is to take a trip west. And then, attempt to move west. Then, lift the keyc".
The objective part 1 is some text that varies. The objective part 1 is "ard from the floor of the studio. That's it!".
