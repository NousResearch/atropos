...
The cubicle part 0 is some text that varies. The cubicle part 0 is "You find yourself in a cubicle. An usual kind of place. The room is well lit.
...
The washroom part 0 is some text that varies. The washroom part 0 is "You're now in a washroom. I guess you better just go and list everything you see here.
...
The description of f_0 is "that's a typical cabbage!".
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First, it would be a great idea if you could try to take a trip east. And then, pick up the latchkey fro".
The objective part 1 is some text that varies. The objective part 1 is "m the floor of the cubicle. Once that's all handled, you can stop!".
