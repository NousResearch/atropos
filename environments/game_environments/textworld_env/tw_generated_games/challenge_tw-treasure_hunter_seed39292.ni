...
There is an unguarded exit to the east. There is an exit to the south. Don't worry, it is unguarded. You don't like doors? Why not try going west, that entranceway is unblocked.".
...
The shower part 0 is some text that varies. The shower part 0 is "I am sorry to announce that you are now in the shower. You begin to take stock of what's in the room.
...
Test quest0_0 with "go south / take mop"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is your task for today. First step, go to the south. Then, pick-up the mop from the floor of the sauna. And if you do that, you're the winner!".
