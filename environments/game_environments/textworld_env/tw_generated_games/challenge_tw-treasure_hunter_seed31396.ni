...
The parlor part 0 is some text that varies. The parlor part 0 is "If you're wondering why everything seems so normal all of a sudden, it's because you've just shown up in the parlor. You begin to take stock of what's in the room.
...
The k_0 is in r_0.
The description of o_0 is "The poem is cheap looking.".
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to TextWorld! Please lift the passkey from the floor of the shower.".
