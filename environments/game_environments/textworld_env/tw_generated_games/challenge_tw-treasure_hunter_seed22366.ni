...
The cookhouse part 0 is some text that varies. The cookhouse part 0 is "Okay, so you're in a cookhouse, cool, but is it usual? You better believe it is.
...
The k_0 is in r_3.
The description of o_0 is "The sock is cheap looking.".
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Your task for today is to lift the sock from the floor of the sauna.".
