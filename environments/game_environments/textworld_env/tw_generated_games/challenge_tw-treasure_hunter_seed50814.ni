...
The vault part 0 is some text that varies. The vault part 0 is "I am excited to announce that you are now in the vault.
...
The attic part 0 is some text that varies. The attic part 0 is "You find yourself in an attic. An usual kind of place. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The objective part 0 is some text that varies. The objective part 0 is "Your objective is to lift the keycard from the floor of the attic.".
