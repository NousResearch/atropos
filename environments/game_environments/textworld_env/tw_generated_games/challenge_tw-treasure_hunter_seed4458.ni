...
The closet part 0 is some text that varies. The closet part 0 is "You're now in a closet. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The studio part 0 is some text that varies. The studio part 0 is "You've just shown up in a studio. I guess you better just go and list everything you see here.
...
The spare room part 0 is some text that varies. The spare room part 0 is "If you're wondering why everything seems so ordinary all of a sudden, it's because you've just walked into the spare room. You begin looking for stuff.
...
The laundry place part 0 is some text that varies. The laundry place part 0 is "You arrive in a laundry place. A typical one.
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an profound round of TextWorld? You do! Here is your task for today. First thing I need you to do is to go south. And then, pick-up the fondue ".
The objective part 1 is some text that varies. The objective part 1 is "from the floor of the spare room. And once you've done that, you win!".
