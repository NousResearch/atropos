...
The studio part 0 is some text that varies. The studio part 0 is "You're now in the studio. You begin looking for stuff.
...
The salon part 0 is some text that varies. The salon part 0 is "You arrive in a salon. A typical one. I guess you better just go and list everything you see here.
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Here is how to play! Your first objective is to attempt to venture east. After that, pick up the latchkey from t".
The objective part 1 is some text that varies. The objective part 1 is "he floor of the studio. And if you do that, you're the winner!".
