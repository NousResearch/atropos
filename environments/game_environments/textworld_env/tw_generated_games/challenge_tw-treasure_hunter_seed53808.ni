...
You need an unguarded exit? You should try going east. There is an exit to the south. Don't worry, it is unblocked. There is an unguarded exit to the west.".
...
The closet part 0 is some text that varies. The closet part 0 is "You find yourself in a closet. A standard kind of place. You can barely contain your excitement.
...
The steam room part 0 is some text that varies. The steam room part 0 is "You're now in a steam room. The room is well lit.
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to TextWorld! Please lift the peanut from the floor of the scullery.".
