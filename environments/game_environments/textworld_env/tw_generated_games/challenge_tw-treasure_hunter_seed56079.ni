...
The chamber part 0 is some text that varies. The chamber part 0 is "Look at that placard! What does it say? It says Welcome to the chamber? Well that's cool.
...
The cubicle part 0 is some text that varies. The cubicle part 0 is "You are in a cubicle. An usual kind of place. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The o_0 is in r_1.
The description of o_1 is "The tv is antiquated.".
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is your task for today. First off, attempt to travel east. Next, pick-up the laptop from the floor of the chamber. And if you do that, you're the winner!".
