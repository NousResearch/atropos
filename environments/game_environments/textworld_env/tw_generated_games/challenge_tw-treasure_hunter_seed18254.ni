...
The playroom part 0 is some text that varies. The playroom part 0 is "You are in a playroom. A standard one. Okay, just remember what you're here to do, and everything will go great.
...
The k_0 is in r_0.
The description of o_0 is "The iron looks well matched to everything else here".
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an life changing round of TextWorld? You do! Lift the iron from the floor of the sauna.".
