...
The washroom part 0 is some text that varies. The washroom part 0 is "You arrive in a washroom. A standard kind of place. You can barely contain your excitement.
...
The workshop part 0 is some text that varies. The workshop part 0 is "You find yourself in a workshop. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The sauna part 0 is some text that varies. The sauna part 0 is "Okay, so you're in a sauna, cool, but is it standard? You better believe it is.
...
The k_0 is in r_0.
The description of o_0 is "The laptop seems out of place here".
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! First thing I need you to do is to go to the north. After that, move west. After that, lift the passkey from the floor of the bar. And if you do th".
The objective part 1 is some text that varies. The objective part 1 is "at, you're the winner!".
