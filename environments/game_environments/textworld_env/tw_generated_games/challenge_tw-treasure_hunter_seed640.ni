...
The garage part 0 is some text that varies. The garage part 0 is "You find yourself in a garage. A typical one. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
You need an unblocked exit? You should try going east. You don't like doors? Why not try going north, that entranceway is unblocked. You don't like doors? Why not try going south, that entranceway is unguarded.".
...
The k_0 is in r_1.
The description of o_0 is "The bug looks to fit in here".
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another life changing session of TextWorld! Here is your task for today. First of all, you could, like, take a trip north. With that done, take a trip east. And then, pick-up the bug from t".
The objective part 1 is some text that varies. The objective part 1 is "he floor of the steam room. Once that's all handled, you can stop!".
