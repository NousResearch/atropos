...
The cookery part 0 is some text that varies. The cookery part 0 is "You have entered the most ordinary of all possible cookerys.
...
The bar part 0 is some text that varies. The bar part 0 is "I am sorry to announce that you are now in the bar. You try to gain information on your surroundings by using a technique you call 'looking.'
...
Test quest0_0 with "go east / go south / take key"
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Here is your task for today. First, it would be good if you could make an effort to move east. With that accomplished, make an attempt to travel so".
The objective part 1 is some text that varies. The objective part 1 is "uth. With that done, pick-up the key from the floor of the basement. And if you do that, you're the winner!".
