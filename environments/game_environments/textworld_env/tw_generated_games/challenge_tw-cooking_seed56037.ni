...
The kitchen part 6 is some text that varies. The kitchen part 6 is " As if things weren't amazing enough already, you can even see a counter. Wow, isn't TextWorld just the best? [if there is something on the s_1]You see [a list of things on the s_1] on the counter.[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You arrive in a normal kind of place. That is to say, you're in a bedroom.
...
The corridor part 0 is some text that varies. The corridor part 0 is "Ah, the corridor. This is some kind of corridor, really great standard vibes in this place, a wonderful standard atmosphere.
...
The pantry part 0 is some text that varies. The pantry part 0 is "Look at that sign! What does it say? It says Welcome to the pantry? Well that's cool.
 ...
 Oh wow! Is that what I think it is? It is! It's a shelf. [if there is something on the s_2]On the shelf you make out [a list of things on the s_2]. I mean, just wow! Isn't TextWorld just the best?[end if]".
...
The f_2 and the f_4 and the f_5 and the f_3 and the f_0 and the f_1 are foods.
The f_2 and the f_4 and the f_5 and the f_3 and the f_0 and the f_1 are privately-named.
