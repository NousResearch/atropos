...
The vault part 0 is some text that varies. The vault part 0 is "You have moved into the most typical of all possible vaults. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The chamber part 0 is some text that varies. The chamber part 0 is "You are in a chamber. You can barely contain your excitement.
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! First stop, head north. Then, make an attempt to go to the east. Okay, and then, retrieve the gummy bear from th".
The objective part 1 is some text that varies. The objective part 1 is "e floor of the cookery. That's it!".
