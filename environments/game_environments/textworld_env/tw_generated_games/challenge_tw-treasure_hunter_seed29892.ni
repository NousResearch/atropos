...
The laundromat part 0 is some text that varies. The laundromat part 0 is "You arrive in a laundromat. A standard kind of place. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
Test quest0_0 with "go south / go east / take burger"
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Here is your task for today. First step, move south. That done, try to go east. With that over with, retrieve th".
The objective part 1 is some text that varies. The objective part 1 is "e burger from the floor of the canteen. And once you've done that, you win!".
