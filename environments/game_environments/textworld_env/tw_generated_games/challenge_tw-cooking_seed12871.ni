...
The r_0 and the r_1 and the r_2 and the r_5 and the r_4 and the r_3 and the r_6 and the r_7 and the r_8 are rooms.
...
The kitchen part 4 is some text that varies. The kitchen part 4 is " You scan the room, seeing a table. The table is massive.[if there is something on the s_0] On the table you see [a list of things on the s_0].[end if]".
...
The kitchen part 8 is some text that varies. The kitchen part 8 is " You make out a stove. Wow, isn't TextWorld just the best? The stove is conventional.[if there is something on the stove_0] On the stove you make out [a list of things on the stove_0].[end if]".
The kitchen part 9 is some text that varies. The kitchen part 9 is "[if there is nothing on the stove_0] But there isn't a thing on it. It would have been so cool if there was stuff on the stove.[end if]".
...
The pantry part 0 is some text that varies. The pantry part 0 is "Look at you, bigshot, walking into a pantry like it isn't some huge deal. I guess you better just go and list everything you see here.
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "Guess what, you are in the place we're calling the bathroom. I guess you better just go and list everything you see here.
...
The livingroom part 0 is some text that varies. The livingroom part 0 is "You arrive in a livingroom. A standard one.
 ...
 You smell an intriguing smell, and follow it to a sofa. I guess it's true what they say, if you're looking for a sofa, go to TextWorld. The sofa is comfy.[if there is something on the s_8] On the sofa you can see [a list of things on the s_8]. Wow! Just like in the movies![end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You're now in the bedroom. You begin to take stock of what's here.
 ...
 Were you looking for a bed? Because look over there, it's a bed. The bed is large.[if there is something on the s_6] On the bed you make out [a list of things on the s_6].[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You find yourself in a backyard. An ordinary one.
 ...
 You see a patio chair. The patio chair is stylish.[if there is something on the s_3] On the patio chair you can make out [a list of things on the s_3]. Classic TextWorld.[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " What's that over there? It looks like it's a patio table. [if there is something on the s_5]You see [a list of things on the s_5] on the patio table.[end if]".
The backyard part 3 is some text that varies. The backyard part 3 is "[if there is nothing on the s_5]However, the patio table, like an empty patio table, has nothing on it. It would have been so cool if there was stuff on the patio table.[end if]".
The backyard part 4 is some text that varies. The backyard part 4 is " You make out a BBQ. Something scurries by right in the corner of your eye. Probably nothing.[if toaster_0 is open and there is something in the toaster_0] The BBQ contains [a list of things in the toaster_0]. Something scurries by right in the corner of your eye. Probably nothing.[end if]".
...
The shed part 2 is some text that varies. The shed part 2 is " You can see a workbench. [if there is something on the s_7]On the workbench you can see [a list of things on the s_7]. Something scurries by right in the corner of your eye. Probably nothing.[end if]".
...
The f_2 and the f_5 and the f_6 and the f_8 and the f_9 and the f_1 and the f_10 and the f_7 and the f_11 and the f_3 and the f_4 and the f_0 are foods.
The f_2 and the f_5 and the f_6 and the f_8 and the f_9 and the f_1 and the f_10 and the f_7 and the f_11 and the f_3 and the f_4 and the f_0 are privately-named.
...
The r_0 and the r_1 and the r_2 and the r_5 and the r_4 and the r_3 and the r_6 and the r_7 and the r_8 are rooms.
The r_0 and the r_1 and the r_2 and the r_5 and the r_4 and the r_3 and the r_6 and the r_7 and the r_8 are privately-named.
...
The printed name of f_9 is "cilantro".
Understand "cilantro" as f_9.
The f_9 is in r_8.
The f_9 is cuttable.
The f_9 is edible.
The f_9 is uncut.
...
The printed name of f_7 is "black pepper".
Understand "black pepper" as f_7.
Understand "black" as f_7.
Understand "pepper" as f_7.
The base of ingredient_1 is f_7.
The f_7 is cooked.
The f_7 is edible.
The f_7 is on the s_2.
...
The printed name of f_0 is "parsley".
Understand "parsley" as f_0.
The f_0 is cuttable.
The f_0 is edible.
