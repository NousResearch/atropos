...
The kitchenette part 0 is some text that varies. The kitchenette part 0 is "You have stumbled into a kitchenette. Not the kitchenette you'd expect. No, this is a kitchenette. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The steam room part 0 is some text that varies. The steam room part 0 is "Look at that placard! What does it say? It says Welcome to the steam room? Well that's cool. I guess you better just go and list everything you see here.
...
The k_0 is in r_1.
The description of o_0 is "The blender looks out of place here".
...
Test quest0_0 with "go west / take blender"
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a fast paced game of TextWorld! Here is your task for today. First of all, you could, like, make an effort to head west. And then, lift the blender from the floor of the scullery. ".
