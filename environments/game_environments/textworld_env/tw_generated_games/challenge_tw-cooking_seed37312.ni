...
The kitchen part 3 is some text that varies. The kitchen part 3 is " As if things weren't amazing enough already, you can even see an oven.[if oven_0 is open and there is something in the oven_0] The oven contains [a list of things in the oven_0], so there's that.[end if]".
...
The kitchen part 5 is some text that varies. The kitchen part 5 is " You scan the room, seeing a table. The table is massive.[if there is something on the s_0] On the table you make out [a list of things on the s_0].[end if]".
The kitchen part 6 is some text that varies. The kitchen part 6 is "[if there is nothing on the s_0] However, the table, like an empty table, has nothing on it. You move on, clearly furious with your TextWorld experience.[end if]".
...
The f_6 and the f_7 and the f_8 and the f_0 and the f_2 and the f_3 and the f_4 and the f_5 and the f_1 are foods.
The f_6 and the f_7 and the f_8 and the f_0 and the f_2 and the f_3 and the f_4 and the f_5 and the f_1 are privately-named.
