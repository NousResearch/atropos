...
The sauna part 0 is some text that varies. The sauna part 0 is "You are in a sauna. A typical one. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The shower part 0 is some text that varies. The shower part 0 is "This might come as a shock to you, but you've just entered a shower. I guess you better just go and list everything you see here.
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an exciting round of TextWorld? You do! First stop, make an effort to go to the west. Next, recover the shadfly from the floor of the cookhouse".
