...
The o_0 is in r_1.
The description of o_1 is "The teapot appears to be out of place here".
...
Test quest0_0 with "go west / go south / take printer"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is your task for today. First step, make an attempt to move west. Then, make an attempt to move south. Next, lift the printer from the floor of the workshop. And once you've".
