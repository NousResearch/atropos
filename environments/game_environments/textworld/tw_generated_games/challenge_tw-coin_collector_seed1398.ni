...
The cookhouse part 0 is some text that varies. The cookhouse part 0 is "You find yourself in a cookhouse. An usual one. You begin looking for stuff.
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an profound round of TextWorld? You do! First, it would be fantastic if you could try to venture south. Following that, lift the coin from the ".
The objective part 1 is some text that varies. The objective part 1 is "floor of the cookhouse. Alright, thanks!".
