...
The kitchen part 3 is some text that varies. The kitchen part 3 is " Look over there! a counter. The counter is usual.[if there is something on the s_1] On the counter you see [a list of things on the s_1].[end if]".
...
The kitchen part 5 is some text that varies. The kitchen part 5 is " You rest your hand against a wall, but you miss the wall and fall onto a stove. The stove is normal.[if there is something on the s_2] On the stove you can make out [a list of things on the s_2].[end if]".
...
The kitchen part 7 is some text that varies. The kitchen part 7 is " You hear a noise behind you and spin around, but you can't see anything other than a kitchen island. The kitchen island is standard.[if there is something on the s_3] On the kitchen island you can make out [a list of things on the s_3].[end if]".
The kitchen part 8 is some text that varies. The kitchen part 8 is "[if there is nothing on the s_3] But the thing is empty, unfortunately. Oh! Why couldn't there just be stuff on it?[end if]".
...
The kitchen part 11 is some text that varies. The kitchen part 11 is " wooden door leading west. There is an unguarded exit to the north. There is an exit to the south. Don't worry, it is unguarded.".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You are in a bedroom. A standard one.
 ...
 You can make out a chest drawer. Now why would someone leave that there?[if c_0 is open and there is something in the c_0] The chest drawer contains [a list of things in the c_0].[end if]".
...
The bedroom part 2 is some text that varies. The bedroom part 2 is " You can make out an antique trunk.[if c_1 is open and there is something in the c_1] The antique trunk contains [a list of things in the c_1]. Hmmm... what else, what else?[end if]".
...
The bedroom part 4 is some text that varies. The bedroom part 4 is " Look over there! a king-size bed. Why don't you take a picture of it, it'll last longer! [if there is something on the s_0]On the king-size bed you see [a list of things on the s_0].[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "Well, here we are in the backyard.
 ...
 You can see a set of chairs. [if there is something on the s_10]On the set of chairs you see [a list of things on the s_10].[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " You see a gleam over in a corner, where you can see a bbq. [if there is something on the s_8]On the bbq you see [a list of things on the s_8]. Now that's what I call TextWorld![end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " You can see a patio table. Now why would someone leave that there? The patio table is standard.[if there is something on the s_9] On the patio table you can see [a list of things on the s_9].[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You arrive in a living room. An ordinary kind of place.
 ...
 You scan the room for a couch, and you find a couch. The couch is usual.[if there is something on the s_5] On the couch you can see [a list of things on the s_5]. Suddenly, you bump your head on the ceiling, but it's not such a bad bump that it's going to prevent you from looking at objects and even things.[end if]".
The living room part 1 is some text that varies. The living room part 1 is "[if there is nothing on the s_5] But the thing is empty, unfortunately. You move on, clearly depressed by TextWorld.[end if]".
The living room part 2 is some text that varies. The living room part 2 is " You hear a noise behind you and spin around, but you can't see anything other than a low table. The low table is standard.[if there is something on the s_6] On the low table you see [a list of things on the s_6].[end if]".
The living room part 3 is some text that varies. The living room part 3 is "[if there is nothing on the s_6] Looks like someone's already been here and taken everything off it, though. What's the point of an empty low table?[end if]".
...
The bathroom part 4 is some text that varies. The bathroom part 4 is " You can see a sink. The sink is ordinary.[if there is something on the s_4] On the sink you can see [a list of things on the s_4].[end if]".
The bathroom part 5 is some text that varies. The bathroom part 5 is "[if there is nothing on the s_4] Unfortunately, there isn't a thing on it. Hopefully, this discovery doesn't ruin your TextWorld experience![end if]".
...
The garden part 0 is some text that varies. The garden part 0 is "You find yourself in a garden. A standard kind of place. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The s_9 is in r_4.
The description of f_0 is "that's a typical half of a bag of chips!".
...
The description of f_1 is "that's an usual bell pepper!".
...
The description of f_2 is "that's an usual milk!".
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Here is how to play! Your first objective is to ensure that the antique trunk in the bedroom is open. After you have pulled open the antique trunk,".
The objective part 1 is some text that varies. The objective part 1 is " retrieve the old key from the antique trunk. After that, make absolutely sure that the wooden door is unlocked. And then, open the wooden door in the bedroom. After that, head east. With that done, o".
The objective part 2 is some text that varies. The objective part 2 is "pen the refrigerator. And then, take the bell pepper from the refrigerator. If you can get your hands on the bell pepper, sit the bell pepper on the stove in the kitchen. And if you do that, you're th".
