...
The kitchen part 6 is some text that varies. The kitchen part 6 is " You can see a table. Wow, isn't TextWorld just the best? The table is massive.[if there is something on the s_0] On the table you can see [a list of things on the s_0].[end if]".
...
The kitchen part 8 is some text that varies. The kitchen part 8 is " You see a counter. [if there is something on the s_1]On the counter you see [a list of things on the s_1]. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[end if]".
The kitchen part 9 is some text that varies. The kitchen part 9 is "[if there is nothing on the s_1]Looks like someone's already been here and taken everything off it, though. You think about smashing the counter to bits, throwing the bits into the garbage, etc, until you get bored and decide to move on.[end if]".
...
The corridor part 0 is some text that varies. The corridor part 0 is "You find yourself in a corridor. An usual kind of place. Okay, just remember what you're here to do, and everything will go great.
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You find yourself in a bathroom. A normal kind of place. The room is well lit.

 You see a gleam over in a corner, where you can see a toilet. [if there is something on the s_3]You see [a list of things on the s_3] on the toilet. Something scurries by right in the corner of your eye. Probably nothing.[end if]".
...
Test quest2_0 with "inventory / examine cookbook / take yellow potato from counter / cook yellow potato with stove"
...
Test quest4_0 with "inventory / examine cookbook / take yellow potato from counter / cook yellow potato with stove / prepare meal"
...
Test quest5_0 with "inventory / examine cookbook / take yellow potato from counter / cook yellow potato with stove / prepare meal / eat meal"
