...
The kitchen part 0 is some text that varies. The kitchen part 0 is "You are in an ordinary kind of place. That is to say, you're in a kitchen. I guess you better just go and list everything you see here.
...
The kitchen part 3 is some text that varies. The kitchen part 3 is "[if there is nothing on the s_1] But there isn't a thing on it. This always happens![end if]".
The kitchen part 4 is some text that varies. The kitchen part 4 is " You see a gleam over in a corner, where you can see a stove. The stove is typical.[if there is something on the s_2] On the stove you can see [a list of things on the s_2].[end if]".
...
The kitchen part 6 is some text that varies. The kitchen part 6 is " You see a gleam over in a corner, where you can see a kitchen island. The kitchen island is usual.[if there is something on the s_3] On the kitchen island you see [a list of things on the s_3].[end if]".
...
The bedroom part 2 is some text that varies. The bedroom part 2 is " You hear a noise behind you and spin around, but you can't see anything other than an antique trunk. The light flickers for a second, but nothing else happens.[if c_1 is open and there is something in the c_1] The antique trunk contains [a list of things in the c_1].[end if]".
...
The bedroom part 4 is some text that varies. The bedroom part 4 is " What's that over there? It looks like it's a king-size bed. [if there is something on the s_0]You see [a list of things on the s_0] on the king-size bed.[end if]".
The bedroom part 5 is some text that varies. The bedroom part 5 is "[if there is nothing on the s_0]The king-size bed appears to be empty. What, you think everything in TextWorld should have stuff on it?[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " You smell an awful smell, and follow it to a bbq. Make a note of this, you might have to put stuff on or in it later on. The bbq is typical.[if there is something on the s_8] On the bbq you can make out [a list of things on the s_8]. You shudder, but continue examining the room.[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " You make out a patio table. [if there is something on the s_9]You see [a list of things on the s_9] on the patio table. Classic TextWorld.[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You're now in a living room.
 ...
 You rest your hand against a wall, but you miss the wall and fall onto a couch. The couch is standard.[if there is something on the s_5] On the couch you make out [a list of things on the s_5].[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You arrive in a bathroom. An usual kind of place. You decide to start listing off everything you see in the room, as if you were in a text adventure.
 ...
 You can make out a toilet. You can't wait to tell the folks at home about this![if c_3 is open and there is something in the c_3] The toilet contains [a list of things in the c_3]. You can't wait to tell the folks at home about this![end if]".
...
The bathroom part 3 is some text that varies. The bathroom part 3 is " bath.[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4]. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[end if]".
...
The bathroom part 5 is some text that varies. The bathroom part 5 is " You rest your hand against a wall, but you miss the wall and fall onto a sink. The sink is standard.[if there is something on the s_4] On the sink you can make out [a list of things on the s_4]. It doesn't get more TextWorld than this![end if]".
...
The garden part 0 is some text that varies. The garden part 0 is "You are in a garden. A normal kind of place. Let's see what's in here.
...
The d_0 is locked.
The description of d_1 is "it's a solid screen door [if open]You can see inside it.[else if closed]You can't see inside it because the lid's in your way.[otherwise]There is a lock on it.[end if]".
...
The f_4 is in r_5.
The f_4 is edible.
The description of f_5 is "The lettuce looks delectable.".
