...
The lounge part 0 is some text that varies. The lounge part 0 is "Well, here we are in a lounge. The room is well lit.
...
The laundry place part 0 is some text that varies. The laundry place part 0 is "You are in a laundry place. An usual one. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
Test quest0_0 with "go east / go east / go east / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an profound round of TextWorld? You do! Here is how to play! First off, if it's not too much trouble, I need you to attempt to take a trip east".
The objective part 1 is some text that varies. The objective part 1 is ". After that, venture east. That done, attempt to take a trip east. And then, retrieve the coin from the floor of the launderette. Once that's all handled, you can stop!".
