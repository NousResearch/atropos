...
The attic part 0 is some text that varies. The attic part 0 is "You arrive in a typical kind of place. That is to say, you're in an attic.
...
The kitchenette part 0 is some text that varies. The kitchenette part 0 is "Well I'll be, you are in the place we're calling the kitchenette. The room is well lit.
...
The f_0 is in r_3.
The description of o_0 is "The insect would seem to be well matched to everything else here".
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Your task for today is to pick up the insect from the floor of the attic.".
