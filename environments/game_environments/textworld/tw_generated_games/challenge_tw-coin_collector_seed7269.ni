...
The dish-pit part 0 is some text that varies. The dish-pit part 0 is "You make a grand eccentric entrance into a dish-pit. Let's see what's in here.
...
Test quest0_0 with "go south / go east / go east / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. Your first objective is to venture south. Okay, and then, make an effort to venture east. And then, move".
The objective part 1 is some text that varies. The objective part 1 is " east. With that accomplished, pick up the coin from the floor of the vault. That's it!".
