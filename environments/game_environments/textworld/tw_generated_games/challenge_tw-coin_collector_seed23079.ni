...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First stop, make an effort to move west. With that accomplished, pick-up the coin from the floor of the ".
The objective part 1 is some text that varies. The objective part 1 is "launderette. That's it!".
