...
The kitchen part 3 is some text that varies. The kitchen part 3 is " You scan the room, seeing a counter. [if there is something on the s_1]On the counter you see [a list of things on the s_1].[end if]".
...
The kitchen part 5 is some text that varies. The kitchen part 5 is " You smell an awful smell, and follow it to a stove. The stove is normal.[if there is something on the s_2] On the stove you can see [a list of things on the s_2].[end if]".
...
The kitchen part 7 is some text that varies. The kitchen part 7 is " You make out a kitchen island. [if there is something on the s_3]On the kitchen island you make out [a list of things on the s_3].[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You've just shown up in a bedroom.
 ...
 You can see a chest drawer.[if c_0 is open and there is something in the c_0] The chest drawer contains [a list of things in the c_0]. Something scurries by right in the corner of your eye. Probably nothing.[end if]".
...
The bedroom part 4 is some text that varies. The bedroom part 4 is " As if things weren't amazing enough already, you can even see a king-size bed. [if there is something on the s_0]On the king-size bed you can see [a list of things on the s_0].[end if]".
The bedroom part 5 is some text that varies. The bedroom part 5 is "[if there is nothing on the s_0]Looks like someone's already been here and taken everything off it, though. Aw, here you were, all excited for there to be things on it![end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You arrive in a backyard. An ordinary one. You begin looking for stuff.

 Were you looking for a set of chairs? Because look over there, it's a set of chairs. [if there is something on the s_10]On the set of chairs you see [a list of things on the s_10].[end if]".
...
The backyard part 3 is some text that varies. The backyard part 3 is "[if there is nothing on the s_8] But the thing is empty, unfortunately. Oh! Why couldn't there just be stuff on it?[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You find yourself in a living room.
 ...
 Hey, want to see a couch? Look over there, a couch. [if there is something on the s_5]On the couch you can make out [a list of things on the s_5].[end if]".
...
The living room part 3 is some text that varies. The living room part 3 is "[if there is nothing on the s_6] The low table appears to be empty. This always happens, here in TextWorld![end if]".
The living room part 4 is some text that varies. The living room part 4 is " You can see a tv. The tv is usual.[if there is something on the s_7] On the tv you see [a list of things on the s_7].[end if]".
The living room part 5 is some text that varies. The living room part 5 is "[if there is nothing on the s_7] However, the tv, like an empty tv, has nothing on it. Silly tv, silly, empty, good for nothing tv.[end if]".
...
The bathroom part 3 is some text that varies. The bathroom part 3 is " bath is right there by you.[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4].[end if]".
...
The bathroom part 5 is some text that varies. The bathroom part 5 is " You can make out a sink. Now why would someone leave that there? The sink is typical.[if there is something on the s_4] On the sink you can make out [a list of things on the s_4].[end if]".
...
The garden part 0 is some text that varies. The garden part 0 is "Look around you. Take it all in. It's not every day someone gets to be in a garden. The room is well lit.
...
The f_4 is in r_5.
The f_4 is edible.
The description of f_5 is "The bell pepper looks heavenly.".
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another fast paced session of TextWorld! Here is your task for today. First stop, look and see that the antique trunk is opened. After opening the antique trunk, take the old key from the a".
The objective part 1 is some text that varies. The objective part 1 is "ntique trunk in the bedroom. And then, unlock the wooden door with the old key. After that, make absolutely sure that the wooden door is open. Then, move east. With that done, ensure that the screen d".
The objective part 2 is some text that varies. The objective part 2 is "oor is open. Then, make an effort to head east. That done, try to take a trip south. After that, pick-up the bell pepper from the floor of the garden. After that, attempt to go to the north. And then,".
The objective part 3 is some text that varies. The objective part 3 is " venture west. Then, sit the bell pepper on the stove within the kitchen. And once you've done that, you win!".
