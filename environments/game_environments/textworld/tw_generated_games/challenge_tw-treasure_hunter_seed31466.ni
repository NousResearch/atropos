...
The r_1 and the r_3 and the r_2 and the r_4 and the r_0 are rooms.
...
The kitchenette part 0 is some text that varies. The kitchenette part 0 is "Well, here we are in a kitchenette. Okay, just remember what you're here to do, and everything will go great.
...
The r_1 and the r_3 and the r_2 and the r_4 and the r_0 are rooms.
The r_1 and the r_3 and the r_2 and the r_4 and the r_0 are privately-named.
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Recover the key from the floor of the vault.".
