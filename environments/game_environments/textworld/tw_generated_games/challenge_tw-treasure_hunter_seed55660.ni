...
The scullery part 0 is some text that varies. The scullery part 0 is "You're now in a scullery. I guess you better just go and list everything you see here.
...
The office part 0 is some text that varies. The office part 0 is "You've just shown up in an office. You can barely contain your excitement.
...
Test quest0_0 with "go south / take licorice strip"
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! Here is how to play! First stop, attempt to move south. After that, lift the licorice strip from ".
The objective part 1 is some text that varies. The objective part 1 is "the floor of the cellar. Got that? Good!".
