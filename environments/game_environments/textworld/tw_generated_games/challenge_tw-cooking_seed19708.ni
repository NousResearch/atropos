...
The r_0 and the r_1 and the r_2 and the r_10 and the r_9 and the r_11 and the r_6 and the r_3 and the r_4 and the r_5 and the r_8 and the r_7 are rooms.
...
The kitchen part 8 is some text that varies. The kitchen part 8 is " You smell an intriguing smell, and follow it to a counter. [if there is something on the s_1]On the counter you make out [a list of things on the s_1].[end if]".
...
The kitchen part 10 is some text that varies. The kitchen part 10 is " You make out a stove. [if there is something on the stove_0]On the stove you can make out [a list of things on the stove_0]. Huh, weird.[end if]".
The kitchen part 11 is some text that varies. The kitchen part 11 is "[if there is nothing on the stove_0]But the thing hasn't got anything on it. You move on, clearly furious with TextWorld.[end if]".
...
The livingroom part 1 is some text that varies. The livingroom part 1 is "[if there is nothing on the s_8] Unfortunately, there isn't a thing on it. Oh! Why couldn't there just be stuff on it?[end if]".
...
The corridor part 2 is some text that varies. The corridor part 2 is " screen door leading west. You don't like doors? Why not try going east, that entranceway is not blocked by one. You don't like doors? Why not try going south, that entranceway is not blocked by one.".
...
The street part 0 is some text that varies. The street part 0 is "You are in a street. It seems to be pretty typical here.
...
The backyard part 0 is some text that varies. The backyard part 0 is "Well, here we are in a backyard.
 ...
 What's that over there? It looks like it's a patio chair. The patio chair is stylish.[if there is something on the s_7] On the patio chair you can make out [a list of things on the s_7].[end if]".
The backyard part 1 is some text that varies. The backyard part 1 is "[if there is nothing on the s_7] But there isn't a thing on it. Hopefully this doesn't make you too upset.[end if]".
The backyard part 2 is some text that varies. The backyard part 2 is " You make out a patio table. [if there is something on the s_9]On the patio table you make out [a list of things on the s_9].[end if]".
The backyard part 3 is some text that varies. The backyard part 3 is "[if there is nothing on the s_9]Looks like someone's already been here and taken everything off it, though. It would have been so cool if there was stuff on the patio table.[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You are in a bedroom. An ordinary kind of place. Let's see what's in here.
 ...
 Oh, great. Here's a bed. The bed is large.[if there is something on the s_5] On the bed you make out [a list of things on the s_5].[end if]".
...
The bathroom part 1 is some text that varies. The bathroom part 1 is "[if there is nothing on the s_6] The toilet appears to be empty. This always happens, here in TextWorld![end if]".
...
The shed part 3 is some text that varies. The shed part 3 is "[if there is nothing on the s_4]Unfortunately, there isn't a thing on it. You make a mental note to not get your hopes up the next time you see a workbench in a room.[end if]".
...
The r_0 and the r_1 and the r_2 and the r_10 and the r_9 and the r_11 and the r_6 and the r_3 and the r_4 and the r_5 and the r_8 and the r_7 are rooms.
The r_0 and the r_1 and the r_2 and the r_10 and the r_9 and the r_11 and the r_6 and the r_3 and the r_4 and the r_5 and the r_8 and the r_7 are privately-named.
...
The printed name of f_3 is "cilantro".
Understand "cilantro" as f_3.
The f_3 is cuttable.
The f_3 is edible.
...
Test quest1_0 with "inventory / go north / go east / go south / examine cookbook / go north / go west / open screen door / go west / go south / take red potato"
...
Test quest4_0 with "inventory / go north / go east / go south / examine cookbook / go north / go west / open screen door / go west / go south / take red potato / go north / go north / go east / go east / go south / prepare meal"
...
Test quest5_0 with "inventory / go north / go east / go south / examine cookbook / go north / go west / open screen door / go west / go south / take red potato / go north / go north / go east / go east / go south / prepare meal / eat meal"
