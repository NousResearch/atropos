...
The r_0 and the r_1 and the r_11 and the r_10 and the r_2 and the r_5 and the r_6 and the r_7 and the r_3 and the r_4 and the r_8 and the r_9 are rooms.

Understand "kitchen" as r_0.
The internal name of r_0 is "kitchen".
The printed name of r_0 is "-= Kitchen =-".
The kitchen part 0 is some text that varies. The kitchen part 0 is "You arrive in a kitchen. An ordinary one. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The kitchen part 5 is some text that varies. The kitchen part 5 is " What's that over there? It looks like it's a table. What a coincidence, weren't you just thinking about a table? [if there is something on the s_0]On the table you can see [a list of things on the s_0].[end if]".
...
The kitchen part 7 is some text that varies. The kitchen part 7 is " You make out a counter. The counter is vast.[if there is something on the s_1] On the counter you can see [a list of things on the s_1]. Hmmm... what else, what else?[end if]".
...
The pantry part 0 is some text that varies. The pantry part 0 is "You've entered a pantry. You start to take note of what's in the room.
 ...
 Look over there! a shelf. [if there is something on the s_2]You see [a list of things on the s_2] on the shelf. It doesn't get more TextWorld than this![end if]".
...
The supermarket part 0 is some text that varies. The supermarket part 0 is "Well, here we are in a supermarket. Okay, just remember what you're here to do, and everything will go great.
...
The street part 0 is some text that varies. The street part 0 is "You are in a street. A standard one. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The corridor part 0 is some text that varies. The corridor part 0 is "Well I'll be, you are in the place we're calling the corridor. You start to take note of what's in the room.
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You are in a bathroom. An usual one.
 ...
 You see a toilet. What a coincidence, weren't you just thinking about a toilet? The toilet is white.[if there is something on the s_4] On the toilet you see [a list of things on the s_4].[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "I am pleased to announce that you are now in the backyard. You decide to just list off a complete list of everything you see in the room, because hey, why not?

 You can make out a patio chair. [if there is something on the s_7]On the patio chair you see [a list of things on the s_7]. Wow! Just like in the movies![end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " You can see a patio table. You wonder idly who left that here. [if there is something on the s_8]You see [a list of things on the s_8] on the patio table.[end if]".
The backyard part 3 is some text that varies. The backyard part 3 is "[if there is nothing on the s_8]However, the patio table, like an empty patio table, has nothing on it. Hm. Oh well[end if]".
...
The shed part 2 is some text that varies. The shed part 2 is " You see a gleam over in a corner, where you can see a workbench. The workbench is wooden.[if there is something on the s_6] On the workbench you can make out [a list of things on the s_6].[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You're now in a bedroom.
 ...
 You can see a bed. The bed is large.[if there is something on the s_9] On the bed you can make out [a list of things on the s_9].[end if]".
...
The livingroom part 0 is some text that varies. The livingroom part 0 is "You find yourself in a livingroom. A normal one.
 ...
 You bend down to tie your shoe. When you stand up, you notice a sofa. [if there is something on the s_5]On the sofa you can make out [a list of things on the s_5].[end if]".
...
The livingroom part 3 is some text that varies. The livingroom part 3 is " front door leading south. There is an exit to the north.".
...
The garden part 0 is some text that varies. The garden part 0 is "Of every garden you could have shown up in, you had to show up in an ordinary one. You begin to take stock of what's in the room.
...
The driveway part 0 is some text that varies. The driveway part 0 is "This just in- You, in the driveway. You begin to take stock of what's here.
...
The f_1 and the f_5 and the f_0 and the f_2 and the f_3 and the f_4 and the f_6 are foods.
The f_1 and the f_5 and the f_0 and the f_2 and the f_3 and the f_4 and the f_6 are privately-named.
...
The r_0 and the r_1 and the r_11 and the r_10 and the r_2 and the r_5 and the r_6 and the r_7 and the r_3 and the r_4 and the r_8 and the r_9 are rooms.
The r_0 and the r_1 and the r_11 and the r_10 and the r_2 and the r_5 and the r_6 and the r_7 and the r_3 and the r_4 and the r_8 and the r_9 are privately-named.
...
The d_0 is closed.
The description of d_1 is "It's a grand [noun] [if open]You can see inside it.[else if locked]There is a lock on it and seems impossible to open.[otherwise]You can't see inside it because the lid's in your way.[end if]".
...
Test quest1_0 with "inventory / go north / open front door / go north / go north / go north / go west / examine cookbook / drop red hot pepper / take banana from counter / open patio door / go south / cook orange bell pepper with BBQ"
...
Test quest4_0 with "inventory / go north / open front door / go north / go north / go north / go west / examine cookbook / drop red hot pepper / take banana from counter"
...
Test quest5_0 with "inventory / go north / open front door / go north / go north / go north / go west / examine cookbook / drop red hot pepper / take banana from counter / open patio door / go south / cook orange bell pepper with BBQ / cook orange bell pepper with BBQ / go north / cook banana with oven"
...
Test quest7_0 with "inventory / go north / open front door / go north / go north / go north / go west / examine cookbook / drop red hot pepper / take banana from counter / open patio door / go south / cook orange bell pepper with BBQ / cook orange bell pepper with BBQ / go north / cook banana with oven / prepare meal"
...
Test quest8_0 with "inventory / go north / open front door / go north / go north / go north / go west / examine cookbook / drop red hot pepper / take banana from counter / open patio door / go south / cook orange bell pepper with BBQ / cook orange bell pepper with BBQ / go north / cook banana with oven / prepare meal / eat meal"
...
This is the simpler notify score changes rule:
	...
	if quest1 completed is true and quest4 completed is true and quest5 completed is true and quest7 completed is true and quest8 completed is true:
