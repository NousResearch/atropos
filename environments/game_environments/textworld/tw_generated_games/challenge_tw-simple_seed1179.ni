...
The kitchen part 3 is some text that varies. The kitchen part 3 is " You can see a counter. I guess it's true what they say, if you're looking for a counter, go to TextWorld. The counter is typical.[if there is something on the s_1] On the counter you can see [a list of things on the s_1].[end if]".
...
The kitchen part 6 is some text that varies. The kitchen part 6 is "[if there is nothing on the s_2]Looks like someone's already been here and taken everything off it, though. You move on, clearly infuriated by TextWorld.[end if]".
The kitchen part 7 is some text that varies. The kitchen part 7 is " You scan the room for a kitchen island, and you find a kitchen island. The kitchen island is normal.[if there is something on the s_3] On the kitchen island you can see [a list of things on the s_3]. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[end if]".
The kitchen part 8 is some text that varies. The kitchen part 8 is "[if there is nothing on the s_3] But the thing hasn't got anything on it. You swear loudly.[end if]".
...
The kitchen part 11 is some text that varies. The kitchen part 11 is " wooden door leading west. There is an unblocked exit to the north. You don't like doors? Why not try going south, that entranceway is unguarded.".
...
The bedroom part 1 is some text that varies. The bedroom part 1 is " chest drawer.[if c_0 is open and there is something in the c_0] The chest drawer contains [a list of things in the c_0]. Huh, weird.[end if]".
...
The bedroom part 6 is some text that varies. The bedroom part 6 is " You make out a king-size bed. [if there is something on the s_0]You see [a list of things on the s_0] on the king-size bed.[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You are in a backyard. A typical one.
 ...
 You see a set of chairs. [if there is something on the s_10]On the set of chairs you see [a list of things on the s_10].[end if]".
The backyard part 1 is some text that varies. The backyard part 1 is "[if there is nothing on the s_10]But the thing hasn't got anything on it. Hm. Oh well[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " Look out! It's a- oh, never mind, it's just a patio table. The patio table is standard.[if there is something on the s_9] On the patio table you see [a list of things on the s_9].[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "Guess what, you are in a place we're calling a living room.
...
The living room part 3 is some text that varies. The living room part 3 is "[if there is nothing on the s_6]Unfortunately, there isn't a thing on it. Aw, and here you were, all excited for there to be things on it![end if]".
The living room part 4 is some text that varies. The living room part 4 is " You scan the room, seeing a tv. The tv is typical.[if there is something on the s_7] On the tv you can see [a list of things on the s_7].[end if]".
The living room part 5 is some text that varies. The living room part 5 is "[if there is nothing on the s_7] But oh no! there's nothing on this piece of garbage. This always happens![end if]".
...
The bathroom part 1 is some text that varies. The bathroom part 1 is " usual looking toilet here.[if c_3 is open and there is something in the c_3] The toilet contains [a list of things in the c_3].[end if]".
...
The bathroom part 5 is some text that varies. The bathroom part 5 is " You can see a sink. The sink is typical.[if there is something on the s_4] On the sink you can see [a list of things on the s_4].[end if]".
...
The f_3 is in r_5.
The f_3 is edible.
The description of f_4 is "The half of a bag of chips looks delicious.".
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Here is how to play! First of all, you could, like, look and see that the chest drawer is wide open. Then, take the old key from the chest drawer i".
The objective part 1 is some text that varies. The objective part 1 is "nside the bedroom. And then, insert the old key into the wooden door's lock to unlock it. After unlocking the wooden door, ensure that the wooden door within the bedroom is open. After that, move east".
The objective part 2 is some text that varies. The objective part 2 is ". With that accomplished, open the screen door. And then, move east. That done, try to take a trip south. And then, retrieve the milk from the floor of the garden. Then, venture north. And then, try t".
The objective part 3 is some text that varies. The objective part 3 is "o move west. If you can manage that, sit the milk on the stove within the kitchen. And if you do that, you're the winner!".
