...
The scullery part 0 is some text that varies. The scullery part 0 is "You are in a scullery. An usual kind of place. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First off, if it's not too much trouble, I need you to make an effort to take a trip east. Once you acco".
The objective part 1 is some text that varies. The objective part 1 is "mplish that, go to the north. With that over with, pick up the latchkey from the floor of the bar. Alright, thanks!".
