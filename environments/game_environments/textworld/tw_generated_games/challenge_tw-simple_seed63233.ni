...
The kitchen part 3 is some text that varies. The kitchen part 3 is " You see a counter. [if there is something on the s_1]You see [a list of things on the s_1] on the counter. You can't wait to tell the folks at home about this![end if]".
...
The kitchen part 5 is some text that varies. The kitchen part 5 is " You rest your hand against a wall, but you miss the wall and fall onto a stove. [if there is something on the s_2]On the stove you make out [a list of things on the s_2].[end if]".
...
The kitchen part 7 is some text that varies. The kitchen part 7 is " You can make out a kitchen island. The kitchen island is normal.[if there is something on the s_3] On the kitchen island you make out [a list of things on the s_3].[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "Well, here we are in the bedroom.
 ...
 You make out a chest drawer.[if c_0 is open and there is something in the c_0] The chest drawer contains [a list of things in the c_0]. What a great pairing of adjectives and nouns![end if]".
...
The bedroom part 5 is some text that varies. The bedroom part 5 is " You see a king-size bed. The king-size bed is normal.[if there is something on the s_0] On the king-size bed you make out [a list of things on the s_0]. There's something strange about this thing being here, but you don't have time to worry about that now.[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You are in a backyard. A standard one.
 ...
 You smell an awful smell, and follow it to a set of chairs. [if there is something on the s_10]On the set of chairs you make out [a list of things on the s_10].[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "Well, here we are in the living room.
 ...
 Oh, great. Here's a couch. Wow, isn't TextWorld just the best? [if there is something on the s_5]On the couch you see [a list of things on the s_5]. There's something strange about this thing being here, but you don't have time to worry about that now.[end if]".
...
The living room part 2 is some text that varies. The living room part 2 is " You can make out a low table. What a coincidence, weren't you just thinking about a low table? The low table is typical.[if there is something on the s_6] On the low table you can see [a list of things on the s_6].[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "Look at you, bigshot, walking into a bathroom like it isn't some huge deal. You start to take note of what's in the room.
...
The bathroom part 6 is some text that varies. The bathroom part 6 is " You see a sink. [if there is something on the s_4]On the sink you see [a list of things on the s_4].[end if]".
...
The garden part 0 is some text that varies. The garden part 0 is "This garden you have just entered is definitely normal.
...
The s_9 is in r_4.
The description of f_0 is "The bell pepper looks tempting.".
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a exciting round of TextWorld! First of all, you could, like, ensure that the antique trunk is open. After opening the antique trunk, retrieve the old key from the antique trunk in".
The objective part 1 is some text that varies. The objective part 1 is " the bedroom. Then, doublecheck that the wooden door within the bedroom is unlocked. After that, ensure that the wooden door in the bedroom is open. And then, make an effort to go east. And then, ensu".
The objective part 2 is some text that varies. The objective part 2 is "re that the refrigerator is open. After that, retrieve the bell pepper from the refrigerator. Then, place the bell pepper on the stove. And once you've done that, you win!".
