...
The kitchen part 2 is some text that varies. The kitchen part 2 is " Oh wow! Is that what I think it is? It is! It's a counter. You shudder, but continue examining the counter. [if there is something on the s_1]You see [a list of things on the s_1] on the counter.[end if]".
...
The kitchen part 6 is some text that varies. The kitchen part 6 is " You make out a kitchen island. The kitchen island is usual.[if there is something on the s_3] On the kitchen island you can make out [a list of things on the s_3]. I mean, just wow! Isn't TextWorld just the best?[end if]".
The kitchen part 7 is some text that varies. The kitchen part 7 is "[if there is nothing on the s_3] Looks like someone's already been here and taken everything off it, though. What, you think everything in TextWorld should have stuff on it?[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You have stumbled into a bedroom. Not the bedroom you'd expect. No, this is a bedroom. Let's see what's in here.

 You see a gleam over in a corner, where you can see a chest drawer.[if c_0 is open and there is something in the c_0] The chest drawer contains [a list of things in the c_0].[end if]".
...
The bedroom part 2 is some text that varies. The bedroom part 2 is " You can make out an antique trunk. Hmm. You always thought you'd be more excited to see an antique trunk in a room.[if c_1 is open and there is something in the c_1] The antique trunk contains [a list of things in the c_1].[end if]".
...
The bedroom part 4 is some text that varies. The bedroom part 4 is " You see a gleam over in a corner, where you can see a king-size bed. The king-size bed is usual.[if there is something on the s_0] On the king-size bed you make out [a list of things on the s_0].[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " What's that over there? It looks like it's a bbq. [if there is something on the s_8]On the bbq you can make out [a list of things on the s_8]. Now that's what I call TextWorld![end if]".
The backyard part 3 is some text that varies. The backyard part 3 is "[if there is nothing on the s_8]Unfortunately, there isn't a thing on it. This always happens, here in TextWorld![end if]".
The backyard part 4 is some text that varies. The backyard part 4 is " Look over there! a patio table. The patio table is ordinary.[if there is something on the s_9] On the patio table you see [a list of things on the s_9].[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You've entered a living room. I guess you better just go and list everything you see here.
...
The living room part 4 is some text that varies. The living room part 4 is " You smell a terrible smell, and follow it to a tv. [if there is something on the s_7]On the tv you can see [a list of things on the s_7]. You shudder, but continue examining the room.[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "Guess what, you are in the place we're calling the bathroom.
 ...
 You rest your hand against a wall, but you miss the wall and fall onto a toilet, so there's that.[if c_3 is open and there is something in the c_3] The toilet contains [a list of things in the c_3].[end if]".
...
The bathroom part 3 is some text that varies. The bathroom part 3 is " bath here.[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4].[end if]".
...
The bathroom part 5 is some text that varies. The bathroom part 5 is " You see a gleam over in a corner, where you can see a sink. The sink is normal.[if there is something on the s_4] On the sink you can see [a list of things on the s_4].[end if]".
