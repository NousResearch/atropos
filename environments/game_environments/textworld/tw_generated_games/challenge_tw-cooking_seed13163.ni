...
The kitchen part 0 is some text that varies. The kitchen part 0 is "You find yourself in a kitchen.
 ...
 You see a fridge. You shudder, but continue examining the room.[if c_0 is open and there is something in the c_0] The fridge contains [a list of things in the c_0].[end if]".
...
The kitchen part 5 is some text that varies. The kitchen part 5 is " You can see a table. Make a note of this, you might have to put stuff on or in it later on. The table is massive.[if there is something on the s_0] On the table you can see [a list of things on the s_0].[end if]".
...
The kitchen part 9 is some text that varies. The kitchen part 9 is " You can see a stove. The stove is conventional.[if there is something on the stove_0] On the stove you can see [a list of things on the stove_0]. Now why would someone leave that there?[end if]".
...
The pantry part 0 is some text that varies. The pantry part 0 is "You are in a pantry. A standard one. I guess you better just go and list everything you see here.
...
The f_1 and the f_2 and the f_7 and the f_3 and the f_4 and the f_5 and the f_0 and the f_6 are foods.
The f_1 and the f_2 and the f_7 and the f_3 and the f_4 and the f_5 and the f_0 and the f_6 are privately-named.
...
Test quest1_0 with "inventory / inventory / go west / examine cookbook / drop salt / take red onion from fridge"
...
Test quest5_0 with "inventory / inventory / go west / examine cookbook / drop salt / take red onion from fridge / take purple potato from counter"
...
Test quest11_0 with "inventory / inventory / go west / examine cookbook / drop salt / take red onion from fridge / take purple potato from counter / prepare meal"
...
Test quest12_0 with "inventory / inventory / go west / examine cookbook / drop salt / take red onion from fridge / take purple potato from counter / prepare meal / eat meal"
