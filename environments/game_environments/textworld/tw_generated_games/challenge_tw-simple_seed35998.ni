...
The kitchen part 3 is some text that varies. The kitchen part 3 is " You make out a counter. [if there is something on the s_1]On the counter you can make out [a list of things on the s_1].[end if]".
The kitchen part 4 is some text that varies. The kitchen part 4 is "[if there is nothing on the s_1]But the thing is empty, unfortunately. Sometimes, just sometimes, TextWorld can just be the worst.[end if]".
The kitchen part 5 is some text that varies. The kitchen part 5 is " Look over there! a stove. The stove is standard.[if there is something on the s_2] On the stove you can make out [a list of things on the s_2].[end if]".
The kitchen part 6 is some text that varies. The kitchen part 6 is "[if there is nothing on the s_2] But the thing is empty. Oh! Why couldn't there just be stuff on it?[end if]".
The kitchen part 7 is some text that varies. The kitchen part 7 is " Hey, want to see a kitchen island? Look over there, a kitchen island. The kitchen island is usual.[if there is something on the s_3] On the kitchen island you can make out [a list of things on the s_3].[end if]".
...
The bedroom part 2 is some text that varies. The bedroom part 2 is " You see an antique trunk.[if c_1 is open and there is something in the c_1] The antique trunk contains [a list of things in the c_1].[end if]".
...
The bedroom part 4 is some text that varies. The bedroom part 4 is " You can see a king-size bed. What a coincidence, weren't you just thinking about a king-size bed? The king-size bed is usual.[if there is something on the s_0] On the king-size bed you can see [a list of things on the s_0].[end if]".
The bedroom part 5 is some text that varies. The bedroom part 5 is "[if there is nothing on the s_0] But the thing hasn't got anything on it. Oh! Why couldn't there just be stuff on it?[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " You make out a bbq. I guess it's true what they say, if you're looking for a bbq, go to TextWorld. [if there is something on the s_8]On the bbq you make out [a list of things on the s_8]. I mean, just wow! Isn't TextWorld just the best?[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " You scan the room, seeing a patio table. The patio table is standard.[if there is something on the s_9] On the patio table you can make out [a list of things on the s_9].[end if]".
The backyard part 5 is some text that varies. The backyard part 5 is "[if there is nothing on the s_9] The patio table appears to be empty. This always happens![end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You've entered a living room.
 ...
 You see a couch. [if there is something on the s_5]On the couch you make out [a list of things on the s_5]. You can't wait to tell the folks at home about this![end if]".
...
The living room part 3 is some text that varies. The living room part 3 is "[if there is nothing on the s_6]Unfortunately, there isn't a thing on it. Oh! Why couldn't there just be stuff on it?[end if]".
The living room part 4 is some text that varies. The living room part 4 is " You can see a tv. The tv is ordinary.[if there is something on the s_7] On the tv you can see [a list of things on the s_7].[end if]".
The living room part 5 is some text that varies. The living room part 5 is "[if there is nothing on the s_7] The tv appears to be empty. You swear loudly.[end if]".
...
The bathroom part 2 is some text that varies. The bathroom part 2 is " You make out a bath. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4].[end if]".
...
The bathroom part 4 is some text that varies. The bathroom part 4 is " You scan the room, seeing a sink. [if there is something on the s_4]On the sink you can see [a list of things on the s_4].[end if]".
The bathroom part 5 is some text that varies. The bathroom part 5 is "[if there is nothing on the s_4]But oh no! there's nothing on this piece of junk. What, you think everything in TextWorld should have stuff on it?[end if]".
...
The f_4 is in r_5.
The f_4 is edible.
The description of f_5 is "that's a standard apple!".
...
The description of f_2 is "that's an ordinary lettuce!".
...
Test quest6_0 with "open chest drawer / take old key from chest drawer / unlock wooden door with old key / open wooden door / go east / go south / take lettuce from couch"
...
Test quest7_0 with "open chest drawer / take old key from chest drawer / unlock wooden door with old key / open wooden door / go east / go south / take lettuce from couch / go north / put lettuce on stove"
...
This is the simpler notify score changes rule:
	...
	if quest0 completed is true and quest1 completed is true and quest2 completed is true and quest3 completed is true and quest4 completed is true and quest5 completed is true and quest6 completed is true and quest7 completed is true:
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First, it would be a great idea if you could open the chest drawer within the bedroom. And then, recover".
The objective part 1 is some text that varies. The objective part 1 is " the old key from the chest drawer. And then, make sure that the wooden door is unlocked. Then, ensure that the wooden door in the bedroom is open. And then, try to travel east. And then, make an effo".
The objective part 2 is some text that varies. The objective part 2 is "rt to take a trip south. With that over with, retrieve the lettuce from the couch. And then, go to the north. And then, rest the lettuce on the stove. And if you do that, you're the winner!".
