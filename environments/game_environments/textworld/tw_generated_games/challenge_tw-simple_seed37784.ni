...
The kitchen part 0 is some text that varies. The kitchen part 0 is "Well how about that, you are in the place we're calling the kitchen. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The kitchen part 2 is some text that varies. The kitchen part 2 is " You see a counter. I guess it's true what they say, if you're looking for a counter, go to TextWorld. The counter is usual.[if there is something on the s_1] On the counter you can make out [a list of things on the s_1].[end if]".
...
The kitchen part 10 is some text that varies. The kitchen part 10 is " wooden door leading west. You don't like doors? Why not try going north, that entranceway is unblocked. You need an unblocked exit? You should try going south.".
...
The bedroom part 1 is some text that varies. The bedroom part 1 is " ordinary looking chest drawer in the room.[if c_0 is open and there is something in the c_0] The chest drawer contains [a list of things in the c_0]. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[end if]".
...
The bedroom part 6 is some text that varies. The bedroom part 6 is " You can see a king-size bed. Now why would someone leave that there? The king-size bed is normal.[if there is something on the s_0] On the king-size bed you can make out [a list of things on the s_0].[end if]".
The bedroom part 7 is some text that varies. The bedroom part 7 is "[if there is nothing on the s_0] But the thing hasn't got anything on it. You think about smashing the king-size bed to bits, throwing the bits into the garbage, etc, until you get bored.[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " You hear a noise behind you and spin around, but you can't see anything other than a bbq. [if there is something on the s_8]On the bbq you make out [a list of things on the s_8].[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " You see a gleam over in a corner, where you can see a patio table. You shudder, but continue examining the patio table. The patio table is usual.[if there is something on the s_9] On the patio table you can see [a list of things on the s_9]. Suddenly, you bump your head on the ceiling, but it's not such a bad bump that it's going to prevent you from looking at objects and even things.[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "Well, here we are in a living room. You try to gain information on your surroundings by using a technique you call 'looking.'

 You make out a couch. [if there is something on the s_5]On the couch you make out [a list of things on the s_5].[end if]".
...
The living room part 3 is some text that varies. The living room part 3 is "[if there is nothing on the s_6]But there isn't a thing on it. You think about smashing the low table to bits, throwing the bits into the garbage, etc, until you get bored.[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You find yourself in a bathroom. An ordinary kind of place. Let's see what's in here.

 You can make out a toilet.[if c_3 is open and there is something in the c_3] The toilet contains [a list of things in the c_3]. I mean, just wow! Isn't TextWorld just the best?[end if]".
...
The bathroom part 3 is some text that varies. The bathroom part 3 is " typical looking bath close by.[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4]. There's something strange about this being here, but you can't put your finger on it.[end if]".
...
The bathroom part 5 is some text that varies. The bathroom part 5 is " You see a gleam over in a corner, where you can see a sink. The sink is normal.[if there is something on the s_4] On the sink you see [a list of things on the s_4].[end if]".
The bathroom part 6 is some text that varies. The bathroom part 6 is "[if there is nothing on the s_4] But the thing is empty. It would have been so cool if there was stuff on the sink.[end if]".
...
The description of d_0 is "The wooden door looks well-built. [if open]You can see inside it.[else if closed]You can't see inside it because the lid's in your way.[otherwise]There is a lock on it.[end if]".
...
The s_9 is in r_4.
The description of f_0 is "that's an usual half of a bag of chips!".
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Your first objective is to ensure that the chest drawer in the bedroom is open. After you have opened the chest drawer, pick up the old key from the chest drawer inside the bedro".
The objective part 1 is some text that varies. The objective part 1 is "om. With the old key, make sure that the wooden door is unlocked. And then, ensure that the wooden door is open. Once you have pulled open the wooden door, head east. Next, ensure that the screen door".
The objective part 2 is some text that varies. The objective part 2 is " is open. And then, go east. And then, go south. Then, retrieve the milk from the floor of the garden. If you can get your hands on the milk, venture north. After that, make an effort to move west. An".
The objective part 3 is some text that varies. The objective part 3 is "d then, rest the milk on the stove in the kitchen. And if you do that, you're the winner!".
