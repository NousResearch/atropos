...
The steam room part 0 is some text that varies. The steam room part 0 is "You find yourself in a steam room. An ordinary one. The room is well lit.
...
Test quest0_0 with "go east / go east / take cashew"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First off, if it's not too much trouble, I need you to make an effort to go east. And then, try to ventu".
The objective part 1 is some text that varies. The objective part 1 is "re east. Then, pick up the cashew from the floor of the cookhouse. Alright, thanks!".
