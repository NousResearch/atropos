...
The cubicle part 0 is some text that varies. The cubicle part 0 is "You find yourself in a cubicle. A typical one. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an profound round of TextWorld? You do! Your first objective is to make an effort to go east. After that, lift the cookie from the floor of the".
The objective part 1 is some text that varies. The objective part 1 is " cubicle. Got that? Good!".
