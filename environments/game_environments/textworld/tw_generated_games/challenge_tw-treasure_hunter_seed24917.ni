...
The study part 0 is some text that varies. The study part 0 is "This might come as a shock to you, but you've just stumbled into a study.
...
There is an exit to the north. Don't worry, it is unguarded. There is an unblocked exit to the south. You don't like doors? Why not try going west, that entranceway is unguarded.".
...
The launderette part 0 is some text that varies. The launderette part 0 is "Okay, so you're in a launderette, cool, but is it normal? You better believe it is. You can barely contain your excitement.
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a exciting game of TextWorld! Your task for today is to retrieve the keycard from the floor of the launderette.".
