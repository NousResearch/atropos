...
The cellar part 0 is some text that varies. The cellar part 0 is "You're now in the cellar. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The study part 0 is some text that varies. The study part 0 is "This might come as a shock to you, but you've just entered a study. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
Test quest0_0 with "go west / take butterfly"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. Your first objective is to go west. That done, lift the butterfly from the floor of the cellar. Got that".
