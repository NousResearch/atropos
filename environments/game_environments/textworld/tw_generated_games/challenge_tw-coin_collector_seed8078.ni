...
The lounge part 0 is some text that varies. The lounge part 0 is "Guess what, you are in the place we're calling the lounge. Okay, just remember what you're here to do, and everything will go great.
...
The description of o_0 is "The coin is cheap looking.".
...
Test quest0_0 with "go north / go west / go west / go west / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First, it would be fantastic if you could attempt to go to the north. If you can finish that, head west.".
The objective part 1 is some text that varies. The objective part 1 is " Once you get through with that, make an attempt to take a trip west. Next, make an attempt to head west. If you can finish that, recover the coin from the floor of the study. Got that? Good!".
