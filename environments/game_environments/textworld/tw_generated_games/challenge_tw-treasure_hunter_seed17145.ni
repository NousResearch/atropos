...
The salon part 0 is some text that varies. The salon part 0 is "You've just sauntered into a salon. Okay, just remember what you're here to do, and everything will go great.
...
The restroom part 0 is some text that varies. The restroom part 0 is "You have fallen into the most standard of all possible restrooms.
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Pick up the keycard from the floor of the steam room.".
