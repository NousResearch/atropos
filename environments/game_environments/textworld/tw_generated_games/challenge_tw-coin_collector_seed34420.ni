...
The vault part 0 is some text that varies. The vault part 0 is "Well I'll be, you are in the place we're calling the vault. You begin looking for stuff.
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. Your first objective is to attempt to venture south. After that, venture east. Once you get around to do".
The objective part 1 is some text that varies. The objective part 1 is "ing that, go north. After that, make an effort to move east. With that over with, lift the coin from the floor of the lounge. And if you do that, you're the winner!".
