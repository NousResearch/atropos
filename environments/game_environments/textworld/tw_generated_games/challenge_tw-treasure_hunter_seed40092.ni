...
The shower part 0 is some text that varies. The shower part 0 is "You find yourself in a shower. An ordinary kind of place. You begin looking for stuff.
...
The study part 0 is some text that varies. The study part 0 is "Well, here we are in a study. I guess you better just go and list everything you see here.
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an profound round of TextWorld? You do! Here is how to play! First thing I need you to do is to move east. Then, pick-up the keycard from the f".
The objective part 1 is some text that varies. The objective part 1 is "loor of the shower. That's it!".
