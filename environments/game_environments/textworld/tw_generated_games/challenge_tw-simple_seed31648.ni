...
The kitchen part 0 is some text that varies. The kitchen part 0 is "You're now in a kitchen.
 ...
 You bend down to tie your shoe. When you stand up, you notice a refrigerator. Now that's what I call TextWorld![if c_2 is open and there is something in the c_2] The refrigerator contains [a list of things in the c_2]. You wonder idly who left that here.[end if]".
...
The kitchen part 2 is some text that varies. The kitchen part 2 is " You lean against the wall, inadvertently pressing a secret button. The wall opens up to reveal a counter. The counter is ordinary.[if there is something on the s_1] On the counter you make out [a list of things on the s_1].[end if]".
The kitchen part 3 is some text that varies. The kitchen part 3 is "[if there is nothing on the s_1] The counter appears to be empty. You move on, clearly upset with your TextWorld experience.[end if]".
The kitchen part 4 is some text that varies. The kitchen part 4 is " You can make out a stove. [if there is something on the s_2]On the stove you can make out [a list of things on the s_2].[end if]".
The kitchen part 5 is some text that varies. The kitchen part 5 is "[if there is nothing on the s_2]But oh no! there's nothing on this piece of garbage. What, you think everything in TextWorld should have stuff on it?[end if]".
The kitchen part 6 is some text that varies. The kitchen part 6 is " You can make out a kitchen island. I guess it's true what they say, if you're looking for a kitchen island, go to TextWorld. [if there is something on the s_3]On the kitchen island you make out [a list of things on the s_3].[end if]".
...
The bedroom part 3 is some text that varies. The bedroom part 3 is " Look over there! an antique trunk. Classic TextWorld.[if c_1 is open and there is something in the c_1] The antique trunk contains [a list of things in the c_1]. I mean, just wow! Isn't TextWorld just the best?[end if]".
...
The bedroom part 5 is some text that varies. The bedroom part 5 is " You can see a king-size bed. The king-size bed is normal.[if there is something on the s_0] On the king-size bed you make out [a list of things on the s_0].[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You are in a backyard. An ordinary kind of place.
 ...
 You make out a set of chairs. Make a note of this, you might have to put stuff on or in it later on. The set of chairs is normal.[if there is something on the s_10] On the set of chairs you can make out [a list of things on the s_10]. Something scurries by right in the corner of your eye. Probably nothing.[end if]".
The backyard part 1 is some text that varies. The backyard part 1 is "[if there is nothing on the s_10] But oh no! there's nothing on this piece of garbage. Hm. Oh well[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " Oh, great. Here's a patio table. I guess it's true what they say, if you're looking for a patio table, go to TextWorld. [if there is something on the s_9]You see [a list of things on the s_9] on the patio table.[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "I am sorry to announce that you are now in the living room.

 You see a couch. [if there is something on the s_5]On the couch you can see [a list of things on the s_5].[end if]".
The living room part 1 is some text that varies. The living room part 1 is "[if there is nothing on the s_5]But there isn't a thing on it. Sometimes, just sometimes, TextWorld can just be the worst.[end if]".
...
The living room part 4 is some text that varies. The living room part 4 is " If you haven't noticed it already, there seems to be something there by the wall, it's a tv. What a coincidence, weren't you just thinking about a tv? The tv is usual.[if there is something on the s_7] On the tv you see [a list of things on the s_7].[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "Of every bathroom you could have walked into, you had to show up in a normal one.

 You make out a toilet.[if c_3 is open and there is something in the c_3] The toilet contains [a list of things in the c_3]. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[end if]".
...
The bathroom part 5 is some text that varies. The bathroom part 5 is " Look out! It's a- oh, never mind, it's just a sink. [if there is something on the s_4]You see [a list of things on the s_4] on the sink.[end if]".
...
The garden part 0 is some text that varies. The garden part 0 is "You're now in the garden. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The c_4 is in r_3.
The c_4 is closed.
The description of f_3 is "The bell pepper looks heavenly.".
...
The f_3 is in r_5.
The f_3 is edible.
The description of f_4 is "The milk looks tantalizing.".
The printed name of f_4 is "milk".
Understand "milk" as f_4.
The f_4 is in r_5.
The f_4 is edible.
The description of f_5 is "The apple looks heavenly.".
...
The s_9 is in r_4.
The description of f_0 is "that's an usual lettuce!".
The printed name of f_0 is "lettuce".
Understand "lettuce" as f_0.
The f_0 is edible.
The f_0 is in the c_2.
The description of f_1 is "The tomato plant looks appetizing.".
...
The description of f_2 is "that's a standard half of a bag of chips!".
