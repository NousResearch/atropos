...
The salon part 0 is some text that varies. The salon part 0 is "You find yourself in a salon. You begin looking for stuff.
...
The bar part 0 is some text that varies. The bar part 0 is "Of every bar you could have walked into, you had to saunter into a normal one. Let's see what's in here.
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to TextWorld! Please pick up the latchkey from the floor of the chamber.".
