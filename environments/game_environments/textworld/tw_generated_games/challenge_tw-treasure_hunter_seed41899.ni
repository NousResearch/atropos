...
The parlor part 0 is some text that varies. The parlor part 0 is "You have walked into the most standard of all possible parlors. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another profound episode of TextWorld! Your task for today is to pick up the keycard from the floor of the parlor.".
