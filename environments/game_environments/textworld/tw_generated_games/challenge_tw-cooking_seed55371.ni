...
The kitchen part 13 is some text that varies. The kitchen part 13 is " frosted-glass door leading west. There is an exit to the east. Don't worry, there is no door. You need an exit without a door? You should try going north.".
...
You don't like doors? Why not try going north, that entranceway is not blocked by one. You don't like doors? Why not try going south, that entranceway is not blocked by one. There is an exit to the west.".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You find yourself in a bedroom. A standard one.
 ...
 Oh, great. Here's a bed. The bed is large.[if there is something on the s_4] On the bed you see [a list of things on the s_4].[end if]".
The bedroom part 1 is some text that varies. The bedroom part 1 is "[if there is nothing on the s_4] The bed appears to be empty. Aw, and here you were, all excited for there to be things on it![end if]".
...
The livingroom part 0 is some text that varies. The livingroom part 0 is "I am excited to announce that you are now in the livingroom.
...
The livingroom part 1 is some text that varies. The livingroom part 1 is "[if there is nothing on the s_3] But oh no! there's nothing on this piece of junk. It would have been so cool if there was stuff on the sofa.[end if]".
...
Test quest1_0 with "inventory / go west / examine cookbook / open fridge / take cilantro from fridge"
...
Test quest5_0 with "inventory / go west / examine cookbook / open fridge / take cilantro from fridge / take cilantro from fridge / take pork chop from fridge"
...
Test quest8_0 with "inventory / go west / examine cookbook / open fridge / take cilantro from fridge / take cilantro from fridge / take pork chop from fridge / prepare meal"
...
Test quest9_0 with "inventory / go west / examine cookbook / open fridge / take cilantro from fridge / take cilantro from fridge / take pork chop from fridge / prepare meal / eat meal"
