...
The r_0 and the r_1 and the r_11 and the r_10 and the r_3 and the r_4 and the r_6 and the r_7 and the r_2 and the r_5 and the r_8 and the r_9 are rooms.

Understand "kitchen" as r_0.
The internal name of r_0 is "kitchen".
The printed name of r_0 is "-= Kitchen =-".
The kitchen part 0 is some text that varies. The kitchen part 0 is "You find yourself in a kitchen. A standard kind of place. I guess you better just go and list everything you see here.
...
The kitchen part 5 is some text that varies. The kitchen part 5 is " You can make out a table. The table is massive.[if there is something on the s_0] On the table you can see [a list of things on the s_0]. You shudder, but continue examining the room.[end if]".
...
The kitchen part 7 is some text that varies. The kitchen part 7 is " What's that over there? It looks like it's a counter. [if there is something on the s_1]On the counter you make out [a list of things on the s_1].[end if]".
...
The kitchen part 9 is some text that varies. The kitchen part 9 is " You hear a noise behind you and spin around, but you can't see anything other than a stove. Now why would someone leave that there? The stove is conventional.[if there is something on the stove_0] On the stove you can make out [a list of things on the stove_0].[end if]".
...
The pantry part 0 is some text that varies. The pantry part 0 is "Of every pantry you could have shown up in, you had to walk into an usual one.
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You arrive in a bedroom. An ordinary kind of place. You decide to start listing off everything you see in the room, as if you were in a text adventure.
 ...
 You rest your hand against a wall, but you miss the wall and fall onto a bed. The bed is large.[if there is something on the s_9] On the bed you can make out [a list of things on the s_9].[end if]".
The bedroom part 1 is some text that varies. The bedroom part 1 is "[if there is nothing on the s_9] But the thing is empty. What, you think everything in TextWorld should have stuff on it?[end if]".
...
The corridor part 2 is some text that varies. The corridor part 2 is " patio door leading west. There is an exit to the east. You don't like doors? Why not try going south, that entranceway is not blocked by one.".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You've just sauntered into a backyard.
 ...
 You can make out a patio table. The patio table is stylish.[if there is something on the s_5] On the patio table you make out [a list of things on the s_5]. I mean, just wow! Isn't TextWorld just the best?[end if]".
...
The backyard part 3 is some text that varies. The backyard part 3 is "[if there is nothing on the s_8]Looks like someone's already been here and taken everything off it, though. Hopefully, this discovery doesn't ruin your TextWorld experience![end if]".
...
The shed part 0 is some text that varies. The shed part 0 is "You find yourself in a shed. A standard one. You start to take note of what's in the room.

 You can see a toolbox. Make a note of this, you might have to put stuff on or in it later on.[if c_1 is open and there is something in the c_1] The toolbox contains [a list of things in the c_1].[end if]".
...
The shed part 2 is some text that varies. The shed part 2 is " As if things weren't amazing enough already, you can even see a workbench. The workbench is wooden.[if there is something on the s_4] On the workbench you see [a list of things on the s_4]. You shudder, but continue examining the room.[end if]".
...
The livingroom part 0 is some text that varies. The livingroom part 0 is "A crooked placard tells you that you are now in the livingroom.
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "Guess what, you are in a place we're calling a bathroom. Let's see what's in here.
...
The garden part 0 is some text that varies. The garden part 0 is "Of every garden you could have shown up in, you had to come round a typical one. You start to take note of what's in the room.
...
The driveway part 0 is some text that varies. The driveway part 0 is "You arrive in a driveway. A typical one.
...
The r_0 and the r_1 and the r_11 and the r_10 and the r_3 and the r_4 and the r_6 and the r_7 and the r_2 and the r_5 and the r_8 and the r_9 are rooms.
The r_0 and the r_1 and the r_11 and the r_10 and the r_3 and the r_4 and the r_6 and the r_7 and the r_2 and the r_5 and the r_8 and the r_9 are privately-named.
...
Test quest7_0 with "inventory / examine cookbook / drop chicken wing / drop red potato / drop yellow bell pepper / open fridge / take carrot from fridge"
...
Test quest10_0 with "inventory / examine cookbook / drop chicken wing / drop red potato / drop yellow bell pepper / open fridge / take carrot from fridge / prepare meal"
...
Test quest11_0 with "inventory / examine cookbook / drop chicken wing / drop red potato / drop yellow bell pepper / open fridge / take carrot from fridge / prepare meal / eat meal"
...
This is the simpler notify score changes rule:
	...
	if quest7 completed is true and quest10 completed is true and quest11 completed is true:
