...
Test quest0_0 with "go south / take banana"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is how to play! Your first objective is to move south. If you can finish that, recover the banana from the floor of the parlor. Once that's all handled, you can stop!".
