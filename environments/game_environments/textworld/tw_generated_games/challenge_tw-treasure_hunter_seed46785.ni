...
The scullery part 0 is some text that varies. The scullery part 0 is "You are in a scullery. A normal one. Okay, just remember what you're here to do, and everything will go great.
...
Test quest0_0 with "go north / take fork"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another profound round of TextWorld! Here is how to play! First off, make an effort to head north. And then, pick-up the fork from the floor of the scullery. Once that's all handled, you ca".
