...
The kitchen part 2 is some text that varies. The kitchen part 2 is " You make out a counter. The counter is typical.[if there is something on the s_1] On the counter you see [a list of things on the s_1].[end if]".
...
The kitchen part 6 is some text that varies. The kitchen part 6 is " You can see a kitchen island. The kitchen island is standard.[if there is something on the s_3] On the kitchen island you see [a list of things on the s_3].[end if]".
...
The bedroom part 1 is some text that varies. The bedroom part 1 is " chest drawer is close by.[if c_0 is open and there is something in the c_0] The chest drawer contains [a list of things in the c_0].[end if]".
...
The bedroom part 3 is some text that varies. The bedroom part 3 is " What's that over there? It looks like it's an antique trunk. You check the price tag that's still affixed to the antique trunk. 15 bucks? What a deal! You'll have to ask where they got this![if c_1 is open and there is something in the c_1] The antique trunk contains [a list of things in the c_1].[end if]".
...
The bedroom part 5 is some text that varies. The bedroom part 5 is " Hey, want to see a king-size bed? Look over there, a king-size bed. [if there is something on the s_0]On the king-size bed you see [a list of things on the s_0], so there's that.[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "I just think it's awesome that you're in a backyard now.
 ...
 You make out a set of chairs. Wow, isn't TextWorld just the best? [if there is something on the s_10]You see [a list of things on the s_10] on the set of chairs. There's something strange about this being here, but you can't put your finger on it.[end if]".
The backyard part 1 is some text that varies. The backyard part 1 is "[if there is nothing on the s_10]But oh no! there's nothing on this piece of garbage. What, you think everything in TextWorld should have stuff on it?[end if]".
The backyard part 2 is some text that varies. The backyard part 2 is " As if things weren't amazing enough already, you can even see a bbq. [if there is something on the s_8]On the bbq you can make out [a list of things on the s_8].[end if]".
The backyard part 3 is some text that varies. The backyard part 3 is "[if there is nothing on the s_8]But the thing hasn't got anything on it. It would have been so cool if there was stuff on the bbq.[end if]".
The backyard part 4 is some text that varies. The backyard part 4 is " Oh wow! Is that what I think it is? It is! It's a patio table. The patio table is typical.[if there is something on the s_9] On the patio table you can see [a list of things on the s_9].[end if]".
The backyard part 5 is some text that varies. The backyard part 5 is "[if there is nothing on the s_9] The patio table appears to be empty. What's the point of an empty patio table?[end if]".
...
The living room part 2 is some text that varies. The living room part 2 is " You can make out a low table. The low table is ordinary.[if there is something on the s_6] On the low table you make out [a list of things on the s_6]. Something scurries by right in the corner of your eye. Probably nothing.[end if]".
...
The living room part 4 is some text that varies. The living room part 4 is " You see a tv. The tv is normal.[if there is something on the s_7] On the tv you can make out [a list of things on the s_7]. Now that's what I call TextWorld![end if]".
...
The bathroom part 1 is some text that varies. The bathroom part 1 is " toilet here.[if c_3 is open and there is something in the c_3] The toilet contains [a list of things in the c_3]. Now why would someone leave that there?[end if]".
...
The bathroom part 4 is some text that varies. The bathroom part 4 is " bath.[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4]. Wow, isn't TextWorld just the best?[end if]".
...
The s_9 is in r_4.
The description of f_0 is "that's an usual milk!".
The printed name of f_0 is "milk".
Understand "milk" as f_0.
The f_0 is edible.
The f_0 is in the c_2.
The description of f_1 is "The bell pepper looks appetizing.".
