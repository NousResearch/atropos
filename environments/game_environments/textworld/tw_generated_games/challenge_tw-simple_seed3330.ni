...
The kitchen part 2 is some text that varies. The kitchen part 2 is " Oh, great. Here's a counter. [if there is something on the s_1]You see [a list of things on the s_1] on the counter. Now that's what I call TextWorld![end if]".
...
The kitchen part 5 is some text that varies. The kitchen part 5 is "[if there is nothing on the s_2] Unfortunately, there isn't a thing on it. Sometimes, just sometimes, TextWorld can just be the worst.[end if]".
The kitchen part 6 is some text that varies. The kitchen part 6 is " Were you looking for a kitchen island? Because look over there, it's a kitchen island. The kitchen island is usual.[if there is something on the s_3] On the kitchen island you see [a list of things on the s_3].[end if]".
...
The bedroom part 6 is some text that varies. The bedroom part 6 is " You can make out a king-size bed. [if there is something on the s_0]On the king-size bed you can make out [a list of things on the s_0].[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " You can see a bbq. The bbq is ordinary.[if there is something on the s_8] On the bbq you see [a list of things on the s_8].[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " Were you looking for a patio table? Because look over there, it's a patio table. The patio table is standard.[if there is something on the s_9] On the patio table you can see [a list of things on the s_9].[end if]".
...
The living room part 3 is some text that varies. The living room part 3 is "[if there is nothing on the s_6]But the thing is empty. What, you think everything in TextWorld should have stuff on it?[end if]".
The living room part 4 is some text that varies. The living room part 4 is " You bend down to tie your shoe. When you stand up, you notice a tv. You shudder, but continue examining the tv. [if there is something on the s_7]On the tv you can see [a list of things on the s_7].[end if]".
...
The bathroom part 3 is some text that varies. The bathroom part 3 is " What's that over there? It looks like it's a bath.[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4].[end if]".
...
The description of f_1 is "The bell pepper looks tasty.".
