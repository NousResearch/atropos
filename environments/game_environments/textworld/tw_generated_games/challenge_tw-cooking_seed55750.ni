...
The r_0 and the r_2 and the r_1 and the r_3 and the r_6 and the r_7 and the r_8 and the r_4 and the r_5 are rooms.
...
The kitchen part 4 is some text that varies. The kitchen part 4 is " You hear a noise behind you and spin around, but you can't see anything other than a table. The table is massive.[if there is something on the s_0] On the table you can see [a list of things on the s_0].[end if]".
...
The kitchen part 8 is some text that varies. The kitchen part 8 is " Look out! It's a- oh, never mind, it's just a stove. Wow, isn't TextWorld just the best? [if there is something on the stove_0]You see [a list of things on the stove_0] on the stove.[end if]".
...
The corridor part 1 is some text that varies. The corridor part 1 is " patio door leading south. There is an exit to the east. Don't worry, there is no door. There is an exit to the north. Don't worry, there is no door. There is an exit to the west. Don't worry, there is no door.".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You've moved into a typical room. Your mind races to think of what kind of room would be typical. And then it hits you. Of course. You're in the backyard.

 What's that over there? It looks like it's a patio chair. The patio chair is stylish.[if there is something on the s_3] On the patio chair you can make out [a list of things on the s_3]. There's something strange about this being here, but you can't put your finger on it.[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " As if things weren't amazing enough already, you can even see a patio table. [if there is something on the s_8]On the patio table you can see [a list of things on the s_8].[end if]".
...
The shed part 3 is some text that varies. The shed part 3 is " You hear a noise behind you and spin around, but you can't see anything other than a workbench. Now why would someone leave that there? [if there is something on the s_6]You see [a list of things on the s_6] on the workbench. Now that's what I call TextWorld![end if]".
...
The bedroom part 1 is some text that varies. The bedroom part 1 is "[if there is nothing on the s_4]But the thing is empty, unfortunately. You make a mental note to not get your hopes up the next time you see a bed in a room.[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You're now in a bathroom. You begin to take stock of what's in the room.
 ...
 You can see a toilet. You wonder idly who left that here. [if there is something on the s_7]On the toilet you see [a list of things on the s_7]. Wow! Just like in the movies![end if]".
...
The r_0 and the r_2 and the r_1 and the r_3 and the r_6 and the r_7 and the r_8 and the r_4 and the r_5 are rooms.
The r_0 and the r_2 and the r_1 and the r_3 and the r_6 and the r_7 and the r_8 and the r_4 and the r_5 are privately-named.
