...
The lounge part 0 is some text that varies. The lounge part 0 is "Of every lounge you could have shown up in, you had to come round a standard one.
...
The kitchen part 0 is some text that varies. The kitchen part 0 is "Look at that notice! What does it say? It says Welcome to the kitchen? Well that's cool. You begin to take stock of what's in the room.
...
The f_0 is in r_2.
The description of o_0 is "The synthesizer is antiquated.".
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Retrieve the loaf of bread from the floor of the kitchen.".
