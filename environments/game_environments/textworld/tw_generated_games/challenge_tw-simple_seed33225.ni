...
The kitchen part 0 is some text that varies. The kitchen part 0 is "Guess what, you are in the place we're calling the kitchen.
 ...
 You can make out a refrigerator. I mean, just wow! Isn't TextWorld just the best?[if c_2 is open and there is something in the c_2] The refrigerator contains [a list of things in the c_2]. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[end if]".
...
The kitchen part 3 is some text that varies. The kitchen part 3 is "[if there is nothing on the s_1] But oh no! there's nothing on this piece of junk. You move on, clearly upset with TextWorld.[end if]".
The kitchen part 4 is some text that varies. The kitchen part 4 is " Were you looking for a stove? Because look over there, it's a stove. [if there is something on the s_2]You see [a list of things on the s_2] on the stove.[end if]".
The kitchen part 5 is some text that varies. The kitchen part 5 is "[if there is nothing on the s_2]But the thing is empty. It would have been so cool if there was stuff on the stove.[end if]".
The kitchen part 6 is some text that varies. The kitchen part 6 is " You can make out a kitchen island. [if there is something on the s_3]You see [a list of things on the s_3] on the kitchen island. Now that's what I call TextWorld![end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You arrive in a bedroom. A typical kind of place.
 ...
 You see a chest drawer. Something scurries by right in the corner of your eye. Probably nothing.[if c_0 is open and there is something in the c_0] The chest drawer contains [a list of things in the c_0].[end if]".
...
The bedroom part 5 is some text that varies. The bedroom part 5 is " You make out a king-size bed. The king-size bed is standard.[if there is something on the s_0] On the king-size bed you see [a list of things on the s_0].[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You've entered a backyard.
 ...
 You scan the room for a set of chairs, and you find a set of chairs. [if there is something on the s_10]On the set of chairs you can make out [a list of things on the s_10].[end if]".
The backyard part 1 is some text that varies. The backyard part 1 is "[if there is nothing on the s_10]But the thing is empty. You move on, clearly infuriated by TextWorld.[end if]".
The backyard part 2 is some text that varies. The backyard part 2 is " You can make out a bbq. The bbq is usual.[if there is something on the s_8] On the bbq you see [a list of things on the s_8].[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You're now in the living room.
 ...
 You see a couch. Make a note of this, you might have to put stuff on or in it later on. The couch is typical.[if there is something on the s_5] On the couch you make out [a list of things on the s_5].[end if]".
The living room part 1 is some text that varies. The living room part 1 is "[if there is nothing on the s_5] But oh no! there's nothing on this piece of garbage. What, you think everything in TextWorld should have stuff on it?[end if]".
The living room part 2 is some text that varies. The living room part 2 is " Hey, want to see a low table? Look over there, a low table. [if there is something on the s_6]You see [a list of things on the s_6] on the low table, so there's that.[end if]".
...
The living room part 4 is some text that varies. The living room part 4 is " You can make out a tv. The tv is typical.[if there is something on the s_7] On the tv you can make out [a list of things on the s_7].[end if]".
...
The bathroom part 6 is some text that varies. The bathroom part 6 is "[if there is nothing on the s_4]But there isn't a thing on it. Oh! Why couldn't there just be stuff on it?[end if]".
...
The description of d_0 is "it's a hefty wooden door [if open]You can see inside it.[else if closed]You can't see inside it because the lid's in your way.[otherwise]There is a lock on it.[end if]".
...
The c_4 is in r_3.
The c_4 is closed.
The description of f_3 is "The apple looks savory.".
The printed name of f_3 is "apple".
Understand "apple" as f_3.
The f_3 is in r_5.
The f_3 is edible.
The description of f_4 is "The tomato plant looks delectable.".
...
The f_4 is in r_5.
The f_4 is edible.
The description of f_5 is "The half of a bag of chips looks tantalizing.".
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is your task for today. First of all, ensure that the antique trunk within the bedroom is open. And then, take the old key from the antique trunk inside the bedroom. After s".
The objective part 1 is some text that varies. The objective part 1 is "tealing the old key, unlock the wooden door in the bedroom. Then, doublecheck that the wooden door in the bedroom is opened. And then, make an attempt to go east. Then, ensure that the screen door in ".
The objective part 2 is some text that varies. The objective part 2 is "the kitchen is open. After pulling open the screen door, take a trip east. Then, try to move south. Once you get around to doing that, lift the apple from the floor of the garden. And then, make an at".
The objective part 3 is some text that varies. The objective part 3 is "tempt to venture north. After that, try to go to the west. And then, put the apple on the stove within the kitchen. And once you've done that, you win!".
