...
The kitchen part 0 is some text that varies. The kitchen part 0 is "You arrive in a kitchen. A typical kind of place.
 ...
 You hear a noise behind you and spin around, but you can't see anything other than a refrigerator. Make a note of this, you might have to put stuff on or in it later on.[if c_2 is open and there is something in the c_2] The refrigerator contains [a list of things in the c_2].[end if]".
...
The kitchen part 4 is some text that varies. The kitchen part 4 is " You can see a stove. The stove is standard.[if there is something on the s_2] On the stove you make out [a list of things on the s_2]. There's something strange about this being here, but you can't put your finger on it.[end if]".
...
The bedroom part 1 is some text that varies. The bedroom part 1 is " usual looking chest drawer nearby.[if c_0 is open and there is something in the c_0] The chest drawer contains [a list of things in the c_0].[end if]".
...
The bedroom part 6 is some text that varies. The bedroom part 6 is " You make out a king-size bed. [if there is something on the s_0]You see [a list of things on the s_0] on the king-size bed. Classic TextWorld.[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " Oh wow! Is that what I think it is? It is! It's a bbq. The bbq is usual.[if there is something on the s_8] On the bbq you make out [a list of things on the s_8]. Hmmm... what else, what else?[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You make a grand eccentric entrance into a living room.
...
The living room part 4 is some text that varies. The living room part 4 is " You see a tv. The tv is usual.[if there is something on the s_7] On the tv you make out [a list of things on the s_7], so there's that.[end if]".
...
The bathroom part 3 is some text that varies. The bathroom part 3 is " You can see a bath. I mean, just wow! Isn't TextWorld just the best?[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4]. Huh, weird.[end if]".
...
The bathroom part 5 is some text that varies. The bathroom part 5 is " You smell a great smell, and follow it to a sink. The sink is normal.[if there is something on the s_4] On the sink you can make out [a list of things on the s_4]. Huh, weird.[end if]".
