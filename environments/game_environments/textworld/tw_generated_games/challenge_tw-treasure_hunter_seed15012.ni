...
The canteen part 0 is some text that varies. The canteen part 0 is "Guess what, you are in a place we're calling a canteen. You begin to take stock of what's in the room.
...
The studio part 0 is some text that varies. The studio part 0 is "Ah, the studio. This is some kind of studio, really great typical vibes in this place, a wonderful typical atmosphere. And now, well, you're in it. You begin to take stock of what's here.
...
The objective part 0 is some text that varies. The objective part 0 is "Your objective is to pick up the latchkey from the floor of the cookhouse.".
