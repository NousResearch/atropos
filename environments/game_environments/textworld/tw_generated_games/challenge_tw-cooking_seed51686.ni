...
The kitchen part 0 is some text that varies. The kitchen part 0 is "Well, here we are in a kitchen.
 ...
 You scan the room, seeing a fridge. Something scurries by right in the corner of your eye. Probably nothing.[if c_0 is open and there is something in the c_0] The fridge contains [a list of things in the c_0].[end if]".
...
The kitchen part 9 is some text that varies. The kitchen part 9 is " You smell an awful smell, and follow it to a stove. The stove is conventional.[if there is something on the stove_0] On the stove you see [a list of things on the stove_0]. Hmmm... what else, what else?[end if]".
...
The f_1 and the f_11 and the f_12 and the f_0 and the f_10 and the f_2 and the f_3 and the f_4 and the f_5 and the f_6 and the f_8 and the f_9 and the f_7 are foods.
The f_1 and the f_11 and the f_12 and the f_0 and the f_10 and the f_2 and the f_3 and the f_4 and the f_5 and the f_6 and the f_8 and the f_9 and the f_7 are privately-named.
...
The printed name of f_12 is "cilantro".
Understand "cilantro" as f_12.
...
The printed name of f_9 is "water".
The indefinite article of f_9 is "some".
Understand "water" as f_9.
The f_9 is drinkable.
