...
The room_1 part 0 is some text that varies. The room_1 part 0 is "You're now in a room_1.
...
The room_0 part 0 is some text that varies. The room_0 part 0 is "You find yourself in a room_0. A typical one.
...
The room_8 part 0 is some text that varies. The room_8 part 0 is "You are in a room_8. A typical one. You start to take note of what's in the room.
...
The room_6 part 0 is some text that varies. The room_6 part 0 is "You've just sauntered into a room_6.
...
The room_9 part 0 is some text that varies. The room_9 part 0 is "You find yourself in a room_9.
...
The side_room_6 part 0 is some text that varies. The side_room_6 part 0 is "You find yourself in a side_room_6. A normal kind of place. You begin to take stock of what's in the room.
...
The room_10 part 0 is some text that varies. The room_10 part 0 is "You are in a room_10. A typical kind of place. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The room_7 part 0 is some text that varies. The room_7 part 0 is "This might come as a shock to you, but you've just stumbled into a room_7. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The room_11 part 0 is some text that varies. The room_11 part 0 is "You find yourself in a room_11. A typical kind of place.

 You see an ancient altar. The ancient altar is ordinary.[if there is something on the s_0] On the ancient altar you can see [a list of things on the s_0], so there's that.[end if]".
The room_11 part 1 is some text that varies. The room_11 part 1 is "[if there is nothing on the s_0] But the thing hasn't got anything on it.[end if]".
...
The room_2 part 0 is some text that varies. The room_2 part 0 is "You've just shown up in a room_2.
...
The room_3 part 0 is some text that varies. The room_3 part 0 is "You arrive in a room_3. A normal kind of place. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.



 There is [if d_2 is open]an open[otherwise]a closed[end if]".
The room_3 part 1 is some text that varies. The room_3 part 1 is " green door leading west. You need an unblocked exit? You should try going east. There is an exit to the north. Don't worry, it is unblocked.".
...
The room_4 part 0 is some text that varies. The room_4 part 0 is "You are in a room_4. An usual kind of place.
...
The room_5 part 0 is some text that varies. The room_5 part 0 is "You're now in the room_5.
...
The side_room_3 part 0 is some text that varies. The side_room_3 part 0 is "You are in a side_room_3. A normal kind of place.
...
The side_room_9 part 0 is some text that varies. The side_room_9 part 0 is "You find yourself in a side_room_9. An usual one.
...
The o_0 and the o_1 and the o_2 and the o_3 and the o_7 and the o_4 and the o_5 and the o_6 and the o_8 and the o_9 are object-likes.
The o_0 and the o_1 and the o_2 and the o_3 and the o_7 and the o_4 and the o_5 and the o_6 and the o_8 and the o_9 are privately-named.
The r_1 and the r_0 and the r_10 and the r_7 and the r_11 and the r_8 and the r_13 and the r_9 and the r_14 and the r_2 and the r_3 and the r_5 and the r_6 and the r_4 and the r_12 are rooms.
...
The description of d_0 is "it's a solid red door [if open]You can see inside it.[else if closed]You can't see inside it because the lid's in your way.[otherwise]There is a lock on it.[end if]".
The printed name of d_0 is "red door".
Understand "red door" as d_0.
Understand "red" as d_0.
Understand "door" as d_0.
The d_0 is locked.
The description of d_1 is "it is what it is, a blue door [if open]You can see inside it.[else if closed]You can't see inside it because the lid's in your way.[otherwise]There is a lock on it.[end if]".
...
The c_2 is in r_5.
The c_2 is closed.
The description of f_3 is "that's a standard durian!".
The printed name of f_3 is "durian".
Understand "durian" as f_3.
The f_3 is in r_12.
The f_3 is edible.
The description of k_0 is "The metal of the red crystal is rusty.".
...
The description of k_2 is "The metal of the green crystal is satin.".
...
The description of o_0 is "The ancient scroll is expensive looking.".
...
The o_0 is in r_1.
The description of o_1 is "The mystic orb would seem to be to fit in here".
The printed name of o_1 is "mystic orb".
Understand "mystic orb" as o_1.
Understand "mystic" as o_1.
Understand "orb" as o_1.
The o_1 is in r_2.
The description of o_2 is "The golden chalice is unremarkable.".
...
The o_2 is in r_3.
The description of o_3 is "The broom is brand new.".
The printed name of o_3 is "broom".
Understand "broom" as o_3.
The o_3 is in r_1.
The description of o_7 is "The worm looks well matched to everything else here".
...
The description of o_4 is "The cane would seem to be well matched to everything else here".
The printed name of o_4 is "cane".
Understand "cane" as o_4.
The player carries the o_4.
The description of o_5 is "The shoe is unremarkable.".
The printed name of o_5 is "shoe".
Understand "shoe" as o_5.
The player carries the o_5.
The description of o_6 is "The sock is dirty.".
The printed name of o_6 is "sock".
Understand "sock" as o_6.
The player carries the o_6.
The description of o_8 is "The soap dispenser appears to be well matched to everything else here".
...
The description of o_9 is "The controller is cheap looking.".
The printed name of o_9 is "controller".
Understand "controller" as o_9.
