...
The r_0 and the r_6 and the r_1 and the r_4 and the r_3 and the r_2 and the r_5 and the r_7 and the r_8 are rooms.
...
The kitchen part 3 is some text that varies. The kitchen part 3 is " oven in the corner.[if oven_0 is open and there is something in the oven_0] The oven contains [a list of things in the oven_0]. There's something strange about this thing being here, but you don't have time to worry about that now.[end if]".
...
The kitchen part 5 is some text that varies. The kitchen part 5 is " You make out a table. What a coincidence, weren't you just thinking about a table? The table is massive.[if there is something on the s_0] On the table you can see [a list of things on the s_0].[end if]".
...
The kitchen part 7 is some text that varies. The kitchen part 7 is " Hey, want to see a counter? Look over there, a counter. [if there is something on the s_1]On the counter you make out [a list of things on the s_1].[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You arrive in a backyard. An ordinary one.
 ...
 You can make out a patio table. Wow, isn't TextWorld just the best? [if there is something on the s_4]You see [a list of things on the s_4] on the patio table.[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " You bend down to tie your shoe. When you stand up, you notice a patio chair. [if there is something on the s_5]You see [a list of things on the s_5] on the patio chair.[end if]".
...
The livingroom part 0 is some text that varies. The livingroom part 0 is "You are in a livingroom. A typical one.
 ...
 You rest your hand against a wall, but you miss the wall and fall onto a sofa. The sofa is comfy.[if there is something on the s_6] On the sofa you see [a list of things on the s_6].[end if]".
The livingroom part 1 is some text that varies. The livingroom part 1 is "[if there is nothing on the s_6] But oh no! there's nothing on this piece of trash. Oh! Why couldn't there just be stuff on it?[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You arrive in a bathroom. An usual one.
 ...
 You see a toilet. Does this look like anything mentioned in the instructions? [if there is something on the s_3]On the toilet you can make out [a list of things on the s_3].[end if]".
...
The shed part 0 is some text that varies. The shed part 0 is "You arrive in a shed. An usual one. The room is well lit.
...
The shed part 2 is some text that varies. The shed part 2 is " You see a workbench. [if there is something on the s_8]On the workbench you see [a list of things on the s_8]. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[end if]".
...
The r_0 and the r_6 and the r_1 and the r_4 and the r_3 and the r_2 and the r_5 and the r_7 and the r_8 are rooms.
The r_0 and the r_6 and the r_1 and the r_4 and the r_3 and the r_2 and the r_5 and the r_7 and the r_8 are privately-named.
...
Test quest1_0 with "inventory / go south / go west / examine cookbook / examine cookbook / go west / go south / take red onion"
...
Test quest4_0 with "inventory / go south / go west / examine cookbook / examine cookbook / go west / go south / take red onion / go north / go north / go east / prepare meal"
...
Test quest5_0 with "inventory / go south / go west / examine cookbook / examine cookbook / go west / go south / take red onion / go north / go north / go east / prepare meal / eat meal"
