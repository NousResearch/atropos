...
The kitchenette part 0 is some text that varies. The kitchenette part 0 is "I just think it's great that you've just entered a kitchenette. You begin looking for stuff.
...
The cubicle part 0 is some text that varies. The cubicle part 0 is "You find yourself in a normal kind of place. That is to say, you're in a cubicle.
...
The office part 0 is some text that varies. The office part 0 is "You've seen better offices, but at least this one seems pretty standard.
...
The description of o_0 is "The napkin looks well matched to everything else here".
...
Test quest0_0 with "go south / go east / take napkin"
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! Here is how to play! First stop, go to the south. With that over with, go east. And then, lift th".
The objective part 1 is some text that varies. The objective part 1 is "e napkin from the floor of the cookery. Got that? Good!".
