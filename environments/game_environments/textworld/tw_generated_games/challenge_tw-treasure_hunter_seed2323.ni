...
You don't like doors? Why not try going east, that entranceway is unblocked. There is an exit to the north. Don't worry, it is unblocked. You don't like doors? Why not try going south, that entranceway is unblocked.".
...
The steam room part 0 is some text that varies. The steam room part 0 is "You arrive in a steam room. An ordinary kind of place. You try to gain information on your surroundings by using a technique you call 'looking.'
...
Test quest0_0 with "go south / go west / take stick of butter"
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an exciting round of TextWorld? You do! First stop, attempt to take a trip south. And then, venture west. After that, pick-up the stick of butt".
The objective part 1 is some text that varies. The objective part 1 is "er from the floor of the study. Once that's all handled, you can stop!".
