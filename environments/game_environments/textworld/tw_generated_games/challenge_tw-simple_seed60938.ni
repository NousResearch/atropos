...
The kitchen part 4 is some text that varies. The kitchen part 4 is " You can see a stove. The stove is standard.[if there is something on the s_2] On the stove you can see [a list of things on the s_2].[end if]".
The kitchen part 5 is some text that varies. The kitchen part 5 is "[if there is nothing on the s_2] However, the stove, like an empty stove, has nothing on it. This always happens, here in TextWorld![end if]".
The kitchen part 6 is some text that varies. The kitchen part 6 is " You hear a noise behind you and spin around, but you can't see anything other than a kitchen island. You can't really describe the kitchen island besides that it's standard. [if there is something on the s_3]On the kitchen island you see [a list of things on the s_3].[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You are in a bedroom. An ordinary one. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.

 You see [if c_0 is locked]a locked[else if c_0 is open]an opened[otherwise]a closed[end if]".
The bedroom part 1 is some text that varies. The bedroom part 1 is " chest drawer, which looks ordinary, in the corner.[if c_0 is open and there is something in the c_0] The chest drawer contains [a list of things in the c_0].[end if]".
...
The bedroom part 3 is some text that varies. The bedroom part 3 is " You make out an antique trunk. Hmmm... what else, what else?[if c_1 is open and there is something in the c_1] The antique trunk contains [a list of things in the c_1].[end if]".
...
The bedroom part 5 is some text that varies. The bedroom part 5 is " You can see a king-size bed. Make a note of this, you might have to put stuff on or in it later on. [if there is something on the s_0]You see [a list of things on the s_0] on the king-size bed.[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " You lean against the wall, inadvertently pressing a secret button. The wall opens up to reveal a bbq. [if there is something on the s_8]You see [a list of things on the s_8] on the bbq. Classic TextWorld.[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " You see a patio table. The patio table is standard.[if there is something on the s_9] On the patio table you make out [a list of things on the s_9].[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You've entered a living room. You start to take note of what's in the room.

 You make out a couch. The couch is ordinary.[if there is something on the s_5] On the couch you see [a list of things on the s_5]. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[end if]".
The living room part 1 is some text that varies. The living room part 1 is "[if there is nothing on the s_5] But the thing is empty. It would have been so cool if there was stuff on the couch.[end if]".
The living room part 2 is some text that varies. The living room part 2 is " Oh, great. Here's a low table. [if there is something on the s_6]On the low table you see [a list of things on the s_6].[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You are in a bathroom. A typical kind of place.
 ...
 You rest your hand against a wall, but you miss the wall and fall onto a toilet.[if c_3 is open and there is something in the c_3] The toilet contains [a list of things in the c_3].[end if]".
...
The bathroom part 2 is some text that varies. The bathroom part 2 is " You see a bath. Wow, check out the price tag that the bath's owner still hasn't taken off! Eighty big ones![if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4].[end if]".
...
The bathroom part 4 is some text that varies. The bathroom part 4 is " If you haven't noticed it already, there seems to be something there by the wall, it's a sink. [if there is something on the s_4]On the sink you can see [a list of things on the s_4]. Classic TextWorld.[end if]".
...
The description of d_0 is "it's a robust wooden door [if open]It is open.[else if closed]It is closed.[otherwise]It is locked.[end if]".
The printed name of d_0 is "wooden door".
Understand "wooden door" as d_0.
Understand "wooden" as d_0.
Understand "door" as d_0.
The d_0 is locked.
The description of d_1 is "it's a robust screen door [if open]It is open.[else if closed]It is closed.[otherwise]It is locked.[end if]".
...
The f_3 is in r_5.
The f_3 is edible.
The description of f_4 is "that's a normal bell pepper!".
...
The description of f_1 is "The lettuce looks tantalizing.".
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is your task for today. Your first objective is to ensure that the antique trunk is open. After that, take the old key from the antique trunk. And then, check that the woode".
The objective part 1 is some text that varies. The objective part 1 is "n door inside the bedroom is unlocked with the old key. And then, open the wooden door inside the bedroom. And then, make an effort to venture east. Next, open the screen door within the kitchen. And ".
The objective part 2 is some text that varies. The objective part 2 is "then, make an attempt to take a trip east. After that, make an effort to head south. And then, pick-up the bell pepper from the floor of the garden. After that, make an effort to venture north. And th".
The objective part 3 is some text that varies. The objective part 3 is "en, make an effort to go to the west. With that accomplished, sit the bell pepper on the stove. And if you do that, you're the winner!".
