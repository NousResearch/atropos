...
The kitchen part 0 is some text that varies. The kitchen part 0 is "Welcome to the kitchen. The room is well lit.
...
The kitchen part 2 is some text that varies. The kitchen part 2 is " You smell a sickening smell, and follow it to a counter. The counter is typical.[if there is something on the s_1] On the counter you make out [a list of things on the s_1].[end if]".
...
The kitchen part 4 is some text that varies. The kitchen part 4 is " You rest your hand against a wall, but you miss the wall and fall onto a stove. Make a note of this, you might have to put stuff on or in it later on. The stove is ordinary.[if there is something on the s_2] On the stove you make out [a list of things on the s_2].[end if]".
The kitchen part 5 is some text that varies. The kitchen part 5 is "[if there is nothing on the s_2] But the thing is empty. You move on, clearly done caring about TextWorld.[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You find yourself in a bedroom. A typical kind of place. You begin to take stock of what's here.
...
The bedroom part 4 is some text that varies. The bedroom part 4 is " You can make out a king-size bed. Now why would someone leave that there? [if there is something on the s_0]On the king-size bed you can see [a list of things on the s_0].[end if]".
The bedroom part 5 is some text that varies. The bedroom part 5 is "[if there is nothing on the s_0]But there isn't a thing on it. Hm. Oh well[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " Hey, want to see a bbq? Look over there, a bbq. The bbq is normal.[if there is something on the s_8] On the bbq you can make out [a list of things on the s_8].[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " You see a patio table. The patio table is ordinary.[if there is something on the s_9] On the patio table you see [a list of things on the s_9].[end if]".
The backyard part 5 is some text that varies. The backyard part 5 is "[if there is nothing on the s_9] However, the patio table, like an empty patio table, has nothing on it. What's the point of an empty patio table?[end if]".
...
The living room part 2 is some text that varies. The living room part 2 is " You see a low table. Why don't you take a picture of it, it'll last longer! The low table is standard.[if there is something on the s_6] On the low table you make out [a list of things on the s_6].[end if]".
...
The living room part 4 is some text that varies. The living room part 4 is " What's that over there? It looks like it's a tv. The tv is usual.[if there is something on the s_7] On the tv you can see [a list of things on the s_7].[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You've come into a typical room. Your mind races to think of what kind of room would be typical. And then it hits you. Of course. You're in the bathroom.
...
The bathroom part 4 is some text that varies. The bathroom part 4 is " bath, which looks typical, here.[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4].[end if]".
...
The description of f_2 is "The tomato plant looks delectable.".
