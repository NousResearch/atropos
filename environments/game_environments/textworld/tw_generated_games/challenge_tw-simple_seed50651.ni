...
The kitchen part 0 is some text that varies. The kitchen part 0 is "You are in a kitchen. A standard kind of place.
 ...
 You make out a refrigerator. Suddenly, you bump your head on the ceiling, but it's not such a bad bump that it's going to prevent you from looking at objects and even things.[if c_2 is open and there is something in the c_2] The refrigerator contains [a list of things in the c_2].[end if]".
...
The kitchen part 6 is some text that varies. The kitchen part 6 is " You make out a kitchen island. The kitchen island is typical.[if there is something on the s_3] On the kitchen island you make out [a list of things on the s_3].[end if]".
...
The bedroom part 2 is some text that varies. The bedroom part 2 is " Look out! It's a- oh, never mind, it's just an antique trunk. I mean, just wow! Isn't TextWorld just the best?[if c_1 is open and there is something in the c_1] The antique trunk contains [a list of things in the c_1].[end if]".
...
The bedroom part 4 is some text that varies. The bedroom part 4 is " You see a king-size bed. The king-size bed is ordinary.[if there is something on the s_0] On the king-size bed you can see [a list of things on the s_0].[end if]".
The bedroom part 5 is some text that varies. The bedroom part 5 is "[if there is nothing on the s_0] But the thing is empty. Hm. Oh well[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You're now in a backyard. You decide to just list off a complete list of everything you see in the room, because hey, why not?

 You can see a set of chairs. The set of chairs is ordinary.[if there is something on the s_10] On the set of chairs you can see [a list of things on the s_10].[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " You scan the room, seeing a patio table. Now why would someone leave that there? [if there is something on the s_9]You see [a list of things on the s_9] on the patio table.[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You're not going to believe this, but you've just entered a living room.

 You lean against the wall, inadvertently pressing a secret button. The wall opens up to reveal a couch! [if there is something on the s_5]You see [a list of things on the s_5] on the couch.[end if]".
...
The living room part 2 is some text that varies. The living room part 2 is " Oh, great. Here's a low table. [if there is something on the s_6]On the low table you see [a list of things on the s_6]. There's something strange about this thing being here, but you don't have time to worry about that now.[end if]".
...
The living room part 4 is some text that varies. The living room part 4 is " Hey, want to see a tv? Look over there, a tv. The tv is standard.[if there is something on the s_7] On the tv you see [a list of things on the s_7]. There's something strange about this being here, but you can't put your finger on it.[end if]".
...
The bathroom part 1 is some text that varies. The bathroom part 1 is " toilet is here.[if c_3 is open and there is something in the c_3] The toilet contains [a list of things in the c_3].[end if]".
...
The bathroom part 3 is some text that varies. The bathroom part 3 is " You smell an awful smell, and follow it to a bath.[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4]. Wow, isn't TextWorld just the best?[end if]".
...
The bathroom part 5 is some text that varies. The bathroom part 5 is " Look out! It's a- oh, never mind, it's just a sink. [if there is something on the s_4]On the sink you can make out [a list of things on the s_4]. Suddenly, you bump your head on the ceiling, but it's not such a bad bump that it's going to prevent you from looking at objects and even things.[end if]".
The bathroom part 6 is some text that varies. The bathroom part 6 is "[if there is nothing on the s_4]But the thing hasn't got anything on it. What's the point of an empty sink?[end if]".
...
The garden part 0 is some text that varies. The garden part 0 is "Well, here we are in the garden. Let's see what's in here.
...
The s_9 is in r_4.
The description of f_0 is "that's a typical lettuce!".
The printed name of f_0 is "lettuce".
Understand "lettuce" as f_0.
The f_0 is edible.
The f_0 is in the c_2.
The description of f_1 is "The half of a bag of chips looks delicious.".
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a exciting game of TextWorld! Here is how to play! First stop, open the antique trunk. And then, retrieve the old key from the antique trunk. If you can get your hands on the old k".
The objective part 1 is some text that varies. The objective part 1 is "ey, unlock the wooden door. And then, make it so that the wooden door inside the bedroom is wide open. Then, make an effort to go east. Following that, ensure that the screen door inside the kitchen i".
The objective part 2 is some text that varies. The objective part 2 is "s open. And then, attempt to head east. Once you succeed at that, move south. Then, retrieve the bell pepper from the floor of the garden. After that, make an attempt to go north. And then, venture we".
The objective part 3 is some text that varies. The objective part 3 is "st. And then, place the bell pepper on the stove. And once you've done that, you win!".
