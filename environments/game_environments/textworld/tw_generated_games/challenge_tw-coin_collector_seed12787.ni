...
The study part 0 is some text that varies. The study part 0 is "Look at you, bigshot, walking into a study like it isn't some huge deal. Let's see what's in here.
...
Test quest0_0 with "go west / go north / go west / go south / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Here is how to play! First, it would be a great idea if you could make an attempt to go to the west. After that, attempt to venture north. Then, ve".
The objective part 1 is some text that varies. The objective part 1 is "nture west. Once you finish that, travel south. After that, pick-up the coin from the floor of the kitchen. And once you've done that, you win!".
