...
The parlor part 0 is some text that varies. The parlor part 0 is "You are in a parlor. A standard kind of place. You begin to take stock of what's in the room.
...
The kitchenette part 0 is some text that varies. The kitchenette part 0 is "You are in a kitchenette. A standard one. You start to take note of what's in the room.
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is how to play! First of all, go to the east. After that, go south. That done, pick-up the cashew from the floor of the parlor. And once you've done that, you win!".
