...
The kitchen part 2 is some text that varies. The kitchen part 2 is " You hear a noise behind you and spin around, but you can't see anything other than a counter. [if there is something on the s_1]You see [a list of things on the s_1] on the counter.[end if]".
...
The kitchen part 4 is some text that varies. The kitchen part 4 is " You make out a stove. The stove is typical.[if there is something on the s_2] On the stove you make out [a list of things on the s_2].[end if]".
...
The kitchen part 6 is some text that varies. The kitchen part 6 is " You see a kitchen island. The kitchen island is typical.[if there is something on the s_3] On the kitchen island you can see [a list of things on the s_3].[end if]".
...
The bedroom part 4 is some text that varies. The bedroom part 4 is " antique trunk here.[if c_1 is open and there is something in the c_1] The antique trunk contains [a list of things in the c_1]. You wonder idly who left that here.[end if]".
...
The bedroom part 6 is some text that varies. The bedroom part 6 is " You lean against the wall, inadvertently pressing a secret button. The wall opens up to reveal a king-size bed. The king-size bed is usual.[if there is something on the s_0] On the king-size bed you can see [a list of things on the s_0].[end if]".
The bedroom part 7 is some text that varies. The bedroom part 7 is "[if there is nothing on the s_0] However, the king-size bed, like an empty king-size bed, has nothing on it.[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You find yourself in a backyard.
 ...
 You hear a noise behind you and spin around, but you can't see anything other than a set of chairs. The set of chairs is standard.[if there is something on the s_10] On the set of chairs you can make out [a list of things on the s_10].[end if]".
The backyard part 1 is some text that varies. The backyard part 1 is "[if there is nothing on the s_10] But there isn't a thing on it. It would have been so cool if there was stuff on the set of chairs! oh well.[end if]".
The backyard part 2 is some text that varies. The backyard part 2 is " You make out a bbq. Wow, isn't TextWorld just the best? The bbq is normal.[if there is something on the s_8] On the bbq you make out [a list of things on the s_8].[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " You can see a patio table. [if there is something on the s_9]You see [a list of things on the s_9] on the patio table. Hmmm... what else, what else?[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "Guess what, you are in the place we're calling the living room.

 You can make out a couch. What a coincidence, weren't you just thinking about a couch? The couch is typical.[if there is something on the s_5] On the couch you see [a list of things on the s_5].[end if]".
...
The living room part 3 is some text that varies. The living room part 3 is "[if there is nothing on the s_6] But oh no! there's nothing on this piece of garbage. Hm. Oh well[end if]".
The living room part 4 is some text that varies. The living room part 4 is " Hey, want to see a tv? Look over there, a tv. What a coincidence, weren't you just thinking about a tv? The tv is usual.[if there is something on the s_7] On the tv you make out [a list of things on the s_7].[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "Look at you, bigshot, walking into a bathroom like it isn't some huge deal. You decide to start listing off everything you see in the room, as if you were in a text adventure.

 You make out [if c_3 is locked]a locked[else if c_3 is open]an opened[otherwise]a closed[end if]".
The bathroom part 1 is some text that varies. The bathroom part 1 is " toilet, which looks standard, in the corner.[if c_3 is open and there is something in the c_3] The toilet contains [a list of things in the c_3].[end if]".
...
The bathroom part 4 is some text that varies. The bathroom part 4 is " bath close by.[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4]. Something scurries by right in the corner of your eye. Probably nothing.[end if]".
...
The bathroom part 6 is some text that varies. The bathroom part 6 is " What's that over there? It looks like it's a sink. [if there is something on the s_4]You see [a list of things on the s_4] on the sink.[end if]".
...
The garden part 0 is some text that varies. The garden part 0 is "I am so happy to announce that you are now in the garden.
...
The c_4 is in r_3.
The c_4 is closed.
The description of f_3 is "The bell pepper looks savory.".
