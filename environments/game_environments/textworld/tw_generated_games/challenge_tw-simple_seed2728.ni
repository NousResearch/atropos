...
The kitchen part 7 is some text that varies. The kitchen part 7 is " You smell an intriguing smell, and follow it to a kitchen island. [if there is something on the s_3]You see [a list of things on the s_3] on the kitchen island.[end if]".
...
The kitchen part 11 is some text that varies. The kitchen part 11 is " wooden door leading west. You need an unguarded exit? You should try going north. There is an exit to the south. Don't worry, it is unguarded.".
...
The bedroom part 5 is some text that varies. The bedroom part 5 is " You can see a king-size bed. The king-size bed is ordinary.[if there is something on the s_0] On the king-size bed you make out [a list of things on the s_0].[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "Of every living room you could have sauntered into, you had to come round a normal one.

 You scan the room for a couch, and you find a couch. The couch is standard.[if there is something on the s_5] On the couch you make out [a list of things on the s_5].[end if]".
...
The living room part 2 is some text that varies. The living room part 2 is " You make out a low table. Wow, isn't TextWorld just the best? The low table is ordinary.[if there is something on the s_6] On the low table you can make out [a list of things on the s_6]. It doesn't get more TextWorld than this![end if]".
...
The living room part 4 is some text that varies. The living room part 4 is " You see a tv. The tv is ordinary.[if there is something on the s_7] On the tv you can make out [a list of things on the s_7]. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[end if]".
The living room part 5 is some text that varies. The living room part 5 is "[if there is nothing on the s_7] However, the tv, like an empty tv, has nothing on it. Aw, here you were, all excited for there to be things on it![end if]".
...
The bathroom part 1 is some text that varies. The bathroom part 1 is " ordinary looking toilet in the room.[if c_3 is open and there is something in the c_3] The toilet contains [a list of things in the c_3]. Now why would someone leave that there?[end if]".
...
The bathroom part 4 is some text that varies. The bathroom part 4 is " bath, which looks typical, right there by you.[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4]. Classic TextWorld.[end if]".
...
The bathroom part 6 is some text that varies. The bathroom part 6 is " You make out a sink. [if there is something on the s_4]You see [a list of things on the s_4] on the sink. It doesn't get more TextWorld than this![end if]".
The bathroom part 7 is some text that varies. The bathroom part 7 is "[if there is nothing on the s_4]Unfortunately, there isn't a thing on it. Hm. Oh well[end if]".
...
The c_4 is in r_3.
The c_4 is closed.
The description of f_3 is "The lettuce looks tantalizing.".
