...
The kitchen part 1 is some text that varies. The kitchen part 1 is " fridge here.[if c_0 is open and there is something in the c_0] The fridge contains [a list of things in the c_0]. There's something strange about this thing being here, but you don't have time to worry about that now.[end if]".
...
The kitchen part 4 is some text that varies. The kitchen part 4 is " oven, which looks conventional, nearby.[if oven_0 is open and there is something in the oven_0] The oven contains [a list of things in the oven_0]. Now why would someone leave that there?[end if]".
...
The kitchen part 6 is some text that varies. The kitchen part 6 is " You scan the room, seeing a table. The table is massive.[if there is something on the s_0] On the table you make out [a list of things on the s_0].[end if]".
...
The pantry part 0 is some text that varies. The pantry part 0 is "You arrive in a pantry. An usual kind of place.
 ...
 You see a shelf. Wow, isn't TextWorld just the best? [if there is something on the s_2]On the shelf you make out [a list of things on the s_2]. I mean, just wow! Isn't TextWorld just the best?[end if]".
...
There is an exit to the north. Don't worry, there is no door. You don't like doors? Why not try going south, that entranceway is not blocked by one. There is an exit to the west. Don't worry, there is no door.".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You have entered the most ordinary of all possible bathrooms. You can barely contain your excitement.
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "Well, here we are in a bedroom.
 ...
 As if things weren't amazing enough already, you can even see a bed. [if there is something on the s_3]You see [a list of things on the s_3] on the bed.[end if]".
...
The f_0 and the f_1 and the f_2 and the f_5 and the f_7 and the f_4 and the f_6 and the f_3 are foods.
The f_0 and the f_1 and the f_2 and the f_5 and the f_7 and the f_4 and the f_6 and the f_3 are privately-named.
...
The printed name of f_6 is "flour".
Understand "flour" as f_6.
The f_6 is edible.
...
The printed name of f_3 is "olive oil".
The indefinite article of f_3 is "some".
Understand "olive oil" as f_3.
Understand "olive" as f_3.
Understand "oil" as f_3.
The f_3 is inedible.
...
Test quest5_0 with "inventory / go south / examine cookbook / take red apple from counter / open fridge / take parsley from fridge"
...
Test quest8_0 with "inventory / go south / examine cookbook / take red apple from counter / open fridge / take parsley from fridge / prepare meal"
...
Test quest9_0 with "inventory / go south / examine cookbook / take red apple from counter / open fridge / take parsley from fridge / prepare meal / eat meal"
