...
The canteen part 0 is some text that varies. The canteen part 0 is "You have come into a canteen. Not the canteen you'd expect. No, this is a canteen. The room is well lit.
...
The office part 0 is some text that varies. The office part 0 is "You are in an office. A normal kind of place. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "I am sorry to announce that you are now in the bathroom. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! Here is how to play! First step, travel east. Following that, make an effort to head east. That d".
The objective part 1 is some text that varies. The objective part 1 is "one, pick-up the passkey from the floor of the office. Got that? Good!".
