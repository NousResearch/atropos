...
The study part 0 is some text that varies. The study part 0 is "You've moved into an usual room. Your mind races to think of what kind of room would be usual. And then it hits you. Of course. You're in the study.
...
Test quest0_0 with "go west / go south / go west / go west / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First off, head west. Following that, travel south. After that, try to venture west. Following that, try".
The objective part 1 is some text that varies. The objective part 1 is " to travel west. Next, pick up the coin from the floor of the attic. That's it!".
