...
The bedchamber part 0 is some text that varies. The bedchamber part 0 is "This just in- You, in the bedchamber. Okay, just remember what you're here to do, and everything will go great.
...
The spare room part 0 is some text that varies. The spare room part 0 is "You are in a spare room. A standard kind of place. Okay, just remember what you're here to do, and everything will go great.
...
The k_0 is in r_4.
The description of o_0 is "The tv appears well matched to everything else here".
...
Test quest0_0 with "go north / take tv"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is your task for today. First of all, you could, like, attempt to take a trip north. That done, recover the tv from the floor of the bedchamber. And if you do that, you're t".
The objective part 1 is some text that varies. The objective part 1 is "he winner!".
