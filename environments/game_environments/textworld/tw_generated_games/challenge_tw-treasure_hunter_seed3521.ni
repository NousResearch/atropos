...
The canteen part 0 is some text that varies. The canteen part 0 is "You find yourself in a canteen. A standard kind of place. Okay, just remember what you're here to do, and everything will go great.
...
The vault part 0 is some text that varies. The vault part 0 is "This is going to sound unbelievable, but you've just entered a vault.
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Your task for today is to pick-up the legume from the floor of the vault.".
