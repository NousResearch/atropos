...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is how to play! First of all, go north. Then, pick-up the coin from the floor of the bar. And if you do that, you're the winner!".
