...
The garage part 0 is some text that varies. The garage part 0 is "You've come into an usual room. Your mind races to think of what kind of room would be usual. And then it hits you. Of course. You're in the garage.
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First of all, you could, like, make an effort to go to the north. With that over with, pick-up the Cat C".
The objective part 1 is some text that varies. The objective part 1 is "alendar from the floor of the study. Got that? Good!".
