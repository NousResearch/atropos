...
Test quest0_0 with "go east / go east / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First off, if it's not too much trouble, I need you to make an attempt to travel east. With that over wi".
The objective part 1 is some text that varies. The objective part 1 is "th, venture east. Then, pick up the coin from the floor of the kitchen. Once that's all handled, you can stop!".
