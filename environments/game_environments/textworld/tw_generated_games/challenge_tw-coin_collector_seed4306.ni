...
The steam room part 0 is some text that varies. The steam room part 0 is "You are in a normal kind of place. That is to say, you're in a steam room.
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First of all, head west. Then, try to travel west. With that done, try to move south. And then, lift the".
The objective part 1 is some text that varies. The objective part 1 is " coin from the floor of the study. And once you've done that, you win!".
