...
The kitchen part 3 is some text that varies. The kitchen part 3 is " You lean against the wall, inadvertently pressing a secret button. The wall opens up to reveal a counter. The counter is standard.[if there is something on the s_1] On the counter you can see [a list of things on the s_1].[end if]".
The kitchen part 4 is some text that varies. The kitchen part 4 is "[if there is nothing on the s_1] Looks like someone's already been here and taken everything off it, though. Hm. Oh well[end if]".
The kitchen part 5 is some text that varies. The kitchen part 5 is " You can see a stove. The stove is ordinary.[if there is something on the s_2] On the stove you make out [a list of things on the s_2].[end if]".
...
The kitchen part 7 is some text that varies. The kitchen part 7 is " Oh, great. Here's a kitchen island. The kitchen island is typical.[if there is something on the s_3] On the kitchen island you make out [a list of things on the s_3]. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You find yourself in a bedroom. An usual one. You begin to take stock of what's here.

 [if c_0 is locked]A locked[else if c_0 is open]An open[otherwise]A closed[end if]".
The bedroom part 1 is some text that varies. The bedroom part 1 is " normal looking chest drawer is in the corner.[if c_0 is open and there is something in the c_0] The chest drawer contains [a list of things in the c_0].[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "Well, here we are in the backyard.
 ...
 You see a set of chairs. The set of chairs is standard.[if there is something on the s_10] On the set of chairs you can make out [a list of things on the s_10].[end if]".
The backyard part 1 is some text that varies. The backyard part 1 is "[if there is nothing on the s_10] The set of chairs appears to be empty. You swear loudly.[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " You lean against the wall, inadvertently pressing a secret button. The wall opens up to reveal a patio table. The patio table is typical.[if there is something on the s_9] On the patio table you can see [a list of things on the s_9].[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You are in a living room. An usual one. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The living room part 1 is some text that varies. The living room part 1 is "[if there is nothing on the s_5]But the thing is empty, unfortunately. You move on, clearly angry about TextWorld.[end if]".
The living room part 2 is some text that varies. The living room part 2 is " You see a low table. [if there is something on the s_6]On the low table you make out [a list of things on the s_6].[end if]".
...
The living room part 4 is some text that varies. The living room part 4 is " What's that over there? It looks like it's a tv. What a coincidence, weren't you just thinking about a tv? The tv is typical.[if there is something on the s_7] On the tv you can see [a list of things on the s_7]. Something scurries by right in the corner of your eye. Probably nothing.[end if]".
...
The bathroom part 5 is some text that varies. The bathroom part 5 is " You scan the room for a sink, and you find a sink. The sink is usual.[if there is something on the s_4] On the sink you see [a list of things on the s_4].[end if]".
...
The garden part 0 is some text that varies. The garden part 0 is "You arrive in a garden. A standard one. You begin to take stock of what's here.
...
The description of f_1 is "that's a standard lettuce!".
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! First thing I need you to do is to open the antique trunk. And then, recover the old key from the antique trunk. And then, unlock the wooden door w".
The objective part 1 is some text that varies. The objective part 1 is "ithin the bedroom. If you have unlocked the wooden door, open the wooden door. After that, go to the east. With that over with, make absolutely sure that the refrigerator in the kitchen is ajar. After".
The objective part 2 is some text that varies. The objective part 2 is " opening the refrigerator, retrieve the lettuce from the refrigerator inside the kitchen. And then, place the lettuce on the stove. Once that's all handled, you can stop!".
