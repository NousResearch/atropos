...
Test quest0_0 with "go west / go west / go west / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an life changing round of TextWorld? You do! Here is how to play! Your first objective is to go to the west. And then, make an attempt to head ".
The objective part 1 is some text that varies. The objective part 1 is "west. After that, take a trip west. Then, lift the coin from the floor of the closet. And if you do that, you're the winner!".
