...
The canteen part 0 is some text that varies. The canteen part 0 is "Of every canteen you could have walked into, you had to walk into an usual one.
...
The cubicle part 0 is some text that varies. The cubicle part 0 is "You've moved into an ordinary room. Your mind races to think of what kind of room would be ordinary. And then it hits you. Of course. You're in the cubicle.
...
The sauna part 0 is some text that varies. The sauna part 0 is "You find yourself in a sauna. A standard kind of place. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The launderette part 0 is some text that varies. The launderette part 0 is "You find yourself in a launderette.
...
Test quest0_0 with "go north / go east / take passkey"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another profound round of TextWorld! Here is your task for today. First stop, go north. Then, try to head east. After that, lift the passkey from the floor of the sauna. That's it!".
