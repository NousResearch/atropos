...
The office part 0 is some text that varies. The office part 0 is "A well framed sign tells you that you are now in the office.
...
The parlor part 0 is some text that varies. The parlor part 0 is "You are in a parlor. A normal kind of place. You start to take note of what's in the room.
...
The description of o_0 is "The coin is brand new.".
...
Test quest0_0 with "go west / go south / go south / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! First stop, attempt to venture west. If you can do that, try to travel south. That done, go to th".
The objective part 1 is some text that varies. The objective part 1 is "e south. With that done, pick up the coin from the floor of the workshop. And if you do that, you're the winner!".
