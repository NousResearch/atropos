...
The room_1 part 0 is some text that varies. The room_1 part 0 is "You've just walked into a room_1.
...
The room_0 part 0 is some text that varies. The room_0 part 0 is "You've just sauntered into a room_0. You start to take note of what's in the room.
...
The room_8 part 0 is some text that varies. The room_8 part 0 is "Well I'll be, you are in a place we're calling a room_8. Let's see what's in here.
...
The room_6 part 0 is some text that varies. The room_6 part 0 is "You find yourself in a room_6. A standard kind of place. You begin to take stock of what's in the room.
...
The room_9 part 0 is some text that varies. The room_9 part 0 is "You've walked into a typical room. Your mind races to think of what kind of room would be typical. And then it hits you. Of course. You're in the room_9.
...
The side_room_6 part 0 is some text that varies. The side_room_6 part 0 is "You are in a side_room_6. A normal kind of place.
...
The room_10 part 0 is some text that varies. The room_10 part 0 is "You've entered a room_10.
...
The room_7 part 0 is some text that varies. The room_7 part 0 is "You are in a room_7. An ordinary one. Okay, just remember what you're here to do, and everything will go great.
...
The room_11 part 0 is some text that varies. The room_11 part 0 is "Well, here we are in a room_11. Okay, just remember what you're here to do, and everything will go great.

 You scan the room for an ancient altar, and you find an ancient altar. Why don't you take a picture of it, it'll last longer! The ancient altar is ordinary.[if there is something on the s_0] On the ancient altar you can make out [a list of things on the s_0].[end if]".
The room_11 part 1 is some text that varies. The room_11 part 1 is "[if there is nothing on the s_0] But the thing hasn't got anything on it. Oh! Why couldn't there just be stuff on it?[end if]".
...
The room_3 part 0 is some text that varies. The room_3 part 0 is "A crooked placard tells you that you are now in the room_3. You try to gain information on your surroundings by using a technique you call 'looking.'



 There is [if d_2 is open]an open[otherwise]a closed[end if]".
The room_3 part 1 is some text that varies. The room_3 part 1 is " green door leading west. There is an exit to the east. Don't worry, it is unguarded. There is an unguarded exit to the north.".
...
The room_4 part 0 is some text that varies. The room_4 part 0 is "You find yourself in a room_4. A normal kind of place.
...
The room_5 part 0 is some text that varies. The room_5 part 0 is "You've just sauntered into a room_5. You begin to take stock of what's in the room.
...
The side_room_3 part 0 is some text that varies. The side_room_3 part 0 is "Look at you, bigshot, walking into a side_room_3 like it isn't some huge deal.
...
The side_room_9 part 0 is some text that varies. The side_room_9 part 0 is "You've just shown up in a side_room_9.
...
The description of d_0 is "it's an ominous red door [if open]You can see inside it.[else if closed]You can't see inside it because the lid's in your way.[otherwise]There is a lock on it.[end if]".
The printed name of d_0 is "red door".
Understand "red door" as d_0.
Understand "red" as d_0.
Understand "door" as d_0.
The d_0 is locked.
The description of d_1 is "it's a rugged blue door [if open]You can see inside it.[else if closed]You can't see inside it because the lid's in your way.[otherwise]There is a lock on it.[end if]".
...
The f_1 is in r_7.
The f_1 is edible.
The description of f_2 is "that's a typical burger!".
...
The f_4 is in r_12.
The f_4 is edible.
The description of k_0 is "The red crystal is surprisingly heavy.".
...
The description of k_2 is "The green crystal is weighty.".
...
The description of o_0 is "The ancient scroll seems to fit in here".
...
The o_0 is in r_1.
The description of o_1 is "The mystic orb is dirty.".
The printed name of o_1 is "mystic orb".
Understand "mystic orb" as o_1.
Understand "mystic" as o_1.
Understand "orb" as o_1.
The o_1 is in r_2.
The description of o_2 is "The golden chalice would seem to be well matched to everything else here".
...
The o_2 is in r_3.
The description of o_3 is "The Quote of the Day Calendar is cheap looking.".
...
The description of o_4 is "The fly larva seems well matched to everything else here".
The printed name of o_4 is "fly larva".
Understand "fly larva" as o_4.
Understand "fly" as o_4.
Understand "larva" as o_4.
The player carries the o_4.
The description of o_5 is "The ladle seems out of place here".
