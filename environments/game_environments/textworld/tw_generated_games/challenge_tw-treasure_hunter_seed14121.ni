...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! Here is your task for today. Your first objective is to go east. If you can manage that, try to m".
The objective part 1 is some text that varies. The objective part 1 is "ove south. Next, lift the latchkey from the floor of the bedroom. And if you do that, you're the winner!".
