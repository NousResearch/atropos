...
The steam room part 0 is some text that varies. The steam room part 0 is "You make another one of your grand eccentric entrances into a steam room. You begin looking for stuff.
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You've stumbled into a normal room. Your mind races to think of what kind of room would be normal. And then it hits you. Of course. You're in the bedroom.
...
The sauna part 0 is some text that varies. The sauna part 0 is "You arrive in a sauna. A normal kind of place. You begin to take stock of what's in the room.
...
The description of o_0 is "The coin seems well matched to everything else here".
...
Test quest0_0 with "go east / go north / go west / go west / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Here is your task for today. First step, make an effort to head east. With that done, make an attempt to go north. Then, take a trip west. And then".
The objective part 1 is some text that varies. The objective part 1 is ", travel west. After that, pick up the coin from the floor of the sauna. Once that's all handled, you can stop!".
