...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a exciting round of TextWorld! Here is how to play! First step, venture west. Then, retrieve the coin from the floor of the cookery. And if you do that, you're the winner!".
