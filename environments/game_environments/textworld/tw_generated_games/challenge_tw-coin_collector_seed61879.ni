...
The spare room part 0 is some text that varies. The spare room part 0 is "You arrive in a spare room. A typical one. The room is well lit.
...
The shower part 0 is some text that varies. The shower part 0 is "This might come as a shock to you, but you've just entered a shower.
...
The restroom part 0 is some text that varies. The restroom part 0 is "Guess what, you are in a place we're calling a restroom. You start to take note of what's in the room.
...
Test quest0_0 with "go east / go south / go west / go west / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an profound round of TextWorld? You do! Here is your task for today. First off, attempt to go to the east. And then, make an attempt to move so".
The objective part 1 is some text that varies. The objective part 1 is "uth. Then, try to go to the west. Next, take a trip west. Then, lift the coin from the floor of the restroom. Alright, thanks!".
