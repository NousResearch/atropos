...
The scullery part 0 is some text that varies. The scullery part 0 is "Well, here we are in a scullery. You begin looking for stuff.
...
The lounge part 0 is some text that varies. The lounge part 0 is "You find yourself in a lounge. A standard one. The room is well lit.
...
Test quest0_0 with "go east / take licorice strip"
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an exciting round of TextWorld? You do! Here is your task for today. First stop, move east. And then, pick up the licorice strip from the floor".
The objective part 1 is some text that varies. The objective part 1 is " of the shower. And once you've done that, you win!".
