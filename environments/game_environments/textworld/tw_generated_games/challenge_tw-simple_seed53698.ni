...
The kitchen part 0 is some text that varies. The kitchen part 0 is "You are in a kitchen. A normal one.
 ...
 You scan the room for a refrigerator, and you find a refrigerator. You wonder idly who left that here.[if c_2 is open and there is something in the c_2] The refrigerator contains [a list of things in the c_2].[end if]".
...
The kitchen part 3 is some text that varies. The kitchen part 3 is "[if there is nothing on the s_1] But the thing is empty, unfortunately. Oh! Why couldn't there just be stuff on it?[end if]".
The kitchen part 4 is some text that varies. The kitchen part 4 is " You make out a stove. The stove is standard.[if there is something on the s_2] On the stove you see [a list of things on the s_2]. Something scurries by right in the corner of your eye. Probably nothing.[end if]".
...
The kitchen part 6 is some text that varies. The kitchen part 6 is " If you haven't noticed it already, there seems to be something there by the wall, it's a kitchen island. The kitchen island is typical.[if there is something on the s_3] On the kitchen island you can make out [a list of things on the s_3].[end if]".
...
The bedroom part 2 is some text that varies. The bedroom part 2 is " You see an antique trunk. Now why would someone leave that there?[if c_1 is open and there is something in the c_1] The antique trunk contains [a list of things in the c_1].[end if]".
...
The bedroom part 4 is some text that varies. The bedroom part 4 is " You can make out a king-size bed. The king-size bed is normal.[if there is something on the s_0] On the king-size bed you make out [a list of things on the s_0], so there's that.[end if]".
The bedroom part 5 is some text that varies. The bedroom part 5 is "[if there is nothing on the s_0] But the thing is empty. Aw, here you were, all excited for there to be things on it![end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You are in a standard kind of place. That is to say, you're in a backyard.

 Were you looking for a set of chairs? Because look over there, it's a set of chairs. Wow, isn't TextWorld just the best? [if there is something on the s_10]You see [a list of things on the s_10] on the set of chairs. Now that's what I call TextWorld![end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " Oh, great. Here's a bbq. The bbq is standard.[if there is something on the s_8] On the bbq you make out [a list of things on the s_8].[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " You see a patio table. The patio table is ordinary.[if there is something on the s_9] On the patio table you make out [a list of things on the s_9].[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You've entered a living room. You decide to start listing off everything you see in the room, as if you were in a text adventure.
 ...
 You can make out a couch. The couch is usual.[if there is something on the s_5] On the couch you see [a list of things on the s_5].[end if]".
...
The living room part 2 is some text that varies. The living room part 2 is " You make out a low table. The low table is ordinary.[if there is something on the s_6] On the low table you make out [a list of things on the s_6].[end if]".
...
The living room part 4 is some text that varies. The living room part 4 is " You rest your hand against a wall, but you miss the wall and fall onto a tv. I guess it's true what they say, if you're looking for a tv, go to TextWorld. [if there is something on the s_7]You see [a list of things on the s_7] on the tv.[end if]".
...
The bathroom part 5 is some text that varies. The bathroom part 5 is " You lean against the wall, inadvertently pressing a secret button. The wall opens up to reveal a sink. [if there is something on the s_4]You see [a list of things on the s_4] on the sink.[end if]".
...
The garden part 0 is some text that varies. The garden part 0 is "You are in a garden. A typical kind of place. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The d_0 is locked.
The description of d_1 is "it's a grand screen door [if open]You can see inside it.[else if closed]You can't see inside it because the lid's in your way.[otherwise]There is a lock on it.[end if]".
...
The description of f_1 is "The half of a bag of chips looks appetizing.".
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is how to play! First of all, ensure that the chest drawer is open. After pulling open the chest drawer, pick up the old key from the chest drawer. Then, doublecheck that th".
The objective part 1 is some text that varies. The objective part 1 is "e wooden door within the bedroom is unlocked. Then, open the wooden door in the bedroom. Then, take a trip east. And then, open the screen door within the kitchen. And then, take a trip east. And then".
The objective part 2 is some text that varies. The objective part 2 is ", take a trip south. Following that, retrieve the apple from the floor of the garden. And then, go north. Then, go to the west. After that, put the apple on the stove inside the kitchen. Once that's a".
The objective part 3 is some text that varies. The objective part 3 is "ll handled, you can stop!".
