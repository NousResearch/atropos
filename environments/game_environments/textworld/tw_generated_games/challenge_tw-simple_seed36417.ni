...
The kitchen part 1 is some text that varies. The kitchen part 1 is " refrigerator is nearby.[if c_2 is open and there is something in the c_2] The refrigerator contains [a list of things in the c_2]. Huh, weird.[end if]".
...
The kitchen part 3 is some text that varies. The kitchen part 3 is " As if things weren't amazing enough already, you can even see a counter. The counter is typical.[if there is something on the s_1] On the counter you can make out [a list of things on the s_1].[end if]".
...
The kitchen part 5 is some text that varies. The kitchen part 5 is " You make out a stove. [if there is something on the s_2]On the stove you see [a list of things on the s_2].[end if]".
...
The kitchen part 7 is some text that varies. The kitchen part 7 is " You can make out a kitchen island. [if there is something on the s_3]You see [a list of things on the s_3] on the kitchen island. Suddenly, you bump your head on the ceiling, but it's not such a bad bump that it's going to prevent you from looking at objects and even things.[end if]".
...
The kitchen part 11 is some text that varies. The kitchen part 11 is " wooden door leading west. There is an exit to the north. Don't worry, it is unblocked. You don't like doors? Why not try going south, that entranceway is unblocked.".
...
The bedroom part 1 is some text that varies. The bedroom part 1 is " chest drawer, which looks standard, in the corner.[if c_0 is open and there is something in the c_0] The chest drawer contains [a list of things in the c_0].[end if]".
...
The bedroom part 5 is some text that varies. The bedroom part 5 is " You make out a king-size bed. The king-size bed is ordinary.[if there is something on the s_0] On the king-size bed you can make out [a list of things on the s_0].[end if]".
The bedroom part 6 is some text that varies. The bedroom part 6 is "[if there is nothing on the s_0] But oh no! there's nothing on this piece of junk. Hm. Oh well[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "Ah, the backyard. This is some kind of backyard, really great standard vibes in this place, a wonderful standard atmosphere. You can barely contain your excitement.

 Oh wow! Is that what I think it is? It is! It's a set of chairs. [if there is something on the s_10]On the set of chairs you can make out [a list of things on the s_10]. You shudder, but continue examining the room.[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " You see a bbq. The bbq is usual.[if there is something on the s_8] On the bbq you can see [a list of things on the s_8].[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " You scan the room, seeing a patio table. [if there is something on the s_9]On the patio table you can make out [a list of things on the s_9].[end if]".
The backyard part 5 is some text that varies. The backyard part 5 is "[if there is nothing on the s_9]But the thing is empty. Oh! Why couldn't there just be stuff on it?[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "Look at you, bigshot, walking into a living room like it isn't some huge deal.

 You see a couch. [if there is something on the s_5]You see [a list of things on the s_5] on the couch. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[end if]".
The living room part 1 is some text that varies. The living room part 1 is "[if there is nothing on the s_5]However, the couch, like an empty couch, has nothing on it. Hm. Oh well[end if]".
The living room part 2 is some text that varies. The living room part 2 is " You make out a low table. Wow, isn't TextWorld just the best? The low table is typical.[if there is something on the s_6] On the low table you can make out [a list of things on the s_6].[end if]".
The living room part 3 is some text that varies. The living room part 3 is "[if there is nothing on the s_6] But oh no! there's nothing on this piece of junk. Aw, and here you were, all excited for there to be things on it![end if]".
The living room part 4 is some text that varies. The living room part 4 is " Look over there! a tv. The tv is normal.[if there is something on the s_7] On the tv you make out [a list of things on the s_7].[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You are in a bathroom. A standard one.
 ...
 If you haven't noticed it already, there seems to be something there by the wall, it's a toilet. Classic TextWorld.[if c_3 is open and there is something in the c_3] The toilet contains [a list of things in the c_3], so there's that.[end if]".
...
The bathroom part 3 is some text that varies. The bathroom part 3 is " typical looking bath is nearby.[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4].[end if]".
...
The bathroom part 5 is some text that varies. The bathroom part 5 is " You see a sink. The sink is normal.[if there is something on the s_4] On the sink you can make out [a list of things on the s_4]. There's something strange about this thing being here, but you don't have time to worry about that now.[end if]".
...
The s_9 is in r_4.
The description of f_0 is "The milk looks appealing.".
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. Your first objective is to ensure that the chest drawer inside the bedroom is open. Then, pick up the ol".
The objective part 1 is some text that varies. The objective part 1 is "d key from the chest drawer. Then, make sure that the wooden door is unlocked. After unlocking the wooden door, ensure that the wooden door within the bedroom is open. Then, move east. And then, open ".
The objective part 2 is some text that varies. The objective part 2 is "the refrigerator inside the kitchen. And then, take the milk from the refrigerator. And then, put the milk on the stove in the kitchen. And if you do that, you're the winner!".
