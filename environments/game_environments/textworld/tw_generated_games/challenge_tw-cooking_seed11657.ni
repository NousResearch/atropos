...
The r_0 and the r_6 and the r_1 and the r_10 and the r_9 and the r_2 and the r_3 and the r_5 and the r_11 and the r_4 and the r_7 and the r_8 are rooms.
...
The kitchen part 4 is some text that varies. The kitchen part 4 is " You can make out a table. You wonder idly who left that here. The table is massive.[if there is something on the s_0] On the table you see [a list of things on the s_0].[end if]".
...
The kitchen part 6 is some text that varies. The kitchen part 6 is " Oh, great. Here's a counter. The counter is vast.[if there is something on the s_1] On the counter you make out [a list of things on the s_1].[end if]".
...
The kitchen part 8 is some text that varies. The kitchen part 8 is " You make out a stove. You wonder idly who left that here. [if there is something on the stove_0]You see [a list of things on the stove_0] on the stove.[end if]".
...
The kitchen part 12 is some text that varies. The kitchen part 12 is " screen door leading west. There is an exit to the east. There is an exit to the north.".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You're now in the backyard.
 ...
 You scan the room for a patio chair, and you find a patio chair. [if there is something on the s_5]You see [a list of things on the s_5] on the patio chair.[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " Look over there! a patio table. The patio table is stylish.[if there is something on the s_9] On the patio table you can make out [a list of things on the s_9].[end if]".
The backyard part 3 is some text that varies. The backyard part 3 is "[if there is nothing on the s_9] The patio table appears to be empty. Aw, and here you were, all excited for there to be things on it![end if]".
...
The corridor part 1 is some text that varies. The corridor part 1 is " fiberglass door leading south. There is an exit to the east. Don't worry, there is no door. There is an exit to the north. Don't worry, there is no door. You don't like doors? Why not try going west, that entranceway is not blocked by one.".
...
The driveway part 0 is some text that varies. The driveway part 0 is "You arrive in a driveway. An usual one. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The bedroom part 1 is some text that varies. The bedroom part 1 is "[if there is nothing on the s_7] But the thing hasn't got anything on it. You move on, clearly upset with TextWorld.[end if]".
...
The livingroom part 0 is some text that varies. The livingroom part 0 is "You're now in a livingroom.
 ...
 You lean against the wall, inadvertently pressing a secret button. The wall opens up to reveal a sofa. The sofa is comfy.[if there is something on the s_8] On the sofa you can make out [a list of things on the s_8].[end if]".
The livingroom part 1 is some text that varies. The livingroom part 1 is "[if there is nothing on the s_8] However, the sofa, like an empty sofa, has nothing on it. Sometimes, just sometimes, TextWorld can just be the worst.[end if]".
...
The supermarket part 0 is some text that varies. The supermarket part 0 is "You arrive in a supermarket.
 ...
 You see a showcase. [if there is something on the s_3]On the showcase you make out [a list of things on the s_3]. It doesn't get more TextWorld than this![end if]".
...
The shed part 2 is some text that varies. The shed part 2 is " What's that over there? It looks like it's a workbench. What a coincidence, weren't you just thinking about a workbench? The workbench is wooden.[if there is something on the s_4] On the workbench you make out [a list of things on the s_4].[end if]".
...
The f_3 and the f_1 and the f_6 and the f_2 and the f_4 and the f_5 and the f_0 are foods.
The f_3 and the f_1 and the f_6 and the f_2 and the f_4 and the f_5 and the f_0 are privately-named.
...
The r_0 and the r_6 and the r_1 and the r_10 and the r_9 and the r_2 and the r_3 and the r_5 and the r_11 and the r_4 and the r_7 and the r_8 are rooms.
The r_0 and the r_6 and the r_1 and the r_10 and the r_9 and the r_2 and the r_3 and the r_5 and the r_11 and the r_4 and the r_7 and the r_8 are privately-named.
...
The printed name of f_5 is "water".
The indefinite article of f_5 is "some".
Understand "water" as f_5.
...
Test quest1_0 with "inventory / go south / go west / examine cookbook / drop olive oil / take red hot pepper from counter"
...
Test quest5_0 with "inventory / go south / go west / examine cookbook / drop olive oil / take red hot pepper from counter / go east / go east / go south / go east / go east / go south / take chicken wing from showcase"
...
Test quest8_0 with "inventory / go south / go west / examine cookbook / drop olive oil / take red hot pepper from counter / go east / go east / go south / go east / go east / go south / take chicken wing from showcase / take chicken wing from showcase / go north / go west / go west / go north / go west / prepare meal"
...
Test quest9_0 with "inventory / go south / go west / examine cookbook / drop olive oil / take red hot pepper from counter / go east / go east / go south / go east / go east / go south / take chicken wing from showcase / take chicken wing from showcase / go north / go west / go west / go north / go west / prepare meal / eat meal"
