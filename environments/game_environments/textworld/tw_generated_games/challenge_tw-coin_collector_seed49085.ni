...
The garage part 0 is some text that varies. The garage part 0 is "I am so happy to announce that you are now in the garage.
...
Test quest0_0 with "go north / go north / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an life changing round of TextWorld? You do! Here is your task for today. First of all, you could, like, attempt to move north. Then, go north.".
The objective part 1 is some text that varies. The objective part 1 is " Next, lift the coin from the floor of the washroom. Got that? Good!".
