...
The vault part 0 is some text that varies. The vault part 0 is "You are in a vault. An ordinary one. You begin to take stock of what's here.
...
Test quest0_0 with "go north / go west / go south / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First off, if it's not too much trouble, I need you to try to take a trip north. Then, make an effort to".
The objective part 1 is some text that varies. The objective part 1 is " venture west. Once you get around to doing that, move south. Then, retrieve the coin from the floor of the sauna. And if you do that, you're the winner!".
