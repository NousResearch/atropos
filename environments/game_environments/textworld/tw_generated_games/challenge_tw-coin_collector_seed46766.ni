...
The description of o_0 is "The coin seems to fit in here".
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another profound session of TextWorld! Here is how to play! First of all, go east. Once you finish that, make an attempt to go east. After that, pick up the coin from the floor of the attic".
