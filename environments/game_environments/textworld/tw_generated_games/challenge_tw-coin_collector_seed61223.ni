...
The bar part 0 is some text that varies. The bar part 0 is "You are in a bar. A standard one. The room is well lit.
...
The cookery part 0 is some text that varies. The cookery part 0 is "You've just walked into a cookery. You begin to take stock of what's here.
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is how to play! First step, attempt to head west. After that, make an effort to travel south. Next, pick-up the coin from the floor of the kitchen. And once you've done that".
