...
The kitchenette part 0 is some text that varies. The kitchenette part 0 is "You find yourself in a kitchenette. A standard one. Let's see what's in here.
...
The recreation zone part 0 is some text that varies. The recreation zone part 0 is "This recreation zone you have just entered is definitely usual. You begin to take stock of what's in the room.
...
The description of o_0 is "The telephone seems well matched to everything else here".
The printed name of o_0 is "telephone".
Understand "telephone" as o_0.
The o_0 is in r_0.
The description of o_1 is "The spork appears to fit in here".
...
Test quest0_0 with "go south / take telephone"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! First of all, you could, like, attempt to move south. Then, lift the telephone from the floor of the workshop. That's it!".
