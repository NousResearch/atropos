...
The kitchen part 5 is some text that varies. The kitchen part 5 is " Were you looking for a table? Because look over there, it's a table! The table is massive.[if there is something on the s_0] On the table you see [a list of things on the s_0]. I mean, just wow! Isn't TextWorld just the best?[end if]".
...
The kitchen part 9 is some text that varies. The kitchen part 9 is " You smell an intriguing smell, and follow it to a stove. The stove is conventional.[if there is something on the stove_0] On the stove you can see [a list of things on the stove_0]. Wow! Just like in the movies![end if]".
...
The f_1 and the f_6 and the f_0 and the f_2 and the f_3 and the f_4 and the f_5 and the f_7 are foods.
The f_1 and the f_6 and the f_0 and the f_2 and the f_3 and the f_4 and the f_5 and the f_7 are privately-named.
