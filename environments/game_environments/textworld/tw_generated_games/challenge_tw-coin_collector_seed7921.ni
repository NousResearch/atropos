...
The laundromat part 0 is some text that varies. The laundromat part 0 is "You arrive in a laundromat. An ordinary kind of place. You start to take note of what's in the room.
...
The description of o_0 is "The coin is dirty.".
...
Test quest0_0 with "go west / go south / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First of all, you could, like, try to head west. Once you manage that, attempt to travel south. That don".
The objective part 1 is some text that varies. The objective part 1 is "e, recover the coin from the floor of the study. Once that's all handled, you can stop!".
