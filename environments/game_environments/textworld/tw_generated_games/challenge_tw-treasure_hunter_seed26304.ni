...
The playroom part 0 is some text that varies. The playroom part 0 is "You find yourself in a playroom. A standard one. Okay, just remember what you're here to do, and everything will go great.
...
The description of o_0 is "The hat would seem to be well matched to everything else here".
...
Test quest0_0 with "go east / take hat"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is your task for today. Your first objective is to go east. With that done, pick-up the hat from the floor of the closet. That's it!".
