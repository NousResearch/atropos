...
The playroom part 0 is some text that varies. The playroom part 0 is "You've entered a playroom. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The closet part 0 is some text that varies. The closet part 0 is "You've just sauntered into a closet. You begin to take stock of what's here.
...
The cookhouse part 0 is some text that varies. The cookhouse part 0 is "Ah, the cookhouse. This is some kind of cookhouse, really great standard vibes in this place, a wonderful standard atmosphere. You begin looking for stuff.
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! Here is how to play! First thing I need you to do is to venture east. Once you finish that, attem".
The objective part 1 is some text that varies. The objective part 1 is "pt to venture north. Following that, lift the lightbulb from the floor of the closet. And once you've done that, you win!".
