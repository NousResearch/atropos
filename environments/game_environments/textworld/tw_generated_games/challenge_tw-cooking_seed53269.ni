...
The r_0 and the r_6 and the r_3 and the r_2 and the r_5 and the r_1 and the r_4 and the r_7 and the r_8 are rooms.
...
The kitchen part 6 is some text that varies. The kitchen part 6 is " You can see a counter. The counter is vast.[if there is something on the s_1] On the counter you see [a list of things on the s_1]. Something scurries by right in the corner of your eye. Probably nothing.[end if]".
The kitchen part 7 is some text that varies. The kitchen part 7 is "[if there is nothing on the s_1] Looks like someone's already been here and taken everything off it, though. Aw, and here you were, all excited for there to be things on it![end if]".
The kitchen part 8 is some text that varies. The kitchen part 8 is " What's that over there? It looks like it's a stove. Why don't you take a picture of it, it'll last longer! The stove is conventional.[if there is something on the stove_0] On the stove you see [a list of things on the stove_0]. There's something strange about this thing being here, but you don't have time to worry about that now.[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You arrive in a backyard. An ordinary one.
 ...
 You see a patio table. The patio table is stylish.[if there is something on the s_3] On the patio table you see [a list of things on the s_3]. Classic TextWorld.[end if]".
...
The pantry part 0 is some text that varies. The pantry part 0 is "Fancy seeing you here. Here, by the way, being the pantry. You can barely contain your excitement.
...
The livingroom part 0 is some text that varies. The livingroom part 0 is "This is going to sound unbelievable, but you've just entered a livingroom. You try to gain information on your surroundings by using a technique you call 'looking.'

 You make out a sofa. [if there is something on the s_5]You see [a list of things on the s_5] on the sofa. Hmmm... what else, what else?[end if]".
...
The shed part 0 is some text that varies. The shed part 0 is "You've seen better sheds, but at least this one seems pretty standard. You try to gain information on your surroundings by using a technique you call 'looking.'

 Were you looking for a toolbox? Because look over there, it's a toolbox. Now why would someone leave that there?[if c_1 is open and there is something in the c_1] The toolbox contains [a list of things in the c_1].[end if]".
...
The shed part 2 is some text that varies. The shed part 2 is " You can make out a workbench. You shudder, but continue examining the workbench. [if there is something on the s_7]On the workbench you can see [a list of things on the s_7].[end if]".
The shed part 3 is some text that varies. The shed part 3 is "[if there is nothing on the s_7]However, the workbench, like an empty workbench, has nothing on it. You move on, clearly infuriated by TextWorld.[end if]".
...
The f_2 and the f_4 and the f_6 and the f_0 and the f_1 and the f_5 and the f_3 are foods.
The f_2 and the f_4 and the f_6 and the f_0 and the f_1 and the f_5 and the f_3 are privately-named.
...
The r_0 and the r_6 and the r_3 and the r_2 and the r_5 and the r_1 and the r_4 and the r_7 and the r_8 are rooms.
The r_0 and the r_6 and the r_3 and the r_2 and the r_5 and the r_1 and the r_4 and the r_7 and the r_8 are privately-named.
...
The description of d_0 is "The [noun] looks solid. [if open]You can see inside it.[else if locked]There is a lock on it and seems impossible to break open.[otherwise]You can't see inside it because the lid's in your way.[end if]".
...
Test quest1_0 with "inventory / inventory / go west / examine cookbook / take block of cheese from fridge"
...
Test quest2_0 with "inventory / inventory / go west / examine cookbook / take block of cheese from fridge / take orange bell pepper from fridge / take purple potato from counter / take purple potato from counter / go west / cook block of cheese with BBQ"
...
Test quest5_0 with "inventory / inventory / go west / examine cookbook / take block of cheese from fridge / take orange bell pepper from fridge"
...
Test quest6_0 with "inventory / inventory / go west / examine cookbook / take block of cheese from fridge / take orange bell pepper from fridge / take purple potato from counter / take purple potato from counter / go west / cook block of cheese with BBQ / cook block of cheese with BBQ / go east / go east / go west / cook orange bell pepper with BBQ"
...
Test quest9_0 with "inventory / inventory / go west / examine cookbook / take block of cheese from fridge / take orange bell pepper from fridge / take purple potato from counter"
...
Test quest10_0 with "inventory / inventory / go west / examine cookbook / take block of cheese from fridge / take orange bell pepper from fridge / take purple potato from counter / take purple potato from counter / go west / cook block of cheese with BBQ / cook block of cheese with BBQ / go east / go east / go west / cook orange bell pepper with BBQ / cook orange bell pepper with BBQ / go east / cook purple potato with stove"
...
Test quest12_0 with "inventory / inventory / go west / examine cookbook / take block of cheese from fridge / take orange bell pepper from fridge / take purple potato from counter / take purple potato from counter / go west / cook block of cheese with BBQ / cook block of cheese with BBQ / go east / go east / go west / cook orange bell pepper with BBQ / cook orange bell pepper with BBQ / go east / cook purple potato with stove / prepare meal"
...
Test quest13_0 with "inventory / inventory / go west / examine cookbook / take block of cheese from fridge / take orange bell pepper from fridge / take purple potato from counter / take purple potato from counter / go west / cook block of cheese with BBQ / cook block of cheese with BBQ / go east / go east / go west / cook orange bell pepper with BBQ / cook orange bell pepper with BBQ / go east / cook purple potato with stove / prepare meal / eat meal"
