...
The kitchen part 0 is some text that varies. The kitchen part 0 is "You find yourself in a kitchen. A typical kind of place.
 ...
 You see a gleam over in a corner, where you can see a refrigerator. Now why would someone leave that there?[if c_2 is open and there is something in the c_2] The refrigerator contains [a list of things in the c_2]. Now why would someone leave that there?[end if]".
...
The kitchen part 2 is some text that varies. The kitchen part 2 is " You scan the room for a counter, and you find a counter. The counter is ordinary.[if there is something on the s_1] On the counter you make out [a list of things on the s_1].[end if]".
...
The kitchen part 6 is some text that varies. The kitchen part 6 is " You smell a pungent smell, and follow it to a kitchen island. [if there is something on the s_3]You see [a list of things on the s_3] on the kitchen island.[end if]".
...
The bedroom part 1 is some text that varies. The bedroom part 1 is " chest drawer here.[if c_0 is open and there is something in the c_0] The chest drawer contains [a list of things in the c_0]. Classic TextWorld.[end if]".
...
The bedroom part 4 is some text that varies. The bedroom part 4 is " antique trunk.[if c_1 is open and there is something in the c_1] The antique trunk contains [a list of things in the c_1]. Huh, weird.[end if]".
...
The bedroom part 7 is some text that varies. The bedroom part 7 is "[if there is nothing on the s_0]But there isn't a thing on it. This always happens, here in TextWorld![end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You are in a backyard. An ordinary kind of place. You begin to take stock of what's here.

 You bend down to tie your shoe. When you stand up, you notice a set of chairs. You can't really describe the set of chairs besides that it's standard. The set of chairs is standard.[if there is something on the s_10] On the set of chairs you can see [a list of things on the s_10].[end if]".
The backyard part 1 is some text that varies. The backyard part 1 is "[if there is nothing on the s_10] But the thing is empty, unfortunately. This always happens![end if]".
The backyard part 2 is some text that varies. The backyard part 2 is " You smell an awful smell, and follow it to a bbq. [if there is something on the s_8]You see [a list of things on the s_8] on the bbq.[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "Well, here we are in the living room. You begin looking for stuff.

 Oh, great. Here's a couch. The couch is normal.[if there is something on the s_5] On the couch you make out [a list of things on the s_5].[end if]".
...
The living room part 2 is some text that varies. The living room part 2 is " You scan the room for a low table, and you find a low table. [if there is something on the s_6]On the low table you can make out [a list of things on the s_6].[end if]".
...
The bathroom part 3 is some text that varies. The bathroom part 3 is " You see a bath. Now why would someone leave that there?[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4].[end if]".
...
The bathroom part 5 is some text that varies. The bathroom part 5 is " You make out a sink. The sink is standard.[if there is something on the s_4] On the sink you can make out [a list of things on the s_4].[end if]".
