...
The kitchen part 2 is some text that varies. The kitchen part 2 is " Look over there! an oven.[if oven_0 is open and there is something in the oven_0] The oven contains [a list of things in the oven_0]. You shudder, but continue examining the room.[end if]".
...
The f_1 and the f_6 and the f_0 and the f_4 and the f_5 and the f_7 and the f_8 and the f_3 and the f_2 are foods.
The f_1 and the f_6 and the f_0 and the f_4 and the f_5 and the f_7 and the f_8 and the f_3 and the f_2 are privately-named.
...
Test quest1_0 with "inventory / examine cookbook / take orange bell pepper from fridge"
...
Test quest5_0 with "inventory / examine cookbook / take orange bell pepper from fridge / take red potato from counter"
...
Test quest8_0 with "inventory / examine cookbook / take orange bell pepper from fridge / take red potato from counter / prepare meal"
...
Test quest9_0 with "inventory / examine cookbook / take orange bell pepper from fridge / take red potato from counter / prepare meal / eat meal"
