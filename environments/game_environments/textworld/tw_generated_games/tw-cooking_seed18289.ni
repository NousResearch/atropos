...
The kitchen part 4 is some text that varies. The kitchen part 4 is " You see a table. [if there is something on the s_0]On the table you see [a list of things on the s_0]. Huh, weird.[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You're now in the bedroom. You begin looking for stuff.
 ...
 Were you looking for a bed? Because look over there, it's a bed. The bed is large.[if there is something on the s_5] On the bed you see [a list of things on the s_5].[end if]".
...
The livingroom part 1 is some text that varies. The livingroom part 1 is "[if there is nothing on the s_4]Unfortunately, there isn't a thing on it. It would have been so cool if there was stuff on the sofa! oh well.[end if]".
...
The f_2 and the f_4 and the f_5 and the f_0 and the f_3 and the f_1 are foods.
The f_2 and the f_4 and the f_5 and the f_0 and the f_3 and the f_1 are privately-named.
...
Test quest1_0 with "inventory / go west / go west / examine cookbook / drop black pepper / drop orange bell pepper / take red hot pepper from counter"
...
Test quest5_0 with "inventory / go west / go west / examine cookbook / drop black pepper / drop orange bell pepper / take red hot pepper from counter / open fridge / take water from fridge"
...
Test quest11_0 with "inventory / go west / go west / examine cookbook / drop black pepper / drop orange bell pepper / take red hot pepper from counter / open fridge / take water from fridge / prepare meal"
...
Test quest12_0 with "inventory / go west / go west / examine cookbook / drop black pepper / drop orange bell pepper / take red hot pepper from counter / open fridge / take water from fridge / prepare meal / eat meal"
