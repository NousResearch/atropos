...
The canteen part 0 is some text that varies. The canteen part 0 is "You arrive in a canteen. An usual kind of place. Okay, just remember what you're here to do, and everything will go great.
...
The vault part 0 is some text that varies. The vault part 0 is "Of every vault you could have shown up in, you had to show up in an usual one.
...
Test quest0_0 with "go north / take sock"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another profound episode of TextWorld! Here is how to play! First, it would be a great idea if you could venture north. And then, recover the sock from the floor of the vault. And once you'".
