...
The kitchen part 0 is some text that varies. The kitchen part 0 is "You arrive in a kitchen. A standard kind of place. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The kitchen part 6 is some text that varies. The kitchen part 6 is " You hear a noise behind you and spin around, but you can't see anything other than a table. [if there is something on the s_0]On the table you see [a list of things on the s_0].[end if]".
...
The kitchen part 8 is some text that varies. The kitchen part 8 is " You can make out a counter. [if there is something on the s_1]You see [a list of things on the s_1] on the counter. You shudder, but continue examining the room.[end if]".
The kitchen part 9 is some text that varies. The kitchen part 9 is "[if there is nothing on the s_1]But oh no! there's nothing on this piece of garbage. Hm. Oh well[end if]".
...
The pantry part 0 is some text that varies. The pantry part 0 is "If you're wondering why everything seems so ordinary all of a sudden, it's because you've just sauntered into the pantry. You can barely contain your excitement.
...
The livingroom part 0 is some text that varies. The livingroom part 0 is "You arrive in a livingroom. A normal kind of place. You can barely contain your excitement.

 You see a sofa. [if there is something on the s_7]You see [a list of things on the s_7] on the sofa. Huh, weird.[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "If you're wondering why everything seems so ordinary all of a sudden, it's because you've just walked into the bedroom.

 You can see a bed. Make a note of this, you might have to put stuff on or in it later on. [if there is something on the s_3]You see [a list of things on the s_3] on the bed.[end if]".
...
The corridor part 1 is some text that varies. The corridor part 1 is " screen door leading north. There is an exit to the south. You don't like doors? Why not try going west, that entranceway is not blocked by one.".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You arrive in a backyard. A standard one. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The backyard part 2 is some text that varies. The backyard part 2 is " You see a gleam over in a corner, where you can see a patio table. You shudder, but continue examining the patio table. [if there is something on the s_8]You see [a list of things on the s_8] on the patio table.[end if]".
...
The shed part 0 is some text that varies. The shed part 0 is "You arrive in a shed. A normal one. You begin to take stock of what's in the room.
...
The shed part 2 is some text that varies. The shed part 2 is " You rest your hand against a wall, but you miss the wall and fall onto a workbench. The workbench is wooden.[if there is something on the s_5] On the workbench you see [a list of things on the s_5].[end if]".
...
The f_5 and the f_4 and the f_1 and the f_2 and the f_0 and the f_3 are foods.
The f_5 and the f_4 and the f_1 and the f_2 and the f_0 and the f_3 are privately-named.
...
The printed name of f_4 is "cilantro".
Understand "cilantro" as f_4.
...
The printed name of f_3 is "black pepper".
Understand "black pepper" as f_3.
Understand "black" as f_3.
...
Test quest1_0 with "inventory / go west / examine cookbook / drop red hot pepper / drop red potato / drop black pepper / go east / go north / open screen door / go north / go west / take red apple"
...
Test quest5_0 with "inventory / go west / examine cookbook / drop red hot pepper / drop red potato / drop black pepper / go east / go north / open screen door / go north / go west / take red apple / go east / go east / go south / go south / go west / open fridge / take cilantro from fridge"
...
Test quest8_0 with "inventory / go west / examine cookbook / drop red hot pepper / drop red potato / drop black pepper / go east / go north / open screen door / go north / go west / take red apple / go east / go east / go south / go south / go west / open fridge / take cilantro from fridge / prepare meal"
...
Test quest9_0 with "inventory / go west / examine cookbook / drop red hot pepper / drop red potato / drop black pepper / go east / go north / open screen door / go north / go west / take red apple / go east / go east / go south / go south / go west / open fridge / take cilantro from fridge / prepare meal / eat meal"
