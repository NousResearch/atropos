...
The kitchen part 6 is some text that varies. The kitchen part 6 is " You lean against the wall, inadvertently pressing a secret button. The wall opens up to reveal a table. The table is massive.[if there is something on the s_0] On the table you can see [a list of things on the s_0]. It doesn't get more TextWorld than this![end if]".
The kitchen part 7 is some text that varies. The kitchen part 7 is "[if there is nothing on the s_0] However, the table, like an empty table, has nothing on it. Oh! Why couldn't there just be stuff on it?[end if]".
The kitchen part 8 is some text that varies. The kitchen part 8 is " Oh, great. Here's a counter. I guess it's true what they say, if you're looking for a counter, go to TextWorld. [if there is something on the s_1]You see [a list of things on the s_1] on the counter. You shudder, but continue examining the room.[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You find yourself in a bedroom. A standard kind of place.
 ...
 If you haven't noticed it already, there seems to be something there by the wall, it's a bed. [if there is something on the s_3]On the bed you make out [a list of things on the s_3].[end if]".
...
The livingroom part 0 is some text that varies. The livingroom part 0 is "You arrive in a livingroom. A standard kind of place.
 ...
 Hey, want to see a sofa? Look over there, a sofa. The sofa is comfy.[if there is something on the s_4] On the sofa you can see [a list of things on the s_4]. Something scurries by right in the corner of your eye. Probably nothing.[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You've just walked into a bathroom.
 ...
 Oh, great. Here's a toilet. [if there is something on the s_5]On the toilet you make out [a list of things on the s_5], so there's that.[end if]".
...
The printed name of f_2 is "parsley".
Understand "parsley" as f_2.
...
The printed name of f_7 is "salt".
Understand "salt" as f_7.
...
Test quest1_0 with "inventory / go north / examine cookbook / open plain door / go north / take salt from shelf"
...
Test quest8_0 with "inventory / go north / examine cookbook / open plain door / go north / take salt from shelf / take salt from shelf / go south / open fridge / take pork chop from fridge"
...
Test quest11_0 with "inventory / go north / examine cookbook / open plain door / go north / take salt from shelf / take salt from shelf / go south / open fridge / take pork chop from fridge / prepare meal"
...
Test quest12_0 with "inventory / go north / examine cookbook / open plain door / go north / take salt from shelf / take salt from shelf / go south / open fridge / take pork chop from fridge / prepare meal / eat meal"
