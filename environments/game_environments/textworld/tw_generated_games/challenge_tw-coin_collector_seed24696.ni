...
The bedchamber part 0 is some text that varies. The bedchamber part 0 is "You're now in the bedchamber. You begin to take stock of what's in the room.
...
The pantry part 0 is some text that varies. The pantry part 0 is "You are in a pantry. A typical one. Let's see what's in here.
...
Test quest0_0 with "go south / go west / go north / go west / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! First of all, go south. Following that, make an attempt to move west. Then, take a trip north. Th".
The objective part 1 is some text that varies. The objective part 1 is "en, venture west. Then, pick up the coin from the floor of the playroom. And if you do that, you're the winner!".
