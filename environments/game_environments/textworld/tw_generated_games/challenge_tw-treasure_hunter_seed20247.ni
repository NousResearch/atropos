...
The attic part 0 is some text that varies. The attic part 0 is "You've just shown up in an attic. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The recreation zone part 0 is some text that varies. The recreation zone part 0 is "You have come into the most usual of all possible recreation zones.
...
The workshop part 0 is some text that varies. The workshop part 0 is "Fancy seeing you here. Here, by the way, being the workshop. You begin looking for stuff.
...
The cookhouse part 0 is some text that varies. The cookhouse part 0 is "I am stoked to announce that you are now in the cookhouse.
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an fast paced round of TextWorld? You do! Your task for today is to recover the banana from the floor of the cellar.".
