...
The kitchen part 2 is some text that varies. The kitchen part 2 is " You make out a counter. What a coincidence, weren't you just thinking about a counter? [if there is something on the s_1]On the counter you see [a list of things on the s_1]. I mean, just wow! Isn't TextWorld just the best?[end if]".
...
The kitchen part 6 is some text that varies. The kitchen part 6 is " Were you looking for a kitchen island? Because look over there, it's a kitchen island. The kitchen island is standard.[if there is something on the s_3] On the kitchen island you can make out [a list of things on the s_3].[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "Of every bedroom you could have walked into, you had to walk into a standard one.

 You can make out [if c_0 is locked]a locked[else if c_0 is open]an opened[otherwise]a closed[end if]".
The bedroom part 1 is some text that varies. The bedroom part 1 is " chest drawer, which looks usual, right there by you.[if c_0 is open and there is something in the c_0] The chest drawer contains [a list of things in the c_0]![end if]".
...
The bedroom part 6 is some text that varies. The bedroom part 6 is " Hey, want to see a king-size bed? Look over there, a king-size bed. The king-size bed is standard.[if there is something on the s_0] On the king-size bed you can make out [a list of things on the s_0]. Something scurries by right in the corner of your eye. Probably nothing.[end if]".
The bedroom part 7 is some text that varies. The bedroom part 7 is "[if there is nothing on the s_0] But the thing hasn't got anything on it. It would have been so cool if there was stuff on the king-size bed.[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You are in a backyard. A typical kind of place. You can barely contain your excitement.

 Look over there! a set of chairs. The set of chairs is normal.[if there is something on the s_10] On the set of chairs you see [a list of things on the s_10].[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " What's that over there? It looks like it's a bbq. The bbq is typical.[if there is something on the s_8] On the bbq you see [a list of things on the s_8].[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " You see a patio table. The patio table is usual.[if there is something on the s_9] On the patio table you can make out [a list of things on the s_9]. Classic TextWorld.[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "Well I'll be, you are in a place we're calling a living room. The room is well lit.

 You see a couch. The couch is typical.[if there is something on the s_5] On the couch you can see [a list of things on the s_5]. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[end if]".
...
The bathroom part 5 is some text that varies. The bathroom part 5 is " You can see a sink. Make a note of this, you might have to put stuff on or in it later on. The sink is ordinary.[if there is something on the s_4] On the sink you make out [a list of things on the s_4].[end if]".
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First stop, make absolutely sure that the antique trunk is opened. And then, retrieve the old key from t".
The objective part 1 is some text that varies. The objective part 1 is "he antique trunk in the bedroom. After you have picked up the old key, look and see that the wooden door inside the bedroom is unlocked. After that, ensure that the wooden door is open. After that, go".
The objective part 2 is some text that varies. The objective part 2 is " to the east. After that, open the refrigerator. After that, recover the milk from the refrigerator. And then, rest the milk on the stove. Alright, thanks!".
