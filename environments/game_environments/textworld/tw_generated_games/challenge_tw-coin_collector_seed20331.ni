...
Test quest0_0 with "go west / go north / go west / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First off, if it's not too much trouble, I need you to go to the west. And then, move north. If you can ".
The objective part 1 is some text that varies. The objective part 1 is "manage that, go west. Then, pick up the coin from the floor of the salon. And if you do that, you're the winner!".
