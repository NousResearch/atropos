...
The chamber part 0 is some text that varies. The chamber part 0 is "You are in a typical kind of place. That is to say, you're in a chamber. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The o_0 is in r_0.
The description of o_1 is "The vacuum would seem to be well matched to everything else here".
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Recover the pen from the floor of the cubicle.".
