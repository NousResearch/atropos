...
The k_0 is in r_3.
The description of o_0 is "The whisk seems to fit in here".
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an life changing round of TextWorld? You do! Here is how to play! First of all, go north. And then, retrieve the latchkey from the floor of the".
The objective part 1 is some text that varies. The objective part 1 is " shower. And if you do that, you're the winner!".
