...
The description of o_0 is "The coin is expensive looking.".
...
Test quest0_0 with "go east / go south / go west / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First off, if it's not too much trouble, I need you to make an effort to head east. After that, make an ".
The objective part 1 is some text that varies. The objective part 1 is "attempt to go south. Then, attempt to go west. And then, recover the coin from the floor of the steam room. Got that? Good!".
