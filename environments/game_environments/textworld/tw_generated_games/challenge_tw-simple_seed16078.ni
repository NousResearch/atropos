...
The kitchen part 2 is some text that varies. The kitchen part 2 is " You make out a counter. You wonder idly who left that here. The counter is usual.[if there is something on the s_1] On the counter you make out [a list of things on the s_1].[end if]".
The kitchen part 3 is some text that varies. The kitchen part 3 is "[if there is nothing on the s_1] But there isn't a thing on it. It would have been so cool if there was stuff on the counter.[end if]".
...
The kitchen part 7 is some text that varies. The kitchen part 7 is "[if there is nothing on the s_3] But there isn't a thing on it. It would have been so cool if there was stuff on the kitchen island.[end if]".
...
The bedroom part 4 is some text that varies. The bedroom part 4 is " You can see a king-size bed. The king-size bed is typical.[if there is something on the s_0] On the king-size bed you see [a list of things on the s_0].[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " Look out! It's a- oh, never mind, it's just a bbq. The bbq is typical.[if there is something on the s_8] On the bbq you can make out [a list of things on the s_8].[end if]".
The backyard part 3 is some text that varies. The backyard part 3 is "[if there is nothing on the s_8] Looks like someone's already been here and taken everything off it, though. It would have been so cool if there was stuff on the bbq.[end if]".
...
The living room part 4 is some text that varies. The living room part 4 is " You see a tv. You shudder, but continue examining the tv. The tv is ordinary.[if there is something on the s_7] On the tv you can make out [a list of things on the s_7].[end if]".
...
The bathroom part 2 is some text that varies. The bathroom part 2 is " You see a bath.[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4]. Something scurries by right in the corner of your eye. Probably nothing.[end if]".
...
The bathroom part 4 is some text that varies. The bathroom part 4 is " You see a sink. The sink is standard.[if there is something on the s_4] On the sink you can see [a list of things on the s_4]. Wow! Just like in the movies![end if]".
...
The c_4 is in r_3.
The c_4 is closed.
The description of f_3 is "The apple looks appealing.".
...
The description of f_2 is "that's a normal bell pepper!".
