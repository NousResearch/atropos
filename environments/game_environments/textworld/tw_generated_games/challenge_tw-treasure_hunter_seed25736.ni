...
The office part 0 is some text that varies. The office part 0 is "You find yourself in an office. An ordinary one. You try to gain information on your surroundings by using a technique you call 'looking.'



There is an exit to the east. Don't worry, it is unguarded. There is an exit to the south. Don't worry, it is unguarded. There is an unblocked exit to the west.".
...
Test quest0_0 with "go east / go south / take teaspoon"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another life changing round of TextWorld! Here is your task for today. First, it would be good if you could venture east. Then, move south. And then, recover the teaspoon from the floor of ".
The objective part 1 is some text that varies. The objective part 1 is "the kitchenette. Once that's all handled, you can stop!".
