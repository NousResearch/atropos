...
The study part 0 is some text that varies. The study part 0 is "Well how about that, you are in the place we're calling the study. You can barely contain your excitement.
...
The kitchenette part 0 is some text that varies. The kitchenette part 0 is "You have moved into a kitchenette. Not the kitchenette you'd expect. No, this is a kitchenette. Let's see what's in here.
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an life changing round of TextWorld? You do! Here is how to play! First thing I need you to do is to make an effort to go east. That done, lift".
The objective part 1 is some text that varies. The objective part 1 is " the stick of butter from the floor of the bar. Alright, thanks!".
