...
The r_0 and the r_5 and the r_1 and the r_9 and the r_2 and the r_3 and the r_7 and the r_6 and the r_10 and the r_4 and the r_8 and the r_11 are rooms.
...
The kitchen part 4 is some text that varies. The kitchen part 4 is " conventional looking oven here.[if oven_0 is open and there is something in the oven_0] The oven contains [a list of things in the oven_0]. Hmmm... what else, what else?[end if]".
...
The kitchen part 14 is some text that varies. The kitchen part 14 is " plain door leading west. You don't like doors? Why not try going north, that entranceway is not blocked by one.".
...
The livingroom part 0 is some text that varies. The livingroom part 0 is "You arrive in a livingroom. A normal one.
 ...
 If you haven't noticed it already, there seems to be something there by the wall, it's a sofa. The sofa is comfy.[if there is something on the s_7] On the sofa you can make out [a list of things on the s_7]. Huh, weird.[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You are in a bathroom. A normal one.
 ...
 You can see a toilet. [if there is something on the s_5]You see [a list of things on the s_5] on the toilet. Huh, weird.[end if]".
...
The shed part 0 is some text that varies. The shed part 0 is "You are in a shed. It seems to be pretty ordinary here.
 ...
 You rest your hand against a wall, but you miss the wall and fall onto a toolbox.[if c_1 is open and there is something in the c_1] The toolbox contains [a list of things in the c_1]. The light flickers for a second, but nothing else happens.[end if]".
...
The shed part 2 is some text that varies. The shed part 2 is " You make out a workbench. The workbench is wooden.[if there is something on the s_9] On the workbench you can make out [a list of things on the s_9].[end if]".
The shed part 3 is some text that varies. The shed part 3 is "[if there is nothing on the s_9] But oh no! there's nothing on this piece of trash.[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You are in a backyard. A typical kind of place.
 ...
 Look over there! a patio table. Why don't you take a picture of it, it'll last longer! The patio table is stylish.[if there is something on the s_4] On the patio table you can see [a list of things on the s_4].[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " You can see a BBQ, so there's that.[if toaster_0 is open and there is something in the toaster_0] The BBQ contains [a list of things in the toaster_0], so there's that.[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You've entered a bedroom. The room is well lit.
 ...
 You make out a bed. The bed is large.[if there is something on the s_8] On the bed you can make out [a list of things on the s_8]. Classic TextWorld.[end if]".
...
The supermarket part 0 is some text that varies. The supermarket part 0 is "Well, here we are in the supermarket. You decide to just list off a complete list of everything you see in the room, because hey, why not?

 What's that over there? It looks like it's a showcase. The showcase is metallic.[if there is something on the s_3] On the showcase you can see [a list of things on the s_3]. Hmmm... what else, what else?[end if]".
...
The r_0 and the r_5 and the r_1 and the r_9 and the r_2 and the r_3 and the r_7 and the r_6 and the r_10 and the r_4 and the r_8 and the r_11 are rooms.
The r_0 and the r_5 and the r_1 and the r_9 and the r_2 and the r_3 and the r_7 and the r_6 and the r_10 and the r_4 and the r_8 and the r_11 are privately-named.
...
Test quest1_0 with "inventory / go north / go west / go south / examine cookbook / open sliding patio door / go south / go south / take banana"
...
Test quest2_0 with "inventory / go north / go west / go south / examine cookbook / open sliding patio door / go south / go south / take banana / go north / go north / go north / take purple potato from counter / take purple potato from counter / go south / cook banana with BBQ"
...
Test quest5_0 with "inventory / go north / go west / go south / examine cookbook / open sliding patio door / go south / go south / take banana / go north / go north / go north / take purple potato from counter"
...
Test quest6_0 with "inventory / go north / go west / go south / examine cookbook / open sliding patio door / go south / go south / take banana / go north / go north / go north / take purple potato from counter / take purple potato from counter / go south / cook banana with BBQ / cook banana with BBQ / go north / cook purple potato with stove"
...
Test quest8_0 with "inventory / go north / go west / go south / examine cookbook / open sliding patio door / go south / go south / take banana / go north / go north / go north / take purple potato from counter / take purple potato from counter / go south / cook banana with BBQ / cook banana with BBQ / go north / cook purple potato with stove / prepare meal"
...
Test quest9_0 with "inventory / go north / go west / go south / examine cookbook / open sliding patio door / go south / go south / take banana / go north / go north / go north / take purple potato from counter / take purple potato from counter / go south / cook banana with BBQ / cook banana with BBQ / go north / cook purple potato with stove / prepare meal / eat meal"
