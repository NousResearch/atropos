...
The r_0 and the r_1 and the r_10 and the r_9 and the r_2 and the r_6 and the r_8 and the r_11 and the r_3 and the r_4 and the r_5 and the r_7 are rooms.
...
The kitchen part 0 is some text that varies. The kitchen part 0 is "You've entered a kitchen.
 ...
 You see a gleam over in a corner, where you can see a fridge. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[if c_0 is open and there is something in the c_0] The fridge contains [a list of things in the c_0].[end if]".
...
The kitchen part 6 is some text that varies. The kitchen part 6 is " You see a gleam over in a corner, where you can see a counter. The counter is vast.[if there is something on the s_1] On the counter you can make out [a list of things on the s_1]. It doesn't get more TextWorld than this![end if]".
...
The kitchen part 8 is some text that varies. The kitchen part 8 is " You rest your hand against a wall, but you miss the wall and fall onto a stove. [if there is something on the stove_0]On the stove you see [a list of things on the stove_0].[end if]".
...
The pantry part 0 is some text that varies. The pantry part 0 is "You are in a pantry. An usual kind of place. You start to take note of what's in the room.
 ...
 You can make out a shelf. Now why would someone leave that there? The shelf is wooden.[if there is something on the s_2] On the shelf you make out [a list of things on the s_2].[end if]".
...
The street part 1 is some text that varies. The street part 1 is " sliding door leading south. There is an exit to the west. Don't worry, there is no door.".
...
The driveway part 0 is some text that varies. The driveway part 0 is "You are in a driveway. It seems to be pretty normal here.
...
The corridor part 0 is some text that varies. The corridor part 0 is "You find yourself in a corridor. An ordinary one.
 ...
 There is [if d_3 is open]an open[otherwise]a closed[end if]".
The corridor part 1 is some text that varies. The corridor part 1 is " front door leading east. There is an exit to the north. You don't like doors? Why not try going south, that entranceway is not blocked by one. There is an exit to the west. Don't worry, there is no door.".
...
The backyard part 0 is some text that varies. The backyard part 0 is "Well, here we are in a backyard. I guess you better just go and list everything you see here.
...
The backyard part 2 is some text that varies. The backyard part 2 is " What's that over there? It looks like it's a patio table. [if there is something on the s_9]You see [a list of things on the s_9] on the patio table. Suddenly, you bump your head on the ceiling, but it's not such a bad bump that it's going to prevent you from looking at objects and even things.[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You find yourself in a bedroom. A typical kind of place. I guess you better just go and list everything you see here.
 ...
 If you haven't noticed it already, there seems to be something there by the wall, it's a bed. The bed is large.[if there is something on the s_7] On the bed you can make out [a list of things on the s_7].[end if]".
...
The livingroom part 0 is some text that varies. The livingroom part 0 is "You've just walked into a livingroom.
 ...
 You can make out a sofa. What a coincidence, weren't you just thinking about a sofa? The sofa is comfy.[if there is something on the s_5] On the sofa you can see [a list of things on the s_5].[end if]".
...
The bathroom part 1 is some text that varies. The bathroom part 1 is "[if there is nothing on the s_8]But oh no! there's nothing on this piece of junk. It would have been so cool if there was stuff on the toilet.[end if]".
...
The shed part 0 is some text that varies. The shed part 0 is "You're now in the shed. You start to take note of what's in the room.
...
The shed part 2 is some text that varies. The shed part 2 is " You can see a workbench. The workbench is wooden.[if there is something on the s_4] On the workbench you make out [a list of things on the s_4].[end if]".
...
The ingredient_1 and the ingredient_0 are ingredient-likes.
The ingredient_1 and the ingredient_0 are privately-named.
...
The r_0 and the r_1 and the r_10 and the r_9 and the r_2 and the r_6 and the r_8 and the r_11 and the r_3 and the r_4 and the r_5 and the r_7 are rooms.
The r_0 and the r_1 and the r_10 and the r_9 and the r_2 and the r_6 and the r_8 and the r_11 and the r_3 and the r_4 and the r_5 and the r_7 are privately-named.
...
Test quest1_0 with "inventory / go east / go east / go north / examine cookbook / examine cookbook / go south / go west / take banana"
...
Test quest2_0 with "inventory / go east / go east / go north / examine cookbook / examine cookbook / go south / go west / take banana / go east / go east / go north / take yellow bell pepper from fridge / take yellow bell pepper from fridge / go south / cook banana with BBQ"
...
Test quest5_0 with "inventory / go east / go east / go north / examine cookbook / examine cookbook / go south / go west / take banana / go east / go east / go north / take yellow bell pepper from fridge"
...
Test quest6_0 with "inventory / go east / go east / go north / examine cookbook / examine cookbook / go south / go west / take banana / go east / go east / go north / take yellow bell pepper from fridge / take yellow bell pepper from fridge / go south / cook banana with BBQ / cook banana with BBQ / go north / cook yellow bell pepper with oven"
...
Test quest8_0 with "inventory / go east / go east / go north / examine cookbook / examine cookbook / go south / go west / take banana / go east / go east / go north / take yellow bell pepper from fridge / take yellow bell pepper from fridge / go south / cook banana with BBQ / cook banana with BBQ / go north / cook yellow bell pepper with oven / prepare meal"
...
Test quest9_0 with "inventory / go east / go east / go north / examine cookbook / examine cookbook / go south / go west / take banana / go east / go east / go north / take yellow bell pepper from fridge / take yellow bell pepper from fridge / go south / cook banana with BBQ / cook banana with BBQ / go north / cook yellow bell pepper with oven / prepare meal / eat meal"
...
This is the simpler notify score changes rule:
	...
	if quest1 completed is true and quest2 completed is true and quest5 completed is true and quest6 completed is true and quest8 completed is true and quest9 completed is true:
