...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a exciting session of TextWorld! First off, if it's not too much trouble, I need you to venture east. Then, attempt to move south. Next, pick up the latchkey from the floor of the ".
The objective part 1 is some text that varies. The objective part 1 is "chamber. Got that? Good!".
