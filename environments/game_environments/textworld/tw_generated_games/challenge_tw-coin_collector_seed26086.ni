...
The studio part 0 is some text that varies. The studio part 0 is "You have fallen into the most ordinary of all possible studios.
...
The launderette part 0 is some text that varies. The launderette part 0 is "You find yourself in a launderette. A normal kind of place. The room is well lit.
...
Test quest0_0 with "go east / go south / go south / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another profound episode of TextWorld! Here is your task for today. First, it would be a great idea if you could travel east. And then, venture south. Next, move south. Then, pick-up the co".
The objective part 1 is some text that varies. The objective part 1 is "in from the floor of the bedroom. Once that's all handled, you can stop!".
