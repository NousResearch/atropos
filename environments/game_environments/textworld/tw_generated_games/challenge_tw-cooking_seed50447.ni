...
The r_0 and the r_5 and the r_1 and the r_2 and the r_3 and the r_4 and the r_6 and the r_7 and the r_10 and the r_11 and the r_8 and the r_9 are rooms.
...
The kitchen part 1 is some text that varies. The kitchen part 1 is " fridge is right there by you.[if c_0 is open and there is something in the c_0] The fridge contains [a list of things in the c_0]. Something scurries by right in the corner of your eye. Probably nothing.[end if]".
...
The kitchen part 6 is some text that varies. The kitchen part 6 is " You see a table. I guess it's true what they say, if you're looking for a table, go to TextWorld. The table is massive.[if there is something on the s_0] On the table you make out [a list of things on the s_0].[end if]".
...
The kitchen part 8 is some text that varies. The kitchen part 8 is " Were you looking for a counter? Because look over there, it's a counter. The counter is vast.[if there is something on the s_1] On the counter you see [a list of things on the s_1]. You shudder, but continue examining the room.[end if]".
...
The kitchen part 14 is some text that varies. The kitchen part 14 is " frosted-glass door leading west. You don't like doors? Why not try going east, that entranceway is not blocked by one. There is an exit to the south. Don't worry, there is no door.".
...
The pantry part 0 is some text that varies. The pantry part 0 is "You're now in a pantry.
 ...
 You see a shelf. The shelf is wooden.[if there is something on the s_2] On the shelf you can make out [a list of things on the s_2]. Suddenly, you bump your head on the ceiling, but it's not such a bad bump that it's going to prevent you from looking at objects and even things.[end if]".
...
The livingroom part 0 is some text that varies. The livingroom part 0 is "You've just sauntered into a livingroom. You begin to take stock of what's here.
 ...
 You see a sofa. Now why would someone leave that there? The sofa is comfy.[if there is something on the s_6] On the sofa you make out [a list of things on the s_6]. Hmmm... what else, what else?[end if]".
...
The livingroom part 3 is some text that varies. The livingroom part 3 is " fiberglass door leading north. There is an exit to the south. There is an exit to the west. Don't worry, there is no door.".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You find yourself in a typical kind of place. That is to say, you're in a bedroom. The room is well lit.
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You arrive in a bathroom. A typical kind of place.
 ...
 Oh wow! Is that what I think it is? It is! It's a toilet. The toilet is white.[if there is something on the s_9] On the toilet you make out [a list of things on the s_9].[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You've just shown up in a backyard. You can barely contain your excitement.

 You can make out a patio chair. Now why would someone leave that there? [if there is something on the s_7]On the patio chair you can make out [a list of things on the s_7].[end if]".
...
The shed part 0 is some text that varies. The shed part 0 is "You're now in a shed. Let's see what's in here.
...
The garden part 0 is some text that varies. The garden part 0 is "You are in a garden. An usual one. You begin to take stock of what's in the room.
...
The r_0 and the r_5 and the r_1 and the r_2 and the r_3 and the r_4 and the r_6 and the r_7 and the r_10 and the r_11 and the r_8 and the r_9 are rooms.
The r_0 and the r_5 and the r_1 and the r_2 and the r_3 and the r_4 and the r_6 and the r_7 and the r_10 and the r_11 and the r_8 and the r_9 are privately-named.
...
The printed name of f_2 is "water".
The indefinite article of f_2 is "some".
Understand "water" as f_2.
The f_2 is drinkable.
The f_2 is inedible.
...
Test quest1_0 with "inventory / go north / examine cookbook / take yellow bell pepper from fridge"
...
Test quest4_0 with "inventory / go north / examine cookbook / take yellow bell pepper from fridge / prepare meal"
...
Test quest5_0 with "inventory / go north / examine cookbook / take yellow bell pepper from fridge / prepare meal / eat meal"
