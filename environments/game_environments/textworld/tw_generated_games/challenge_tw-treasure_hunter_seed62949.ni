...
The shower part 0 is some text that varies. The shower part 0 is "Well, here we are in a shower. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another life changing session of TextWorld! Here is how to play! First thing I need you to do is to make an effort to go west. With that accomplished, retrieve the garlic clove from the flo".
