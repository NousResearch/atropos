...
The kitchen part 7 is some text that varies. The kitchen part 7 is " You see a counter. Why don't you take a picture of it, it'll last longer! [if there is something on the s_1]On the counter you see [a list of things on the s_1].[end if]".
...
The kitchen part 9 is some text that varies. The kitchen part 9 is " If you haven't noticed it already, there seems to be something there by the wall, it's a stove. [if there is something on the stove_0]On the stove you make out [a list of things on the stove_0], so there's that.[end if]".
...
Test quest8_0 with "inventory / examine cookbook / take yellow potato from counter / open fridge / take yellow bell pepper from fridge / prepare meal"
...
Test quest9_0 with "inventory / examine cookbook / take yellow potato from counter / open fridge / take yellow bell pepper from fridge / prepare meal / eat meal"
