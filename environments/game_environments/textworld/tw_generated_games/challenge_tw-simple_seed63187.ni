...
The kitchen part 0 is some text that varies. The kitchen part 0 is "You find yourself in a kitchen. An ordinary kind of place.
 ...
 You can make out a refrigerator. You wonder idly who left that here.[if c_2 is open and there is something in the c_2] The refrigerator contains [a list of things in the c_2]. Huh, weird.[end if]".
...
The kitchen part 3 is some text that varies. The kitchen part 3 is "[if there is nothing on the s_1]But the thing is empty. What, you think everything in TextWorld should have stuff on it?[end if]".
The kitchen part 4 is some text that varies. The kitchen part 4 is " You scan the room for a stove, and you find a stove. The stove is usual.[if there is something on the s_2] On the stove you can make out [a list of things on the s_2].[end if]".
...
The kitchen part 7 is some text that varies. The kitchen part 7 is "[if there is nothing on the s_3] The kitchen island appears to be empty. Hopefully this doesn't make you too upset.[end if]".
...
The bedroom part 4 is some text that varies. The bedroom part 4 is " You rest your hand against a wall, but you miss the wall and fall onto a king-size bed. [if there is something on the s_0]On the king-size bed you make out [a list of things on the s_0].[end if]".
The bedroom part 5 is some text that varies. The bedroom part 5 is "[if there is nothing on the s_0]But the thing hasn't got anything on it. Hopefully, this discovery doesn't ruin your TextWorld experience![end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You have entered a backyard. Not the backyard you'd expect. No, this is a backyard. Let's see what's in here.

 You can see a set of chairs. You wonder idly who left that here. The set of chairs is usual.[if there is something on the s_10] On the set of chairs you make out [a list of things on the s_10].[end if]".
The backyard part 1 is some text that varies. The backyard part 1 is "[if there is nothing on the s_10] Looks like someone's already been here and taken everything off it, though. Oh! Why couldn't there just be stuff on it?[end if]".
The backyard part 2 is some text that varies. The backyard part 2 is " You can see a bbq. [if there is something on the s_8]On the bbq you can make out [a list of things on the s_8]. Hmmm... what else, what else?[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " You smell an interesting smell, and follow it to a patio table. The patio table is usual.[if there is something on the s_9] On the patio table you can see [a list of things on the s_9].[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You've just walked into a living room.
 ...
 You make out a couch. [if there is something on the s_5]On the couch you can make out [a list of things on the s_5]. There's something strange about this thing being here, but you don't have time to worry about that now.[end if]".
...
The living room part 2 is some text that varies. The living room part 2 is " You can see a low table. The low table is ordinary.[if there is something on the s_6] On the low table you can see [a list of things on the s_6]. I mean, just wow! Isn't TextWorld just the best?[end if]".
...
The living room part 4 is some text that varies. The living room part 4 is " You see a tv. The tv is usual.[if there is something on the s_7] On the tv you see [a list of things on the s_7].[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You are in a bathroom. A typical kind of place. You try to gain information on your surroundings by using a technique you call 'looking.'

 You see [if c_3 is locked]a locked[else if c_3 is open]an opened[otherwise]a closed[end if]".
The bathroom part 1 is some text that varies. The bathroom part 1 is " toilet nearby.[if c_3 is open and there is something in the c_3] The toilet contains [a list of things in the c_3]. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[end if]".
...
The bathroom part 4 is some text that varies. The bathroom part 4 is " bath right there by you.[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4].[end if]".
...
The bathroom part 6 is some text that varies. The bathroom part 6 is " You make out a sink. [if there is something on the s_4]On the sink you can see [a list of things on the s_4].[end if]".
The bathroom part 7 is some text that varies. The bathroom part 7 is "[if there is nothing on the s_4]Unfortunately, there isn't a thing on it. Silly sink, silly, empty, good for nothing sink.[end if]".
