...
The shower part 0 is some text that varies. The shower part 0 is "I never took you for the sort of person who would show up in a shower, but I guess I was wrong. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
Test quest0_0 with "go south / go south / go south / go south / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First, it would be great if you could go south. Following that, make an attempt to go to the south. And ".
The objective part 1 is some text that varies. The objective part 1 is "then, go to the south. With that done, take a trip south. And then, lift the coin from the floor of the canteen. And if you do that, you're the winner!".
