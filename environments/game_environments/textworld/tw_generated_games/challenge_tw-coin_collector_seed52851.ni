...
The salon part 0 is some text that varies. The salon part 0 is "This might come as a shock to you, but you've just come into a salon.
...
The office part 0 is some text that varies. The office part 0 is "This might come as a shock to you, but you've just walked into an office.
...
The launderette part 0 is some text that varies. The launderette part 0 is "You are in a launderette. An ordinary kind of place. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The description of o_0 is "The coin would seem to be well matched to everything else here".
...
Test quest0_0 with "go east / go south / go west / go north / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an exciting round of TextWorld? You do! Here is your task for today. First of all, you could, like, travel east. With that over with, attempt t".
The objective part 1 is some text that varies. The objective part 1 is "o go south. And then, make an effort to move west. And then, try to go to the north. Next, pick-up the coin from the floor of the launderette. Once that's all handled, you can stop!".
