...
The r_0 and the r_5 and the r_11 and the r_10 and the r_2 and the r_3 and the r_9 and the r_4 and the r_1 and the r_6 and the r_8 and the r_7 are rooms.
...
The kitchen part 4 is some text that varies. The kitchen part 4 is " You can make out a table. [if there is something on the s_0]On the table you can see [a list of things on the s_0].[end if]".
...
The pantry part 0 is some text that varies. The pantry part 0 is "You are in a pantry. You can barely contain your excitement.
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "Look at you, bigshot, walking into a bedroom like it isn't some huge deal. You start to take note of what's in the room.
 ...
 As if things weren't amazing enough already, you can even see a bed. Now why would someone leave that there? [if there is something on the s_8]On the bed you can see [a list of things on the s_8].[end if]".
The bedroom part 1 is some text that varies. The bedroom part 1 is "[if there is nothing on the s_8]Looks like someone's already been here and taken everything off it, though. You think about smashing the bed to bits, throwing the bits into the garbage, etc, until you get bored and decide to move on.[end if]".
...
The livingroom part 0 is some text that varies. The livingroom part 0 is "You've just walked into a livingroom.
 ...
 Were you looking for a sofa? Because look over there, it's a sofa. [if there is something on the s_9]You see [a list of things on the s_9] on the sofa. I mean, just wow! Isn't TextWorld just the best?[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You find yourself in a bathroom. A normal one.
 ...
 Oh wow! Is that what I think it is? It is! It's a toilet. [if there is something on the s_6]On the toilet you see [a list of things on the s_6].[end if]".
The bathroom part 1 is some text that varies. The bathroom part 1 is "[if there is nothing on the s_6]However, the toilet, like an empty toilet, has nothing on it. This always happens, here in TextWorld![end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " Hey, want to see a patio chair? Look over there, a patio chair. [if there is something on the s_5]On the patio chair you can make out [a list of things on the s_5].[end if]".
The backyard part 3 is some text that varies. The backyard part 3 is "[if there is nothing on the s_5]Looks like someone's already been here and taken everything off it, though. Hm. Oh well[end if]".
...
The shed part 3 is some text that varies. The shed part 3 is " You scan the room for a workbench, and you find a workbench. The workbench is wooden.[if there is something on the s_7] On the workbench you see [a list of things on the s_7]. Huh, weird.[end if]".
The shed part 4 is some text that varies. The shed part 4 is "[if there is nothing on the s_7] However, the workbench, like an empty workbench, has nothing on it. Oh! Why couldn't there just be stuff on it?[end if]".
...
The f_5 and the f_7 and the f_9 and the f_1 and the f_10 and the f_11 and the f_0 and the f_2 and the f_3 and the f_6 and the f_8 and the f_4 are foods.
The f_5 and the f_7 and the f_9 and the f_1 and the f_10 and the f_11 and the f_0 and the f_2 and the f_3 and the f_6 and the f_8 and the f_4 are privately-named.
...
The r_0 and the r_5 and the r_11 and the r_10 and the r_2 and the r_3 and the r_9 and the r_4 and the r_1 and the r_6 and the r_8 and the r_7 are rooms.
The r_0 and the r_5 and the r_11 and the r_10 and the r_2 and the r_3 and the r_9 and the r_4 and the r_1 and the r_6 and the r_8 and the r_7 are privately-named.
...
The d_1 is closed.
The description of d_4 is "The [noun] looks robust. [if open]You can see inside it.[else if locked]There is a lock on it and seems impossible to bash open.[otherwise]You can't see inside it because the lid's in your way.[end if]".
...
The printed name of f_11 is "salt".
Understand "salt" as f_11.
The base of ingredient_0 is f_11.
The f_11 is cooked.
The f_11 is edible.
The f_11 is on the s_2.
...
The printed name of f_4 is "olive oil".
The indefinite article of f_4 is "some".
Understand "olive oil" as f_4.
Understand "olive" as f_4.
Understand "oil" as f_4.
The f_4 is inedible.
