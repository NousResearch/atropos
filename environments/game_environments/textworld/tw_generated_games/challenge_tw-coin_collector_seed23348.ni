...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an exciting round of TextWorld? You do! First step, go to the south. With that accomplished, make an effort to venture west. With that over wit".
The objective part 1 is some text that varies. The objective part 1 is "h, venture west. That done, recover the coin from the floor of the playroom. Once that's all handled, you can stop!".
