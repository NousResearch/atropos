...
The kitchen part 3 is some text that varies. The kitchen part 3 is "[if there is nothing on the s_1] The counter appears to be empty. What, you think everything in TextWorld should have stuff on it?[end if]".
The kitchen part 4 is some text that varies. The kitchen part 4 is " You can see a stove. The stove is usual.[if there is something on the s_2] On the stove you can see [a list of things on the s_2].[end if]".
The kitchen part 5 is some text that varies. The kitchen part 5 is "[if there is nothing on the s_2] But the thing hasn't got anything on it. Hm. Oh well[end if]".
...
The bedroom part 3 is some text that varies. The bedroom part 3 is " As if things weren't amazing enough already, you can even see an antique trunk. Classic TextWorld.[if c_1 is open and there is something in the c_1] The antique trunk contains [a list of things in the c_1].[end if]".
...
The bedroom part 5 is some text that varies. The bedroom part 5 is " You can make out a king-size bed. [if there is something on the s_0]On the king-size bed you can see [a list of things on the s_0]. Something scurries by right in the corner of your eye. Probably nothing.[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You find yourself in a backyard. An ordinary one.
 ...
 You lean against the wall, inadvertently pressing a secret button. The wall opens up to reveal a set of chairs. Now why would someone leave that there? The set of chairs is normal.[if there is something on the s_10] On the set of chairs you can see [a list of things on the s_10].[end if]".
The backyard part 1 is some text that varies. The backyard part 1 is "[if there is nothing on the s_10] But the thing is empty. This always happens, here in TextWorld![end if]".
The backyard part 2 is some text that varies. The backyard part 2 is " You can make out a bbq. Why don't you take a picture of it, it'll last longer! [if there is something on the s_8]On the bbq you can make out [a list of things on the s_8].[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " You make out a patio table. The patio table is normal.[if there is something on the s_9] On the patio table you see [a list of things on the s_9].[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You find yourself in a living room. An usual kind of place. I guess you better just go and list everything you see here.

 You can see a couch. The couch is normal.[if there is something on the s_5] On the couch you can see [a list of things on the s_5]. There's something strange about this thing being here, but you don't have time to worry about that now.[end if]".
The living room part 1 is some text that varies. The living room part 1 is "[if there is nothing on the s_5] But the thing is empty, unfortunately. You move on, clearly furious with TextWorld.[end if]".
The living room part 2 is some text that varies. The living room part 2 is " You scan the room, seeing a low table. [if there is something on the s_6]On the low table you see [a list of things on the s_6].[end if]".
The living room part 3 is some text that varies. The living room part 3 is "[if there is nothing on the s_6]But the thing hasn't got anything on it. This always happens, here in TextWorld![end if]".
The living room part 4 is some text that varies. The living room part 4 is " What's that over there? It looks like it's a tv. The tv is normal.[if there is something on the s_7] On the tv you can make out [a list of things on the s_7]. Something scurries by right in the corner of your eye. Probably nothing.[end if]".
...
The bathroom part 3 is some text that varies. The bathroom part 3 is " You can make out a bath.[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4]. You shudder, but continue examining the room.[end if]".
...
The bathroom part 5 is some text that varies. The bathroom part 5 is " You see a sink. The sink is normal.[if there is something on the s_4] On the sink you can see [a list of things on the s_4].[end if]".
...
The c_4 is in r_3.
The c_4 is closed.
The description of f_3 is "The half of a bag of chips looks appealing.".
