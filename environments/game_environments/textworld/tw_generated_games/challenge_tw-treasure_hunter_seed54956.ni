...
The laundry place part 0 is some text that varies. The laundry place part 0 is "You make a grand eccentric entrance into a laundry place. You try to gain information on your surroundings by using a technique you call 'looking.'
...
Test quest0_0 with "go west / take peanut"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First stop, attempt to move west. Then, lift the peanut from the floor of the laundry place. And once yo".
The objective part 1 is some text that varies. The objective part 1 is "u've done that, you win!".
