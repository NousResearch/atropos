...
The laundry place part 0 is some text that varies. The laundry place part 0 is "You find yourself in a laundry place. An ordinary one. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The description of o_0 is "The coin is well-used.".
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an exciting round of TextWorld? You do! Here is how to play! First off, make an attempt to go west. Next, try to travel south. After that, go e".
The objective part 1 is some text that varies. The objective part 1 is "ast. And then, make an effort to take a trip east. And then, pick up the coin from the floor of the launderette. Alright, thanks!".
