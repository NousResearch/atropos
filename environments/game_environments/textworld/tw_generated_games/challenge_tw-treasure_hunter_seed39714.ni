...
The cookhouse part 0 is some text that varies. The cookhouse part 0 is "You are in a cookhouse. An ordinary kind of place. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The f_0 is in r_3.
The description of f_1 is "The sandwich looks delicious.".
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another life changing round of TextWorld! First stop, attempt to move west. And then, pick-up the loaf of bread from the floor of the scullery. And once you've done that, you win!".
