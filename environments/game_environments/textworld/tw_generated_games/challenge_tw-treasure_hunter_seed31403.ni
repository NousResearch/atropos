...
The laundromat part 0 is some text that varies. The laundromat part 0 is "You're now in a laundromat. I guess you better just go and list everything you see here.
...
The pantry part 0 is some text that varies. The pantry part 0 is "You find yourself in a pantry. A standard kind of place. You begin to take stock of what's in the room.
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an exciting round of TextWorld? You do! Here is your task for today. First step, head east. And then, recover the passkey from the floor of the".
The objective part 1 is some text that varies. The objective part 1 is " pantry. Once that's all handled, you can stop!".
