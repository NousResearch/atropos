...
The restroom part 0 is some text that varies. The restroom part 0 is "Of every restroom you could have shown up in, you had to walk into a standard one.
...
Test quest0_0 with "go west / go west / go south / go east / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is your task for today. First, it would be fantastic if you could move west. With that accomplished, go west. After that, try to go to the south. Once you get around to doin".
The objective part 1 is some text that varies. The objective part 1 is "g that, take a trip east. Then, recover the coin from the floor of the closet. And if you do that, you're the winner!".
