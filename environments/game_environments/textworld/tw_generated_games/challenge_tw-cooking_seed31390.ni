...
The kitchen part 4 is some text that varies. The kitchen part 4 is " You see a table. [if there is something on the s_0]On the table you see [a list of things on the s_0]. Classic TextWorld.[end if]".
...
The kitchen part 9 is some text that varies. The kitchen part 9 is "[if there is nothing on the stove_0]But the thing is empty. You think about smashing the stove to bits, throwing the bits in the dump, etc, until you get bored and decide to move on.[end if]".
...
Test quest1_0 with "inventory / examine cookbook / drop red apple / drop black pepper / take red onion from fridge"
...
Test quest10_0 with "inventory / examine cookbook / drop red apple / drop black pepper / take red onion from fridge / prepare meal"
...
Test quest11_0 with "inventory / examine cookbook / drop red apple / drop black pepper / take red onion from fridge / prepare meal / eat meal"
