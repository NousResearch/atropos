...
The kitchen part 0 is some text that varies. The kitchen part 0 is "You find yourself in a kitchen. A typical kind of place. I guess you better just go and list everything you see here.
...
The kitchen part 2 is some text that varies. The kitchen part 2 is " You see a counter. The counter is usual.[if there is something on the s_1] On the counter you can see [a list of things on the s_1]. Classic TextWorld.[end if]".
...
The kitchen part 4 is some text that varies. The kitchen part 4 is " You make out a stove. The stove is normal.[if there is something on the s_2] On the stove you can see [a list of things on the s_2].[end if]".
...
The kitchen part 6 is some text that varies. The kitchen part 6 is " You smell a sickening smell, and follow it to a kitchen island. The kitchen island is normal.[if there is something on the s_3] On the kitchen island you see [a list of things on the s_3].[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You find yourself in a bedroom. A typical kind of place. You begin to take stock of what's in the room.
...
The bedroom part 5 is some text that varies. The bedroom part 5 is " What's that over there? It looks like it's a king-size bed. [if there is something on the s_0]You see [a list of things on the s_0] on the king-size bed. Huh, weird.[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You've entered a backyard.
 ...
 Look out! It's a- oh, never mind, it's just a set of chairs. The set of chairs is usual.[if there is something on the s_10] On the set of chairs you make out [a list of things on the s_10].[end if]".
The backyard part 1 is some text that varies. The backyard part 1 is "[if there is nothing on the s_10] But the thing is empty. Hopefully, this discovery doesn't ruin your TextWorld experience![end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "This might come as a shock to you, but you've just entered a living room.

 You bend down to tie your shoe. When you stand up, you notice a couch. [if there is something on the s_5]On the couch you can make out [a list of things on the s_5].[end if]".
...
The living room part 2 is some text that varies. The living room part 2 is " You can see a low table. [if there is something on the s_6]On the low table you can see [a list of things on the s_6].[end if]".
The living room part 3 is some text that varies. The living room part 3 is "[if there is nothing on the s_6]The low table appears to be empty. It would have been so cool if there was stuff on the low table! oh well.[end if]".
The living room part 4 is some text that varies. The living room part 4 is " You smell an interesting smell, and follow it to a tv. [if there is something on the s_7]You see [a list of things on the s_7] on the tv.[end if]".
...
The bathroom part 6 is some text that varies. The bathroom part 6 is " You can see a sink. [if there is something on the s_4]On the sink you make out [a list of things on the s_4].[end if]".
...
The s_9 is in r_4.
The description of f_0 is "The half of a bag of chips looks tantalizing.".
...
The description of f_2 is "The milk looks appealing.".
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an exciting round of TextWorld? You do! First of all, you could, like, open the antique trunk inside the bedroom. Once you have pulled open the".
The objective part 1 is some text that varies. The objective part 1 is " antique trunk, retrieve the old key from the antique trunk. After that, doublecheck that the wooden door is unlocked with the old key. And then, ensure that the wooden door in the bedroom is open. Af".
The objective part 2 is some text that varies. The objective part 2 is "ter that, go to the east. That done, ensure that the screen door within the kitchen is open. Then, go east. And then, head south. And then, retrieve the bell pepper from the floor of the garden. And t".
The objective part 3 is some text that varies. The objective part 3 is "hen, make an effort to go north. After that, go to the west. Then, sit the bell pepper on the stove. Got that? Good!".
