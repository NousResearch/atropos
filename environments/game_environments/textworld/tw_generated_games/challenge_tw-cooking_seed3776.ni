...
The r_0 and the r_2 and the r_1 and the r_3 and the r_5 and the r_4 and the r_6 and the r_7 and the r_8 are rooms.
...
The kitchen part 1 is some text that varies. The kitchen part 1 is " conventional looking fridge close by.[if c_0 is open and there is something in the c_0] The fridge contains [a list of things in the c_0]. I mean, just wow! Isn't TextWorld just the best?[end if]".
...
The kitchen part 4 is some text that varies. The kitchen part 4 is " oven is here.[if oven_0 is open and there is something in the oven_0] The oven contains [a list of things in the oven_0]. Make a note of this, you might have to put stuff on or in it later on.[end if]".
...
The kitchen part 7 is some text that varies. The kitchen part 7 is "[if there is nothing on the s_0]But the thing hasn't got anything on it. You move on, clearly upset by TextWorld.[end if]".
The kitchen part 8 is some text that varies. The kitchen part 8 is " As if things weren't amazing enough already, you can even see a counter. The counter is vast.[if there is something on the s_1] On the counter you can make out [a list of things on the s_1].[end if]".
...
The kitchen part 10 is some text that varies. The kitchen part 10 is " Look over there! a stove. The stove is conventional.[if there is something on the stove_0] On the stove you can see [a list of things on the stove_0].[end if]".
The kitchen part 11 is some text that varies. The kitchen part 11 is "[if there is nothing on the stove_0] But there isn't a thing on it. Hm. Oh well[end if]".
...
The kitchen part 14 is some text that varies. The kitchen part 14 is " patio door leading south. There is an exit to the west. Don't worry, there is no door.".
...
The livingroom part 0 is some text that varies. The livingroom part 0 is "You are in a normal kind of place. That is to say, you're in a livingroom.
 ...
 As if things weren't amazing enough already, you can even see a sofa. [if there is something on the s_8]On the sofa you make out [a list of things on the s_8].[end if]".
The livingroom part 1 is some text that varies. The livingroom part 1 is "[if there is nothing on the s_8]But there isn't a thing on it. Sometimes, just sometimes, TextWorld can just be the worst.[end if]".
...
The bathroom part 1 is some text that varies. The bathroom part 1 is "[if there is nothing on the s_6] But oh no! there's nothing on this piece of trash. You think about smashing the toilet to bits, throwing the bits into a pit, etc, until you get bored and decide to move on.[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You find yourself in a bedroom. A typical one.
 ...
 Were you looking for a bed? Because look over there, it's a bed. [if there is something on the s_3]On the bed you can see [a list of things on the s_3].[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You are in a backyard. It seems to be pretty usual here.
...
The backyard part 2 is some text that varies. The backyard part 2 is " You scan the room, seeing a patio table. [if there is something on the s_7]On the patio table you can make out [a list of things on the s_7]. You can't wait to tell the folks at home about this![end if]".
...
The garden part 0 is some text that varies. The garden part 0 is "You've just walked into a garden. Okay, just remember what you're here to do, and everything will go great.
...
The f_2 and the f_3 and the f_4 and the f_6 and the f_7 and the f_0 and the f_1 and the f_5 are foods.
The f_2 and the f_3 and the f_4 and the f_6 and the f_7 and the f_0 and the f_1 and the f_5 are privately-named.
...
The r_0 and the r_2 and the r_1 and the r_3 and the r_5 and the r_4 and the r_6 and the r_7 and the r_8 are rooms.
The r_0 and the r_2 and the r_1 and the r_3 and the r_5 and the r_4 and the r_6 and the r_7 and the r_8 are privately-named.
...
The printed name of f_6 is "parsley".
Understand "parsley" as f_6.
...
Test quest1_0 with "inventory / examine cookbook / drop white onion / drop yellow potato / drop purple potato / take banana from counter"
...
Test quest5_0 with "inventory / examine cookbook / drop white onion / drop yellow potato / drop purple potato / take banana from counter / take parsley from fridge"
...
Test quest9_0 with "inventory / examine cookbook / drop white onion / drop yellow potato / drop purple potato / take banana from counter / take parsley from fridge / take parsley from fridge / go south / go east / take red hot pepper"
...
Test quest12_0 with "inventory / examine cookbook / drop white onion / drop yellow potato / drop purple potato / take banana from counter / take parsley from fridge / take parsley from fridge / go south / go east / take red hot pepper / go west / go west / go north / prepare meal"
...
Test quest13_0 with "inventory / examine cookbook / drop white onion / drop yellow potato / drop purple potato / take banana from counter / take parsley from fridge / take parsley from fridge / go south / go east / take red hot pepper / go west / go west / go north / prepare meal / eat meal"
