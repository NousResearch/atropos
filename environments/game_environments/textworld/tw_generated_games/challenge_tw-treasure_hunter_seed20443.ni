...
The vault part 0 is some text that varies. The vault part 0 is "You find yourself in a vault. The room is well lit.
...
The study part 0 is some text that varies. The study part 0 is "Fancy seeing you here. Here, by the way, being the study. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The sauna part 0 is some text that varies. The sauna part 0 is "You're not going to believe this, but you've just entered a sauna.
...
The dish-pit part 0 is some text that varies. The dish-pit part 0 is "You are in a dish-pit. A typical one. Okay, just remember what you're here to do, and everything will go great.
...
The f_0 is in r_0.
The description of o_0 is "The golf ball is modern.".
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Your task for today is to lift the candy bar from the floor of the vault.".
