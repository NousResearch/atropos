...
The laundromat part 0 is some text that varies. The laundromat part 0 is "You've just shown up in a laundromat. The room is well lit.
...
Test quest0_0 with "go east / go south / go east / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a life changing episode of TextWorld! Here is how to play! First, it would be great if you could make an attempt to go to the east. With that done, attempt to travel south. After t".
The objective part 1 is some text that varies. The objective part 1 is "hat, take a trip east. With that done, recover the coin from the floor of the shower. That's it!".
