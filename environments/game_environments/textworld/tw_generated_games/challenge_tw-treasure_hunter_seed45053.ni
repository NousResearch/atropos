...
The bar part 0 is some text that varies. The bar part 0 is "Ah, the bar. This is some kind of bar, really great standard vibes in this place, a wonderful standard atmosphere.
...
The shower part 0 is some text that varies. The shower part 0 is "Well how about that, you are in the place we're calling the shower. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The laundromat part 0 is some text that varies. The laundromat part 0 is "You arrive in a laundromat. A normal one. The room is well lit.
...
The k_0 is in r_0.
The description of o_0 is "The tablet appears to be to fit in here".
...
Test quest0_0 with "take tablet"
...
The objective part 0 is some text that varies. The objective part 0 is "Your objective is to pick up the tablet from the floor of the lounge.".
