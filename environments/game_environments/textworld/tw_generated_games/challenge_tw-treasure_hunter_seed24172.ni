...
The basement part 0 is some text that varies. The basement part 0 is "Guess what, you are in the place we're calling the basement. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The launderette part 0 is some text that varies. The launderette part 0 is "Well, here we are in the launderette. The room is well lit.
...
The o_0 is in r_4.
The description of o_1 is "The shoe is dirty.".
...
Test quest0_0 with "go east / take sock"
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Here is how to play! Your first objective is to make an attempt to move east. After that, recover the sock from ".
The objective part 1 is some text that varies. The objective part 1 is "the floor of the launderette. That's it!".
