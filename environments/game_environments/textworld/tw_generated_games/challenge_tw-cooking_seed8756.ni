...
The kitchen part 2 is some text that varies. The kitchen part 2 is " You see an oven. There's something strange about this thing being here, but you don't have time to worry about that now.[if oven_0 is open and there is something in the oven_0] The oven contains [a list of things in the oven_0].[end if]".
...
The kitchen part 4 is some text that varies. The kitchen part 4 is " You can see a table. [if there is something on the s_0]On the table you can see [a list of things on the s_0]. Something scurries by right in the corner of your eye. Probably nothing.[end if]".
...
The kitchen part 6 is some text that varies. The kitchen part 6 is " You can make out a counter. Now why would someone leave that there? [if there is something on the s_1]On the counter you see [a list of things on the s_1].[end if]".
...
The kitchen part 8 is some text that varies. The kitchen part 8 is " You hear a noise behind you and spin around, but you can't see anything other than a stove. The stove is conventional.[if there is something on the stove_0] On the stove you make out [a list of things on the stove_0].[end if]".
...
Test quest1_0 with "inventory / examine cookbook / drop purple potato / drop red potato / take red hot pepper from counter"
...
Test quest5_0 with "inventory / examine cookbook / drop purple potato / drop red potato / take red hot pepper from counter / take block of cheese from fridge"
...
Test quest9_0 with "inventory / examine cookbook / drop purple potato / drop red potato / take red hot pepper from counter / take block of cheese from fridge / take red onion from fridge"
...
Test quest12_0 with "inventory / examine cookbook / drop purple potato / drop red potato / take red hot pepper from counter / take block of cheese from fridge / take red onion from fridge / prepare meal"
...
Test quest13_0 with "inventory / examine cookbook / drop purple potato / drop red potato / take red hot pepper from counter / take block of cheese from fridge / take red onion from fridge / prepare meal / eat meal"
