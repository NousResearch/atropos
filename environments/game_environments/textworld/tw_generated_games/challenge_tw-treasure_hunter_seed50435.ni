...
The bar part 0 is some text that varies. The bar part 0 is "Look at that sign! What does it say? It says Welcome to the bar? Well that's cool.
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an exciting round of TextWorld? You do! Here is how to play! First thing I need you to do is to venture west. Following that, recover the latch".
The objective part 1 is some text that varies. The objective part 1 is "key from the floor of the dish-pit. And if you do that, you're the winner!".
