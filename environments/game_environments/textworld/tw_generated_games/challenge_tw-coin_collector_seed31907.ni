...
The vault part 0 is some text that varies. The vault part 0 is "You've entered a vault. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The parlor part 0 is some text that varies. The parlor part 0 is "You arrive in a parlor. A standard one. The room is well lit.
...
The description of o_0 is "The coin appears well matched to everything else here".
...
Test quest0_0 with "go south / go east / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! First of all, you could, like, go to the south. Once you get through with that, move east. And then, recover the coin from the floor of the vault. Alright, thanks!".
