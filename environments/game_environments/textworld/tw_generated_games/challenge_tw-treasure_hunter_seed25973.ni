...
The salon part 0 is some text that varies. The salon part 0 is "I just think it's awesome that you're in a salon now. You begin to take stock of what's in the room.
...
The cookery part 0 is some text that varies. The cookery part 0 is "You arrive in a cookery. An ordinary kind of place. Let's see what's in here.
...
The sauna part 0 is some text that varies. The sauna part 0 is "If you're wondering why everything seems so typical all of a sudden, it's because you've just shown up in the sauna. You begin to take stock of what's in the room.
...
The description of o_0 is "The soap dispenser would seem to be well matched to everything else here".
...
Test quest0_0 with "go west / take soap dispenser"
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Here is your task for today. First off, try to go to the west. With that accomplished, lift the soap dispenser from the floor of the sauna. Alright".
