...
The salon part 0 is some text that varies. The salon part 0 is "This salon you have just entered is definitely usual.
...
The cookhouse part 0 is some text that varies. The cookhouse part 0 is "You've entered a cookhouse. You begin to take stock of what's here.
...
There is an unblocked exit to the east. There is an exit to the south. Don't worry, it is unblocked. You don't like doors? Why not try going west, that entranceway is unguarded.".
...
The parlor part 0 is some text that varies. The parlor part 0 is "Well, here we are in the parlor. I guess you better just go and list everything you see here.
...
The cookery part 0 is some text that varies. The cookery part 0 is "Well, here we are in the cookery. You can barely contain your excitement.
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is how to play! First stop, make an attempt to take a trip north. Okay, and then, head east. And then, recover the loaf of bread from the floor of the cookery. Once that's a".
