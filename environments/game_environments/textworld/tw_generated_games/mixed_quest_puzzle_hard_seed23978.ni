...
The r_1 and the r_0 and the r_10 and the r_7 and the r_11 and the r_8 and the r_13 and the r_9 and the r_14 and the r_15 and the r_17 and the r_12 and the r_18 and the r_19 and the r_2 and the r_21 and the r_22 and the r_16 and the r_3 and the r_5 and the r_6 and the r_4 and the r_20 are rooms.

Understand "room_1" as r_1.
The internal name of r_1 is "room_1".
The printed name of r_1 is "-= Room_1 =-".
The room_1 part 0 is some text that varies. The room_1 part 0 is "If you're wondering why everything seems so typical all of a sudden, it's because you've just shown up in the room_1. The room is well lit.
...
The room_0 part 0 is some text that varies. The room_0 part 0 is "You arrive in a room_0. A typical kind of place. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The room_8 part 0 is some text that varies. The room_8 part 0 is "Well, here we are in a room_8.
...
The room_6 part 0 is some text that varies. The room_6 part 0 is "You find yourself in a room_6. An usual kind of place.



There is an exit to the east. Don't worry, it is unguarded. There is an exit to the north. Don't worry, it is unblocked. You don't like doors? Why not try going west, that entranceway is unguarded.".
...
The room_9 part 0 is some text that varies. The room_9 part 0 is "You've entered a room_9.
...
The side_room_6 part 0 is some text that varies. The side_room_6 part 0 is "You've entered a side_room_6. You start to take note of what's in the room.
...
The room_10 part 0 is some text that varies. The room_10 part 0 is "You find yourself in a room_10. An ordinary one. Okay, just remember what you're here to do, and everything will go great.
...
The room_7 part 0 is some text that varies. The room_7 part 0 is "You've entered a room_7. Let's see what's in here.
...
The room_11 part 0 is some text that varies. The room_11 part 0 is "You find yourself in a room_11. A standard one. You decide to just list off a complete list of everything you see in the room, because hey, why not?



There is an exit to the east. Don't worry, it is unblocked. There is an unblocked exit to the west.".
The description of r_14 is "[room_11 part 0]".

The r_10 is mapped west of r_14.
The r_19 is mapped east of r_14.
Understand "room_12" as r_15.
The internal name of r_15 is "room_12".
The printed name of r_15 is "-= Room_12 =-".
The room_12 part 0 is some text that varies. The room_12 part 0 is "You've just sauntered into a room_12.
...
The description of r_15 is "[room_12 part 0]".

The r_11 is mapped west of r_15.
The r_16 is mapped north of r_15.
The r_21 is mapped east of r_15.
Understand "room_13" as r_17.
The internal name of r_17 is "room_13".
The printed name of r_17 is "-= Room_13 =-".
The room_13 part 0 is some text that varies. The room_13 part 0 is "Look around you. Take it all in. It's not every day someone gets to be in a room_13.



There is an exit to the west. Don't worry, it is unguarded.".
The description of r_17 is "[room_13 part 0]".
...
The side_room_9 part 0 is some text that varies. The side_room_9 part 0 is "Of every side_room_9 you could have sauntered into, you had to walk into an usual one.
...
Understand "room_14" as r_18.
The internal name of r_18 is "room_14".
The printed name of r_18 is "-= Room_14 =-".
The room_14 part 0 is some text that varies. The room_14 part 0 is "You arrive in an usual kind of place. That is to say, you're in a room_14.



There is an exit to the west. Don't worry, it is unguarded.".
The description of r_18 is "[room_14 part 0]".

The r_13 is mapped west of r_18.
Understand "room_15" as r_19.
The internal name of r_19 is "room_15".
The printed name of r_19 is "-= Room_15 =-".
The room_15 part 0 is some text that varies. The room_15 part 0 is "You are in a room_15. An usual one.
...
The description of r_19 is "[room_15 part 0]".

The r_14 is mapped west of r_19.
The r_20 is mapped north of r_19.
Understand "room_2" as r_2.
The internal name of r_2 is "room_2".
The printed name of r_2 is "-= Room_2 =-".
The room_2 part 0 is some text that varies. The room_2 part 0 is "You find yourself in a room_2. A normal one.
...
Understand "room_16" as r_21.
The internal name of r_21 is "room_16".
The printed name of r_21 is "-= Room_16 =-".
The room_16 part 0 is some text that varies. The room_16 part 0 is "Look at you, bigshot, walking into a room_16 like it isn't some huge deal.



You don't like doors? Why not try going west, that entranceway is unguarded.".
The description of r_21 is "[room_16 part 0]".

The r_15 is mapped west of r_21.
Understand "room_17" as r_22.
The internal name of r_22 is "room_17".
The printed name of r_22 is "-= Room_17 =-".
The room_17 part 0 is some text that varies. The room_17 part 0 is "You arrive in a room_17. An ordinary kind of place. You start to take note of what's in the room.

 You scan the room for an ancient altar, and you find an ancient altar. The ancient altar is typical.[if there is something on the s_0] On the ancient altar you can make out [a list of things on the s_0].[end if]".
The room_17 part 1 is some text that varies. The room_17 part 1 is "[if there is nothing on the s_0] Looks like someone's already been here and taken everything off it, though. Aw, here you were, all excited for there to be things on it![end if]".
The room_17 part 2 is some text that varies. The room_17 part 2 is "

There is an unblocked exit to the west.".
The description of r_22 is "[room_17 part 0][room_17 part 1][room_17 part 2]".

The r_16 is mapped west of r_22.
Understand "side_room_12" as r_16.
The internal name of r_16 is "side_room_12".
The printed name of r_16 is "-= Side_Room_12 =-".
The side_room_12 part 0 is some text that varies. The side_room_12 part 0 is "You've entered a side_room_12.
...
The description of r_16 is "[side_room_12 part 0]".

The r_15 is mapped south of r_16.
The r_22 is mapped east of r_16.
Understand "room_3" as r_3.
The internal name of r_3 is "room_3".
The printed name of r_3 is "-= Room_3 =-".
The room_3 part 0 is some text that varies. The room_3 part 0 is "You arrive in a room_3. A normal kind of place. The room is well lit.



 There is [if d_2 is open]an open[otherwise]a closed[end if]".
The room_3 part 1 is some text that varies. The room_3 part 1 is " green door leading west. There is an exit to the east. Don't worry, it is unblocked. There is an unguarded exit to the north.".
...
The room_4 part 0 is some text that varies. The room_4 part 0 is "You've just walked into a room_4. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The room_5 part 0 is some text that varies. The room_5 part 0 is "You are in a room_5. An usual one.
...
The side_room_3 part 0 is some text that varies. The side_room_3 part 0 is "You've entered a side_room_3. You begin to take stock of what's in the room.
...
Understand "side_room_15" as r_20.
The internal name of r_20 is "side_room_15".
The printed name of r_20 is "-= Side_Room_15 =-".
The side_room_15 part 0 is some text that varies. The side_room_15 part 0 is "You arrive in a side_room_15. An ordinary kind of place. I guess you better just go and list everything you see here.



You need an unguarded exit? You should try going south.".
The description of r_20 is "[side_room_15 part 0]".

The r_19 is mapped south of r_20.
...
The f_0 and the f_3 and the f_4 and the f_1 and the f_2 and the f_5 are foods.
The f_0 and the f_3 and the f_4 and the f_1 and the f_2 and the f_5 are privately-named.
The k_0 and the k_1 and the k_2 are keys.
The k_0 and the k_1 and the k_2 are privately-named.
The o_0 and the o_1 and the o_2 and the o_4 and the o_7 and the o_3 and the o_5 and the o_6 are object-likes.
The o_0 and the o_1 and the o_2 and the o_4 and the o_7 and the o_3 and the o_5 and the o_6 are privately-named.
The r_1 and the r_0 and the r_10 and the r_7 and the r_11 and the r_8 and the r_13 and the r_9 and the r_14 and the r_15 and the r_17 and the r_12 and the r_18 and the r_19 and the r_2 and the r_21 and the r_22 and the r_16 and the r_3 and the r_5 and the r_6 and the r_4 and the r_20 are rooms.
The r_1 and the r_0 and the r_10 and the r_7 and the r_11 and the r_8 and the r_13 and the r_9 and the r_14 and the r_15 and the r_17 and the r_12 and the r_18 and the r_19 and the r_2 and the r_21 and the r_22 and the r_16 and the r_3 and the r_5 and the r_6 and the r_4 and the r_20 are privately-named.
...
The description of d_0 is "it is what it is, a red door [if open]You can see inside it.[else if closed]You can't see inside it because the lid's in your way.[otherwise]There is a lock on it.[end if]".
The printed name of d_0 is "red door".
Understand "red door" as d_0.
Understand "red" as d_0.
Understand "door" as d_0.
The d_0 is locked.
The description of d_1 is "it's a robust blue door [if open]You can see inside it.[else if closed]You can't see inside it because the lid's in your way.[otherwise]There is a lock on it.[end if]".
The printed name of d_1 is "blue door".
Understand "blue door" as d_1.
Understand "blue" as d_1.
Understand "door" as d_1.
The d_1 is locked.
The description of d_2 is "it's a noble green door [if open]It is open.[else if closed]It is closed.[otherwise]It is locked.[end if]".
...
The f_4 is in r_21.
The f_4 is edible.
The description of k_0 is "The red crystal is cold to the touch".
...
The description of k_1 is "The metal of the blue crystal is rusty.".
...
The description of k_2 is "The green crystal is heavier than it looks.".
...
The description of o_0 is "The ancient scroll appears out of place here".
...
The o_0 is in r_1.
The description of o_1 is "The mystic orb appears out of place here".
The printed name of o_1 is "mystic orb".
Understand "mystic orb" as o_1.
Understand "mystic" as o_1.
Understand "orb" as o_1.
The o_1 is in r_2.
The description of o_2 is "The golden chalice seems out of place here".
...
The o_2 is in r_3.
The description of o_4 is "The frisbee seems out of place here".
The printed name of o_4 is "frisbee".
Understand "frisbee" as o_4.
The o_4 is in r_7.
The description of o_7 is "The scarf is brand new.".
...
The description of o_3 is "The lightbulb is antiquated.".
...
The description of o_6 is "The monitor is well-used.".
The printed name of o_6 is "monitor".
Understand "monitor" as o_6.
