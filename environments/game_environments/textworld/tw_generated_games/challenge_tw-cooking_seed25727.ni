...
The r_0 and the r_4 and the r_1 and the r_6 and the r_3 and the r_5 and the r_8 and the r_2 and the r_7 are rooms.
...
The kitchen part 6 is some text that varies. The kitchen part 6 is " You can see a table. Now why would someone leave that there? The table is massive.[if there is something on the s_0] On the table you can make out [a list of things on the s_0]. Wow! Just like in the movies![end if]".
...
The kitchen part 8 is some text that varies. The kitchen part 8 is " You scan the room, seeing a counter. The counter is vast.[if there is something on the s_1] On the counter you make out [a list of things on the s_1].[end if]".
...
The kitchen part 10 is some text that varies. The kitchen part 10 is " You see a stove. The stove is conventional.[if there is something on the stove_0] On the stove you make out [a list of things on the stove_0].[end if]".
...
The kitchen part 13 is some text that varies. The kitchen part 13 is " plain door leading east. You don't like doors? Why not try going south, that entranceway is not blocked by one. You don't like doors? Why not try going west, that entranceway is not blocked by one.".
...
The corridor part 1 is some text that varies. The corridor part 1 is " patio door leading west. You don't like doors? Why not try going north, that entranceway is not blocked by one. You need an exit without a door? You should try going south.".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You find yourself in a backyard. A standard one. You decide to start listing off everything you see in the room, as if you were in a text adventure.

 You smell an intriguing smell, and follow it to a patio chair. [if there is something on the s_6]On the patio chair you can make out [a list of things on the s_6].[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " You see a patio table. Now why would someone leave that there? [if there is something on the s_7]You see [a list of things on the s_7] on the patio table.[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "This just in- You, in the bedroom.
 ...
 Look over there! a bed. The bed is large.[if there is something on the s_4] On the bed you can make out [a list of things on the s_4].[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You are in a bathroom.
 ...
 You see a toilet. [if there is something on the s_8]On the toilet you can see [a list of things on the s_8]. You shudder, but continue examining the room.[end if]".
...
The shed part 0 is some text that varies. The shed part 0 is "You arrive in a shed. A normal kind of place. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The shed part 2 is some text that varies. The shed part 2 is " You can see a workbench. I guess it's true what they say, if you're looking for a workbench, go to TextWorld. The workbench is wooden.[if there is something on the s_3] On the workbench you can make out [a list of things on the s_3].[end if]".
...
The r_0 and the r_4 and the r_1 and the r_6 and the r_3 and the r_5 and the r_8 and the r_2 and the r_7 are rooms.
The r_0 and the r_4 and the r_1 and the r_6 and the r_3 and the r_5 and the r_8 and the r_2 and the r_7 are privately-named.
...
Test quest1_0 with "inventory / open barn door / go north / open patio door / go east / go north / examine cookbook / go south / go south / go west / go west / take white onion"
...
Test quest2_0 with "inventory / open barn door / go north / open patio door / go east / go north / examine cookbook / go south / go south / go west / go west / take white onion / take yellow potato / go east / go east / go east / go north / cook white onion with oven"
...
Test quest5_0 with "inventory / open barn door / go north / open patio door / go east / go north / examine cookbook / go south / go south / go west / go west / take white onion / take yellow potato"
...
Test quest6_0 with "inventory / open barn door / go north / open patio door / go east / go north / examine cookbook / go south / go south / go west / go west / take white onion / take yellow potato / go east / go east / go east / go north / cook white onion with oven / cook yellow potato with oven"
...
Test quest8_0 with "inventory / open barn door / go north / open patio door / go east / go north / examine cookbook / go south / go south / go west / go west / take white onion / take yellow potato / go east / go east / go east / go north / cook white onion with oven / cook yellow potato with oven / prepare meal"
...
Test quest9_0 with "inventory / open barn door / go north / open patio door / go east / go north / examine cookbook / go south / go south / go west / go west / take white onion / take yellow potato / go east / go east / go east / go north / cook white onion with oven / cook yellow potato with oven / prepare meal / eat meal"
