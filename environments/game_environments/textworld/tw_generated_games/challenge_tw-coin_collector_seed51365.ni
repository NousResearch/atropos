...
The canteen part 0 is some text that varies. The canteen part 0 is "You find yourself in a canteen. A normal one. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The description of o_0 is "The coin would seem to be out of place here".
...
Test quest0_0 with "go east / go north / go east / go east / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First of all, attempt to go to the east. Then, head north. And then, move east. With that over with, go ".
The objective part 1 is some text that varies. The objective part 1 is "to the east. And then, pick-up the coin from the floor of the restroom. Got that? Good!".
