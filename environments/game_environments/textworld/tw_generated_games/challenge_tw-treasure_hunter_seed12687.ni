...
The steam room part 0 is some text that varies. The steam room part 0 is "This is going to sound unbelievable, but you've just entered a steam room. You can barely contain your excitement.
...
Test quest0_0 with "go north / take cookie"
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! First step, go to the north. Okay, and then, pick up the cookie from the floor of the parlor. And if you do that, you're the winner!".
