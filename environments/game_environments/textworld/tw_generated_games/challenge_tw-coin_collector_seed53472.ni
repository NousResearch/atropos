...
The study part 0 is some text that varies. The study part 0 is "This might come as a shock to you, but you've just entered a study. You start to take note of what's in the room.
...
The description of o_0 is "The coin appears out of place here".
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an fast paced round of TextWorld? You do! Here is your task for today. First off, travel east. And then, attempt to go to the south. And then, ".
The objective part 1 is some text that varies. The objective part 1 is "try to go to the west. After that, attempt to go west. And then, recover the coin from the floor of the washroom. And if you do that, you're the winner!".
