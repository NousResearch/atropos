...
The kitchen part 2 is some text that varies. The kitchen part 2 is " You see a counter. The counter is typical.[if there is something on the s_1] On the counter you can make out [a list of things on the s_1]. Wow! Just like in the movies![end if]".
...
The kitchen part 4 is some text that varies. The kitchen part 4 is " You see a stove. You shudder, but continue examining the stove. The stove is usual.[if there is something on the s_2] On the stove you can see [a list of things on the s_2].[end if]".
...
The kitchen part 6 is some text that varies. The kitchen part 6 is " You see a kitchen island. The kitchen island is usual.[if there is something on the s_3] On the kitchen island you see [a list of things on the s_3].[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You are in a bedroom. An usual kind of place.
 ...
 If you haven't noticed it already, there seems to be something there by the wall, it's a chest drawer. Now that's what I call TextWorld![if c_0 is open and there is something in the c_0] The chest drawer contains [a list of things in the c_0].[end if]".
...
The bedroom part 4 is some text that varies. The bedroom part 4 is " Were you looking for a king-size bed? Because look over there, it's a king-size bed. [if there is something on the s_0]You see [a list of things on the s_0] on the king-size bed.[end if]".
The bedroom part 5 is some text that varies. The bedroom part 5 is "[if there is nothing on the s_0]But the thing is empty, unfortunately. It would have been so cool if there was stuff on the king-size bed.[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You are in a backyard. An ordinary kind of place. Okay, just remember what you're here to do, and everything will go great.

 Look over there! a set of chairs. The set of chairs is ordinary.[if there is something on the s_10] On the set of chairs you can see [a list of things on the s_10].[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " Oh, great. Here's a bbq. [if there is something on the s_8]You see [a list of things on the s_8] on the bbq.[end if]".
...
The backyard part 5 is some text that varies. The backyard part 5 is "[if there is nothing on the s_9]The patio table appears to be empty. What, you think everything in TextWorld should have stuff on it?[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You find yourself in a living room. An ordinary one.

 Were you looking for a couch? Because look over there, it's a couch. The couch is typical.[if there is something on the s_5] On the couch you can see [a list of things on the s_5].[end if]".
...
The living room part 2 is some text that varies. The living room part 2 is " You can see a low table. The low table is typical.[if there is something on the s_6] On the low table you see [a list of things on the s_6]. Wow! Just like in the movies![end if]".
...
The living room part 4 is some text that varies. The living room part 4 is " You make out a tv. You wonder idly who left that here. [if there is something on the s_7]On the tv you can make out [a list of things on the s_7].[end if]".
...
The f_3 is in r_5.
The f_3 is edible.
The description of f_4 is "The apple looks savory.".
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a exciting round of TextWorld! Here is your task for today. First stop, ensure that the antique trunk is open. Then, take the old key from the antique trunk. Then, assure that the ".
The objective part 1 is some text that varies. The objective part 1 is "wooden door inside the bedroom is unlocked. Then, make it so that the wooden door in the bedroom is ajar. And then, make an attempt to travel east. Okay, and then, ensure that the refrigerator within ".
The objective part 2 is some text that varies. The objective part 2 is "the kitchen is open. After that, recover the tomato plant from the refrigerator inside the kitchen. Then, put the tomato plant on the stove. And if you do that, you're the winner!".
