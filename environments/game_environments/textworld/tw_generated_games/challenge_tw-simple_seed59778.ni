...
The kitchen part 1 is some text that varies. The kitchen part 1 is " refrigerator, which looks usual, in the corner.[if c_2 is open and there is something in the c_2] The refrigerator contains [a list of things in the c_2]. There's something strange about this being here, but you can't put your finger on it.[end if]".
...
The kitchen part 3 is some text that varies. The kitchen part 3 is " You make out a counter. The counter is normal.[if there is something on the s_1] On the counter you see [a list of things on the s_1].[end if]".
The kitchen part 4 is some text that varies. The kitchen part 4 is "[if there is nothing on the s_1] But oh no! there's nothing on this piece of garbage. It would have been so cool if there was stuff on the counter.[end if]".
The kitchen part 5 is some text that varies. The kitchen part 5 is " What's that over there? It looks like it's a stove. The stove is normal.[if there is something on the s_2] On the stove you make out [a list of things on the s_2]. I mean, just wow! Isn't TextWorld just the best?[end if]".
...
The kitchen part 7 is some text that varies. The kitchen part 7 is " If you haven't noticed it already, there seems to be something there by the wall, it's a kitchen island. The kitchen island is normal.[if there is something on the s_3] On the kitchen island you can make out [a list of things on the s_3].[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You're now in a bedroom. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The bedroom part 2 is some text that varies. The bedroom part 2 is " You make out an antique trunk.[if c_1 is open and there is something in the c_1] The antique trunk contains [a list of things in the c_1].[end if]".
...
The bedroom part 4 is some text that varies. The bedroom part 4 is " You see a gleam over in a corner, where you can see a king-size bed. The king-size bed is usual.[if there is something on the s_0] On the king-size bed you can see [a list of things on the s_0]. You can't wait to tell the folks at home about this![end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "Well, here we are in the backyard.
 ...
 You can see a set of chairs. Wow, isn't TextWorld just the best? [if there is something on the s_10]You see [a list of things on the s_10] on the set of chairs.[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " You see a bbq. Wow, isn't TextWorld just the best? [if there is something on the s_8]On the bbq you make out [a list of things on the s_8]. Something scurries by right in the corner of your eye. Probably nothing.[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " Oh, great. Here's a patio table. The patio table is ordinary.[if there is something on the s_9] On the patio table you can see [a list of things on the s_9].[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You are in a living room. An usual kind of place.
 ...
 You can make out a couch. The couch is ordinary.[if there is something on the s_5] On the couch you can make out [a list of things on the s_5]. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[end if]".
The living room part 1 is some text that varies. The living room part 1 is "[if there is nothing on the s_5] However, the couch, like an empty couch, has nothing on it. Sometimes, just sometimes, TextWorld can just be the worst.[end if]".
The living room part 2 is some text that varies. The living room part 2 is " Hey, want to see a low table? Look over there, a low table. [if there is something on the s_6]On the low table you can see [a list of things on the s_6].[end if]".
...
The living room part 4 is some text that varies. The living room part 4 is " You make out a tv. The tv is normal.[if there is something on the s_7] On the tv you can make out [a list of things on the s_7]. Hmmm... what else, what else?[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You find yourself in a bathroom. A normal kind of place.
 ...
 You make out a toilet.[if c_3 is open and there is something in the c_3] The toilet contains [a list of things in the c_3]. Make a note of this, you might have to put stuff on or in it later on.[end if]".
...
The bathroom part 2 is some text that varies. The bathroom part 2 is " You can see a bath.[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4].[end if]".
...
The bathroom part 4 is some text that varies. The bathroom part 4 is " You see a sink. You shudder, but continue examining the sink. [if there is something on the s_4]On the sink you see [a list of things on the s_4]. Huh, weird.[end if]".
The bathroom part 5 is some text that varies. The bathroom part 5 is "[if there is nothing on the s_4]But the thing is empty, unfortunately. Oh! Why couldn't there just be stuff on it?[end if]".
...
The d_0 is locked.
The description of d_1 is "The screen door looks well-built. [if open]It is open.[else if closed]It is closed.[otherwise]It is locked.[end if]".
...
The c_4 is in r_3.
The c_4 is closed.
The description of f_3 is "that's a standard milk!".
...
The f_4 is in r_5.
The f_4 is edible.
The description of f_5 is "that's a typical apple!".
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another profound round of TextWorld! First of all, doublecheck that the antique trunk is opened. And then, retrieve the old key from the antique trunk within the bedroom. And then, insert t".
The objective part 1 is some text that varies. The objective part 1 is "he old key into the wooden door in the bedroom's lock to unlock it. After unlocking the wooden door, open the wooden door inside the bedroom. And then, make an effort to take a trip east. With that ov".
The objective part 2 is some text that varies. The objective part 2 is "er with, look and see that the screen door inside the kitchen is ajar. And then, make an effort to venture east. And then, venture south. After that, recover the milk from the floor of the garden. Aft".
The objective part 3 is some text that varies. The objective part 3 is "er that, go north. After that, venture west. Then, place the milk on the stove inside the kitchen. And once you've done that, you win!".
