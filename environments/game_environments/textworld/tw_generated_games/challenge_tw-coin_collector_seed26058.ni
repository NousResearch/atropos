...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a life changing episode of TextWorld! Here is your task for today. First off, if it's not too much trouble, I need you to make an effort to venture west. After that, venture south.".
The objective part 1 is some text that varies. The objective part 1 is " Then, move south. After that, make an attempt to take a trip east. Following that, retrieve the coin from the floor of the basement. Got that? Good!".
