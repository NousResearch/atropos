...
The kitchen part 8 is some text that varies. The kitchen part 8 is " You make out a counter. Wow, isn't TextWorld just the best? The counter is vast.[if there is something on the s_1] On the counter you make out [a list of things on the s_1].[end if]".
...
The kitchen part 10 is some text that varies. The kitchen part 10 is " Oh, great. Here's a stove. What a coincidence, weren't you just thinking about a stove? The stove is conventional.[if there is something on the stove_0] On the stove you can see [a list of things on the stove_0].[end if]".
...
Test quest4_0 with "inventory / examine cookbook / drop red onion / take parsley from fridge"
...
Test quest7_0 with "inventory / examine cookbook / drop red onion / take parsley from fridge / prepare meal"
...
Test quest8_0 with "inventory / examine cookbook / drop red onion / take parsley from fridge / prepare meal / eat meal"
