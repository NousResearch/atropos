...
The kitchen part 6 is some text that varies. The kitchen part 6 is " What's that over there? It looks like it's a kitchen island. The kitchen island is normal.[if there is something on the s_3] On the kitchen island you can make out [a list of things on the s_3].[end if]".
...
The bedroom part 2 is some text that varies. The bedroom part 2 is " Oh, great. Here's an antique trunk.[if c_1 is open and there is something in the c_1] The antique trunk contains [a list of things in the c_1].[end if]".
...
The bedroom part 4 is some text that varies. The bedroom part 4 is " You lean against the wall, inadvertently pressing a secret button. The wall opens up to reveal a king-size bed. [if there is something on the s_0]You see [a list of things on the s_0] on the king-size bed. Now that's what I call TextWorld![end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "Welcome to the backyard.
...
The backyard part 2 is some text that varies. The backyard part 2 is " You rest your hand against a wall, but you miss the wall and fall onto a bbq. [if there is something on the s_8]You see [a list of things on the s_8] on the bbq. There's something strange about this being here, but you can't put your finger on it.[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You are in a living room. It seems to be pretty standard here. You can barely contain your excitement.

 You lean against the wall, inadvertently pressing a secret button. The wall opens up to reveal a couch. You can't really describe the couch besides that it's standard. [if there is something on the s_5]You see [a list of things on the s_5] on the couch.[end if]".
...
The living room part 2 is some text that varies. The living room part 2 is " You can make out a low table. [if there is something on the s_6]On the low table you make out [a list of things on the s_6]. Now that's what I call TextWorld![end if]".
The living room part 3 is some text that varies. The living room part 3 is "[if there is nothing on the s_6]But oh no! there's nothing on this piece of garbage. Aw, here you were, all excited for there to be things on it![end if]".
The living room part 4 is some text that varies. The living room part 4 is " You see a tv! The tv is typical.[if there is something on the s_7] On the tv you see [a list of things on the s_7].[end if]".
...
The bathroom part 5 is some text that varies. The bathroom part 5 is " You see a sink. I guess it's true what they say, if you're looking for a sink, go to TextWorld. [if there is something on the s_4]You see [a list of things on the s_4] on the sink. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[end if]".
...
The garden part 0 is some text that varies. The garden part 0 is "You find yourself in a garden. A normal kind of place. The room is well lit.
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First of all, you could, like, doublecheck that the chest drawer is opened. After that, retrieve the old".
The objective part 1 is some text that varies. The objective part 1 is " key from the chest drawer within the bedroom. After that, unlock the wooden door with the old key. And then, assure that the wooden door within the bedroom is open. And then, make an attempt to trave".
The objective part 2 is some text that varies. The objective part 2 is "l east. And then, assure that the refrigerator in the kitchen is opened. After that, recover the apple from the refrigerator. And then, place the apple on the stove. And if you do that, you're the win".
