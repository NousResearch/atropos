...
The cubicle part 0 is some text that varies. The cubicle part 0 is "You have moved into the most standard of all possible cubicles. You begin looking for stuff.
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Here is your task for today. First off, if it's not too much trouble, I need you to venture south. And then, pick up the passkey from the floor of ".
The objective part 1 is some text that varies. The objective part 1 is "the bedroom. That's it!".
