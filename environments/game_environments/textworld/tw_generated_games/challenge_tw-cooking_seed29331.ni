...
The r_0 and the r_2 and the r_1 and the r_5 and the r_10 and the r_9 and the r_3 and the r_4 and the r_6 and the r_7 and the r_11 and the r_8 are rooms.
...
The kitchen part 4 is some text that varies. The kitchen part 4 is " You can see a table. The table is massive.[if there is something on the s_0] On the table you can see [a list of things on the s_0]. Huh, weird.[end if]".
...
The kitchen part 6 is some text that varies. The kitchen part 6 is " You see a counter. Why don't you take a picture of it, it'll last longer! [if there is something on the s_1]On the counter you see [a list of things on the s_1].[end if]".
...
The kitchen part 8 is some text that varies. The kitchen part 8 is " You make out a stove. The stove is conventional.[if there is something on the stove_0] On the stove you make out [a list of things on the stove_0]. Wow! Just like in the movies![end if]".
...
The kitchen part 12 is some text that varies. The kitchen part 12 is " frosted-glass door leading west. There is an exit to the north. Don't worry, there is no door. You don't like doors? Why not try going south, that entranceway is not blocked by one.".
...
The livingroom part 1 is some text that varies. The livingroom part 1 is "[if there is nothing on the s_9] But the thing is empty. Hm. Oh well[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You arrive in a bedroom. A typical kind of place.
 ...
 Hey, want to see a bed? Look over there, a bed. The bed is large.[if there is something on the s_7] On the bed you make out [a list of things on the s_7].[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You find yourself in a backyard. An ordinary one.
 ...
 You see a patio chair. The patio chair is stylish.[if there is something on the s_6] On the patio chair you can make out [a list of things on the s_6].[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " Hey, want to see a patio table? Look over there, a patio table. Now why would someone leave that there? [if there is something on the s_8]On the patio table you can make out [a list of things on the s_8].[end if]".
The backyard part 3 is some text that varies. The backyard part 3 is "[if there is nothing on the s_8]Looks like someone's already been here and taken everything off it, though. This always happens![end if]".
...
The garden part 0 is some text that varies. The garden part 0 is "You are in a garden. An usual one. I guess you better just go and list everything you see here.
...
The shed part 0 is some text that varies. The shed part 0 is "You find yourself in a shed. A standard one.
 ...
 You see a toolbox. Classic TextWorld.[if c_1 is open and there is something in the c_1] The toolbox contains [a list of things in the c_1]![end if]".
...
The shed part 2 is some text that varies. The shed part 2 is " Oh, great. Here's a workbench. [if there is something on the s_5]On the workbench you can make out [a list of things on the s_5].[end if]".
The shed part 3 is some text that varies. The shed part 3 is "[if there is nothing on the s_5]The workbench appears to be empty. It would have been so cool if there was stuff on the workbench.[end if]".
...
The r_0 and the r_2 and the r_1 and the r_5 and the r_10 and the r_9 and the r_3 and the r_4 and the r_6 and the r_7 and the r_11 and the r_8 are rooms.
The r_0 and the r_2 and the r_1 and the r_5 and the r_10 and the r_9 and the r_3 and the r_4 and the r_6 and the r_7 and the r_11 and the r_8 are privately-named.
...
Test quest4_0 with "inventory / go north / examine cookbook / open fridge / take red onion from fridge / prepare meal"
...
Test quest5_0 with "inventory / go north / examine cookbook / open fridge / take red onion from fridge / prepare meal / eat meal"
