...
Test quest0_0 with "go west / go west / go north / go north / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! Here is how to play! Your first objective is to go to the west. With that accomplished, attempt t".
The objective part 1 is some text that varies. The objective part 1 is "o move west. Then, attempt to go north. Then, travel north. And then, retrieve the coin from the floor of the kitchen. Alright, thanks!".
