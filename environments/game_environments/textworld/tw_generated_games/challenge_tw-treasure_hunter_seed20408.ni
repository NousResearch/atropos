...
The attic part 0 is some text that varies. The attic part 0 is "You find yourself in an attic. A typical one. I guess you better just go and list everything you see here.
...
The washroom part 0 is some text that varies. The washroom part 0 is "You have fallen into the most ordinary of all possible washrooms.
...
The parlor part 0 is some text that varies. The parlor part 0 is "Well how about that, you are in a place we're calling a parlor.
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! Pick up the worm from the floor of the attic.".
