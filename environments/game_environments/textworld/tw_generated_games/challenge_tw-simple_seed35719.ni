...
The kitchen part 0 is some text that varies. The kitchen part 0 is "Of every kitchen you could have sauntered into, you had to walk into a standard one. Okay, just remember what you're here to do, and everything will go great.

 [if c_2 is locked]A locked[else if c_2 is open]An open[otherwise]A closed[end if]".
The kitchen part 1 is some text that varies. The kitchen part 1 is " refrigerator, which looks usual, is right there by you.[if c_2 is open and there is something in the c_2] The refrigerator contains [a list of things in the c_2].[end if]".
...
The kitchen part 3 is some text that varies. The kitchen part 3 is " You bend down to tie your shoe. When you stand up, you notice a counter. The counter is typical.[if there is something on the s_1] On the counter you can make out [a list of things on the s_1].[end if]".
...
The kitchen part 5 is some text that varies. The kitchen part 5 is " You see a stove. The stove is usual.[if there is something on the s_2] On the stove you see [a list of things on the s_2].[end if]".
...
The kitchen part 7 is some text that varies. The kitchen part 7 is " You see a kitchen island. The kitchen island is standard.[if there is something on the s_3] On the kitchen island you see [a list of things on the s_3].[end if]".
...
The bedroom part 6 is some text that varies. The bedroom part 6 is " Were you looking for a king-size bed? Because look over there, it's a king-size bed. The king-size bed is ordinary.[if there is something on the s_0] On the king-size bed you can make out [a list of things on the s_0]. You can't wait to tell the folks at home about this![end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You are in a backyard. A typical one. You begin looking for stuff.

 You can make out a set of chairs. The set of chairs is ordinary.[if there is something on the s_10] On the set of chairs you see [a list of things on the s_10].[end if]".
The backyard part 1 is some text that varies. The backyard part 1 is "[if there is nothing on the s_10] However, the set of chairs, like an empty set of chairs, has nothing on it. You move on, clearly upset with TextWorld.[end if]".
The backyard part 2 is some text that varies. The backyard part 2 is " You can make out a bbq. [if there is something on the s_8]On the bbq you see [a list of things on the s_8].[end if]".
...
The backyard part 5 is some text that varies. The backyard part 5 is "[if there is nothing on the s_9]But oh no! there's nothing on this piece of trash. You move on, clearly done caring about TextWorld.[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You arrive in a typical kind of place. That is to say, you're in a living room.

 You see a gleam over in a corner, where you can see a couch. The couch is normal.[if there is something on the s_5] On the couch you see [a list of things on the s_5].[end if]".
...
The living room part 2 is some text that varies. The living room part 2 is " You see a low table. [if there is something on the s_6]You see [a list of things on the s_6] on the low table. Classic TextWorld.[end if]".
...
The bathroom part 4 is some text that varies. The bathroom part 4 is " usual looking bath in the corner.[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4].[end if]".
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First step, doublecheck that the chest drawer is open. After that, take the old key from the chest drawe".
The objective part 1 is some text that varies. The objective part 1 is "r. After that, assure that the wooden door is unlocked. After that, ensure that the wooden door is open. And then, move east. If you can do that, open the screen door. And then, try to go to the east.".
The objective part 2 is some text that varies. The objective part 2 is " With that accomplished, make an effort to take a trip south. That done, lift the lettuce from the floor of the garden. And then, take a trip north. And then, try to go to the west. And then, rest the".
The objective part 3 is some text that varies. The objective part 3 is " lettuce on the stove. Got that? Good!".
