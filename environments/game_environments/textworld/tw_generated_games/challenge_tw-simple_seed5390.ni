...
The kitchen part 4 is some text that varies. The kitchen part 4 is "[if there is nothing on the s_1]But the thing hasn't got anything on it. Hm. Oh well[end if]".
The kitchen part 5 is some text that varies. The kitchen part 5 is " You can make out a stove. [if there is something on the s_2]You see [a list of things on the s_2] on the stove.[end if]".
The kitchen part 6 is some text that varies. The kitchen part 6 is "[if there is nothing on the s_2]But the thing hasn't got anything on it. It would have been so cool if there was stuff on the stove.[end if]".
...
The kitchen part 8 is some text that varies. The kitchen part 8 is "[if there is nothing on the s_3]But oh no! there's nothing on this piece of trash. What, you think everything in TextWorld should have stuff on it?[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "Well I'll be, you are in a place we're calling a bedroom.
 ...
 You can make out a chest drawer. You shudder, but continue examining the room.[if c_0 is open and there is something in the c_0] The chest drawer contains [a list of things in the c_0].[end if]".
...
The bedroom part 2 is some text that varies. The bedroom part 2 is " Were you looking for an antique trunk? Because look over there, it's an antique trunk. Hmmm... what else, what else?[if c_1 is open and there is something in the c_1] The antique trunk contains [a list of things in the c_1]. Hmmm... what else, what else?[end if]".
...
The bedroom part 4 is some text that varies. The bedroom part 4 is " You scan the room, seeing a king-size bed. The king-size bed is usual.[if there is something on the s_0] On the king-size bed you make out [a list of things on the s_0].[end if]".
The bedroom part 5 is some text that varies. The bedroom part 5 is "[if there is nothing on the s_0] Looks like someone's already been here and taken everything off it, though. You think about smashing the king-size bed to bits, throwing the bits in a fire, etc, until you get bored.[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You are in a backyard. A standard one.
 ...
 You see a set of chairs. The set of chairs is standard.[if there is something on the s_10] On the set of chairs you see [a list of things on the s_10]. You shudder, but continue examining the room.[end if]".
...
The backyard part 3 is some text that varies. The backyard part 3 is "[if there is nothing on the s_8]But there isn't a thing on it. Aw, here you were, all excited for there to be things on it![end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You find yourself in a living room. You decide to start listing off everything you see in the room, as if you were in a text adventure.

 You can see a couch. The couch is ordinary.[if there is something on the s_5] On the couch you see [a list of things on the s_5]. You shudder, but continue examining the room.[end if]".
...
The living room part 4 is some text that varies. The living room part 4 is " You can make out a tv. [if there is something on the s_7]On the tv you can see [a list of things on the s_7].[end if]".
...
The c_4 is in r_3.
The c_4 is closed.
The description of f_3 is "that's an usual half of a bag of chips!".
...
The description of f_2 is "that's a standard apple!".
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an life changing round of TextWorld? You do! Here is your task for today. First step, ensure that the antique trunk is open. And then, retrieve".
The objective part 1 is some text that varies. The objective part 1 is " the old key from the antique trunk. After that, assure that the wooden door is unlocked with the old key. After you have unlocked the wooden door, ensure that the wooden door is open. And then, go to".
The objective part 2 is some text that varies. The objective part 2 is " the east. And then, make it so that the refrigerator is open. Then, recover the bell pepper from the refrigerator inside the kitchen. After taking the bell pepper, put the bell pepper on the stove. O".
The objective part 3 is some text that varies. The objective part 3 is "nce that's all handled, you can stop!".
