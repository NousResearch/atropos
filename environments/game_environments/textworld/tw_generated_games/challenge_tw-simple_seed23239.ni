...
The kitchen part 0 is some text that varies. The kitchen part 0 is "You arrive in a kitchen. An ordinary kind of place.
 ...
 You make out a refrigerator. Now that's what I call TextWorld![if c_2 is open and there is something in the c_2] The refrigerator contains [a list of things in the c_2]. Now that's what I call TextWorld![end if]".
...
The kitchen part 2 is some text that varies. The kitchen part 2 is " You see a gleam over in a corner, where you can see a counter. [if there is something on the s_1]On the counter you can see [a list of things on the s_1].[end if]".
...
The kitchen part 4 is some text that varies. The kitchen part 4 is " You rest your hand against a wall, but you miss the wall and fall onto a stove. The stove is usual.[if there is something on the s_2] On the stove you see [a list of things on the s_2].[end if]".
The kitchen part 5 is some text that varies. The kitchen part 5 is "[if there is nothing on the s_2] The stove appears to be empty. Aw, here you were, all excited for there to be things on it![end if]".
The kitchen part 6 is some text that varies. The kitchen part 6 is " You can make out a kitchen island. [if there is something on the s_3]On the kitchen island you make out [a list of things on the s_3]. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[end if]".
...
The bedroom part 6 is some text that varies. The bedroom part 6 is " You can see a king-size bed. The king-size bed is typical.[if there is something on the s_0] On the king-size bed you can see [a list of things on the s_0]. I mean, just wow! Isn't TextWorld just the best?[end if]".
The bedroom part 7 is some text that varies. The bedroom part 7 is "[if there is nothing on the s_0] But the thing is empty, unfortunately. Oh! Why couldn't there just be stuff on it?[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You arrive in a backyard. A typical one.
 ...
 If you haven't noticed it already, there seems to be something there by the wall, it's a set of chairs. [if there is something on the s_10]You see [a list of things on the s_10] on the set of chairs.[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " Look over there! a bbq. [if there is something on the s_8]You see [a list of things on the s_8] on the bbq.[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " You can see a patio table. [if there is something on the s_9]On the patio table you make out [a list of things on the s_9].[end if]".
The backyard part 5 is some text that varies. The backyard part 5 is "[if there is nothing on the s_9]But there isn't a thing on it. Hm. Oh well[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You are in a living room. It seems to be pretty typical here.

 You make out a couch. The couch is ordinary.[if there is something on the s_5] On the couch you make out [a list of things on the s_5]. Something scurries by right in the corner of your eye. Probably nothing.[end if]".
The living room part 1 is some text that varies. The living room part 1 is "[if there is nothing on the s_5] Looks like someone's already been here and taken everything off it, though. You move on, clearly furious with your TextWorld experience.[end if]".
The living room part 2 is some text that varies. The living room part 2 is " You hear a noise behind you and spin around, but you can't see anything other than a low table. You wonder idly who left that here. [if there is something on the s_6]You see [a list of things on the s_6] on the low table.[end if]".
...
The living room part 4 is some text that varies. The living room part 4 is " You see a gleam over in a corner, where you can see a tv. The tv is typical.[if there is something on the s_7] On the tv you make out [a list of things on the s_7].[end if]".
The living room part 5 is some text that varies. The living room part 5 is "[if there is nothing on the s_7] But the thing hasn't got anything on it. What, you think everything in TextWorld should have stuff on it?[end if]".
...
The bathroom part 1 is some text that varies. The bathroom part 1 is " toilet close by.[if c_3 is open and there is something in the c_3] The toilet contains [a list of things in the c_3]. You can't wait to tell the folks at home about this![end if]".
...
The bathroom part 6 is some text that varies. The bathroom part 6 is " You scan the room, seeing a sink. [if there is something on the s_4]You see [a list of things on the s_4] on the sink. I mean, just wow! Isn't TextWorld just the best?[end if]".
The bathroom part 7 is some text that varies. The bathroom part 7 is "[if there is nothing on the s_4]But the thing hasn't got anything on it. What, you think everything in TextWorld should have stuff on it?[end if]".
...
The d_0 is locked.
The description of d_1 is "The screen door looks manageable. [if open]You can see inside it.[else if closed]You can't see inside it because the lid's in your way.[otherwise]There is a lock on it.[end if]".
...
The s_9 is in r_4.
The description of f_0 is "The milk looks tempting.".
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First, it would be fantastic if you could look and see that the chest drawer in the bedroom is opened. O".
The objective part 1 is some text that varies. The objective part 1 is "nce you have pulled open the chest drawer, pick up the old key from the chest drawer in the bedroom. After that, make it so that the wooden door in the bedroom is unlocked with the old key. And then, ".
The objective part 2 is some text that varies. The objective part 2 is "assure that the wooden door is opened. Then, go to the east. Then, make sure that the screen door is wide open. Then, make an effort to travel east. And then, go south. And then, pick up the half of a".
The objective part 3 is some text that varies. The objective part 3 is " bag of chips from the floor of the garden. Then, head north. That done, try to go to the west. After that, place the half of a bag of chips on the stove. Once that's all handled, you can stop!".
