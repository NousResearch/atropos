...
The kitchen part 5 is some text that varies. The kitchen part 5 is " You make out a stove. [if there is something on the s_2]You see [a list of things on the s_2] on the stove.[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You are in a bedroom. A standard kind of place. You start to take note of what's in the room.
 ...
 You smell an intriguing smell, and follow it to a chest drawer. Huh, weird.[if c_0 is open and there is something in the c_0] The chest drawer contains [a list of things in the c_0]. You wonder idly who left that here.[end if]".
...
The bedroom part 4 is some text that varies. The bedroom part 4 is " You see a king-size bed. The king-size bed is usual.[if there is something on the s_0] On the king-size bed you see [a list of things on the s_0]. You can't wait to tell the folks at home about this![end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You've just walked into a backyard.
 ...
 You see a set of chairs. What a coincidence, weren't you just thinking about a set of chairs? The set of chairs is typical.[if there is something on the s_10] On the set of chairs you can make out [a list of things on the s_10].[end if]".
The backyard part 1 is some text that varies. The backyard part 1 is "[if there is nothing on the s_10] The set of chairs appears to be empty. You move on, clearly furious with your TextWorld experience.[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " You make out a patio table. The patio table is typical.[if there is something on the s_9] On the patio table you make out [a list of things on the s_9].[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You are in a living room. An usual kind of place. Let's see what's in here.
...
The living room part 2 is some text that varies. The living room part 2 is " Look out! It's a- oh, never mind, it's just a low table. The low table is normal.[if there is something on the s_6] On the low table you can see [a list of things on the s_6]. Make a note of this, you might have to put stuff on or in it later on.[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You've entered a bathroom. You begin to take stock of what's here.
 ...
 Were you looking for a toilet? Because look over there, it's a toilet.[if c_3 is open and there is something in the c_3] The toilet contains [a list of things in the c_3].[end if]".
...
The bathroom part 2 is some text that varies. The bathroom part 2 is " If you haven't noticed it already, there seems to be something there by the wall, it's a bath.[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4]. You shudder, but continue examining the room.[end if]".
...
The bathroom part 4 is some text that varies. The bathroom part 4 is " Look out! It's a- oh, never mind, it's just a sink. The sink is usual.[if there is something on the s_4] On the sink you can see [a list of things on the s_4].[end if]".
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First thing I need you to do is to ensure that the chest drawer is open. And then, retrieve the old key ".
The objective part 1 is some text that varies. The objective part 1 is "from the chest drawer inside the bedroom. After that, make sure that the wooden door in the bedroom is unlocked. And then, ensure that the wooden door inside the bedroom is open. And then, make an eff".
The objective part 2 is some text that varies. The objective part 2 is "ort to go to the east. And then, travel south. With that over with, take the lettuce from the couch within the living room. Then, make an attempt to travel north. Then, sit the lettuce on the stove. A".
