...
The closet part 0 is some text that varies. The closet part 0 is "Guess what, you are in a place we're calling a closet. You begin to take stock of what's in the room.
...
The kitchenette part 0 is some text that varies. The kitchenette part 0 is "You arrive in a kitchenette. An usual kind of place.
...
The description of o_0 is "The coin is antiquated.".
...
Test quest0_0 with "go west / go west / go south / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First off, attempt to go to the west. Next, make an attempt to head west. And then, make an effort to mo".
The objective part 1 is some text that varies. The objective part 1 is "ve south. Next, recover the coin from the floor of the vault. Got that? Good!".
