...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an fast paced round of TextWorld? You do! Here is how to play! First stop, travel north. After that, recover the peanut from the floor of the s".
The objective part 1 is some text that varies. The objective part 1 is "team room. Got that? Good!".
