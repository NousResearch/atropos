...
The cookhouse part 0 is some text that varies. The cookhouse part 0 is "This might come as a shock to you, but you've just entered a cookhouse. You begin to take stock of what's in the room.
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a fast paced session of TextWorld! Here is how to play! First of all, you could, like, make an attempt to venture south. Okay, and then, go to the south. Then, pick-up the coin fro".
The objective part 1 is some text that varies. The objective part 1 is "m the floor of the basement. And once you've done that, you win!".
