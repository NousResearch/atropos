...
The cubicle part 0 is some text that varies. The cubicle part 0 is "You arrive in a cubicle. An ordinary one. You begin to take stock of what's in the room.
...
Test quest0_0 with "go south / go east / take fondue"
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an life changing round of TextWorld? You do! First off, if it's not too much trouble, I need you to move south. With that accomplished, go to t".
The objective part 1 is some text that varies. The objective part 1 is "he east. Then, lift the fondue from the floor of the cookhouse. Got that? Good!".
