...
The kitchen part 5 is some text that varies. The kitchen part 5 is " You can see a table. [if there is something on the s_0]On the table you can make out [a list of things on the s_0]. It doesn't get more TextWorld than this![end if]".
...
The f_2 and the f_5 and the f_6 and the f_0 and the f_3 and the f_4 and the f_1 are foods.
The f_2 and the f_5 and the f_6 and the f_0 and the f_3 and the f_4 and the f_1 are privately-named.
...
Test quest5_0 with "inventory / examine cookbook / take red apple from counter / take banana from counter"
...
Test quest11_0 with "inventory / examine cookbook / take red apple from counter / take banana from counter / prepare meal"
...
Test quest12_0 with "inventory / examine cookbook / take red apple from counter / take banana from counter / prepare meal / eat meal"
