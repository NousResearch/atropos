...
The kitchen part 1 is some text that varies. The kitchen part 1 is " refrigerator is here.[if c_2 is open and there is something in the c_2] The refrigerator contains [a list of things in the c_2]. The light flickers for a second, but nothing else happens.[end if]".
...
The kitchen part 3 is some text that varies. The kitchen part 3 is " You can see a counter. [if there is something on the s_1]On the counter you make out [a list of things on the s_1].[end if]".
...
The kitchen part 5 is some text that varies. The kitchen part 5 is " You hear a noise behind you and spin around, but you can't see anything other than a stove. The stove is normal.[if there is something on the s_2] On the stove you make out [a list of things on the s_2].[end if]".
...
The kitchen part 7 is some text that varies. The kitchen part 7 is " You see a gleam over in a corner, where you can see a kitchen island. [if there is something on the s_3]On the kitchen island you make out [a list of things on the s_3].[end if]".
The kitchen part 8 is some text that varies. The kitchen part 8 is "[if there is nothing on the s_3]But the thing is empty, unfortunately.[end if]".
...
The bedroom part 1 is some text that varies. The bedroom part 1 is " chest drawer in the corner.[if c_0 is open and there is something in the c_0] The chest drawer contains [a list of things in the c_0]. Now why would someone leave that there?[end if]".
...
The bedroom part 4 is some text that varies. The bedroom part 4 is " antique trunk in the corner.[if c_1 is open and there is something in the c_1] The antique trunk contains [a list of things in the c_1].[end if]".
...
The bedroom part 6 is some text that varies. The bedroom part 6 is " If you haven't noticed it already, there seems to be something there by the wall, it's a king-size bed. The king-size bed is standard.[if there is something on the s_0] On the king-size bed you see [a list of things on the s_0].[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You're not going to believe this, but you've just entered a backyard. Okay, just remember what you're here to do, and everything will go great.

 You can see a set of chairs. The set of chairs is usual.[if there is something on the s_10] On the set of chairs you can see [a list of things on the s_10]. There's something strange about this being here, but you can't put your finger on it.[end if]".
The backyard part 1 is some text that varies. The backyard part 1 is "[if there is nothing on the s_10] Looks like someone's already been here and taken everything off it, though. You move on, clearly infuriated by TextWorld.[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " You see a patio table. Now why would someone leave that there? The patio table is standard.[if there is something on the s_9] On the patio table you can see [a list of things on the s_9].[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You arrive in a living room. A standard one. You start to take note of what's in the room.

 You can see a couch. The couch is usual.[if there is something on the s_5] On the couch you see [a list of things on the s_5].[end if]".
The living room part 1 is some text that varies. The living room part 1 is "[if there is nothing on the s_5] But the thing hasn't got anything on it. You make a mental note to not get your hopes up the next time you see a couch in a room.[end if]".
The living room part 2 is some text that varies. The living room part 2 is " You scan the room, seeing a low table. Now why would someone leave that there? [if there is something on the s_6]On the low table you can make out [a list of things on the s_6]. Hmmm... what else, what else?[end if]".
...
The living room part 4 is some text that varies. The living room part 4 is " You bend down to tie your shoe. When you stand up, you notice a tv. The tv is ordinary.[if there is something on the s_7] On the tv you see [a list of things on the s_7].[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You are in a bathroom. A typical one. You begin to take stock of what's here.
...
The bathroom part 3 is some text that varies. The bathroom part 3 is " If you haven't noticed it already, there seems to be something there by the wall, it's a bath. Now that's what I call TextWorld![if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4]. Now that's what I call TextWorld![end if]".
...
The bathroom part 5 is some text that varies. The bathroom part 5 is " You hear a noise behind you and spin around, but you can't see anything other than a sink. [if there is something on the s_4]You see [a list of things on the s_4] on the sink.[end if]".
...
The garden part 0 is some text that varies. The garden part 0 is "Well how about that, you are in a place we're calling a garden. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The d_0 is locked.
The description of d_1 is "it's a towering screen door [if open]It is open.[else if closed]It is closed.[otherwise]It is locked.[end if]".
...
The f_3 is in r_5.
The f_3 is edible.
The description of f_4 is "The lettuce looks delicious.".
...
The description of f_1 is "The milk looks tantalizing.".
The printed name of f_1 is "milk".
Understand "milk" as f_1.
The f_1 is edible.
The f_1 is in the c_2.
The description of f_2 is "The tomato plant looks tasty.".
