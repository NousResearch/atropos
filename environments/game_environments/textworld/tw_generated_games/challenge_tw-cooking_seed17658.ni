...
The kitchen part 0 is some text that varies. The kitchen part 0 is "You arrive in a kitchen. A typical one. You begin to take stock of what's here.

 [if c_0 is locked]A locked[else if c_0 is open]An open[otherwise]A closed[end if]".
The kitchen part 1 is some text that varies. The kitchen part 1 is " conventional looking fridge is here.[if c_0 is open and there is something in the c_0] The fridge contains [a list of things in the c_0].[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You arrive in a bedroom. A standard one. You can barely contain your excitement.
 ...
 You make out a bed. The bed is large.[if there is something on the s_5] On the bed you can see [a list of things on the s_5].[end if]".
The bedroom part 1 is some text that varies. The bedroom part 1 is "[if there is nothing on the s_5] However, the bed, like an empty bed, has nothing on it. You swear loudly.[end if]".
...
The livingroom part 0 is some text that varies. The livingroom part 0 is "You find yourself in a livingroom. An ordinary kind of place. You can barely contain your excitement.
 ...
 Look over there! a sofa. Now why would someone leave that there? The sofa is comfy.[if there is something on the s_4] On the sofa you can see [a list of things on the s_4], so there's that.[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You find yourself in a bathroom. An ordinary one.
 ...
 Were you looking for a toilet? Because look over there, it's a toilet. The toilet is white.[if there is something on the s_3] On the toilet you see [a list of things on the s_3].[end if]".
The bathroom part 1 is some text that varies. The bathroom part 1 is "[if there is nothing on the s_3] But there isn't a thing on it. You swear loudly.[end if]".
...
The pantry part 0 is some text that varies. The pantry part 0 is "You've just sauntered into a pantry.
 ...
 Look over there! a shelf. [if there is something on the s_2]On the shelf you see [a list of things on the s_2], so there's that.[end if]".
...
The printed name of f_5 is "salt".
Understand "salt" as f_5.
The f_5 is edible.
...
Test quest1_0 with "inventory / go south / go south / examine cookbook / open fridge / take parsley from fridge"
...
Test quest4_0 with "inventory / go south / go south / examine cookbook / open fridge / take parsley from fridge / prepare meal"
...
Test quest5_0 with "inventory / go south / go south / examine cookbook / open fridge / take parsley from fridge / prepare meal / eat meal"
