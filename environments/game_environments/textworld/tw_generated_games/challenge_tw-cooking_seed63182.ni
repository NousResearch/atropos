...
The r_0 and the r_6 and the r_1 and the r_4 and the r_11 and the r_10 and the r_2 and the r_3 and the r_7 and the r_9 and the r_5 and the r_8 are rooms.
...
The kitchen part 0 is some text that varies. The kitchen part 0 is "You arrive in a kitchen. A typical one.
 ...
 You bend down to tie your shoe. When you stand up, you notice a fridge. Hmmm... what else, what else?[if c_0 is open and there is something in the c_0] The fridge contains [a list of things in the c_0]. I mean, just wow! Isn't TextWorld just the best?[end if]".
...
The kitchen part 8 is some text that varies. The kitchen part 8 is " You rest your hand against a wall, but you miss the wall and fall onto a stove. [if there is something on the stove_0]On the stove you can see [a list of things on the stove_0].[end if]".
...
The kitchen part 12 is some text that varies. The kitchen part 12 is " patio door leading west. You don't like doors? Why not try going east, that entranceway is not blocked by one. You don't like doors? Why not try going south, that entranceway is not blocked by one.".
...
The backyard part 2 is some text that varies. The backyard part 2 is " Look out! It's a- oh, never mind, it's just a patio table. [if there is something on the s_5]On the patio table you make out [a list of things on the s_5].[end if]".
The backyard part 3 is some text that varies. The backyard part 3 is "[if there is nothing on the s_5]But oh no! there's nothing on this piece of trash. Hm. Oh well[end if]".
The backyard part 4 is some text that varies. The backyard part 4 is " Oh wow! Is that what I think it is? It is! It's a BBQ. Wow, isn't TextWorld just the best?[if toaster_0 is open and there is something in the toaster_0] The BBQ contains [a list of things in the toaster_0]. Wow, isn't TextWorld just the best?[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You arrive in a bathroom. A typical one. You begin looking for stuff.
 ...
 You smell an intriguing smell, and follow it to a toilet! [if there is something on the s_9]You see [a list of things on the s_9] on the toilet.[end if]".
...
The supermarket part 0 is some text that varies. The supermarket part 0 is "You've entered a supermarket.
 ...
 You make out a showcase. You shudder, but continue examining the showcase. [if there is something on the s_3]On the showcase you can make out [a list of things on the s_3].[end if]".
The supermarket part 1 is some text that varies. The supermarket part 1 is "[if there is nothing on the s_3]But the thing hasn't got anything on it. What's the point of an empty showcase?[end if]".
...
The street part 0 is some text that varies. The street part 0 is "I just think it's awesome that you're in a street now. I guess you better just go and list everything you see here.
...
The livingroom part 0 is some text that varies. The livingroom part 0 is "You've just walked into a livingroom.
 ...
 You can make out a sofa. [if there is something on the s_7]You see [a list of things on the s_7] on the sofa. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[end if]".
...
The livingroom part 3 is some text that varies. The livingroom part 3 is " front door leading north. There is an exit to the south. You need an exit without a door? You should try going west.".
...
The pantry part 0 is some text that varies. The pantry part 0 is "I am so happy to announce that you are now in the pantry. You begin looking for stuff.
...
The shed part 0 is some text that varies. The shed part 0 is "You are in a shed. A normal one. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The shed part 2 is some text that varies. The shed part 2 is " You smell a wretched smell, and follow it to a workbench. The workbench is wooden.[if there is something on the s_8] On the workbench you see [a list of things on the s_8]. Suddenly, you bump your head on the ceiling, but it's not such a bad bump that it's going to prevent you from looking at objects and even things.[end if]".
The shed part 3 is some text that varies. The shed part 3 is "[if there is nothing on the s_8] But oh no! there's nothing on this piece of garbage. Aw, here you were, all excited for there to be things on it![end if]".
...
The f_10 and the f_4 and the f_5 and the f_6 and the f_0 and the f_1 and the f_2 and the f_3 and the f_7 and the f_8 and the f_9 are foods.
The f_10 and the f_4 and the f_5 and the f_6 and the f_0 and the f_1 and the f_2 and the f_3 and the f_7 and the f_8 and the f_9 are privately-named.
...
The r_0 and the r_6 and the r_1 and the r_4 and the r_11 and the r_10 and the r_2 and the r_3 and the r_7 and the r_9 and the r_5 and the r_8 are rooms.
The r_0 and the r_6 and the r_1 and the r_4 and the r_11 and the r_10 and the r_2 and the r_3 and the r_7 and the r_9 and the r_5 and the r_8 are privately-named.
...
The printed name of f_10 is "parsley".
Understand "parsley" as f_10.
The f_10 is in r_7.
...
The printed name of f_6 is "olive oil".
The indefinite article of f_6 is "some".
Understand "olive oil" as f_6.
Understand "olive" as f_6.
Understand "oil" as f_6.
...
Test quest1_0 with "inventory / open patio door / go east / examine cookbook / open plain door / go north / take olive oil from shelf"
...
Test quest4_0 with "inventory / open patio door / go east / examine cookbook / open plain door / go north / take olive oil from shelf / take olive oil from shelf / go south / prepare meal"
...
Test quest5_0 with "inventory / open patio door / go east / examine cookbook / open plain door / go north / take olive oil from shelf / take olive oil from shelf / go south / prepare meal / eat meal"
