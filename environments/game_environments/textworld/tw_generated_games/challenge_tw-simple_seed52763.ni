...
The kitchen part 0 is some text that varies. The kitchen part 0 is "You arrive in a kitchen. A standard one.
 ...
 You rest your hand against a wall, but you miss the wall and fall onto a refrigerator. Hmmm... what else, what else?[if c_2 is open and there is something in the c_2] The refrigerator contains [a list of things in the c_2]. Hmmm... what else, what else?[end if]".
...
The kitchen part 2 is some text that varies. The kitchen part 2 is " You can see a counter. The counter is ordinary.[if there is something on the s_1] On the counter you see [a list of things on the s_1]. Now that's what I call TextWorld![end if]".
...
The kitchen part 4 is some text that varies. The kitchen part 4 is " You smell an interesting smell, and follow it to a stove. Make a note of this, you might have to put stuff on or in it later on. [if there is something on the s_2]On the stove you make out [a list of things on the s_2].[end if]".
...
The kitchen part 6 is some text that varies. The kitchen part 6 is " Oh, great. Here's a kitchen island. [if there is something on the s_3]You see [a list of things on the s_3] on the kitchen island.[end if]".
...
The kitchen part 10 is some text that varies. The kitchen part 10 is " wooden door leading west. You need an unblocked exit? You should try going north. You need an unblocked exit? You should try going south.".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You arrive in a bedroom. An usual kind of place. The room is well lit.
...
The bedroom part 5 is some text that varies. The bedroom part 5 is " You can see a king-size bed. [if there is something on the s_0]On the king-size bed you can see [a list of things on the s_0].[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " You can see a bbq. The bbq is standard.[if there is something on the s_8] On the bbq you see [a list of things on the s_8].[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " You can see a patio table. [if there is something on the s_9]You see [a list of things on the s_9] on the patio table, so there's that.[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You find yourself in a living room. An usual kind of place.
 ...
 What's that over there? It looks like it's a couch. [if there is something on the s_5]You see [a list of things on the s_5] on the couch.[end if]".
...
The living room part 5 is some text that varies. The living room part 5 is "[if there is nothing on the s_7]But the thing is empty. Aw, and here you were, all excited for there to be things on it![end if]".
...
The bathroom part 5 is some text that varies. The bathroom part 5 is " You scan the room for a sink, and you find a sink. You wonder idly who left that here. The sink is normal.[if there is something on the s_4] On the sink you make out [a list of things on the s_4]. Something scurries by right in the corner of your eye. Probably nothing.[end if]".
