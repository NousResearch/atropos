...
The kitchen part 4 is some text that varies. The kitchen part 4 is " As if things weren't amazing enough already, you can even see a table. [if there is something on the s_0]On the table you can make out [a list of things on the s_0].[end if]".
...
Test quest1_0 with "inventory / examine cookbook / take cilantro from fridge"
...
Test quest4_0 with "inventory / examine cookbook / take cilantro from fridge / prepare meal"
...
Test quest5_0 with "inventory / examine cookbook / take cilantro from fridge / prepare meal / eat meal"
