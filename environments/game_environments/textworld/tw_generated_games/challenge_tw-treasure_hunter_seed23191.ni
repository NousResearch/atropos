...
The cookery part 0 is some text that varies. The cookery part 0 is "You are in a cookery. A normal one. I guess you better just go and list everything you see here.
...
The kitchen part 0 is some text that varies. The kitchen part 0 is "This might come as a shock to you, but you've just entered a kitchen. You begin looking for stuff.
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! First stop, make an effort to go north. Next, retrieve the banana from the floor of the bedroom. Once that's all handled, you can stop!".
