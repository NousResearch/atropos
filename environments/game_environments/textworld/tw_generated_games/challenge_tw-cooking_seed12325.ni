...
The r_0 and the r_3 and the r_1 and the r_10 and the r_9 and the r_11 and the r_2 and the r_4 and the r_5 and the r_8 and the r_6 and the r_7 are rooms.

Understand "kitchen" as r_0.
The internal name of r_0 is "kitchen".
The printed name of r_0 is "-= Kitchen =-".
The kitchen part 0 is some text that varies. The kitchen part 0 is "You are in a kitchen. A standard one. Let's see what's in here.

 You hear a noise behind you and spin around, but you can't see anything other than a fridge. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[if c_0 is open and there is something in the c_0] The fridge contains [a list of things in the c_0].[end if]".
...
The kitchen part 4 is some text that varies. The kitchen part 4 is " What's that over there? It looks like it's a table. The table is massive.[if there is something on the s_0] On the table you can see [a list of things on the s_0].[end if]".
...
The kitchen part 8 is some text that varies. The kitchen part 8 is " What's that over there? It looks like it's a stove. [if there is something on the stove_0]On the stove you can make out [a list of things on the stove_0]. There's something strange about this being here, but you can't put your finger on it.[end if]".
The kitchen part 9 is some text that varies. The kitchen part 9 is "[if there is nothing on the stove_0]Looks like someone's already been here and taken everything off it, though. Hopefully this doesn't make you too upset.[end if]".
...
The kitchen part 12 is some text that varies. The kitchen part 12 is " screen door leading north. There is an exit to the south. You don't like doors? Why not try going west, that entranceway is not blocked by one.".
...
The supermarket part 1 is some text that varies. The supermarket part 1 is "[if there is nothing on the s_3] However, the showcase, like an empty showcase, has nothing on it. You move on, clearly furious with your TextWorld experience.[end if]".
...
The livingroom part 2 is some text that varies. The livingroom part 2 is "
 ...
 There is [if d_3 is open]an open[otherwise]a closed[end if]".
The livingroom part 3 is some text that varies. The livingroom part 3 is " front door leading south. There is an exit to the north. Don't worry, there is no door. There is an exit to the west.".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You've just shown up in a bedroom.
 ...
 You can see a bed. The bed is large.[if there is something on the s_9] On the bed you see [a list of things on the s_9]. Classic TextWorld.[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "Look around you. Take it all in. It's not every day someone gets to be in a bathroom.
 ...
 You hear a noise behind you and spin around, but you can't see anything other than a toilet. The toilet is white.[if there is something on the s_8] On the toilet you can see [a list of things on the s_8].[end if]".
The bathroom part 1 is some text that varies. The bathroom part 1 is "[if there is nothing on the s_8] The toilet appears to be empty. You move on, clearly upset with TextWorld.[end if]".
...
The shed part 1 is some text that varies. The shed part 1 is " toolbox, which looks metallic, is in the room.[if c_1 is open and there is something in the c_1] The toolbox contains [a list of things in the c_1].[end if]".
...
The shed part 3 is some text that varies. The shed part 3 is " You see a workbench. You wonder idly who left that here. [if there is something on the s_6]You see [a list of things on the s_6] on the workbench.[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You find yourself in a backyard. An usual kind of place. The room is well lit.

 You see a gleam over in a corner, where you can see a patio chair. The patio chair is stylish.[if there is something on the s_4] On the patio chair you make out [a list of things on the s_4].[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " You can make out a patio table. [if there is something on the s_7]On the patio table you make out [a list of things on the s_7]. Now that's what I call TextWorld![end if]".
...
The garden part 0 is some text that varies. The garden part 0 is "You arrive in a garden. A typical one. Let's see what's in here.
...
The f_6 and the f_8 and the f_2 and the f_7 and the f_9 and the f_0 and the f_1 and the f_3 and the f_4 and the f_5 and the f_10 are foods.
The f_6 and the f_8 and the f_2 and the f_7 and the f_9 and the f_0 and the f_1 and the f_3 and the f_4 and the f_5 and the f_10 are privately-named.
...
The r_0 and the r_3 and the r_1 and the r_10 and the r_9 and the r_11 and the r_2 and the r_4 and the r_5 and the r_8 and the r_6 and the r_7 are rooms.
The r_0 and the r_3 and the r_1 and the r_10 and the r_9 and the r_11 and the r_2 and the r_4 and the r_5 and the r_8 and the r_6 and the r_7 are privately-named.
...
The printed name of f_8 is "parsley".
Understand "parsley" as f_8.
The f_8 is in r_7.
The f_8 is cuttable.
The f_8 is edible.
The f_8 is uncut.
...
The printed name of f_10 is "flour".
Understand "flour" as f_10.
The f_10 is edible.
...
Test quest1_0 with "inventory / inventory / go west / go west / go south / examine cookbook / drop red potato / drop block of cheese / drop red onion / take purple potato from counter"
...
Test quest5_0 with "inventory / inventory / go west / go west / go south / examine cookbook / drop red potato / drop block of cheese / drop red onion / take purple potato from counter / take pork chop from fridge"
...
Test quest9_0 with "inventory / inventory / go west / go west / go south / examine cookbook / drop red potato / drop block of cheese / drop red onion / take purple potato from counter / take pork chop from fridge / take white onion from fridge"
...
Test quest12_0 with "inventory / inventory / go west / go west / go south / examine cookbook / drop red potato / drop block of cheese / drop red onion / take purple potato from counter / take pork chop from fridge / take white onion from fridge / prepare meal"
...
Test quest13_0 with "inventory / inventory / go west / go west / go south / examine cookbook / drop red potato / drop block of cheese / drop red onion / take purple potato from counter / take pork chop from fridge / take white onion from fridge / prepare meal / eat meal"
