...
The cellar part 0 is some text that varies. The cellar part 0 is "You find yourself in a cellar. An usual one. You start to take note of what's in the room.
...
Test quest0_0 with "go north / go west / go south / go east / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. Your first objective is to go north. Then, make an attempt to move west. Next, move south. And then, go ".
The objective part 1 is some text that varies. The objective part 1 is "to the east. And then, recover the coin from the floor of the closet. And once you've done that, you win!".
