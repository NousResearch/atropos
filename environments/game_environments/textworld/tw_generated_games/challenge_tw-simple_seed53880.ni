...
The kitchen part 2 is some text that varies. The kitchen part 2 is " Were you looking for a counter? Because look over there, it's a counter. The counter is usual.[if there is something on the s_1] On the counter you can make out [a list of things on the s_1]. You shudder, but continue examining the room.[end if]".
...
The kitchen part 4 is some text that varies. The kitchen part 4 is " Oh wow! Is that what I think it is? It is! It's a stove. The stove is ordinary.[if there is something on the s_2] On the stove you make out [a list of things on the s_2]. Hmmm... what else, what else?[end if]".
...
The bedroom part 6 is some text that varies. The bedroom part 6 is "[if there is nothing on the s_0]The king-size bed appears to be empty. What's the point of an empty king-size bed?[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You are in a backyard. A typical kind of place. You try to gain information on your surroundings by using a technique you call 'looking.'

 If you haven't noticed it already, there seems to be something there by the wall, it's a set of chairs. The set of chairs is typical.[if there is something on the s_10] On the set of chairs you can make out [a list of things on the s_10].[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " You smell a wretched smell, and follow it to a bbq. The bbq is typical.[if there is something on the s_8] On the bbq you see [a list of things on the s_8].[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " You scan the room for a patio table, and you find a patio table. The patio table is typical.[if there is something on the s_9] On the patio table you can make out [a list of things on the s_9].[end if]".
The backyard part 5 is some text that varies. The backyard part 5 is "[if there is nothing on the s_9] However, the patio table, like an empty patio table, has nothing on it. You move on, clearly done caring about your TextWorld experience.[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You arrive in a living room. An usual kind of place.

 You can see a couch. [if there is something on the s_5]On the couch you make out [a list of things on the s_5]. You shudder, but continue examining the room.[end if]".
...
The living room part 2 is some text that varies. The living room part 2 is " You make out a low table. What a coincidence, weren't you just thinking about a low table? The low table is usual.[if there is something on the s_6] On the low table you see [a list of things on the s_6].[end if]".
...
The living room part 4 is some text that varies. The living room part 4 is " You see a tv. The tv is typical.[if there is something on the s_7] On the tv you make out [a list of things on the s_7].[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You've stumbled into a normal room. Your mind races to think of what kind of room would be normal. And then it hits you. Of course. You're in the bathroom. The room is well lit.

 You see a toilet.[if c_3 is open and there is something in the c_3] The toilet contains [a list of things in the c_3]. Make a note of this, you might have to put stuff on or in it later on.[end if]".
...
The bathroom part 2 is some text that varies. The bathroom part 2 is " You can see a bath.[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4]. Make a note of this, you might have to put stuff on or in it later on.[end if]".
...
The bathroom part 4 is some text that varies. The bathroom part 4 is " You see a sink. Now why would someone leave that there? The sink is typical.[if there is something on the s_4] On the sink you can see [a list of things on the s_4]. You can't wait to tell the folks at home about this![end if]".
...
The description of f_2 is "The bell pepper looks tasty.".
