...
The basement part 0 is some text that varies. The basement part 0 is "You are in a basement. An usual kind of place. You begin looking for stuff.
...
The cellar part 0 is some text that varies. The cellar part 0 is "This might come as a shock to you, but you've just stumbled into a cellar. I guess you better just go and list everything you see here.
...
Test quest0_0 with "go south / go east / go east / go east / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Here is how to play! First stop, attempt to travel south. And then, go to the east. And then, try to move east. Then, take a trip east. Then, retri".
The objective part 1 is some text that varies. The objective part 1 is "eve the coin from the floor of the basement. And once you've done that, you win!".
