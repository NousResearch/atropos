...
The kitchenette part 0 is some text that varies. The kitchenette part 0 is "You find yourself in a kitchenette. An ordinary kind of place. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The cookhouse part 0 is some text that varies. The cookhouse part 0 is "Look around you. Take it all in. It's not every day someone gets to be in a cookhouse. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The cubicle part 0 is some text that varies. The cubicle part 0 is "Look at that board! What does it say? It says Welcome to the cubicle? Well that's cool.
...
Test quest0_0 with "go west / go south / go south / go west / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Here is your task for today. Your first objective is to try to head west. After that, attempt to head south. After that, attempt to travel south. T".
The objective part 1 is some text that varies. The objective part 1 is "hat done, try to travel west. And then, pick up the coin from the floor of the studio. Once that's all handled, you can stop!".
