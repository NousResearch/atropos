...
The canteen part 0 is some text that varies. The canteen part 0 is "You've fallen into a typical room. Your mind races to think of what kind of room would be typical. And then it hits you. Of course. You're in the canteen. Okay, just remember what you're here to do, and everything will go great.
...
Test quest0_0 with "go east / go east / take knife"
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Here is how to play! First stop, make an attempt to go to the east. Following that, venture east. After that, pi".
The objective part 1 is some text that varies. The objective part 1 is "ck up the knife from the floor of the kitchenette. Got that? Good!".
