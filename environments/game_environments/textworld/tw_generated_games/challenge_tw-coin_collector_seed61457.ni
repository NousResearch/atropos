...
The salon part 0 is some text that varies. The salon part 0 is "Look around you. Take it all in. It's not every day someone gets to be in a salon.
...
The spare room part 0 is some text that varies. The spare room part 0 is "This might come as a shock to you, but you've just walked into a spare room.
...
Test quest0_0 with "go south / go south / go west / go south / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. Your first objective is to try to move south. And then, try to venture south. And then, attempt to go to".
The objective part 1 is some text that varies. The objective part 1 is " the west. After that, head south. Next, recover the coin from the floor of the office. And if you do that, you're the winner!".
