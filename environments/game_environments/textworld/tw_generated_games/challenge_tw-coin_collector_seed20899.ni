...
The canteen part 0 is some text that varies. The canteen part 0 is "This might come as a shock to you, but you've just moved into a canteen. Let's see what's in here.
...
The cookhouse part 0 is some text that varies. The cookhouse part 0 is "Look at you, bigshot, walking into a cookhouse like it isn't some huge deal. You start to take note of what's in the room.
...
The description of o_0 is "The coin is clean.".
...
Test quest0_0 with "go south / go west / go north / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a fast paced game of TextWorld! Here is your task for today. Your first objective is to travel south. Okay, and then, head west. That done, take a trip north. If you can accomplish".
The objective part 1 is some text that varies. The objective part 1 is " that, recover the coin from the floor of the cookhouse. And if you do that, you're the winner!".
