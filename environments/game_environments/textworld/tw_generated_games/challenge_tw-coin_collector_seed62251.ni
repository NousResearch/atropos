...
The attic part 0 is some text that varies. The attic part 0 is "You arrive in an attic. A normal kind of place. You begin looking for stuff.
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! Here is your task for today. First of all, you could, like, make an attempt to head west. Then, a".
The objective part 1 is some text that varies. The objective part 1 is "ttempt to go to the west. Then, pick-up the coin from the floor of the workshop. That's it!".
