...
The kitchen part 1 is some text that varies. The kitchen part 1 is " refrigerator is right there by you.[if c_2 is open and there is something in the c_2] The refrigerator contains [a list of things in the c_2]. Now that's what I call TextWorld![end if]".
...
The kitchen part 3 is some text that varies. The kitchen part 3 is " You can make out a counter. The counter is normal.[if there is something on the s_1] On the counter you can see [a list of things on the s_1].[end if]".
...
The kitchen part 6 is some text that varies. The kitchen part 6 is "[if there is nothing on the s_2]The stove appears to be empty. Aw, and here you were, all excited for there to be things on it![end if]".
The kitchen part 7 is some text that varies. The kitchen part 7 is " Oh, great. Here's a kitchen island. The kitchen island is normal.[if there is something on the s_3] On the kitchen island you make out [a list of things on the s_3].[end if]".
...
The kitchen part 11 is some text that varies. The kitchen part 11 is " wooden door leading west. You need an unblocked exit? You should try going north. You don't like doors? Why not try going south, that entranceway is unblocked.".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You are in a bedroom. A normal kind of place. Okay, just remember what you're here to do, and everything will go great.

 You can make out [if c_0 is locked]a locked[else if c_0 is open]an opened[otherwise]a closed[end if]".
The bedroom part 1 is some text that varies. The bedroom part 1 is " chest drawer close by.[if c_0 is open and there is something in the c_0] The chest drawer contains [a list of things in the c_0].[end if]".
...
The bedroom part 3 is some text that varies. The bedroom part 3 is " You can make out an antique trunk.[if c_1 is open and there is something in the c_1] The antique trunk contains [a list of things in the c_1].[end if]".
...
The bedroom part 5 is some text that varies. The bedroom part 5 is " You see a king-size bed. The king-size bed is normal.[if there is something on the s_0] On the king-size bed you can see [a list of things on the s_0].[end if]".
The bedroom part 6 is some text that varies. The bedroom part 6 is "[if there is nothing on the s_0] However, the king-size bed, like an empty king-size bed, has nothing on it. Aw, here you were, all excited for there to be things on it![end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You've come into an ordinary room. Your mind races to think of what kind of room would be ordinary. And then it hits you. Of course. You're in the backyard.
...
The backyard part 1 is some text that varies. The backyard part 1 is "[if there is nothing on the s_10]The set of chairs appears to be empty. This always happens![end if]".
The backyard part 2 is some text that varies. The backyard part 2 is " You see a gleam over in a corner, where you can see a bbq. The bbq is ordinary.[if there is something on the s_8] On the bbq you can make out [a list of things on the s_8].[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "Well I'll be, you are in the place we're calling the living room. You decide to just list off a complete list of everything you see in the room, because hey, why not?

 You make out a couch. Make a note of this, you might have to put stuff on or in it later on. [if there is something on the s_5]On the couch you see [a list of things on the s_5]. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[end if]".
The living room part 1 is some text that varies. The living room part 1 is "[if there is nothing on the s_5]But oh no! there's nothing on this piece of junk. Oh! Why couldn't there just be stuff on it?[end if]".
...
The living room part 4 is some text that varies. The living room part 4 is " You make out a tv. The tv is standard.[if there is something on the s_7] On the tv you see [a list of things on the s_7].[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "Wow! You're in a bathroom. You begin to take stock of what's in the room.

 You scan the room, seeing a toilet.[if c_3 is open and there is something in the c_3] The toilet contains [a list of things in the c_3]. I mean, just wow! Isn't TextWorld just the best?[end if]".
...
The bathroom part 2 is some text that varies. The bathroom part 2 is " You can see a bath. Now why would someone leave that there?[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4].[end if]".
...
The bathroom part 4 is some text that varies. The bathroom part 4 is " You scan the room for a sink, and you find a sink. The sink is typical.[if there is something on the s_4] On the sink you make out [a list of things on the s_4]. Hmmm... what else, what else?[end if]".
...
The garden part 0 is some text that varies. The garden part 0 is "You're now in a garden. You can barely contain your excitement.
...
The d_0 is locked.
The description of d_1 is "it's a stuffy screen door [if open]You can see inside it.[else if closed]You can't see inside it because the lid's in your way.[otherwise]There is a lock on it.[end if]".
...
The f_3 is in r_5.
The f_3 is edible.
The description of f_4 is "The milk looks delectable.".
...
The s_9 is in r_4.
The description of f_0 is "that's an usual bell pepper!".
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another life changing game of TextWorld! Here is how to play! First off, if it's not too much trouble, I need you to make it so that the antique trunk is wide open. After that, retrieve the".
The objective part 1 is some text that varies. The objective part 1 is " old key from the antique trunk in the bedroom. If you can get your hands on the old key, make absolutely sure that the wooden door within the bedroom is unlocked. After that, doublecheck that the woo".
The objective part 2 is some text that varies. The objective part 2 is "den door within the bedroom is open. Then, travel east. Once you finish that, assure that the screen door inside the kitchen is wide open. And then, try to go east. Then, go south. If you can accompli".
The objective part 3 is some text that varies. The objective part 3 is "sh that, recover the lettuce from the floor of the garden. And then, make an effort to take a trip north. Then, venture west. With that done, put the lettuce on the stove. And once you've done that, y".
The objective part 4 is some text that varies. The objective part 4 is "ou win!".
