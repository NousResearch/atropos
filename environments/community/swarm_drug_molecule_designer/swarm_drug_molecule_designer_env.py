...
class SwarmMoleculeConfig(BaseEnvConfig):
    system_prompt: Optional[str] = Field("You are a swarm molecular designer. Return optimized atom index.", description="System prompt")

class SwarmMoleculeEnv(BaseEnv):
    env_config_cls = SwarmMoleculeConfig

    async def get_next_item(self):
        prompt = "Seek optimized bond atomic position slot (0 to 4) under ant colony pheromones."
