...
class MyceliumNutrientConfig(BaseEnvConfig):
    system_prompt: Optional[str] = Field(
        "You compute mycelial nutrient flux. Return the midpoint flux value.",
...
class MyceliumNutrientEnv(BaseEnv):
    ...
    async def get_next_item(self):
        prompt = (
            "Compute mycelium nutrient flux midpoint for source=100.0 and drain=50.0."
        )
        return (
