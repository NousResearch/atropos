...
class ChladniEmbeddingConfig(BaseEnvConfig):
    system_prompt: Optional[str] = Field("You compute Chladni resonance amplitudes. Return float.", description="System prompt")

class ChladniEmbeddingEnv(BaseEnv):
    env_config_cls = ChladniEmbeddingConfig
    async def get_next_item(self):
        prompt = "Compute Chladni resonance amplitude at position (0.5, 0.5) with mode n=2, m=3."
