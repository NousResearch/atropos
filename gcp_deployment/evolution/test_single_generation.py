...
def run_test():
    ...
    for gen in range(10):
        ...
        print(f"  Best cue: glow={population[0].glow:.2f}, "
        ...
        if len(population) > 1: 
            ...
            if top_half_count == 0 and len(population) > 0 : top_half_count = 1
            ...
            for _ in range(offspring_count):
                ...
                mutated_cue = VisualCueTest(
                    ...
                    pulse_hz=max(0.5, min(5.0, parent.pulse_hz + random.uniform(-0.5, 0.5))),
