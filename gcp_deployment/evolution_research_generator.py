...
async def evaluate_vr_fitness(parameters):
    ...
    fitness = base_performance + glow_bonus + pulse_bonus + hue_bonus + blur_penalty + size_bonus + transparency_bonus + noise
...
def analyze_convergence(generation_stats):
    ...
    return {
        ...
        "improvement": generation_stats[-1]["max_fitness"] - generation_stats[0]["max_fitness"]
    }
